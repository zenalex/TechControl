...
{
    public partial class РегистрыРегистрПерсоналОбъектаДвижения
{
    [NsgTypeName("NsgDataTableRow", Guid = "3204e112-4eaf-49ea-b83c-4826a641dd85")]
    public partial class Строка : NsgSoft.DataObjects.NsgDataTableRow
    {
        ...
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("3204e112-4eaf-49ea-b83c-4826a641dd85"));
            if (obj == null)
                obj = new Строка();
        ...
        public override NsgMultipleObjectDescriptor Descriptor
        {
            get
            {
                if (descriptor == null)
                {
                    ...
                    descriptor.Name = "РегистрыРегистрПерсоналОбъектаДвижения";
