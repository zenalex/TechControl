...
namespace TechControl.Метаданные._SystemTables
{
    ...
    [NsgTypeName("NsgDataTable", Guid = "6df6157e-2916-4f55-8dfd-3fca751c151c")]
    public partial class РегистрыРегистрТехникаОбъектаДвижения : NsgSoft.DataObjects.NsgDataTable
    {
        #region Данные
        ...
        /// Создание объекта
        /// </summary>
        protected РегистрыРегистрТехникаОбъектаДвижения()
            : base()
        {
        }
        ...
        /// </summary>
        protected РегистрыРегистрТехникаОбъектаДвижения(NsgObject obj)
            : base(obj)
        {
        }
        ...
        public static РегистрыРегистрТехникаОбъектаДвижения Новый()
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("6df6157e-2916-4f55-8dfd-3fca751c151c"));
            if (obj == null)
                obj = new РегистрыРегистрТехникаОбъектаДвижения();
            return obj as РегистрыРегистрТехникаОбъектаДвижения;
        }
	...
	Идентификатор.Guid = NsgService.StringToGuid("e2fa7ac2-2c54-4f15-bce2-544f0bd3c245");
	...
	Автоинкремент.Guid = NsgService.StringToGuid("e7ed3a39-550f-472b-a941-549e75ae13f7");
	...
	Владелец.GroupName = "";
	Владелец.Guid = NsgService.StringToGuid("20f2b7a5-5df3-45ab-8dc9-b6ccd7af71eb");
	...
	OwnerFullName = "Регистры.РегистрТехникаОбъекта";
	RegisterPeriod = NsgSoft.Common.NsgPeriod.None;
	RegisterPeriodCount = 1;
	TableSubType = NsgSoft.Common.NsgTableSubType.RegisterCharacteristicsTable;
	EntityType = NsgSoft.DataObjects.NsgInterfacedObject.EntityTypes.Object;
	Name = "РегистрыРегистрТехникаОбъектаДвижения";
	Visible = true;
	Guid = NsgService.StringToGuid("6df6157e-2916-4f55-8dfd-3fca751c151c");
	DefaultSortingName = "";
	...
	TableName = "_tab_RegistryRegistrTekh";
	Presentation = new NsgSoft.DataObjects.NsgLanguageString(new System.String[]{"(Default)"},
		 new System.Object[]{""});
	Description = "Регистры регистр техника объекта движения";
	...
	GroupName = "_SystemTables";
        ...
        {
            return "_SystemTables.РегистрыРегистрТехникаОбъектаДвижения";
        }
        ...
        /// </summary>
        public new РегистрыРегистрТехникаОбъектаДвижения.Строка NewRow()
        {
            return newRow(null) as РегистрыРегистрТехникаОбъектаДвижения.Строка;
        }
        ...
        {
            if (row == null)
                row = new РегистрыРегистрТехникаОбъектаДвижения.Строка(this);
            return base.newRow(row) as РегистрыРегистрТехникаОбъектаДвижения.Строка;
        }

        /// <summary>
        /// Добавить новую строку в таблицу путем копирования переданной строки
        /// </summary>
        public РегистрыРегистрТехникаОбъектаДвижения.Строка NewRow(РегистрыРегистрТехникаОбъектаДвижения.Строка inRow)
        {
            РегистрыРегистрТехникаОбъектаДвижения.Строка row = inRow.Clone as РегистрыРегистрТехникаОбъектаДвижения.Строка;
            return base.newRow(row) as РегистрыРегистрТехникаОбъектаДвижения.Строка;
        }
        ...
        /// </summary>
        public new РегистрыРегистрТехникаОбъектаДвижения.Строка GetRow(int rowNumber)
        {
            return base.GetRow(rowNumber) as РегистрыРегистрТехникаОбъектаДвижения.Строка;
        }

        /// <summary>
        /// Возвращает новую строку таблицы, но в саму таблицу ее не включает (эталонная строка)
        /// </summary>
        public new РегистрыРегистрТехникаОбъектаДвижения.Строка GetEtalonRow()
        {
            РегистрыРегистрТехникаОбъектаДвижения.Строка row = new РегистрыРегистрТехникаОбъектаДвижения.Строка(this);
            row.MetaData = MetaData;
            return row;
        }

        private РегистрыРегистрТехникаОбъектаДвижения.Строка[] convertRowsArray(NsgDataTableRow[] array)
        {
            РегистрыРегистрТехникаОбъектаДвижения.Строка[] res = new РегистрыРегистрТехникаОбъектаДвижения.Строка[array.Length];
            array.CopyTo(res, 0);
            return res;
        }
        ...
        public new РегистрыРегистрТехникаОбъектаДвижения.Строка FindRowByTag(object Tag)
        {
            return base.FindRowByTag(Tag) as РегистрыРегистрТехникаОбъектаДвижения.Строка;
        }
        ...
        /// <param name="compare">Критерии поиска.</param>
        /// <returns>Найденные строки.</returns>
        public new РегистрыРегистрТехникаОбъектаДвижения.Строка[] FindRowsByTag(object Tag)
        {
        ...
        /// <param name="compare">Критерии поиска.</param>
        /// <returns>Найденные строки.</returns>
        public new РегистрыРегистрТехникаОбъектаДвижения.Строка FindRow(NsgCompare compare)
        {
            return base.FindRow(compare) as РегистрыРегистрТехникаОбъектаДвижения.Строка;
        }
        ...
        /// <returns>Найденные строки.</returns>
        public new РегистрыРегистрТехникаОбъектаДвижения.Строка FindRow(string inName, object inValue)
        {
            return base.FindRow(inName, inValue) as РегистрыРегистрТехникаОбъектаДвижения.Строка;
        }
        ...
        /// <param name="inValue">Значение поля.</param>
        /// <returns>Найденные строки.</returns>
        public new РегистрыРегистрТехникаОбъектаДвижения.Строка FindRow(NsgDataFixedFields inName, object inValue)
        {
            return base.FindRow(inName, inValue) as РегистрыРегистрТехникаОбъектаДвижения.Строка;
        }
        ...
        /// <param name="compare">Критерии поиска.</param>
        /// <returns>Найденные строки.</returns>
        public new РегистрыРегистрТехникаОбъектаДвижения.Строка[] FindRows(NsgCompare compare)
        {
        ...
        /// <param name="inValue">Значение поля.</param>
        /// <returns>Найденные строки.</returns>
        public new РегистрыРегистрТехникаОбъектаДвижения.Строка[] FindRows(string inName, object inValue)
        {
        ...
        /// <param name="inValue">Значение поля.</param>
        /// <returns>Найденные строки.</returns>
        public new РегистрыРегистрТехникаОбъектаДвижения.Строка[] FindRows(NsgDataFixedFields inName, object inValue)
        {
            return convertRowsArray(base.FindRows(inName, inValue));
        }
        ...
        /// </summary>
        public  NsgVirtualCursor<РегистрыРегистрТехникаОбъектаДвижения> GetNewVirtualCursor()
        {
            return base.GetNewVirtualCursor<РегистрыРегистрТехникаОбъектаДвижения>();
        }

        /// <summary>
        /// Получить все строки таблицы с учетом наложенного фильтра. Для получения всех сьтрок без учета фильтра используется свойство AllRows
        /// </summary>
        public new РегистрыРегистрТехникаОбъектаДвижения.Строка[] Rows
        {
            get
            {
        ...
        /// </summary>
        public new РегистрыРегистрТехникаОбъектаДвижения.Строка[] AllRows
        {
            get
            {
        ...
        /// <returns>Найденные строки.</returns>
        public new РегистрыРегистрТехникаОбъектаДвижения.Строка GetRow(Guid inID)
        {
            return base.GetRow(inID) as РегистрыРегистрТехникаОбъектаДвижения.Строка;
        }
        #endregion
        ...
        private РегистрыРегистрТехникаОбъектаДвижения[] convertArray(NsgMultipleObject[] array)
        {
            РегистрыРегистрТехникаОбъектаДвижения[] res = new РегистрыРегистрТехникаОбъектаДвижения[array.Length];
            array.CopyTo(res, 0);
            return res;
        }
        ...
        public new virtual РегистрыРегистрТехникаОбъектаДвижения[] FindAll(NsgCompare compare)
        {
        ...
        /// <returns>Список найденных объектов.</returns>
        public new virtual РегистрыРегистрТехникаОбъектаДвижения[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, NsgCompare compare)
        {
        ...
        /// <returns>Список найденных объектов.</returns>
        public new virtual РегистрыРегистрТехникаОбъектаДвижения[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, string inName, object inValue)
        {
        ...
        /// <param name="inValue">Значение для поиска. Условие поиска - полное совпадение.</param>
        /// <returns>Список найденных объектов.</returns>
        public new virtual РегистрыРегистрТехникаОбъектаДвижения[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, NsgDataFixedFields inName,
            object inValue)
        {
            return convertArray(base.FindAll(ref count, row_start, sorting, inName, inValue));
        }
        ...
        public override NsgObject CloneObject
        {
            get
            {
                return new РегистрыРегистрТехникаОбъектаДвижения(this as NsgObject);
            }
        }
        ...
        public new class ColumnDescriptor : NsgSoft.Forms.NsgColumnDescriptor
        {
            public ColumnDescriptor()
                : base()
            {
                base.NSGType = typeof(РегистрыРегистрТехникаОбъектаДвижения);
            }
			...
			public new РегистрыРегистрТехникаОбъектаДвижения Value
            {
                get
                {
                    return (РегистрыРегистрТехникаОбъектаДвижения)base.Value;
                }
                set
                {
                    base.Value = value;
