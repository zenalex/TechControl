...
{
    public partial class РегистрыРегистрТехникаОбъектаДвижения
{
    [NsgTypeName("NsgDataTableRow", Guid = "6df6157e-2916-4f55-8dfd-3fca751c151c")]
    public partial class Строка : NsgSoft.DataObjects.NsgDataTableRow
    {
        ...
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("6df6157e-2916-4f55-8dfd-3fca751c151c"));
            if (obj == null)
                obj = new Строка();
        ...
        public override NsgMultipleObjectDescriptor Descriptor
        {
            get
            {
                if (descriptor == null)
                {
                    ...
                    descriptor.Name = "РегистрыРегистрТехникаОбъектаДвижения";
