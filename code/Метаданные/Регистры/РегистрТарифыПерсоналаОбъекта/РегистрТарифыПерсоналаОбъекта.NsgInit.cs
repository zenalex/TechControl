...
namespace TechControl.Метаданные.Регистры
{
    ...
    [NsgTypeName("NsgDataCharacteristics", Guid = "4be8e95d-3344-45b7-b97c-ddbd14535c04")]
    public partial class РегистрТарифыПерсоналаОбъекта : NsgSoft.DataObjects.NsgDataCharacteristics
    {
        #region Данные
        ...
        /// </summary>
        public static РегистрТарифыПерсоналаОбъекта Новый(NsgDataDocument document)
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("4be8e95d-3344-45b7-b97c-ddbd14535c04"));
            if (obj == null)
                obj = new РегистрТарифыПерсоналаОбъекта();
            (obj as РегистрТарифыПерсоналаОбъекта).Document = document;
            return obj as РегистрТарифыПерсоналаОбъекта;
        }
        ...
        /// Создание объекта
        /// </summary>
        protected РегистрТарифыПерсоналаОбъекта()
            : base()
        {
        }
        ...
        /// </summary>
        protected РегистрТарифыПерсоналаОбъекта(NsgObject obj)
            : base(obj)
        {
        }
        ...
        public static РегистрТарифыПерсоналаОбъекта Новый()
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("4be8e95d-3344-45b7-b97c-ddbd14535c04"));
            if (obj == null)
                obj = new РегистрТарифыПерсоналаОбъекта();
	...
	Идентификатор.Guid = NsgService.StringToGuid("d575e58b-36a9-4034-bd0a-024460480a9c");
	...
	Автоинкремент.Guid = NsgService.StringToGuid("b32cfe83-96fc-4519-90a5-d58a7bebc2c1");
			...
			#region создание _SystemTables.РегистрыРегистрТарифыПерсоналаОбъектаДвижения Движения
			{  
	...
	Движения.ReferentName = "РегистрыРегистрТарифыПерсоналаОбъектаДвижения";
	...
	Движения.GroupName = "";
	Движения.Guid = NsgService.StringToGuid("ceaee6ec-0c4e-4e25-920e-4dd1278b21d2");
	
				if (!ObjectList.Contains("Движения"))
                    ObjectList.Add(Движения);
			}
			#endregion //создание _SystemTables.РегистрыРегистрТарифыПерсоналаОбъектаДвижения Движения
	...
	Владелец.GroupName = "";
	Владелец.Guid = NsgService.StringToGuid("f23adb9e-1dca-475f-8a2f-70672d51c0dc");
	...
	Name = "РегистрТарифыПерсоналаОбъекта";
	Visible = true;
	Guid = NsgService.StringToGuid("4be8e95d-3344-45b7-b97c-ddbd14535c04");
	DefaultSortingName = "";
	...
	TableName = "_reg_RegistrTarifyPerson";
	...
	ConnectAdditionalTables();
        ...
        public override NsgMultipleObjectDescriptor Descriptor
        {
            get
            {
                if (descriptor == null)
                {
                    ...
                    descriptor.Name = "РегистрТарифыПерсоналаОбъекта";
        ...
        {
            return "Регистры.РегистрТарифыПерсоналаОбъекта";
        }
        ...
        public _SystemTables.РегистрыРегистрТарифыПерсоналаОбъектаДвижения Движения
        {
            get
            {
				 NsgRegisterTable __Движения = ObjectList["Движения"] as NsgRegisterTable;
                 return (_SystemTables.РегистрыРегистрТарифыПерсоналаОбъектаДвижения)__Движения.Referent;
            }
            set
            {
                NsgRegisterTable __Движения = ObjectList["Движения"] as NsgRegisterTable;
        ...
        private РегистрТарифыПерсоналаОбъекта[] convertArray(NsgMultipleObject[] array)
        {
            РегистрТарифыПерсоналаОбъекта[] res = new РегистрТарифыПерсоналаОбъекта[array.Length];
            array.CopyTo(res, 0);
            return res;
        }
        ...
        public new virtual РегистрТарифыПерсоналаОбъекта[] FindAll(NsgCompare compare)
        {
        ...
        /// <returns>Список найденных объектов.</returns>
        public new virtual РегистрТарифыПерсоналаОбъекта[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, NsgCompare compare)
        {
        ...
        /// <returns>Список найденных объектов.</returns>
        public new virtual РегистрТарифыПерсоналаОбъекта[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, string inName, object inValue)
        {
        ...
        /// <param name="inValue">Значение для поиска. Условие поиска - полное совпадение.</param>
        /// <returns>Список найденных объектов.</returns>
        public new virtual РегистрТарифыПерсоналаОбъекта[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, NsgDataFixedFields inName,
            object inValue)
        {
            return convertArray(base.FindAll(ref count, row_start, sorting, inName, inValue));
        }
        ...
        public override NsgObject CloneObject
        {
            get
            {
                return new РегистрТарифыПерсоналаОбъекта(this as NsgObject);
            }
        }
        ...
        public new class ColumnDescriptor : NsgSoft.Forms.NsgColumnDescriptor
        {
            public ColumnDescriptor()
                : base()
            {
                base.NSGType = typeof(РегистрТарифыПерсоналаОбъекта);
            }
			...
			public new РегистрТарифыПерсоналаОбъекта Value
            {
                get
                {
                    return (РегистрТарифыПерсоналаОбъекта)base.Value;
                }
                set
                {
                    base.Value = value;
