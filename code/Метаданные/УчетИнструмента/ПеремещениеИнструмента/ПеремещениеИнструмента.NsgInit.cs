...
namespace TechControl.Метаданные.УчетИнструмента
{
    ...
    [NsgTypeName("NsgDataDocument", Guid = "396101d3-491c-4740-abf1-298541aa558f")]
    public partial class ПеремещениеИнструмента : NsgSoft.DataObjects.NsgDataDocument
    {
        #region Данные
        ...
        /// Создание объекта
        /// </summary>
        protected ПеремещениеИнструмента()
            : base()
        {
        }
        ...
        /// </summary>
        protected ПеремещениеИнструмента(NsgObject obj)
            : base(obj)
        {
        }
        ...
        public static ПеремещениеИнструмента Новый()
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("396101d3-491c-4740-abf1-298541aa558f"));
            if (obj == null)
                obj = new ПеремещениеИнструмента();
            return obj as ПеремещениеИнструмента;
        }
	...
	Идентификатор.Guid = NsgService.StringToGuid("18120255-8e7e-4fa1-a56f-517cba631d4b");
	...
	Автоинкремент.Guid = NsgService.StringToGuid("7f9acded-406b-424f-9bca-dc9e1ce620f4");
	...
	ПрефиксКода.Guid = NsgService.StringToGuid("4f8b7062-9603-4532-8879-a2b8b02dd9a0");
	...
	НомерКода.GroupName = "";
	НомерКода.Guid = NsgService.StringToGuid("70cd47f4-82d9-4911-812a-04e8ed747637");
	...
	НомерДокумента.Guid = NsgService.StringToGuid("6f07c24d-10f0-4387-9e4e-25b4276b0613");
	...
	ДатаДокумента.Guid = NsgService.StringToGuid("08307e34-17d5-40f8-8c48-84c57f081aa0");
	...
	Индекс.GroupName = "";
	Индекс.Guid = NsgService.StringToGuid("ae8924c3-13f5-425b-abae-506ccae8b9b4");
	...
	ДокументОснование.Guid = NsgService.StringToGuid("8f7ca612-83d8-4a75-b775-8bd00e7f8783");
	...
	Комментарий.Guid = NsgService.StringToGuid("11fc4a7c-582c-4447-aef9-b983f9b2e814");
	...
	СостояниеДокумента.Guid = NsgService.StringToGuid("e15f73b8-550c-4a53-9f17-bda33a769d5c");
	...
	Получатель.FilterForConfigurator = "Мониторинг.Сотрудники,Мониторинг.Объекты";
	...
	Получатель.Guid = NsgService.StringToGuid("898d2490-07be-4d7f-86dc-e6dca2bb177f");
			...
			#region создание _SystemTables.УчетИнструментаПеремещениеИнструментаТаблица Таблица
			{  
	...
	Таблица.ReferentName = "УчетИнструментаПеремещениеИнструментаТаблица";
	Таблица.OwnerName = "";
	...
	Таблица.GroupName = "";
	Таблица.Guid = NsgService.StringToGuid("f480a000-a9f0-4a7b-a290-0e92dd660f5d");
	
				if (!ObjectList.Contains("Таблица"))
                    ObjectList.Add(Таблица);
			}
			#endregion //создание _SystemTables.УчетИнструментаПеремещениеИнструментаТаблица Таблица
	...
	Отправитель.FilterForConfigurator = "Мониторинг.Сотрудники,Мониторинг.Объекты";
	...
	Отправитель.Guid = NsgService.StringToGuid("c17e7a53-ff14-4616-929c-6caa75b10193");
			...
			#region создание TechControl.Метаданные.УчетИнструмента.ПеремещениеИнструментаФормаЭлемента ФормаЭлемента
			{  
	...
	ФормаЭлемента.FormClassName = "TechControl.Метаданные.УчетИнструмента.ПеремещениеИнструментаФормаЭлемента";
	...
	ФормаЭлемента.Guid = NsgService.StringToGuid("2c2c3e8b-be93-4bcd-ac9b-bf54d150c717");
	
				if (!ObjectList.Contains("ФормаЭлемента"))
                    ObjectList.Add(ФормаЭлемента);
			}
			#endregion //создание TechControl.Метаданные.УчетИнструмента.ПеремещениеИнструментаФормаЭлемента ФормаЭлемента
			

			#region заполнение полей класса
				//NsgDataDocument
	IsLoadedFromDll = true;
	SlaveDocuments = new List<string>(new string[]{"Сервис.ОбщийЖурнал", "Мониторинг.ФормированиеСмены", "Сервис.СервернаяЗадача", "Мониторинг.ОтработанноеВремяТехники", "Мониторинг.ЗакрытиеСмены", "Мониторинг.Заправка", "Мониторинг.ПоставкаТоплива", "Мониторинг.ФормированиеСменыДень", "СлужебныеСправочники.ПриглашениеПользователя", "Учет.ПриходнаяНакладная", "Учет.Перемещение", "Мониторинг.РегистрацияХодок", "Мониторинг.Ходки", "СлужебныеСправочники.Уведомления", "Мониторинг.ПроверкаЗаправки", "Грузы.ВывозГруза", "Грузы.ПривозГруза", "Учет.ПодтверждениеПеремещения", "УчетСпецодеждыИСИЗ.ПеремещениеСпецодежды", "УчетИнструмента.ПеремещениеИнструмента"});
	SearchFieldName = "_Code";
	HandleWithoutTransaction = false;
	UsedRegistersForConfigurator = new NsgSoft.DataObjects.NsgPropertyCollection(new System.String[]{"Сервис.ПечатныеФормы", "Мониторинг.РегистрМониторингТехники", "Мониторинг.ФиксацияИстории", "Сервис.ПраваПользователей", "Мониторинг.МониторирнгТехники", "Мониторинг.РегистрОтработанногоВремени", "Мониторинг.РегистрСмен", "Мониторинг.РегистрЗаправок", "Мониторинг.РегистрПоставокТоплива", "Мониторинг.ФиксацияИсторииСотрудников", "Учет.ОстаткиНоменклатуры", "УчетСпецодеждыИСИЗ.РегистрУчетСпецодежды", "УчетИнструмента.РегистрУчетИнструмента"},
		 new System.Object[]{NsgSoft.DataObjects.NsgDataDocument.RegisterHandleRegime.None, NsgSoft.DataObjects.NsgDataDocument.RegisterHandleRegime.None, NsgSoft.DataObjects.NsgDataDocument.RegisterHandleRegime.None, NsgSoft.DataObjects.NsgDataDocument.RegisterHandleRegime.None, NsgSoft.DataObjects.NsgDataDocument.RegisterHandleRegime.None, NsgSoft.DataObjects.NsgDataDocument.RegisterHandleRegime.None, NsgSoft.DataObjects.NsgDataDocument.RegisterHandleRegime.None, NsgSoft.DataObjects.NsgDataDocument.RegisterHandleRegime.None, NsgSoft.DataObjects.NsgDataDocument.RegisterHandleRegime.None, NsgSoft.DataObjects.NsgDataDocument.RegisterHandleRegime.None, NsgSoft.DataObjects.NsgDataDocument.RegisterHandleRegime.Write, NsgSoft.DataObjects.NsgDataDocument.RegisterHandleRegime.None, NsgSoft.DataObjects.NsgDataDocument.RegisterHandleRegime.Write});
	...
	Name = "ПеремещениеИнструмента";
	Visible = true;
	Guid = NsgService.StringToGuid("396101d3-491c-4740-abf1-298541aa558f");
	DefaultSortingName = "";
	...
	Presentation = new NsgSoft.DataObjects.NsgLanguageString(new System.String[]{"(Default)"},
		 new System.Object[]{""});
	Description = "Перемещение инструмента";
	...
	GroupName = "УчетИнструмента";
        ...
        public override NsgMultipleObjectDescriptor Descriptor
        {
            get
            {
                if (descriptor == null)
                {
                    ...
                    descriptor.Name = "ПеремещениеИнструмента";
        ...
        {
            return "УчетИнструмента.ПеремещениеИнструмента";
        }
        ...
        [NsgView(NsgViewTypes.DesignTime)]
        [NsgTypeName("NsgReferencedObject")]
        [NsgReferentsFilterAttribute("Мониторинг.Сотрудники,Мониторинг.Объекты")]
        ...
        public _SystemTables.УчетИнструментаПеремещениеИнструментаТаблица Таблица
        {
            get
            {
				 NsgDataTableReference __Таблица = ObjectList["Таблица"] as NsgDataTableReference;
                 return (_SystemTables.УчетИнструментаПеремещениеИнструментаТаблица)__Таблица.Referent;
            }
            set
            {
                NsgDataTableReference __Таблица = ObjectList["Таблица"] as NsgDataTableReference;
        ...
        private ПеремещениеИнструмента[] convertArray(NsgMultipleObject[] array)
        {
            ПеремещениеИнструмента[] res = new ПеремещениеИнструмента[array.Length];
            array.CopyTo(res, 0);
            return res;
        }
        ...
        public new virtual ПеремещениеИнструмента[] FindAll(NsgCompare compare)
        {
        ...
        /// <returns>Список найденных объектов.</returns>
        public new virtual ПеремещениеИнструмента[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, NsgCompare compare)
        {
        ...
        /// <returns>Список найденных объектов.</returns>
        public new virtual ПеремещениеИнструмента[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, string inName, object inValue)
        {
        ...
        /// <param name="inValue">Значение для поиска. Условие поиска - полное совпадение.</param>
        /// <returns>Список найденных объектов.</returns>
        public new virtual ПеремещениеИнструмента[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, NsgDataFixedFields inName,
            object inValue)
        {
            return convertArray(base.FindAll(ref count, row_start, sorting, inName, inValue));
        }
        ...
        public override NsgObject CloneObject
        {
            get
            {
                return new ПеремещениеИнструмента(this as NsgObject);
            }
        }
        ...
        public new class ColumnDescriptor : NsgSoft.Forms.NsgColumnDescriptor
        {
            public ColumnDescriptor()
                : base()
            {
                base.NSGType = typeof(ПеремещениеИнструмента);
            }
			...
			public new ПеремещениеИнструмента Value
            {
                get
                {
                    return (ПеремещениеИнструмента)base.Value;
                }
                set
                {
                    base.Value = value;
