...
namespace TechControl.Метаданные.Документы
{
    ...
    [NsgTypeName("NsgDataDocument", Guid = "08a635bd-6ee8-4af1-a6c6-ab27af90155e")]
    public partial class ПлановыйГрафикРаботы : NsgSoft.DataObjects.NsgDataDocument
    {
        #region Данные
        ...
        /// Создание объекта
        /// </summary>
        protected ПлановыйГрафикРаботы()
            : base()
        {
        }
        ...
        /// </summary>
        protected ПлановыйГрафикРаботы(NsgObject obj)
            : base(obj)
        {
        }
        ...
        public static ПлановыйГрафикРаботы Новый()
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("08a635bd-6ee8-4af1-a6c6-ab27af90155e"));
            if (obj == null)
                obj = new ПлановыйГрафикРаботы();
            return obj as ПлановыйГрафикРаботы;
        }
	...
	Идентификатор.Guid = NsgService.StringToGuid("5a8fd688-bd8c-4099-bd58-11f1317e71b9");
	...
	Автоинкремент.Guid = NsgService.StringToGuid("e9d68a28-2d28-4508-8f85-8e91e88d688b");
	...
	ПрефиксКода.Guid = NsgService.StringToGuid("13334dc4-9142-43b2-b40b-82eee93748c6");
	...
	НомерКода.GroupName = "";
	НомерКода.Guid = NsgService.StringToGuid("21b954c2-9d73-4b46-b1ca-c882e9ba2f0b");
	...
	НомерДокумента.Guid = NsgService.StringToGuid("eae02dd0-d309-4760-b5de-4521705140f2");
	...
	ДатаДокумента.Guid = NsgService.StringToGuid("96069d58-3016-4941-802b-e02395ec18b5");
	...
	Индекс.GroupName = "";
	Индекс.Guid = NsgService.StringToGuid("174ba5be-6772-4362-84ba-7accc71fc4e9");
	...
	ДокументОснование.Guid = NsgService.StringToGuid("68cfac9e-10f9-48da-bed0-956ed7013b8d");
	...
	Комментарий.Guid = NsgService.StringToGuid("02855aa2-b707-44eb-9b6d-ae22eade5aa5");
	...
	СостояниеДокумента.Guid = NsgService.StringToGuid("9bbff11e-ede7-4641-9f48-cdee6e8ddd5b");
			...
			#region создание System.DateTime МесяцГрафика
			{  
                NsgDataDateTime МесяцГрафика = null;
				if (ObjectList.Contains("МесяцГрафика"))
                    МесяцГрафика = ObjectList["МесяцГрафика"] as NsgDataDateTime;
                else
                    МесяцГрафика = new NsgDataDateTime();
	//NsgDataDateTime
	МесяцГрафика.IsLoadedFromDll = true;
	МесяцГрафика.Format = NsgSoft.Common.NsgDateTimeFormat.DateTime;
	МесяцГрафика.StringFormat = "";
	МесяцГрафика.SubType = NsgSoft.Common.NsgRekvisitSubType.Common;
	МесяцГрафика.IncludeInPredefined = false;
	МесяцГрафика.PeriodicType = NsgSoft.Database.PeriodicTypes.None;
	МесяцГрафика.Required = false;
	МесяцГрафика.EmptyValue = "";
	МесяцГрафика.NullAllow = false;
	МесяцГрафика.IndexType = NsgSoft.Database.NsgRekvisitIndexType.None;
	МесяцГрафика.FieldName = "MesjacGrafika";
	МесяцГрафика.SaveInDatabase = true;
	МесяцГрафика.InformMetaDataOnValueChanged = false;
	МесяцГрафика.Visible = true;
	МесяцГрафика.Name = "МесяцГрафика";
	МесяцГрафика.Presentation = new NsgSoft.DataObjects.NsgLanguageString(new System.String[]{"(Default)"},
		 new System.Object[]{""});
	МесяцГрафика.Description = "Месяц графика";
	МесяцГрафика.EditorVisible = NsgSoft.DataObjects.NsgDataObjectEditorAccess.Full;
	МесяцГрафика.GroupName = "";
	МесяцГрафика.Guid = NsgService.StringToGuid("837f0964-9897-445c-a068-94670ce1ffcc");
	
				if (!ObjectList.Contains("МесяцГрафика"))
                    ObjectList.Add(МесяцГрафика);
			}
			#endregion //создание System.DateTime МесяцГрафика
			
			#region создание System.DateTime ДатаПервогоРабочегоДня
			{  
                NsgDataDateTime ДатаПервогоРабочегоДня = null;
				if (ObjectList.Contains("ДатаПервогоРабочегоДня"))
                    ДатаПервогоРабочегоДня = ObjectList["ДатаПервогоРабочегоДня"] as NsgDataDateTime;
                else
                    ДатаПервогоРабочегоДня = new NsgDataDateTime();
	//NsgDataDateTime
	ДатаПервогоРабочегоДня.IsLoadedFromDll = true;
	ДатаПервогоРабочегоДня.Format = NsgSoft.Common.NsgDateTimeFormat.DateTime;
	ДатаПервогоРабочегоДня.StringFormat = "";
	ДатаПервогоРабочегоДня.SubType = NsgSoft.Common.NsgRekvisitSubType.Common;
	ДатаПервогоРабочегоДня.IncludeInPredefined = false;
	ДатаПервогоРабочегоДня.PeriodicType = NsgSoft.Database.PeriodicTypes.None;
	ДатаПервогоРабочегоДня.Required = false;
	ДатаПервогоРабочегоДня.EmptyValue = "";
	ДатаПервогоРабочегоДня.NullAllow = false;
	ДатаПервогоРабочегоДня.IndexType = NsgSoft.Database.NsgRekvisitIndexType.None;
	ДатаПервогоРабочегоДня.FieldName = "DataPervogoRaboch";
	ДатаПервогоРабочегоДня.SaveInDatabase = true;
	ДатаПервогоРабочегоДня.InformMetaDataOnValueChanged = false;
	ДатаПервогоРабочегоДня.Visible = true;
	ДатаПервогоРабочегоДня.Name = "ДатаПервогоРабочегоДня";
	ДатаПервогоРабочегоДня.Presentation = new NsgSoft.DataObjects.NsgLanguageString(new System.String[]{"(Default)"},
		 new System.Object[]{""});
	ДатаПервогоРабочегоДня.Description = "Дата первого рабочего дня";
	ДатаПервогоРабочегоДня.EditorVisible = NsgSoft.DataObjects.NsgDataObjectEditorAccess.Full;
	ДатаПервогоРабочегоДня.GroupName = "";
	ДатаПервогоРабочегоДня.Guid = NsgService.StringToGuid("7a407a67-29b1-4f27-99ee-a3140dfb835d");
	
				if (!ObjectList.Contains("ДатаПервогоРабочегоДня"))
                    ObjectList.Add(ДатаПервогоРабочегоДня);
			}
			#endregion //создание System.DateTime ДатаПервогоРабочегоДня
	...
	ВидРежимаРаботы.Guid = NsgService.StringToGuid("72fa53ba-cc67-4149-a4b2-a01cf66f7920");
	...
	Сотрудник.GroupName = "";
	Сотрудник.Guid = NsgService.StringToGuid("733eeeb9-fb69-4874-995c-2622db5a9228");
	...
	Объект.GroupName = "";
	Объект.Guid = NsgService.StringToGuid("593c55b9-3c85-44dd-b530-3e5e244e8083");
	...
	Name = "ПлановыйГрафикРаботы";
	Visible = true;
	Guid = NsgService.StringToGuid("08a635bd-6ee8-4af1-a6c6-ab27af90155e");
	DefaultSortingName = "";
	...
	TableName = "_doc_PlanovyijGrafikRaboty";
	...
	GroupName = "Документы";
        ...
        public new partial class Names// :NsgSoft.DataObjects.NsgDataDocument.Names
        {
            ...
            /// Месяц графика
            /// </summary>
            public static String МесяцГрафика
            {
                get
                {
                    return "МесяцГрафика";
            ...
            /// </summary>
            public static String ДатаПервогоРабочегоДня
            {
                get
                {
                    return "ДатаПервогоРабочегоДня";
                }
            }
        ...
        public override NsgMultipleObjectDescriptor Descriptor
        {
            get
            {
                if (descriptor == null)
                {
                    ...
                    descriptor.Name = "ПлановыйГрафикРаботы";
        ...
        {
            return "Документы.ПлановыйГрафикРаботы";
        }
        ...
        public System.DateTime МесяцГрафика
        {
            get
            {
				 NsgDataDateTime __МесяцГрафика = ObjectList["МесяцГрафика"] as NsgDataDateTime;
                 return (System.DateTime)__МесяцГрафика.Value;
            }
            set
            {
                NsgDataDateTime __МесяцГрафика = ObjectList["МесяцГрафика"] as NsgDataDateTime;
                __МесяцГрафика.Value = value;
            }
        }
        ...
        public System.DateTime ДатаПервогоРабочегоДня
        {
            get
            {
				 NsgDataDateTime __ДатаПервогоРабочегоДня = ObjectList["ДатаПервогоРабочегоДня"] as NsgDataDateTime;
                 return (System.DateTime)__ДатаПервогоРабочегоДня.Value;
            }
            set
            {
                NsgDataDateTime __ДатаПервогоРабочегоДня = ObjectList["ДатаПервогоРабочегоДня"] as NsgDataDateTime;
                __ДатаПервогоРабочегоДня.Value = value;
            }
        }
        ...
        private ПлановыйГрафикРаботы[] convertArray(NsgMultipleObject[] array)
        {
            ПлановыйГрафикРаботы[] res = new ПлановыйГрафикРаботы[array.Length];
            array.CopyTo(res, 0);
            return res;
        }
        ...
        public new virtual ПлановыйГрафикРаботы[] FindAll(NsgCompare compare)
        {
        ...
        /// <returns>Список найденных объектов.</returns>
        public new virtual ПлановыйГрафикРаботы[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, NsgCompare compare)
        {
        ...
        /// <returns>Список найденных объектов.</returns>
        public new virtual ПлановыйГрафикРаботы[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, string inName, object inValue)
        {
        ...
        /// <param name="inValue">Значение для поиска. Условие поиска - полное совпадение.</param>
        /// <returns>Список найденных объектов.</returns>
        public new virtual ПлановыйГрафикРаботы[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, NsgDataFixedFields inName,
            object inValue)
        {
            return convertArray(base.FindAll(ref count, row_start, sorting, inName, inValue));
        }
        ...
        public override NsgObject CloneObject
        {
            get
            {
                return new ПлановыйГрафикРаботы(this as NsgObject);
            }
        }
        ...
        public new class ColumnDescriptor : NsgSoft.Forms.NsgColumnDescriptor
        {
            public ColumnDescriptor()
                : base()
            {
                base.NSGType = typeof(ПлановыйГрафикРаботы);
            }
			...
			public new ПлановыйГрафикРаботы Value
            {
                get
                {
                    return (ПлановыйГрафикРаботы)base.Value;
                }
                set
                {
                    base.Value = value;
