...
namespace TechControl.Метаданные.Документы
{
    ...
    [NsgTypeName("NsgDataDocument", Guid = "101021ce-185e-489c-aca6-613c239ff21f")]
    public partial class ДокументСменыТекущегоВидаРабот : NsgSoft.DataObjects.NsgDataDocument
    {
        #region Данные
        ...
        /// Создание объекта
        /// </summary>
        protected ДокументСменыТекущегоВидаРабот()
            : base()
        {
        }
        ...
        /// </summary>
        protected ДокументСменыТекущегоВидаРабот(NsgObject obj)
            : base(obj)
        {
        }
        ...
        public static ДокументСменыТекущегоВидаРабот Новый()
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("101021ce-185e-489c-aca6-613c239ff21f"));
            if (obj == null)
                obj = new ДокументСменыТекущегоВидаРабот();
            return obj as ДокументСменыТекущегоВидаРабот;
        }
	...
	Идентификатор.Guid = NsgService.StringToGuid("7dd5c978-b3be-4e8b-91ee-db0273e99f86");
	...
	Автоинкремент.Guid = NsgService.StringToGuid("a98d92af-d068-4364-967d-4f9abb2a36e0");
	...
	ПрефиксКода.Guid = NsgService.StringToGuid("8b0b8595-4b05-460c-b434-4869612345af");
	...
	НомерКода.GroupName = "";
	НомерКода.Guid = NsgService.StringToGuid("d7db62ed-75ff-40f7-894b-ba284aecbc62");
	...
	НомерДокумента.Guid = NsgService.StringToGuid("fce9f65e-7ca3-4dc5-920c-96f50bbd7f30");
	...
	ДатаДокумента.Guid = NsgService.StringToGuid("a7890000-3ab2-4d22-b0e9-0552db140771");
	...
	Индекс.GroupName = "";
	Индекс.Guid = NsgService.StringToGuid("1d8d25e2-e2ef-45bf-9ea4-750901b7110f");
	...
	ДокументОснование.FilterForConfigurator = "Документы.ЗаявкиНаРаботы";
	...
	ДокументОснование.Guid = NsgService.StringToGuid("d3c38969-72b9-4529-901d-dcd21a917f0a");
	...
	Комментарий.Guid = NsgService.StringToGuid("b290de3c-75a1-4c79-99da-9158af8be882");
	...
	СостояниеДокумента.Guid = NsgService.StringToGuid("45a4d2e5-3bf6-405b-9247-684d90ddbd36");
	...
	ВидРабот.GroupName = "";
	ВидРабот.Guid = NsgService.StringToGuid("4cc494e6-7455-4557-8a30-88a984a1cb70");
	...
	Name = "ДокументСменыТекущегоВидаРабот";
	Visible = true;
	Guid = NsgService.StringToGuid("101021ce-185e-489c-aca6-613c239ff21f");
	DefaultSortingName = "";
	...
	TableName = "_doc_DokumentSmenyTekusc";
	...
	GroupName = "Документы";
        ...
        public override NsgMultipleObjectDescriptor Descriptor
        {
            get
            {
                if (descriptor == null)
                {
                    ...
                    descriptor.Name = "ДокументСменыТекущегоВидаРабот";
        ...
        {
            return "Документы.ДокументСменыТекущегоВидаРабот";
        }
        ...
        private ДокументСменыТекущегоВидаРабот[] convertArray(NsgMultipleObject[] array)
        {
            ДокументСменыТекущегоВидаРабот[] res = new ДокументСменыТекущегоВидаРабот[array.Length];
            array.CopyTo(res, 0);
            return res;
        }
        ...
        public new virtual ДокументСменыТекущегоВидаРабот[] FindAll(NsgCompare compare)
        {
        ...
        /// <returns>Список найденных объектов.</returns>
        public new virtual ДокументСменыТекущегоВидаРабот[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, NsgCompare compare)
        {
        ...
        /// <returns>Список найденных объектов.</returns>
        public new virtual ДокументСменыТекущегоВидаРабот[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, string inName, object inValue)
        {
        ...
        /// <param name="inValue">Значение для поиска. Условие поиска - полное совпадение.</param>
        /// <returns>Список найденных объектов.</returns>
        public new virtual ДокументСменыТекущегоВидаРабот[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, NsgDataFixedFields inName,
            object inValue)
        {
            return convertArray(base.FindAll(ref count, row_start, sorting, inName, inValue));
        }
        ...
        public override NsgObject CloneObject
        {
            get
            {
                return new ДокументСменыТекущегоВидаРабот(this as NsgObject);
            }
        }
        ...
        public new class ColumnDescriptor : NsgSoft.Forms.NsgColumnDescriptor
        {
            public ColumnDescriptor()
                : base()
            {
                base.NSGType = typeof(ДокументСменыТекущегоВидаРабот);
            }
			...
			public new ДокументСменыТекущегоВидаРабот Value
            {
                get
                {
                    return (ДокументСменыТекущегоВидаРабот)base.Value;
                }
                set
                {
                    base.Value = value;
