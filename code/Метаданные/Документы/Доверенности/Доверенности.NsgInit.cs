...
namespace TechControl.Метаданные.Документы
{
    ...
    [NsgTypeName("NsgDataDocument", Guid = "ce3cce95-13c5-4308-8767-88a37c5f51ff")]
    public partial class Доверенности : NsgSoft.DataObjects.NsgDataDocument
    {
        #region Данные
        ...
        /// </summary>
        protected Доверенности(NsgObject obj)
            : base(obj)
        {
        }
        ...
        public static Доверенности Новый()
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("ce3cce95-13c5-4308-8767-88a37c5f51ff"));
            if (obj == null)
                obj = new Доверенности();
            return obj as Доверенности;
        }
	...
	Идентификатор.Guid = NsgService.StringToGuid("9d38e977-86c9-44f1-a70e-5756be2b1905");
	...
	Автоинкремент.Guid = NsgService.StringToGuid("c9d04d89-9a03-43bc-962e-3958a0c58709");
	...
	ПрефиксКода.Guid = NsgService.StringToGuid("6c7391c4-3515-4950-ab24-2f79155a2921");
	...
	НомерКода.GroupName = "";
	НомерКода.Guid = NsgService.StringToGuid("c413e21f-ea6e-40de-9e8b-8c5fa701c287");
	...
	НомерДокумента.Guid = NsgService.StringToGuid("871510af-421c-4f31-9405-0bc08196a266");
	...
	ДатаДокумента.Guid = NsgService.StringToGuid("fab1e74f-a1cc-40a1-87ea-59f81539be87");
	...
	Индекс.GroupName = "";
	Индекс.Guid = NsgService.StringToGuid("e65d6226-be28-4bb4-9796-c43e848483ef");
	...
	ДокументОснование.Guid = NsgService.StringToGuid("468fae2d-4f46-415a-8b99-f51a2376b04d");
	...
	Комментарий.Guid = NsgService.StringToGuid("9134b5a4-0a8b-4996-a2d5-e693c77bac0c");
	...
	СостояниеДокумента.Guid = NsgService.StringToGuid("f75d591d-fd54-4d18-8afe-125b42bcefb5");
			...
			#region создание System.DateTime ДействуетПо
			{  
                NsgDataDateTime ДействуетПо = null;
				if (ObjectList.Contains("ДействуетПо"))
                    ДействуетПо = ObjectList["ДействуетПо"] as NsgDataDateTime;
                else
                    ДействуетПо = new NsgDataDateTime();
	//NsgDataDateTime
	ДействуетПо.IsLoadedFromDll = true;
	ДействуетПо.Format = NsgSoft.Common.NsgDateTimeFormat.DateTime;
	ДействуетПо.StringFormat = "";
	ДействуетПо.SubType = NsgSoft.Common.NsgRekvisitSubType.Common;
	ДействуетПо.IncludeInPredefined = false;
	ДействуетПо.PeriodicType = NsgSoft.Database.PeriodicTypes.None;
	ДействуетПо.Required = false;
	ДействуетПо.EmptyValue = "";
	ДействуетПо.NullAllow = false;
	ДействуетПо.IndexType = NsgSoft.Database.NsgRekvisitIndexType.None;
	ДействуетПо.FieldName = "DeijstvuetPo";
	ДействуетПо.SaveInDatabase = true;
	ДействуетПо.InformMetaDataOnValueChanged = false;
	ДействуетПо.Visible = true;
	ДействуетПо.Name = "ДействуетПо";
	ДействуетПо.Presentation = new NsgSoft.DataObjects.NsgLanguageString(new System.String[]{"(Default)"},
		 new System.Object[]{""});
	ДействуетПо.Description = "Действует по";
	ДействуетПо.EditorVisible = NsgSoft.DataObjects.NsgDataObjectEditorAccess.Full;
	ДействуетПо.GroupName = "";
	ДействуетПо.Guid = NsgService.StringToGuid("3fbdfd97-4245-4cfa-a99a-c25a58f51abb");
	
				if (!ObjectList.Contains("ДействуетПо"))
                    ObjectList.Add(ДействуетПо);
			}
			#endregion //создание System.DateTime ДействуетПо
	...
	Сотрудник.GroupName = "";
	Сотрудник.Guid = NsgService.StringToGuid("f749ecc0-20f7-41a6-b875-c92d2ab4f349");
			...
			#region создание TechControl.Метаданные.Документы.ДоверенностиФормаЭлемента ФормаЭлемента
			{  
	...
	ФормаЭлемента.FormClassName = "TechControl.Метаданные.Документы.ДоверенностиФормаЭлемента";
	...
	ФормаЭлемента.Guid = NsgService.StringToGuid("dd2cde1a-fee1-4c8c-a8c0-d148a5721990");
	
				if (!ObjectList.Contains("ФормаЭлемента"))
                    ObjectList.Add(ФормаЭлемента);
			}
			#endregion //создание TechControl.Метаданные.Документы.ДоверенностиФормаЭлемента ФормаЭлемента
			
			#region создание System.DateTime ДействуетС
			{  
                NsgDataDateTime ДействуетС = null;
				if (ObjectList.Contains("ДействуетС"))
                    ДействуетС = ObjectList["ДействуетС"] as NsgDataDateTime;
                else
                    ДействуетС = new NsgDataDateTime();
	//NsgDataDateTime
	ДействуетС.IsLoadedFromDll = true;
	ДействуетС.Format = NsgSoft.Common.NsgDateTimeFormat.DateTime;
	ДействуетС.StringFormat = "";
	ДействуетС.SubType = NsgSoft.Common.NsgRekvisitSubType.Common;
	ДействуетС.IncludeInPredefined = false;
	ДействуетС.PeriodicType = NsgSoft.Database.PeriodicTypes.None;
	ДействуетС.Required = false;
	ДействуетС.EmptyValue = "";
	ДействуетС.NullAllow = false;
	ДействуетС.IndexType = NsgSoft.Database.NsgRekvisitIndexType.None;
	ДействуетС.FieldName = "DeijstvuetS";
	ДействуетС.SaveInDatabase = true;
	ДействуетС.InformMetaDataOnValueChanged = false;
	ДействуетС.Visible = true;
	ДействуетС.Name = "ДействуетС";
	ДействуетС.Presentation = new NsgSoft.DataObjects.NsgLanguageString(new System.String[]{"(Default)"},
		 new System.Object[]{""});
	ДействуетС.Description = "Действует с";
	ДействуетС.EditorVisible = NsgSoft.DataObjects.NsgDataObjectEditorAccess.Full;
	ДействуетС.GroupName = "";
	ДействуетС.Guid = NsgService.StringToGuid("7687d581-f295-4ed0-bc38-e240b9e60570");
	
				if (!ObjectList.Contains("ДействуетС"))
                    ObjectList.Add(ДействуетС);
			}
			#endregion //создание System.DateTime ДействуетС
			
			#region создание System.String СтрокаОснование
			{  
                NsgDataString СтрокаОснование = null;
				if (ObjectList.Contains("СтрокаОснование"))
                    СтрокаОснование = ObjectList["СтрокаОснование"] as NsgDataString;
                else
                    СтрокаОснование = new NsgDataString();
	//NsgDataString
	СтрокаОснование.IsLoadedFromDll = true;
	СтрокаОснование.Length = 50;
	СтрокаОснование.StringFormat = "";
	СтрокаОснование.SubType = NsgSoft.Common.NsgRekvisitSubType.Common;
	СтрокаОснование.IncludeInPredefined = false;
	СтрокаОснование.PeriodicType = NsgSoft.Database.PeriodicTypes.None;
	СтрокаОснование.Required = false;
	СтрокаОснование.EmptyValue = "";
	СтрокаОснование.NullAllow = false;
	СтрокаОснование.IndexType = NsgSoft.Database.NsgRekvisitIndexType.None;
	СтрокаОснование.FieldName = "StrokaOsnovanie";
	СтрокаОснование.SaveInDatabase = true;
	СтрокаОснование.InformMetaDataOnValueChanged = false;
	СтрокаОснование.Visible = true;
	СтрокаОснование.Name = "СтрокаОснование";
	СтрокаОснование.Presentation = new NsgSoft.DataObjects.NsgLanguageString(new System.String[]{"(Default)"},
		 new System.Object[]{""});
	СтрокаОснование.Description = "Строка основание";
	СтрокаОснование.EditorVisible = NsgSoft.DataObjects.NsgDataObjectEditorAccess.Full;
	СтрокаОснование.GroupName = "";
	СтрокаОснование.Guid = NsgService.StringToGuid("f896c644-c1b5-4ffb-93a6-af625805a245");
	
				if (!ObjectList.Contains("СтрокаОснование"))
                    ObjectList.Add(СтрокаОснование);
			}
			#endregion //создание System.String СтрокаОснование
	...
	Должность.GroupName = "";
	Должность.Guid = NsgService.StringToGuid("406f2bd8-552a-45e8-abad-46322dfd5e72");
	...
	Name = "Доверенности";
	Visible = true;
	Guid = NsgService.StringToGuid("ce3cce95-13c5-4308-8767-88a37c5f51ff");
	DefaultSortingName = "";
	...
	GroupName = "Документы";
        ...
        public new partial class Names// :NsgSoft.DataObjects.NsgDataDocument.Names
        {
            ...
            /// Действует по
            /// </summary>
            public static String ДействуетПо
            {
                get
                {
                    return "ДействуетПо";
            ...
            /// Действует с
            /// </summary>
            public static String ДействуетС
            {
                get
                {
                    return "ДействуетС";
            ...
            /// Строка основание
            /// </summary>
            public static String СтрокаОснование
            {
                get
                {
                    return "СтрокаОснование";
                }
            }
        ...
        public System.DateTime ДействуетПо
        {
            get
            {
				 NsgDataDateTime __ДействуетПо = ObjectList["ДействуетПо"] as NsgDataDateTime;
                 return (System.DateTime)__ДействуетПо.Value;
            }
            set
            {
                NsgDataDateTime __ДействуетПо = ObjectList["ДействуетПо"] as NsgDataDateTime;
                __ДействуетПо.Value = value;
            }
        }
        ...
        public System.DateTime ДействуетС
        {
            get
            {
				 NsgDataDateTime __ДействуетС = ObjectList["ДействуетС"] as NsgDataDateTime;
                 return (System.DateTime)__ДействуетС.Value;
            }
            set
            {
                NsgDataDateTime __ДействуетС = ObjectList["ДействуетС"] as NsgDataDateTime;
                __ДействуетС.Value = value;
            }
        }
        ...
        public System.String СтрокаОснование
        {
            get
            {
				 NsgDataString __СтрокаОснование = ObjectList["СтрокаОснование"] as NsgDataString;
                 return (System.String)__СтрокаОснование.Value;
            }
            set
            {
                NsgDataString __СтрокаОснование = ObjectList["СтрокаОснование"] as NsgDataString;
                __СтрокаОснование.Value = value;
            }
        }
        ...
        private Доверенности[] convertArray(NsgMultipleObject[] array)
        {
            Доверенности[] res = new Доверенности[array.Length];
            array.CopyTo(res, 0);
            return res;
        }
        ...
        public new virtual Доверенности[] FindAll(NsgCompare compare)
        {
        ...
        /// <returns>Список найденных объектов.</returns>
        public new virtual Доверенности[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, NsgCompare compare)
        {
        ...
        /// <returns>Список найденных объектов.</returns>
        public new virtual Доверенности[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, string inName, object inValue)
        {
        ...
        /// <param name="inValue">Значение для поиска. Условие поиска - полное совпадение.</param>
        /// <returns>Список найденных объектов.</returns>
        public new virtual Доверенности[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, NsgDataFixedFields inName,
            object inValue)
        {
            return convertArray(base.FindAll(ref count, row_start, sorting, inName, inValue));
        }
        ...
        public override NsgObject CloneObject
        {
            get
            {
                return new Доверенности(this as NsgObject);
            }
        }
        ...
        public new class ColumnDescriptor : NsgSoft.Forms.NsgColumnDescriptor
        {
            public ColumnDescriptor()
                : base()
            {
                base.NSGType = typeof(Доверенности);
            }
			...
			public new Доверенности Value
            {
                get
                {
                    return (Доверенности)base.Value;
                }
                set
                {
                    base.Value = value;
