...
{
    public partial class ДокументыНастройкиПраздниковТаблицаПраздников
{
    [NsgTypeName("NsgDataTableRow", Guid = "8f65688c-0326-4f70-a923-a252c0135cb9")]
    public partial class Строка : NsgSoft.DataObjects.NsgDataTableRow
    {
        ...
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("8f65688c-0326-4f70-a923-a252c0135cb9"));
            if (obj == null)
                obj = new Строка();
        ...
        public new partial class Names// :NsgSoft.DataObjects.NsgDataTableRow.Names
        {
            ...
            /// Название праздника
            /// </summary>
            public static String НазваниеПраздника
            {
                get
                {
                    return "НазваниеПраздника";
                }
            }
        ...
        public override NsgMultipleObjectDescriptor Descriptor
        {
            get
            {
                if (descriptor == null)
                {
                    ...
                    descriptor.Name = "ДокументыНастройкиПраздниковТаблицаПраздников";
        ...
        [NsgReferentsFilterAttribute("Документы.НастройкиПраздников")]
        ...
        public System.String НазваниеПраздника
        {
            get
            {
				 NsgDataString __НазваниеПраздника = ObjectList["НазваниеПраздника"] as NsgDataString;
                 return (System.String)__НазваниеПраздника.Value;
            }
            set
            {
                NsgDataString __НазваниеПраздника = ObjectList["НазваниеПраздника"] as NsgDataString;
                __НазваниеПраздника.Value = value;
            }
        }
