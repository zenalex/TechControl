...
{
    public partial class ДокументыЭСМТаблица
{
    [NsgTypeName("NsgDataTableRow", Guid = "7298b4fc-60d5-4197-9253-186bd3b9d399")]
    public partial class Строка : NsgSoft.DataObjects.NsgDataTableRow
    {
        ...
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("7298b4fc-60d5-4197-9253-186bd3b9d399"));
            if (obj == null)
                obj = new Строка();
        ...
        public new partial class Names// :NsgSoft.DataObjects.NsgDataTableRow.Names
        {
            ...
            /// </summary>
            public static String ОтработаноМашиноЧасов
            {
                get
                {
                    return "ОтработаноМашиноЧасов";
                }
            }
        ...
        public override NsgMultipleObjectDescriptor Descriptor
        {
            get
            {
                if (descriptor == null)
                {
                    ...
                    descriptor.Name = "ДокументыЭСМТаблица";
        ...
        public System.Decimal ОтработаноМашиноЧасов
        {
            get
            {
				 NsgDataFloat __ОтработаноМашиноЧасов = ObjectList["ОтработаноМашиноЧасов"] as NsgDataFloat;
                 return (System.Decimal)__ОтработаноМашиноЧасов.Value;
            }
            set
            {
                NsgDataFloat __ОтработаноМашиноЧасов = ObjectList["ОтработаноМашиноЧасов"] as NsgDataFloat;
                __ОтработаноМашиноЧасов.Value = value;
            }
        }
