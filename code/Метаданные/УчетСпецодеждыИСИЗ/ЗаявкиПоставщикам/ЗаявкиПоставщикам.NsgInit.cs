...
namespace TechControl.Метаданные.УчетСпецодеждыИСИЗ
{
    ...
    [NsgTypeName("NsgDataDocument", Guid = "cb8f66a7-5dcf-4273-98b5-7ea99b3d6f0f")]
    public partial class ЗаявкиПоставщикам : NsgSoft.DataObjects.NsgDataDocument
    {
        #region Данные
        ...
        /// </summary>
        protected ЗаявкиПоставщикам(NsgObject obj)
            : base(obj)
        {
        }
        ...
        public static ЗаявкиПоставщикам Новый()
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("cb8f66a7-5dcf-4273-98b5-7ea99b3d6f0f"));
            if (obj == null)
                obj = new ЗаявкиПоставщикам();
            return obj as ЗаявкиПоставщикам;
        }
	...
	Идентификатор.Guid = NsgService.StringToGuid("74c0eaa0-7d5d-4327-9e96-79af38be908b");
	...
	Автоинкремент.Guid = NsgService.StringToGuid("6b7cf8fd-0937-4bd6-8853-f6097e9d23a8");
	...
	ПрефиксКода.Guid = NsgService.StringToGuid("99346ec0-50c8-43a6-bf10-e495ae253570");
	...
	НомерКода.GroupName = "";
	НомерКода.Guid = NsgService.StringToGuid("a32141fd-fea9-4d90-a7d8-e1ffab45e3db");
	...
	НомерДокумента.Guid = NsgService.StringToGuid("5c53e058-ffb4-4837-96ba-e0c5754ba86c");
	...
	ДатаДокумента.Guid = NsgService.StringToGuid("6c07ede0-5de1-4c2b-9cd3-500ccee0cd1b");
	...
	Индекс.GroupName = "";
	Индекс.Guid = NsgService.StringToGuid("3af2b78b-bdfe-46f4-91fb-d70e0725e3a6");
	...
	ДокументОснование.Guid = NsgService.StringToGuid("cea14595-1dde-4453-8f97-c3b1380b2a03");
	...
	Комментарий.Guid = NsgService.StringToGuid("15a42768-8765-459c-a6c2-9c58febf0b44");
	...
	СостояниеДокумента.Guid = NsgService.StringToGuid("a8723799-9127-40a1-beeb-cc977b271717");
			...
			#region создание _SystemTables.УчетСпецодеждыИСИЗЗаявкиПоставщикамТаблица Таблица
			{  
	...
	Таблица.ReferentName = "УчетСпецодеждыИСИЗЗаявкиПоставщикамТаблица";
	Таблица.OwnerName = "";
	...
	Таблица.GroupName = "";
	Таблица.Guid = NsgService.StringToGuid("5c20fd64-6dc8-4dc7-9e31-467aa7152033");
	
				if (!ObjectList.Contains("Таблица"))
                    ObjectList.Add(Таблица);
			}
			#endregion //создание _SystemTables.УчетСпецодеждыИСИЗЗаявкиПоставщикамТаблица Таблица
	...
	Поставщик.GroupName = "";
	Поставщик.Guid = NsgService.StringToGuid("62f601e5-f7fd-4c25-949b-a2d7a5e089f3");
	...
	Сотрудник.GroupName = "";
	Сотрудник.Guid = NsgService.StringToGuid("bb7d36a2-f2fd-443b-aa0f-8f96379ec6d4");
	...
	Объект.GroupName = "";
	Объект.Guid = NsgService.StringToGuid("d9b52ecb-d890-47ad-a4a0-943e364eeff9");
			...
			#region создание TechControl.Метаданные.УчетСпецодеждыИСИЗ.ЗаявкиПоставщикамФормаЭлемента ФормаЭлемента
			{  
	...
	ФормаЭлемента.FormClassName = "TechControl.Метаданные.УчетСпецодеждыИСИЗ.ЗаявкиПоставщикамФормаЭлемента";
	...
	ФормаЭлемента.Guid = NsgService.StringToGuid("1c134d4d-284a-40fc-9b17-e44d84f5f553");
	
				if (!ObjectList.Contains("ФормаЭлемента"))
                    ObjectList.Add(ФормаЭлемента);
			}
			#endregion //создание TechControl.Метаданные.УчетСпецодеждыИСИЗ.ЗаявкиПоставщикамФормаЭлемента ФормаЭлемента
			

			#region заполнение полей класса
				//NsgDataDocument
	IsLoadedFromDll = true;
	SlaveDocuments = new List<string>(new string[]{"Сервис.ОбщийЖурнал", "Мониторинг.ФормированиеСмены", "Сервис.СервернаяЗадача", "Мониторинг.ОтработанноеВремяТехники", "Мониторинг.ЗакрытиеСмены", "Мониторинг.Заправка", "Мониторинг.ПоставкаТоплива", "Мониторинг.ФормированиеСменыДень", "СлужебныеСправочники.ПриглашениеПользователя", "Учет.ПриходнаяНакладная", "Учет.Перемещение", "Мониторинг.РегистрацияХодок", "Мониторинг.Ходки", "СлужебныеСправочники.Уведомления", "Мониторинг.ПроверкаЗаправки", "Грузы.ВывозГруза", "Грузы.ПривозГруза", "УчетСпецодеждыИСИЗ.ПеремещениеСпецодежды", "УчетИнструмента.ПеремещениеИнструмента", "Учет.ФормированиеЦены", "УчетСпецодеждыИСИЗ.ЗаявкиПоставщикам"});
	SearchFieldName = "_Code";
	HandleWithoutTransaction = false;
	UsedRegistersForConfigurator = new NsgSoft.DataObjects.NsgPropertyCollection(new System.String[]{"Сервис.ПечатныеФормы", "Мониторинг.РегистрМониторингТехники", "Мониторинг.ФиксацияИстории", "Сервис.ПраваПользователей", "Мониторинг.МониторирнгТехники", "Мониторинг.РегистрОтработанногоВремени", "Мониторинг.РегистрСмен", "Мониторинг.РегистрЗаправок", "Мониторинг.РегистрПоставокТоплива", "Мониторинг.ФиксацияИсторииСотрудников", "Учет.ОстаткиНоменклатуры", "УчетСпецодеждыИСИЗ.РегистрУчетСпецодежды", "УчетИнструмента.РегистрУчетИнструмента", "Учет.РегистрЦен"},
		 new System.Object[]{NsgSoft.DataObjects.NsgDataDocument.RegisterHandleRegime.None, NsgSoft.DataObjects.NsgDataDocument.RegisterHandleRegime.None, NsgSoft.DataObjects.NsgDataDocument.RegisterHandleRegime.None, NsgSoft.DataObjects.NsgDataDocument.RegisterHandleRegime.None, NsgSoft.DataObjects.NsgDataDocument.RegisterHandleRegime.None, NsgSoft.DataObjects.NsgDataDocument.RegisterHandleRegime.None, NsgSoft.DataObjects.NsgDataDocument.RegisterHandleRegime.None, NsgSoft.DataObjects.NsgDataDocument.RegisterHandleRegime.None, NsgSoft.DataObjects.NsgDataDocument.RegisterHandleRegime.None, NsgSoft.DataObjects.NsgDataDocument.RegisterHandleRegime.None, NsgSoft.DataObjects.NsgDataDocument.RegisterHandleRegime.None, NsgSoft.DataObjects.NsgDataDocument.RegisterHandleRegime.None, NsgSoft.DataObjects.NsgDataDocument.RegisterHandleRegime.None, NsgSoft.DataObjects.NsgDataDocument.RegisterHandleRegime.None});
	...
	Name = "ЗаявкиПоставщикам";
	Visible = true;
	Guid = NsgService.StringToGuid("cb8f66a7-5dcf-4273-98b5-7ea99b3d6f0f");
	DefaultSortingName = "";
	...
	TableName = "_doc_ZajavkiPostavschikam";
	...
	GroupName = "УчетСпецодеждыИСИЗ";
        ...
        public override NsgMultipleObjectDescriptor Descriptor
        {
            get
            {
                if (descriptor == null)
                {
                    ...
                    descriptor.Name = "ЗаявкиПоставщикам";
        ...
        {
            return "УчетСпецодеждыИСИЗ.ЗаявкиПоставщикам";
        }
        ...
        public _SystemTables.УчетСпецодеждыИСИЗЗаявкиПоставщикамТаблица Таблица
        {
            get
            {
				 NsgDataTableReference __Таблица = ObjectList["Таблица"] as NsgDataTableReference;
                 return (_SystemTables.УчетСпецодеждыИСИЗЗаявкиПоставщикамТаблица)__Таблица.Referent;
            }
            set
            {
                NsgDataTableReference __Таблица = ObjectList["Таблица"] as NsgDataTableReference;
        ...
        private ЗаявкиПоставщикам[] convertArray(NsgMultipleObject[] array)
        {
            ЗаявкиПоставщикам[] res = new ЗаявкиПоставщикам[array.Length];
            array.CopyTo(res, 0);
            return res;
        }
        ...
        public new virtual ЗаявкиПоставщикам[] FindAll(NsgCompare compare)
        {
        ...
        /// <returns>Список найденных объектов.</returns>
        public new virtual ЗаявкиПоставщикам[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, NsgCompare compare)
        {
        ...
        /// <returns>Список найденных объектов.</returns>
        public new virtual ЗаявкиПоставщикам[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, string inName, object inValue)
        {
        ...
        /// <param name="inValue">Значение для поиска. Условие поиска - полное совпадение.</param>
        /// <returns>Список найденных объектов.</returns>
        public new virtual ЗаявкиПоставщикам[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, NsgDataFixedFields inName,
            object inValue)
        {
            return convertArray(base.FindAll(ref count, row_start, sorting, inName, inValue));
        }
        ...
        public override NsgObject CloneObject
        {
            get
            {
                return new ЗаявкиПоставщикам(this as NsgObject);
            }
        }
        ...
        public new class ColumnDescriptor : NsgSoft.Forms.NsgColumnDescriptor
        {
            public ColumnDescriptor()
                : base()
            {
                base.NSGType = typeof(ЗаявкиПоставщикам);
            }
			...
			public new ЗаявкиПоставщикам Value
            {
                get
                {
                    return (ЗаявкиПоставщикам)base.Value;
                }
                set
                {
                    base.Value = value;
