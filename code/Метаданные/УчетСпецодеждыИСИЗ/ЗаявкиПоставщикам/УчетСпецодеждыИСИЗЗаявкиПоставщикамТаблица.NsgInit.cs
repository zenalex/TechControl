...
namespace TechControl.Метаданные._SystemTables
{
    ...
    [NsgTypeName("NsgDataTable", Guid = "b8be4c26-3d2f-40df-add5-e032b284379e")]
    public partial class УчетСпецодеждыИСИЗЗаявкиПоставщикамТаблица : NsgSoft.DataObjects.NsgDataTable
    {
        #region Данные
        ...
        /// Создание объекта
        /// </summary>
        protected УчетСпецодеждыИСИЗЗаявкиПоставщикамТаблица()
            : base()
        {
        }
        ...
        /// </summary>
        protected УчетСпецодеждыИСИЗЗаявкиПоставщикамТаблица(NsgObject obj)
            : base(obj)
        {
        }
        ...
        public static УчетСпецодеждыИСИЗЗаявкиПоставщикамТаблица Новый()
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("b8be4c26-3d2f-40df-add5-e032b284379e"));
            if (obj == null)
                obj = new УчетСпецодеждыИСИЗЗаявкиПоставщикамТаблица();
            return obj as УчетСпецодеждыИСИЗЗаявкиПоставщикамТаблица;
        }
	...
	Идентификатор.Guid = NsgService.StringToGuid("5e607451-38d9-4795-abc3-55ba055d1213");
	...
	Автоинкремент.Guid = NsgService.StringToGuid("c6c0891e-d148-4795-b000-76d8c97db26c");
	...
	Владелец.FilterForConfigurator = "УчетСпецодеждыИСИЗ.ЗаявкиПоставщикам";
	...
	Владелец.GroupName = "";
	Владелец.Guid = NsgService.StringToGuid("cfba27ff-67df-46e5-a9c1-fcc94137314b");
	...
	НомерСтроки.Guid = NsgService.StringToGuid("94585eb4-494c-4ea9-8b20-ec1f068a2f79");
	...
	Номенклатура.Guid = NsgService.StringToGuid("bfac4a8c-0200-4159-bd3f-908b3f8c7996");
	...
	Размер.GroupName = "";
	Размер.Guid = NsgService.StringToGuid("14f582c8-56f0-4d63-8d21-dc468308d639");
	...
	Количество.Guid = NsgService.StringToGuid("c9126b44-62ba-442e-8e59-e3c0131a90d9");
	...
	Цена.GroupName = "";
	Цена.Guid = NsgService.StringToGuid("ba83e692-eb99-49d4-9afb-8a7d437a3571");
	...
	OwnerFullName = "УчетСпецодеждыИСИЗ.ЗаявкиПоставщикам";
	RegisterPeriod = NsgSoft.Common.NsgPeriod.None;
	RegisterPeriodCount = 0;
	TableSubType = NsgSoft.Common.NsgTableSubType.TablePart;
	EntityType = NsgSoft.DataObjects.NsgInterfacedObject.EntityTypes.Object;
	Name = "УчетСпецодеждыИСИЗЗаявкиПоставщикамТаблица";
	Visible = true;
	Guid = NsgService.StringToGuid("b8be4c26-3d2f-40df-add5-e032b284379e");
	DefaultSortingName = "";
	...
	Presentation = new NsgSoft.DataObjects.NsgLanguageString(new System.String[]{"(Default)"},
		 new System.Object[]{""});
	Description = "Учет спецодежды ИСИЗЗаявки поставщикам таблица";
	...
	GroupName = "_SystemTables";
        ...
        {
            return "_SystemTables.УчетСпецодеждыИСИЗЗаявкиПоставщикамТаблица";
        }
        ...
        /// </summary>
        public new УчетСпецодеждыИСИЗЗаявкиПоставщикамТаблица.Строка NewRow()
        {
            return newRow(null) as УчетСпецодеждыИСИЗЗаявкиПоставщикамТаблица.Строка;
        }
        ...
        {
            if (row == null)
                row = new УчетСпецодеждыИСИЗЗаявкиПоставщикамТаблица.Строка(this);
            return base.newRow(row) as УчетСпецодеждыИСИЗЗаявкиПоставщикамТаблица.Строка;
        }

        /// <summary>
        /// Добавить новую строку в таблицу путем копирования переданной строки
        /// </summary>
        public УчетСпецодеждыИСИЗЗаявкиПоставщикамТаблица.Строка NewRow(УчетСпецодеждыИСИЗЗаявкиПоставщикамТаблица.Строка inRow)
        {
            УчетСпецодеждыИСИЗЗаявкиПоставщикамТаблица.Строка row = inRow.Clone as УчетСпецодеждыИСИЗЗаявкиПоставщикамТаблица.Строка;
            return base.newRow(row) as УчетСпецодеждыИСИЗЗаявкиПоставщикамТаблица.Строка;
        }
        ...
        /// </summary>
        public new УчетСпецодеждыИСИЗЗаявкиПоставщикамТаблица.Строка GetRow(int rowNumber)
        {
            return base.GetRow(rowNumber) as УчетСпецодеждыИСИЗЗаявкиПоставщикамТаблица.Строка;
        }

        /// <summary>
        /// Возвращает новую строку таблицы, но в саму таблицу ее не включает (эталонная строка)
        /// </summary>
        public new УчетСпецодеждыИСИЗЗаявкиПоставщикамТаблица.Строка GetEtalonRow()
        {
            УчетСпецодеждыИСИЗЗаявкиПоставщикамТаблица.Строка row = new УчетСпецодеждыИСИЗЗаявкиПоставщикамТаблица.Строка(this);
            row.MetaData = MetaData;
            return row;
        }

        private УчетСпецодеждыИСИЗЗаявкиПоставщикамТаблица.Строка[] convertRowsArray(NsgDataTableRow[] array)
        {
            УчетСпецодеждыИСИЗЗаявкиПоставщикамТаблица.Строка[] res = new УчетСпецодеждыИСИЗЗаявкиПоставщикамТаблица.Строка[array.Length];
            array.CopyTo(res, 0);
            return res;
        }
        ...
        public new УчетСпецодеждыИСИЗЗаявкиПоставщикамТаблица.Строка FindRowByTag(object Tag)
        {
            return base.FindRowByTag(Tag) as УчетСпецодеждыИСИЗЗаявкиПоставщикамТаблица.Строка;
        }
        ...
        /// <param name="compare">Критерии поиска.</param>
        /// <returns>Найденные строки.</returns>
        public new УчетСпецодеждыИСИЗЗаявкиПоставщикамТаблица.Строка[] FindRowsByTag(object Tag)
        {
        ...
        /// <param name="compare">Критерии поиска.</param>
        /// <returns>Найденные строки.</returns>
        public new УчетСпецодеждыИСИЗЗаявкиПоставщикамТаблица.Строка FindRow(NsgCompare compare)
        {
            return base.FindRow(compare) as УчетСпецодеждыИСИЗЗаявкиПоставщикамТаблица.Строка;
        }
        ...
        /// <returns>Найденные строки.</returns>
        public new УчетСпецодеждыИСИЗЗаявкиПоставщикамТаблица.Строка FindRow(string inName, object inValue)
        {
            return base.FindRow(inName, inValue) as УчетСпецодеждыИСИЗЗаявкиПоставщикамТаблица.Строка;
        }
        ...
        /// <param name="inValue">Значение поля.</param>
        /// <returns>Найденные строки.</returns>
        public new УчетСпецодеждыИСИЗЗаявкиПоставщикамТаблица.Строка FindRow(NsgDataFixedFields inName, object inValue)
        {
            return base.FindRow(inName, inValue) as УчетСпецодеждыИСИЗЗаявкиПоставщикамТаблица.Строка;
        }
        ...
        /// <param name="compare">Критерии поиска.</param>
        /// <returns>Найденные строки.</returns>
        public new УчетСпецодеждыИСИЗЗаявкиПоставщикамТаблица.Строка[] FindRows(NsgCompare compare)
        {
        ...
        /// <param name="inValue">Значение поля.</param>
        /// <returns>Найденные строки.</returns>
        public new УчетСпецодеждыИСИЗЗаявкиПоставщикамТаблица.Строка[] FindRows(string inName, object inValue)
        {
        ...
        /// <param name="inValue">Значение поля.</param>
        /// <returns>Найденные строки.</returns>
        public new УчетСпецодеждыИСИЗЗаявкиПоставщикамТаблица.Строка[] FindRows(NsgDataFixedFields inName, object inValue)
        {
            return convertRowsArray(base.FindRows(inName, inValue));
        }
        ...
        /// </summary>
        public  NsgVirtualCursor<УчетСпецодеждыИСИЗЗаявкиПоставщикамТаблица> GetNewVirtualCursor()
        {
            return base.GetNewVirtualCursor<УчетСпецодеждыИСИЗЗаявкиПоставщикамТаблица>();
        }

        /// <summary>
        /// Получить все строки таблицы с учетом наложенного фильтра. Для получения всех сьтрок без учета фильтра используется свойство AllRows
        /// </summary>
        public new УчетСпецодеждыИСИЗЗаявкиПоставщикамТаблица.Строка[] Rows
        {
            get
            {
        ...
        /// </summary>
        public new УчетСпецодеждыИСИЗЗаявкиПоставщикамТаблица.Строка[] AllRows
        {
            get
            {
        ...
        /// <returns>Найденные строки.</returns>
        public new УчетСпецодеждыИСИЗЗаявкиПоставщикамТаблица.Строка GetRow(Guid inID)
        {
            return base.GetRow(inID) as УчетСпецодеждыИСИЗЗаявкиПоставщикамТаблица.Строка;
        }
        #endregion
        ...
        private УчетСпецодеждыИСИЗЗаявкиПоставщикамТаблица[] convertArray(NsgMultipleObject[] array)
        {
            УчетСпецодеждыИСИЗЗаявкиПоставщикамТаблица[] res = new УчетСпецодеждыИСИЗЗаявкиПоставщикамТаблица[array.Length];
            array.CopyTo(res, 0);
            return res;
        }
        ...
        public new virtual УчетСпецодеждыИСИЗЗаявкиПоставщикамТаблица[] FindAll(NsgCompare compare)
        {
        ...
        /// <returns>Список найденных объектов.</returns>
        public new virtual УчетСпецодеждыИСИЗЗаявкиПоставщикамТаблица[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, NsgCompare compare)
        {
        ...
        /// <returns>Список найденных объектов.</returns>
        public new virtual УчетСпецодеждыИСИЗЗаявкиПоставщикамТаблица[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, string inName, object inValue)
        {
        ...
        /// <param name="inValue">Значение для поиска. Условие поиска - полное совпадение.</param>
        /// <returns>Список найденных объектов.</returns>
        public new virtual УчетСпецодеждыИСИЗЗаявкиПоставщикамТаблица[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, NsgDataFixedFields inName,
            object inValue)
        {
            return convertArray(base.FindAll(ref count, row_start, sorting, inName, inValue));
        }
        ...
        public override NsgObject CloneObject
        {
            get
            {
                return new УчетСпецодеждыИСИЗЗаявкиПоставщикамТаблица(this as NsgObject);
            }
        }
        ...
        public new class ColumnDescriptor : NsgSoft.Forms.NsgColumnDescriptor
        {
            public ColumnDescriptor()
                : base()
            {
                base.NSGType = typeof(УчетСпецодеждыИСИЗЗаявкиПоставщикамТаблица);
            }
			...
			public new УчетСпецодеждыИСИЗЗаявкиПоставщикамТаблица Value
            {
                get
                {
                    return (УчетСпецодеждыИСИЗЗаявкиПоставщикамТаблица)base.Value;
                }
                set
                {
                    base.Value = value;
