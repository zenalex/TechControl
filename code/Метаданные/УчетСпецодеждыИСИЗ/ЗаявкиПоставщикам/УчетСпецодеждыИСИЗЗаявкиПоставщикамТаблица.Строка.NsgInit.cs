...
{
    public partial class УчетСпецодеждыИСИЗЗаявкиПоставщикамТаблица
{
    [NsgTypeName("NsgDataTableRow", Guid = "b8be4c26-3d2f-40df-add5-e032b284379e")]
    public partial class Строка : NsgSoft.DataObjects.NsgDataTableRow
    {
        ...
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("b8be4c26-3d2f-40df-add5-e032b284379e"));
            if (obj == null)
                obj = new Строка();
        ...
        public override NsgMultipleObjectDescriptor Descriptor
        {
            get
            {
                if (descriptor == null)
                {
                    ...
                    descriptor.Name = "УчетСпецодеждыИСИЗЗаявкиПоставщикамТаблица";
        ...
        [NsgReferentsFilterAttribute("УчетСпецодеждыИСИЗ.ЗаявкиПоставщикам")]
