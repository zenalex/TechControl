...
namespace TechControl.Метаданные.УчетСпецодеждыИСИЗ
{
    ...
    [NsgTypeName("NsgDataDictionary", Guid = "acbaecc9-e512-42af-a13a-1423d08083d1")]
    public partial class Склады : NsgSoft.DataObjects.NsgDataDictionary
    {
        #region Данные
        ...
        /// </summary>
        protected Склады(NsgObject obj)
            : base(obj)
        {
        }
        ...
        public static Склады Новый()
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("acbaecc9-e512-42af-a13a-1423d08083d1"));
            if (obj == null)
                obj = new Склады();
            return obj as Склады;
        }
	...
	Идентификатор.Guid = NsgService.StringToGuid("0536d542-41f5-4719-827d-d2e828f3a472");
	...
	Автоинкремент.Guid = NsgService.StringToGuid("e759787d-005b-47a2-856d-e57deadda082");
	...
	ЭтоГруппа.GroupName = "";
	ЭтоГруппа.Guid = NsgService.StringToGuid("397330cb-c0b2-4380-8da6-f55e73646c27");
	...
	ИдентификаторРодителя.Guid = NsgService.StringToGuid("03d11714-8dfb-443c-b6ba-d5fc49bba554");
	...
	Уровень.GroupName = "";
	Уровень.Guid = NsgService.StringToGuid("0adabcb2-2924-4e3b-83cd-62e7d700ca8e");
	...
	ПрефиксКода.Guid = NsgService.StringToGuid("94a686e5-acc7-497f-8d87-547a0b58a9db");
	...
	НомерКода.GroupName = "";
	НомерКода.Guid = NsgService.StringToGuid("563260ca-5713-4e4f-9ebd-b619b1b1282f");
	...
	Код.GroupName = "";
	Код.Guid = NsgService.StringToGuid("19f0729c-ebd5-42e1-93d2-d8b0328ef125");
	...
	Наименование.Guid = NsgService.StringToGuid("403d2ebf-87be-4673-8558-e8c9f8bc25e5");
	...
	СостояниеДокумента.Guid = NsgService.StringToGuid("c4419df8-177d-435f-a067-b46b305c1199");
	...
	Name = "Склады";
	Visible = true;
	Guid = NsgService.StringToGuid("acbaecc9-e512-42af-a13a-1423d08083d1");
	DefaultSortingName = "";
	...
	GroupName = "УчетСпецодеждыИСИЗ";
        ...
        {
            return "УчетСпецодеждыИСИЗ.Склады";
        }
        ...
        public Склады Родитель
        {
            get
            {
                return base.Parent as Склады;
            }
            set
            {
                base.Parent = value;
        ...
        private Склады[] convertArray(NsgMultipleObject[] array)
        {
            Склады[] res = new Склады[array.Length];
            array.CopyTo(res, 0);
            return res;
        }
        ...
        public new virtual Склады[] FindAll(NsgCompare compare)
        {
        ...
        /// <returns>Список найденных объектов.</returns>
        public new virtual Склады[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, NsgCompare compare)
        {
        ...
        /// <returns>Список найденных объектов.</returns>
        public new virtual Склады[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, string inName, object inValue)
        {
        ...
        /// <param name="inValue">Значение для поиска. Условие поиска - полное совпадение.</param>
        /// <returns>Список найденных объектов.</returns>
        public new virtual Склады[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, NsgDataFixedFields inName,
            object inValue)
        {
            return convertArray(base.FindAll(ref count, row_start, sorting, inName, inValue));
        }
        ...
        public override NsgObject CloneObject
        {
            get
            {
                return new Склады(this as NsgObject);
            }
        }
        ...
        public new class ColumnDescriptor : NsgSoft.Forms.NsgColumnDescriptor
        {
			...
			public new Склады Value
            {
                get
                {
                    return (Склады)base.Value;
                }
                set
                {
                    base.Value = value;
