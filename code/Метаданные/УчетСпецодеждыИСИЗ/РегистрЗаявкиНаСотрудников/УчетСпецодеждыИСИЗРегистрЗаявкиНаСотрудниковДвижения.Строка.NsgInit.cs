...
{
    public partial class УчетСпецодеждыИСИЗРегистрЗаявкиНаСотрудниковДвижения
{
    [NsgTypeName("NsgDataTableRow", Guid = "2d1bd63a-299f-49ae-a5b1-d327b3237572")]
    public partial class Строка : NsgSoft.DataObjects.NsgDataTableRow
    {
        ...
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("2d1bd63a-299f-49ae-a5b1-d327b3237572"));
            if (obj == null)
                obj = new Строка();
        ...
        public override NsgMultipleObjectDescriptor Descriptor
        {
            get
            {
                if (descriptor == null)
                {
                    ...
                    descriptor.Name = "УчетСпецодеждыИСИЗРегистрЗаявкиНаСотрудниковДвижения";
