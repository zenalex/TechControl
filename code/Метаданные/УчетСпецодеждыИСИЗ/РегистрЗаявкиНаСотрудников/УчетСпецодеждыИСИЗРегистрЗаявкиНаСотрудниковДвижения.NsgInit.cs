...
namespace TechControl.Метаданные._SystemTables
{
    ...
    [NsgTypeName("NsgDataTable", Guid = "2d1bd63a-299f-49ae-a5b1-d327b3237572")]
    public partial class УчетСпецодеждыИСИЗРегистрЗаявкиНаСотрудниковДвижения : NsgSoft.DataObjects.NsgDataTable
    {
        #region Данные
        ...
        /// Создание объекта
        /// </summary>
        protected УчетСпецодеждыИСИЗРегистрЗаявкиНаСотрудниковДвижения()
            : base()
        {
        }
        ...
        /// </summary>
        protected УчетСпецодеждыИСИЗРегистрЗаявкиНаСотрудниковДвижения(NsgObject obj)
            : base(obj)
        {
        }
        ...
        public static УчетСпецодеждыИСИЗРегистрЗаявкиНаСотрудниковДвижения Новый()
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("2d1bd63a-299f-49ae-a5b1-d327b3237572"));
            if (obj == null)
                obj = new УчетСпецодеждыИСИЗРегистрЗаявкиНаСотрудниковДвижения();
            return obj as УчетСпецодеждыИСИЗРегистрЗаявкиНаСотрудниковДвижения;
        }
	...
	Идентификатор.Guid = NsgService.StringToGuid("08dc0913-4b31-4e72-9880-458a22f96af8");
	...
	Автоинкремент.Guid = NsgService.StringToGuid("0d777f5e-b66a-4498-a1c4-e96e0d3785df");
	...
	Владелец.GroupName = "";
	Владелец.Guid = NsgService.StringToGuid("a9e16f4e-9c3b-4629-9dce-783c55b062aa");
	...
	OwnerFullName = "УчетСпецодеждыИСИЗ.РегистрЗаявкиНаСотрудников";
	RegisterPeriod = NsgSoft.Common.NsgPeriod.None;
	RegisterPeriodCount = 1;
	TableSubType = NsgSoft.Common.NsgTableSubType.RegisterCharacteristicsTable;
	EntityType = NsgSoft.DataObjects.NsgInterfacedObject.EntityTypes.Object;
	Name = "УчетСпецодеждыИСИЗРегистрЗаявкиНаСотрудниковДвижения";
	Visible = true;
	Guid = NsgService.StringToGuid("2d1bd63a-299f-49ae-a5b1-d327b3237572");
	DefaultSortingName = "";
	...
	Presentation = new NsgSoft.DataObjects.NsgLanguageString(new System.String[]{"(Default)"},
		 new System.Object[]{""});
	Description = "Учет спецодежды ИСИЗРегистр заявки на сотрудников движения";
	...
	GroupName = "_SystemTables";
        ...
        {
            return "_SystemTables.УчетСпецодеждыИСИЗРегистрЗаявкиНаСотрудниковДвижения";
        }
        ...
        /// </summary>
        public new УчетСпецодеждыИСИЗРегистрЗаявкиНаСотрудниковДвижения.Строка NewRow()
        {
            return newRow(null) as УчетСпецодеждыИСИЗРегистрЗаявкиНаСотрудниковДвижения.Строка;
        }
        ...
        {
            if (row == null)
                row = new УчетСпецодеждыИСИЗРегистрЗаявкиНаСотрудниковДвижения.Строка(this);
            return base.newRow(row) as УчетСпецодеждыИСИЗРегистрЗаявкиНаСотрудниковДвижения.Строка;
        }

        /// <summary>
        /// Добавить новую строку в таблицу путем копирования переданной строки
        /// </summary>
        public УчетСпецодеждыИСИЗРегистрЗаявкиНаСотрудниковДвижения.Строка NewRow(УчетСпецодеждыИСИЗРегистрЗаявкиНаСотрудниковДвижения.Строка inRow)
        {
            УчетСпецодеждыИСИЗРегистрЗаявкиНаСотрудниковДвижения.Строка row = inRow.Clone as УчетСпецодеждыИСИЗРегистрЗаявкиНаСотрудниковДвижения.Строка;
            return base.newRow(row) as УчетСпецодеждыИСИЗРегистрЗаявкиНаСотрудниковДвижения.Строка;
        }
        ...
        /// </summary>
        public new УчетСпецодеждыИСИЗРегистрЗаявкиНаСотрудниковДвижения.Строка GetRow(int rowNumber)
        {
            return base.GetRow(rowNumber) as УчетСпецодеждыИСИЗРегистрЗаявкиНаСотрудниковДвижения.Строка;
        }

        /// <summary>
        /// Возвращает новую строку таблицы, но в саму таблицу ее не включает (эталонная строка)
        /// </summary>
        public new УчетСпецодеждыИСИЗРегистрЗаявкиНаСотрудниковДвижения.Строка GetEtalonRow()
        {
            УчетСпецодеждыИСИЗРегистрЗаявкиНаСотрудниковДвижения.Строка row = new УчетСпецодеждыИСИЗРегистрЗаявкиНаСотрудниковДвижения.Строка(this);
            row.MetaData = MetaData;
            return row;
        }

        private УчетСпецодеждыИСИЗРегистрЗаявкиНаСотрудниковДвижения.Строка[] convertRowsArray(NsgDataTableRow[] array)
        {
            УчетСпецодеждыИСИЗРегистрЗаявкиНаСотрудниковДвижения.Строка[] res = new УчетСпецодеждыИСИЗРегистрЗаявкиНаСотрудниковДвижения.Строка[array.Length];
            array.CopyTo(res, 0);
            return res;
        }
        ...
        public new УчетСпецодеждыИСИЗРегистрЗаявкиНаСотрудниковДвижения.Строка FindRowByTag(object Tag)
        {
            return base.FindRowByTag(Tag) as УчетСпецодеждыИСИЗРегистрЗаявкиНаСотрудниковДвижения.Строка;
        }
        ...
        /// <param name="compare">Критерии поиска.</param>
        /// <returns>Найденные строки.</returns>
        public new УчетСпецодеждыИСИЗРегистрЗаявкиНаСотрудниковДвижения.Строка[] FindRowsByTag(object Tag)
        {
        ...
        /// <param name="compare">Критерии поиска.</param>
        /// <returns>Найденные строки.</returns>
        public new УчетСпецодеждыИСИЗРегистрЗаявкиНаСотрудниковДвижения.Строка FindRow(NsgCompare compare)
        {
            return base.FindRow(compare) as УчетСпецодеждыИСИЗРегистрЗаявкиНаСотрудниковДвижения.Строка;
        }
        ...
        /// <returns>Найденные строки.</returns>
        public new УчетСпецодеждыИСИЗРегистрЗаявкиНаСотрудниковДвижения.Строка FindRow(string inName, object inValue)
        {
            return base.FindRow(inName, inValue) as УчетСпецодеждыИСИЗРегистрЗаявкиНаСотрудниковДвижения.Строка;
        }
        ...
        /// <param name="inValue">Значение поля.</param>
        /// <returns>Найденные строки.</returns>
        public new УчетСпецодеждыИСИЗРегистрЗаявкиНаСотрудниковДвижения.Строка FindRow(NsgDataFixedFields inName, object inValue)
        {
            return base.FindRow(inName, inValue) as УчетСпецодеждыИСИЗРегистрЗаявкиНаСотрудниковДвижения.Строка;
        }
        ...
        /// <param name="compare">Критерии поиска.</param>
        /// <returns>Найденные строки.</returns>
        public new УчетСпецодеждыИСИЗРегистрЗаявкиНаСотрудниковДвижения.Строка[] FindRows(NsgCompare compare)
        {
        ...
        /// <param name="inValue">Значение поля.</param>
        /// <returns>Найденные строки.</returns>
        public new УчетСпецодеждыИСИЗРегистрЗаявкиНаСотрудниковДвижения.Строка[] FindRows(string inName, object inValue)
        {
        ...
        /// <param name="inValue">Значение поля.</param>
        /// <returns>Найденные строки.</returns>
        public new УчетСпецодеждыИСИЗРегистрЗаявкиНаСотрудниковДвижения.Строка[] FindRows(NsgDataFixedFields inName, object inValue)
        {
            return convertRowsArray(base.FindRows(inName, inValue));
        }
        ...
        /// </summary>
        public  NsgVirtualCursor<УчетСпецодеждыИСИЗРегистрЗаявкиНаСотрудниковДвижения> GetNewVirtualCursor()
        {
            return base.GetNewVirtualCursor<УчетСпецодеждыИСИЗРегистрЗаявкиНаСотрудниковДвижения>();
        }

        /// <summary>
        /// Получить все строки таблицы с учетом наложенного фильтра. Для получения всех сьтрок без учета фильтра используется свойство AllRows
        /// </summary>
        public new УчетСпецодеждыИСИЗРегистрЗаявкиНаСотрудниковДвижения.Строка[] Rows
        {
            get
            {
        ...
        /// </summary>
        public new УчетСпецодеждыИСИЗРегистрЗаявкиНаСотрудниковДвижения.Строка[] AllRows
        {
            get
            {
        ...
        /// <returns>Найденные строки.</returns>
        public new УчетСпецодеждыИСИЗРегистрЗаявкиНаСотрудниковДвижения.Строка GetRow(Guid inID)
        {
            return base.GetRow(inID) as УчетСпецодеждыИСИЗРегистрЗаявкиНаСотрудниковДвижения.Строка;
        }
        #endregion
        ...
        private УчетСпецодеждыИСИЗРегистрЗаявкиНаСотрудниковДвижения[] convertArray(NsgMultipleObject[] array)
        {
            УчетСпецодеждыИСИЗРегистрЗаявкиНаСотрудниковДвижения[] res = new УчетСпецодеждыИСИЗРегистрЗаявкиНаСотрудниковДвижения[array.Length];
            array.CopyTo(res, 0);
            return res;
        }
        ...
        public new virtual УчетСпецодеждыИСИЗРегистрЗаявкиНаСотрудниковДвижения[] FindAll(NsgCompare compare)
        {
        ...
        /// <returns>Список найденных объектов.</returns>
        public new virtual УчетСпецодеждыИСИЗРегистрЗаявкиНаСотрудниковДвижения[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, NsgCompare compare)
        {
        ...
        /// <returns>Список найденных объектов.</returns>
        public new virtual УчетСпецодеждыИСИЗРегистрЗаявкиНаСотрудниковДвижения[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, string inName, object inValue)
        {
        ...
        /// <param name="inValue">Значение для поиска. Условие поиска - полное совпадение.</param>
        /// <returns>Список найденных объектов.</returns>
        public new virtual УчетСпецодеждыИСИЗРегистрЗаявкиНаСотрудниковДвижения[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, NsgDataFixedFields inName,
            object inValue)
        {
            return convertArray(base.FindAll(ref count, row_start, sorting, inName, inValue));
        }
        ...
        public override NsgObject CloneObject
        {
            get
            {
                return new УчетСпецодеждыИСИЗРегистрЗаявкиНаСотрудниковДвижения(this as NsgObject);
            }
        }
        ...
        public new class ColumnDescriptor : NsgSoft.Forms.NsgColumnDescriptor
        {
            public ColumnDescriptor()
                : base()
            {
                base.NSGType = typeof(УчетСпецодеждыИСИЗРегистрЗаявкиНаСотрудниковДвижения);
            }
			...
			public new УчетСпецодеждыИСИЗРегистрЗаявкиНаСотрудниковДвижения Value
            {
                get
                {
                    return (УчетСпецодеждыИСИЗРегистрЗаявкиНаСотрудниковДвижения)base.Value;
                }
                set
                {
                    base.Value = value;
