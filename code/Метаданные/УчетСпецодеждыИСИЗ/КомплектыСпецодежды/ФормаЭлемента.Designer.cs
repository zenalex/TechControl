...

{
    ...
    public partial class КомплектыСпецодеждыФормаЭлемента:NsgSoft.Forms.NsgMultipleObjectElementForm
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(КомплектыСпецодеждыФормаЭлемента));
            ...
            this.ТаблицаКомплектаСпецодежды = new TechControl.Метаданные._SystemTables.УчетСпецодеждыИСИЗКомплектыСпецодеждыТаблицаКомплектаСпецодежды.ColumnDescriptor();
            this.Родитель = new TechControl.Метаданные.УчетСпецодеждыИСИЗ.КомплектыСпецодежды.ColumnDescriptor();
            ...
            this.Comment.FullName = "УчетСпецодеждыИСИЗ.КомплектыСпецодежды.Идентификатор";
            ...
            this.nsgVisualMultipleObject.Columns.Collection.Add(this.ТаблицаКомплектаСпецодежды);
            ...
            this.nsgVisualMultipleObject.FullName = "УчетСпецодеждыИСИЗ.КомплектыСпецодежды";
            // 
            // nsgIGrid1
            // 
        ...
        "Visible"};
            ...
            this.nsgIGrid1.Location = new System.Drawing.Point(6, 39);
            ...
            this.nsgIGrid1.Size = new System.Drawing.Size(723, 295);
            ...
            this.vmoТаблица.FullName = "_SystemTables.УчетСпецодеждыИСИЗКомплектыСпецодеждыТаблицаКомплектаСпецодежды.Вла" +
    "делец";
            // 
            // vmoТаблица
            // 
            nsgObjectDescriptor1.ConfigurationName = "TechControl";
            nsgObjectDescriptor1.FullName = "_SystemTables.УчетСпецодеждыИСИЗКомплектыСпецодеждыТаблицаКомплектаСпецодежды.Вла" +
    "делец";
            nsgObjectDescriptor1.MetaDataName = "Метаданные";
            nsgMasterDetailBinding1.DetailField = nsgObjectDescriptor1;
            nsgObjectDescriptor2.FullName = "УчетСпецодеждыИСИЗ.КомплектыСпецодежды.ТаблицаКомплектаСпецодежды";
            ...
            this.nsgInput1.FullName = "УчетСпецодеждыИСИЗ.КомплектыСпецодежды.Наименование";
            ...
            this.nsgInput1.Location = new System.Drawing.Point(73, 9);
            ...
            this.nsgInput1.Size = new System.Drawing.Size(283, 20);
            ...
            // 
            // ТаблицаКомплектаСпецодежды
            // 
            this.ТаблицаКомплектаСпецодежды.AutoGenerated = true;
            this.ТаблицаКомплектаСпецодежды.Caption = "ТаблицаКомплектаСпецодежды";
            this.ТаблицаКомплектаСпецодежды.Creator = typeof(NsgSoft.Forms.NsgMultipleObjectElementForm);
            this.ТаблицаКомплектаСпецодежды.Name = "ТаблицаКомплектаСпецодежды";
            this.ТаблицаКомплектаСпецодежды.NSGType = typeof(TechControl.Метаданные._SystemTables.УчетСпецодеждыИСИЗКомплектыСпецодеждыТаблицаКомплектаСпецодежды);
            this.ТаблицаКомплектаСпецодежды.PropertyType = typeof(TechControl.Метаданные._SystemTables.УчетСпецодеждыИСИЗКомплектыСпецодеждыТаблицаКомплектаСпецодежды);
            this.ТаблицаКомплектаСпецодежды.SearchCondition.OwnerComponent = this.ТаблицаКомплектаСпецодежды;
            this.ТаблицаКомплектаСпецодежды.SearchCondition.Parameters = new NsgSoft.DataObjects.NsgCompareParam[0];
            this.ТаблицаКомплектаСпецодежды.Visible = false;
            // 
            // Родитель
            // 
            ...
            this.Родитель.NSGType = typeof(TechControl.Метаданные.УчетСпецодеждыИСИЗ.КомплектыСпецодежды);
            this.Родитель.PropertyType = typeof(TechControl.Метаданные.УчетСпецодеждыИСИЗ.КомплектыСпецодежды);
            ...
            // 
            // КомплектыСпецодеждыФормаЭлемента
            // 
            this.AllowDrop = true;
        ...
        protected _SystemTables.УчетСпецодеждыИСИЗКомплектыСпецодеждыТаблицаКомплектаСпецодежды.ColumnDescriptor ТаблицаКомплектаСпецодежды;
        protected КомплектыСпецодежды.ColumnDescriptor Родитель;
