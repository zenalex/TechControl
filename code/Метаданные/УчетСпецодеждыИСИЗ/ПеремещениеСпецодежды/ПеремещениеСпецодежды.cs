        ...
        protected override bool Handling()
        {
            ...
            else if (Отправитель is Объекты объект)
            {
                ...
                foreach (var i in Таблица.AllRows)
                {
                    ...
                    остаткиНоменклатуры.Стоимость = i.Количество * i.НоменклатураСпецодеждыИСИЗ.ПолучитьСтоимость(ДатаНачалаЭксплуатации != NsgService.MinDate ? ДатаНачалаЭксплуатации : ДатаДокумента);
