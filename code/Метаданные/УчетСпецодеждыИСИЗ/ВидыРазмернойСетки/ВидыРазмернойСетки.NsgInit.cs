...
namespace TechControl.Метаданные.УчетСпецодеждыИСИЗ
{
    ...
    [NsgTypeName("NsgDataDictionary", Guid = "8b4deac6-5671-4321-b0f2-b7625f77e92b")]
    public partial class ВидыРазмернойСетки : NsgSoft.DataObjects.NsgDataDictionary
    {
        #region Данные
        ...
        /// </summary>
        protected ВидыРазмернойСетки(NsgObject obj)
            : base(obj)
        {
        }
        ...
        public static ВидыРазмернойСетки Новый()
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("8b4deac6-5671-4321-b0f2-b7625f77e92b"));
            if (obj == null)
                obj = new ВидыРазмернойСетки();
            return obj as ВидыРазмернойСетки;
        }
	...
	Идентификатор.Guid = NsgService.StringToGuid("9a1b90b2-7828-4a63-aca2-eee689747f16");
	...
	Автоинкремент.Guid = NsgService.StringToGuid("d10d9657-4d3f-4de6-bcca-a2354355b9dc");
	...
	ЭтоГруппа.GroupName = "";
	ЭтоГруппа.Guid = NsgService.StringToGuid("b622247f-222a-4991-922d-46c52f14ff0e");
	...
	ИдентификаторРодителя.Guid = NsgService.StringToGuid("a0f98653-45ab-48ee-bc9c-06ea7e91543b");
	...
	Уровень.GroupName = "";
	Уровень.Guid = NsgService.StringToGuid("96d417a4-3e12-47ac-a674-e47350a8c4f2");
	...
	ПрефиксКода.Guid = NsgService.StringToGuid("b8f0babf-5cfb-4e5c-94b5-b2ee9d1c38ef");
	...
	НомерКода.GroupName = "";
	НомерКода.Guid = NsgService.StringToGuid("0431809b-56ec-4ab0-b420-d54752ab7abd");
	...
	Код.GroupName = "";
	Код.Guid = NsgService.StringToGuid("fa1c1680-1de6-4c1d-ac46-3abb03264df4");
	...
	Наименование.Guid = NsgService.StringToGuid("08ff6609-5212-452f-916d-974e9ad52713");
	...
	СостояниеДокумента.Guid = NsgService.StringToGuid("c2b16625-33ff-44e1-a062-821d5b519cab");
	...
	Name = "ВидыРазмернойСетки";
	Visible = true;
	Guid = NsgService.StringToGuid("8b4deac6-5671-4321-b0f2-b7625f77e92b");
	DefaultSortingName = "";
	...
	TableName = "_dic_VidyRazmernoijSetki";
	...
	GroupName = "УчетСпецодеждыИСИЗ";
        ...
        public override NsgMultipleObjectDescriptor Descriptor
        {
            get
            {
                if (descriptor == null)
                {
                    ...
                    descriptor.Name = "ВидыРазмернойСетки";
        ...
        {
            return "УчетСпецодеждыИСИЗ.ВидыРазмернойСетки";
        }
        ...
        public ВидыРазмернойСетки Родитель
        {
            get
            {
                return base.Parent as ВидыРазмернойСетки;
            }
            set
            {
                base.Parent = value;
        ...
        private ВидыРазмернойСетки[] convertArray(NsgMultipleObject[] array)
        {
            ВидыРазмернойСетки[] res = new ВидыРазмернойСетки[array.Length];
            array.CopyTo(res, 0);
            return res;
        }
        ...
        public new virtual ВидыРазмернойСетки[] FindAll(NsgCompare compare)
        {
        ...
        /// <returns>Список найденных объектов.</returns>
        public new virtual ВидыРазмернойСетки[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, NsgCompare compare)
        {
        ...
        /// <returns>Список найденных объектов.</returns>
        public new virtual ВидыРазмернойСетки[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, string inName, object inValue)
        {
        ...
        /// <param name="inValue">Значение для поиска. Условие поиска - полное совпадение.</param>
        /// <returns>Список найденных объектов.</returns>
        public new virtual ВидыРазмернойСетки[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, NsgDataFixedFields inName,
            object inValue)
        {
            return convertArray(base.FindAll(ref count, row_start, sorting, inName, inValue));
        }
        ...
        public override NsgObject CloneObject
        {
            get
            {
                return new ВидыРазмернойСетки(this as NsgObject);
            }
        }
        ...
        public new class ColumnDescriptor : NsgSoft.Forms.NsgColumnDescriptor
        {
            public ColumnDescriptor()
                : base()
            {
                base.NSGType = typeof(ВидыРазмернойСетки);
            }
			...
			public new ВидыРазмернойСетки Value
            {
                get
                {
                    return (ВидыРазмернойСетки)base.Value;
                }
                set
                {
                    base.Value = value;
