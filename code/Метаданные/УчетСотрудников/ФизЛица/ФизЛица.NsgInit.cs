...
namespace TechControl.Метаданные.УчетСотрудников
{
    ...
    [NsgTypeName("NsgDataDictionary", Guid = "96e7eeb4-b8ad-4aaf-a60f-06f4a83f6221")]
    public partial class ФизЛица : NsgSoft.DataObjects.NsgDataDictionary
    {
        ...
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("96e7eeb4-b8ad-4aaf-a60f-06f4a83f6221"));
            if (obj == null)
                obj = new ФизЛица();
	...
	Идентификатор.Guid = NsgService.StringToGuid("ab28f2de-3903-4818-a932-3c629da58884");
	...
	Автоинкремент.Guid = NsgService.StringToGuid("8718b50a-eae1-4e82-b5eb-6862006d57e2");
	...
	ЭтоГруппа.GroupName = "";
	ЭтоГруппа.Guid = NsgService.StringToGuid("0026ed4a-3560-46c6-8f5a-7698a005e671");
	...
	ИдентификаторРодителя.Guid = NsgService.StringToGuid("5a1740fe-c957-493e-ab0d-b623efe2ca79");
	...
	Уровень.GroupName = "";
	Уровень.Guid = NsgService.StringToGuid("0e8960af-6999-4b6d-8957-ede4a406ee95");
	...
	ПрефиксКода.Guid = NsgService.StringToGuid("aeaf85eb-734e-4a40-ad75-8aaf811e9e5c");
	...
	НомерКода.GroupName = "";
	НомерКода.Guid = NsgService.StringToGuid("57c880a8-6f8e-49f8-bc69-85379a5b190e");
	...
	Код.GroupName = "";
	Код.Guid = NsgService.StringToGuid("09fa0098-b735-43c0-84d3-7701ba14ef5b");
	...
	Наименование.Guid = NsgService.StringToGuid("ba644bdd-61be-4adf-8454-b3d8cbd8f854");
	...
	СостояниеДокумента.Guid = NsgService.StringToGuid("cdacdd93-4801-4e22-b793-65072394ebdf");
	...
	Фамилия.SubType = NsgSoft.Common.NsgRekvisitSubType.Common;
	...
	Фамилия.GroupName = "";
	Фамилия.Guid = NsgService.StringToGuid("58013afe-35e0-42fb-8439-2b55629aa293");
	...
	Отчество.SubType = NsgSoft.Common.NsgRekvisitSubType.Common;
	...
	Отчество.GroupName = "";
	Отчество.Guid = NsgService.StringToGuid("a42caec2-bb80-4278-9aea-86bbcc5d4451");
			...
			#region создание TechControl.Метаданные.УчетСотрудников.ФизЛицаФормаЭлемента ФормаЭлемента
			{  
	...
	ФормаЭлемента.FormClassName = "TechControl.Метаданные.УчетСотрудников.ФизЛицаФормаЭлемента";
	...
	ФормаЭлемента.Guid = NsgService.StringToGuid("15169af6-befd-48ee-8d95-f81add7a675d");
	
				if (!ObjectList.Contains("ФормаЭлемента"))
                    ObjectList.Add(ФормаЭлемента);
			}
			#endregion //создание TechControl.Метаданные.УчетСотрудников.ФизЛицаФормаЭлемента ФормаЭлемента
	...
	Имя.Length = 0;
	Имя.StringFormat = "";
	Имя.SubType = NsgSoft.Common.NsgRekvisitSubType.Common;
	...
	Имя.GroupName = "";
	Имя.Guid = NsgService.StringToGuid("fb63a871-f131-4a68-8e2f-7476c0d288cf");
	...
	Name = "ФизЛица";
	Visible = true;
	Guid = NsgService.StringToGuid("96e7eeb4-b8ad-4aaf-a60f-06f4a83f6221");
	DefaultSortingName = "";
	...
	GroupName = "УчетСотрудников";
        ...
        {
            return "УчетСотрудников.ФизЛица";
        }
