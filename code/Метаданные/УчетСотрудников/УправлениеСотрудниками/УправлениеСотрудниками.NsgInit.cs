...
namespace TechControl.Метаданные.УчетСотрудников
{
    ...
    [NsgTypeName("NsgReportObject", Guid = "58387771-8f1c-46c0-ae71-1ccdfad7689f")]
    public partial class УправлениеСотрудниками : NsgSoft.DataObjects.NsgReportObject
    {
        #region Данные
        ...
        /// Создание объекта
        /// </summary>
        protected УправлениеСотрудниками()
            : base()
        {
        }
        ...
        /// </summary>
        protected УправлениеСотрудниками(NsgObject obj)
            : base(obj)
        {
        }
        ...
        public static УправлениеСотрудниками Новый()
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("58387771-8f1c-46c0-ae71-1ccdfad7689f"));
            if (obj == null)
                obj = new УправлениеСотрудниками();
            return obj as УправлениеСотрудниками;
        }
	...
	Идентификатор.Guid = NsgService.StringToGuid("a8b569fe-fd96-4b86-8f42-81e61bd20779");
	...
	Автоинкремент.Guid = NsgService.StringToGuid("2833656a-e84a-4e9a-8e08-f913f9056664");
			...
			#region создание TechControl.Метаданные.УчетСотрудников.УправлениеСотрудникамиФорма Форма
			{  
	...
	Форма.FormClassName = "TechControl.Метаданные.УчетСотрудников.УправлениеСотрудникамиФорма";
	...
	Форма.GroupName = "";
	Форма.Guid = NsgService.StringToGuid("50cdfb97-8b31-4e04-a354-3b1a5408234f");
	
				if (!ObjectList.Contains("Форма"))
                    ObjectList.Add(Форма);
			}
			#endregion //создание TechControl.Метаданные.УчетСотрудников.УправлениеСотрудникамиФорма Форма
			

			#region заполнение полей класса
				//NsgReportObject
	IsLoadedFromDll = true;
	Name = "УправлениеСотрудниками";
	Visible = true;
	Guid = NsgService.StringToGuid("58387771-8f1c-46c0-ae71-1ccdfad7689f");
	DefaultSortingName = "";
	...
	TableName = "_report_UpravlenieSotrud";
	...
	GroupName = "УчетСотрудников";
        ...
        public override NsgMultipleObjectDescriptor Descriptor
        {
            get
            {
                if (descriptor == null)
                {
                    ...
                    descriptor.Name = "УправлениеСотрудниками";
        ...
        {
            return "УчетСотрудников.УправлениеСотрудниками";
        }
        ...
        private УправлениеСотрудниками[] convertArray(NsgMultipleObject[] array)
        {
            УправлениеСотрудниками[] res = new УправлениеСотрудниками[array.Length];
            array.CopyTo(res, 0);
            return res;
        }
        ...
        public new virtual УправлениеСотрудниками[] FindAll(NsgCompare compare)
        {
        ...
        /// <returns>Список найденных объектов.</returns>
        public new virtual УправлениеСотрудниками[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, NsgCompare compare)
        {
        ...
        /// <returns>Список найденных объектов.</returns>
        public new virtual УправлениеСотрудниками[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, string inName, object inValue)
        {
        ...
        /// <param name="inValue">Значение для поиска. Условие поиска - полное совпадение.</param>
        /// <returns>Список найденных объектов.</returns>
        public new virtual УправлениеСотрудниками[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, NsgDataFixedFields inName,
            object inValue)
        {
            return convertArray(base.FindAll(ref count, row_start, sorting, inName, inValue));
        }
        ...
        public override NsgObject CloneObject
        {
            get
            {
                return new УправлениеСотрудниками(this as NsgObject);
            }
        }
        ...
        public new class ColumnDescriptor : NsgSoft.Forms.NsgColumnDescriptor
        {
            public ColumnDescriptor()
                : base()
            {
                base.NSGType = typeof(УправлениеСотрудниками);
            }
			...
			public new УправлениеСотрудниками Value
            {
                get
                {
                    return (УправлениеСотрудниками)base.Value;
                }
                set
                {
                    base.Value = value;
