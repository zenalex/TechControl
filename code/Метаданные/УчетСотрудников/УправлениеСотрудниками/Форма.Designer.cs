...

{
    ...
    public partial class УправлениеСотрудникамиФорма:NsgSoft.Forms.NsgReportForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.Контрагент_vmoТаблицаИтогов = new TechControl.Метаданные.Мониторинг.Контрагенты.ColumnDescriptor();
            this.Объект_vmoТаблицаИтогов = new TechControl.Метаданные.Мониторинг.Объекты.ColumnDescriptor();
        ...
        "Visible"};
            ...
            nsgIGridColumn8.Name = "Контрагент";
        ...
        "Visible"};
            ...
            // vmoТаблицаИтогов
            // 
            this.vmoТаблицаИтогов.Columns.Collection.Add(this.Контрагент_vmoТаблицаИтогов);
            this.vmoТаблицаИтогов.Columns.Collection.Add(this.Объект_vmoТаблицаИтогов);
            ...
            this.tpФормирование.Visible = false;
            // 
            // nsgInput3
            // 
            ...
            this.nsgInput5.FullName = "Контрагент";
            ...
            this.nsgInput5.Requsite = "Контрагент";
            ...
            // 
            // Контрагент_vmoТаблицаИтогов
            // 
            this.Контрагент_vmoТаблицаИтогов.Caption = "Контрагент";
            this.Контрагент_vmoТаблицаИтогов.Creator = typeof(NsgSoft.Forms.NsgReportForm);
            this.Контрагент_vmoТаблицаИтогов.Name = "Контрагент";
            this.Контрагент_vmoТаблицаИтогов.NSGType = typeof(TechControl.Метаданные.Мониторинг.Контрагенты);
            this.Контрагент_vmoТаблицаИтогов.PropertyType = typeof(TechControl.Метаданные.Мониторинг.Контрагенты);
            this.Контрагент_vmoТаблицаИтогов.SearchCondition.OwnerComponent = this.Контрагент_vmoТаблицаИтогов;
            this.Контрагент_vmoТаблицаИтогов.SearchCondition.Parameters = new NsgSoft.DataObjects.NsgCompareParam[0];
            // 
            // Объект_vmoТаблицаИтогов
            // 
            this.Объект_vmoТаблицаИтогов.Caption = "Объект";
            this.Объект_vmoТаблицаИтогов.Creator = typeof(NsgSoft.Forms.NsgReportForm);
            this.Объект_vmoТаблицаИтогов.Name = "Объект";
            this.Объект_vmoТаблицаИтогов.NSGType = typeof(TechControl.Метаданные.Мониторинг.Объекты);
            this.Объект_vmoТаблицаИтогов.PropertyType = typeof(TechControl.Метаданные.Мониторинг.Объекты);
            this.Объект_vmoТаблицаИтогов.SearchCondition.OwnerComponent = this.Объект_vmoТаблицаИтогов;
            this.Объект_vmoТаблицаИтогов.SearchCondition.Parameters = new NsgSoft.DataObjects.NsgCompareParam[0];
            // 
        ...
        protected Мониторинг.Контрагенты.ColumnDescriptor Контрагент_vmoТаблицаИтогов;
        protected Мониторинг.Объекты.ColumnDescriptor Объект_vmoТаблицаИтогов;
        ...
        protected NsgVisualMultipleObject vmoТаблицаИтогов;
