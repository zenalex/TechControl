...
{
    public partial class УчетСотрудниковНазначенияСотрудниковТаблица
{
    [NsgTypeName("NsgDataTableRow", Guid = "d98086c0-116a-43d6-ae77-808cfbc994b6")]
    public partial class Строка : NsgSoft.DataObjects.NsgDataTableRow
    {
        ...
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("d98086c0-116a-43d6-ae77-808cfbc994b6"));
            if (obj == null)
                obj = new Строка();
        ...
        public override NsgMultipleObjectDescriptor Descriptor
        {
            get
            {
                if (descriptor == null)
                {
                    ...
                    descriptor.Name = "УчетСотрудниковНазначенияСотрудниковТаблица";
