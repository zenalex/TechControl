...
namespace TechControl.Метаданные.УчетСотрудников
{
    ...
    [NsgTypeName("NsgDataDocument", Guid = "dffa0ca6-19b7-44e4-a81d-cb53add5ae91")]
    public partial class ПриказОНазначенииСотрудника : NsgSoft.DataObjects.NsgDataDocument
    {
        #region Данные
        ...
        /// Создание объекта
        /// </summary>
        protected ПриказОНазначенииСотрудника()
            : base()
        {
        }
        ...
        /// </summary>
        protected ПриказОНазначенииСотрудника(NsgObject obj)
            : base(obj)
        {
        }
        ...
        public static ПриказОНазначенииСотрудника Новый()
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("dffa0ca6-19b7-44e4-a81d-cb53add5ae91"));
            if (obj == null)
                obj = new ПриказОНазначенииСотрудника();
            return obj as ПриказОНазначенииСотрудника;
        }
	...
	Идентификатор.Guid = NsgService.StringToGuid("4a4fb56a-bdac-410a-9b03-390bd75c0771");
	...
	Автоинкремент.Guid = NsgService.StringToGuid("08d7f721-f8a9-4df1-8594-6e1832fd2a55");
	...
	ПрефиксКода.Guid = NsgService.StringToGuid("5d45e281-482f-476e-a36b-0e7b7f0f0694");
	...
	НомерКода.GroupName = "";
	НомерКода.Guid = NsgService.StringToGuid("56cc0bb3-7392-4516-9f3c-f92ff81e58da");
	...
	НомерДокумента.Guid = NsgService.StringToGuid("5ab42ec8-b326-49e2-85fd-cb08631faf14");
	...
	ДатаДокумента.Guid = NsgService.StringToGuid("3ebf113c-85cb-4a81-bc84-a350463c2db5");
	...
	Индекс.GroupName = "";
	Индекс.Guid = NsgService.StringToGuid("3e29eb39-fc43-495f-b7bb-b3b9185ff514");
	...
	ДокументОснование.FilterForConfigurator = "УчетСотрудников.НазначенияСотрудников";
	...
	ДокументОснование.Guid = NsgService.StringToGuid("f4fb3784-2bef-40a1-bd18-eaff86728463");
	...
	Комментарий.Guid = NsgService.StringToGuid("bee99af0-fdad-4e37-9e04-89c63891d035");
	...
	СостояниеДокумента.Guid = NsgService.StringToGuid("29e90035-199e-4dda-befd-77b454336ac8");
	...
	Сотрудник.GroupName = "";
	Сотрудник.Guid = NsgService.StringToGuid("9fa63b00-ad96-476e-be0f-0eb812801201");
	...
	Должность.GroupName = "";
	Должность.Guid = NsgService.StringToGuid("e6df4851-28f2-470c-9ad8-8c1c93ff14a1");
	...
	Name = "ПриказОНазначенииСотрудника";
	Visible = true;
	Guid = NsgService.StringToGuid("dffa0ca6-19b7-44e4-a81d-cb53add5ae91");
	DefaultSortingName = "";
	...
	TableName = "_doc_PrikazONaznacheniiS";
	...
	GroupName = "УчетСотрудников";
        ...
        public override NsgMultipleObjectDescriptor Descriptor
        {
            get
            {
                if (descriptor == null)
                {
                    ...
                    descriptor.Name = "ПриказОНазначенииСотрудника";
        ...
        {
            return "УчетСотрудников.ПриказОНазначенииСотрудника";
        }
        ...
        [NsgReferentsFilterAttribute("УчетСотрудников.НазначенияСотрудников")]
        ...
        private ПриказОНазначенииСотрудника[] convertArray(NsgMultipleObject[] array)
        {
            ПриказОНазначенииСотрудника[] res = new ПриказОНазначенииСотрудника[array.Length];
            array.CopyTo(res, 0);
            return res;
        }
        ...
        public new virtual ПриказОНазначенииСотрудника[] FindAll(NsgCompare compare)
        {
        ...
        /// <returns>Список найденных объектов.</returns>
        public new virtual ПриказОНазначенииСотрудника[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, NsgCompare compare)
        {
        ...
        /// <returns>Список найденных объектов.</returns>
        public new virtual ПриказОНазначенииСотрудника[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, string inName, object inValue)
        {
        ...
        /// <param name="inValue">Значение для поиска. Условие поиска - полное совпадение.</param>
        /// <returns>Список найденных объектов.</returns>
        public new virtual ПриказОНазначенииСотрудника[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, NsgDataFixedFields inName,
            object inValue)
        {
            return convertArray(base.FindAll(ref count, row_start, sorting, inName, inValue));
        }
        ...
        public override NsgObject CloneObject
        {
            get
            {
                return new ПриказОНазначенииСотрудника(this as NsgObject);
            }
        }
        ...
        public new class ColumnDescriptor : NsgSoft.Forms.NsgColumnDescriptor
        {
            public ColumnDescriptor()
                : base()
            {
                base.NSGType = typeof(ПриказОНазначенииСотрудника);
            }
			...
			public new ПриказОНазначенииСотрудника Value
            {
                get
                {
                    return (ПриказОНазначенииСотрудника)base.Value;
                }
                set
                {
                    base.Value = value;
