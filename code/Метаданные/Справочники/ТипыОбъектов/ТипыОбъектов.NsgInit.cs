...
namespace TechControl.Метаданные.Справочники
{
    ...
    [NsgTypeName("NsgDataDictionary", Guid = "00773bc9-dcda-4181-85fd-1262d39a83b1")]
    public partial class ТипыОбъектов : NsgSoft.DataObjects.NsgDataDictionary
    {
        #region Данные
        ...
        /// </summary>
        protected ТипыОбъектов(NsgObject obj)
            : base(obj)
        {
        }
        ...
        public static ТипыОбъектов Новый()
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("00773bc9-dcda-4181-85fd-1262d39a83b1"));
            if (obj == null)
                obj = new ТипыОбъектов();
            return obj as ТипыОбъектов;
        }
	...
	Идентификатор.Guid = NsgService.StringToGuid("8cad550c-8179-442a-ba91-951a0cef20e8");
	...
	Автоинкремент.Guid = NsgService.StringToGuid("e2b5496c-4e54-4771-94b0-2332005661e4");
	...
	ЭтоГруппа.GroupName = "";
	ЭтоГруппа.Guid = NsgService.StringToGuid("97febe09-2447-4a8a-854b-7e1b24b9e131");
	...
	ИдентификаторРодителя.Guid = NsgService.StringToGuid("bece4010-5571-4713-b855-cfe32e1dce54");
	...
	Уровень.GroupName = "";
	Уровень.Guid = NsgService.StringToGuid("d6727201-01a4-4322-acfa-7538e71bbea5");
	...
	ПрефиксКода.Guid = NsgService.StringToGuid("29fb08cb-c8dd-4f63-844f-0e38e8a6e68e");
	...
	НомерКода.GroupName = "";
	НомерКода.Guid = NsgService.StringToGuid("5e250fd2-4f73-4930-8c5d-0e8b30fcedf9");
	...
	Код.GroupName = "";
	Код.Guid = NsgService.StringToGuid("4fab1f05-6ce2-41c5-8831-3e08c726267c");
	...
	Наименование.Guid = NsgService.StringToGuid("4608d50c-3111-40af-85f0-271bfc3ec277");
	...
	СостояниеДокумента.Guid = NsgService.StringToGuid("b5246881-3b69-4b96-a287-d207ce969e85");
			...
			#region создание TechControl.Метаданные.Справочники.ТипыОбъектовФормаЭлемента ФормаЭлемента
			{  
	...
	ФормаЭлемента.FormClassName = "TechControl.Метаданные.Справочники.ТипыОбъектовФормаЭлемента";
	...
	ФормаЭлемента.Guid = NsgService.StringToGuid("51d4003e-c687-4103-a85e-9d62c58e886e");
	
				if (!ObjectList.Contains("ФормаЭлемента"))
                    ObjectList.Add(ФормаЭлемента);
			}
			#endregion //создание TechControl.Метаданные.Справочники.ТипыОбъектовФормаЭлемента ФормаЭлемента
			
			#region создание _SystemTables.СправочникиТипыОбъектовТаблицаНоменлатуры ТаблицаНоменлатуры
			{  
                NsgDataTableReference ТаблицаНоменлатуры = null;
				if (ObjectList.Contains("ТаблицаНоменлатуры"))
                    ТаблицаНоменлатуры = ObjectList["ТаблицаНоменлатуры"] as NsgDataTableReference;
                else
                    ТаблицаНоменлатуры = new NsgDataTableReference();
	//NsgDataTableReference
	ТаблицаНоменлатуры.IsLoadedFromDll = true;
	ТаблицаНоменлатуры.Name = "ТаблицаНоменлатуры";
	ТаблицаНоменлатуры.SaveInDatabase = false;
	ТаблицаНоменлатуры.ReferentGroup = "_SystemTables";
	ТаблицаНоменлатуры.ReferentName = "СправочникиТипыОбъектовТаблицаНоменлатуры";
	ТаблицаНоменлатуры.OwnerName = "";
	ТаблицаНоменлатуры.AllowEmptyOwner = false;
	ТаблицаНоменлатуры.StringFormat = "";
	ТаблицаНоменлатуры.SubType = NsgSoft.Common.NsgRekvisitSubType.Tables;
	ТаблицаНоменлатуры.IncludeInPredefined = false;
	ТаблицаНоменлатуры.PeriodicType = NsgSoft.Database.PeriodicTypes.None;
	ТаблицаНоменлатуры.Required = false;
	ТаблицаНоменлатуры.EmptyValue = "";
	ТаблицаНоменлатуры.NullAllow = false;
	ТаблицаНоменлатуры.IndexType = NsgSoft.Database.NsgRekvisitIndexType.None;
	ТаблицаНоменлатуры.FieldName = "TablicaNomenlatury";
	ТаблицаНоменлатуры.InformMetaDataOnValueChanged = false;
	ТаблицаНоменлатуры.Visible = true;
	ТаблицаНоменлатуры.Presentation = new NsgSoft.DataObjects.NsgLanguageString(new System.String[]{"(Default)"},
		 new System.Object[]{""});
	ТаблицаНоменлатуры.Description = "Таблица номенлатуры";
	ТаблицаНоменлатуры.EditorVisible = NsgSoft.DataObjects.NsgDataObjectEditorAccess.Full;
	ТаблицаНоменлатуры.GroupName = "";
	ТаблицаНоменлатуры.Guid = NsgService.StringToGuid("554fa7cd-dd36-4a11-839e-17689d9da527");
	
				if (!ObjectList.Contains("ТаблицаНоменлатуры"))
                    ObjectList.Add(ТаблицаНоменлатуры);
			}
			#endregion //создание _SystemTables.СправочникиТипыОбъектовТаблицаНоменлатуры ТаблицаНоменлатуры
	...
	Name = "ТипыОбъектов";
	Visible = true;
	Guid = NsgService.StringToGuid("00773bc9-dcda-4181-85fd-1262d39a83b1");
	DefaultSortingName = "";
	...
	GroupName = "Справочники";
        ...
        public new partial class Names// :NsgSoft.DataObjects.NsgDataDictionary.Names
        {
            ...
            /// Таблица номенлатуры
            /// </summary>
            public static String ТаблицаНоменлатуры
            {
                get
                {
                    return "ТаблицаНоменлатуры";
                }
            }
        ...
        {
            return "Справочники.ТипыОбъектов";
        }
        ...
        public _SystemTables.СправочникиТипыОбъектовТаблицаНоменлатуры ТаблицаНоменлатуры
        {
            get
            {
				 NsgDataTableReference __ТаблицаНоменлатуры = ObjectList["ТаблицаНоменлатуры"] as NsgDataTableReference;
                 return (_SystemTables.СправочникиТипыОбъектовТаблицаНоменлатуры)__ТаблицаНоменлатуры.Referent;
            }
            set
            {
                NsgDataTableReference __ТаблицаНоменлатуры = ObjectList["ТаблицаНоменлатуры"] as NsgDataTableReference;
                __ТаблицаНоменлатуры.Referent = value;
            }
        }
        ...
        public ТипыОбъектов Родитель
        {
            get
            {
                return base.Parent as ТипыОбъектов;
            }
            set
            {
                base.Parent = value;
        ...
        private ТипыОбъектов[] convertArray(NsgMultipleObject[] array)
        {
            ТипыОбъектов[] res = new ТипыОбъектов[array.Length];
            array.CopyTo(res, 0);
            return res;
        }
        ...
        public new virtual ТипыОбъектов[] FindAll(NsgCompare compare)
        {
        ...
        /// <returns>Список найденных объектов.</returns>
        public new virtual ТипыОбъектов[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, NsgCompare compare)
        {
        ...
        /// <returns>Список найденных объектов.</returns>
        public new virtual ТипыОбъектов[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, string inName, object inValue)
        {
        ...
        /// <param name="inValue">Значение для поиска. Условие поиска - полное совпадение.</param>
        /// <returns>Список найденных объектов.</returns>
        public new virtual ТипыОбъектов[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, NsgDataFixedFields inName,
            object inValue)
        {
            return convertArray(base.FindAll(ref count, row_start, sorting, inName, inValue));
        }
        ...
        public override NsgObject CloneObject
        {
            get
            {
                return new ТипыОбъектов(this as NsgObject);
            }
        }
        ...
        public new class ColumnDescriptor : NsgSoft.Forms.NsgColumnDescriptor
        {
            public ColumnDescriptor()
                : base()
            {
                base.NSGType = typeof(ТипыОбъектов);
            }
			...
			public new ТипыОбъектов Value
            {
                get
                {
                    return (ТипыОбъектов)base.Value;
                }
                set
                {
                    base.Value = value;
