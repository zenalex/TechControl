...
namespace TechControl.Метаданные.Справочники
{
    ...
    [NsgTypeName("NsgDataDictionary", Guid = "efc64d82-62f9-4226-ac23-9974342dfb0e")]
    public partial class ВидыРабот : NsgSoft.DataObjects.NsgDataDictionary
    {
        #region Данные
        ...
        /// </summary>
        protected ВидыРабот(NsgObject obj)
            : base(obj)
        {
        }
        ...
        public static ВидыРабот Новый()
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("efc64d82-62f9-4226-ac23-9974342dfb0e"));
            if (obj == null)
                obj = new ВидыРабот();
            return obj as ВидыРабот;
        }
	...
	Идентификатор.Guid = NsgService.StringToGuid("589817f6-a407-412c-b94f-06987b2023fd");
	...
	Автоинкремент.Guid = NsgService.StringToGuid("fd15eaf6-216c-4f9b-bf40-f92895c8d04f");
	...
	ЭтоГруппа.GroupName = "";
	ЭтоГруппа.Guid = NsgService.StringToGuid("ab9f4236-75d6-4da3-826b-5fa3c5eff608");
	...
	ИдентификаторРодителя.Guid = NsgService.StringToGuid("dedd2b22-7948-4d3b-9793-0e9356f82329");
	...
	Уровень.GroupName = "";
	Уровень.Guid = NsgService.StringToGuid("6c34865f-5648-4a48-9320-105ed14c9fac");
	...
	ПрефиксКода.Guid = NsgService.StringToGuid("27e0404a-ad22-4a85-aea3-37eae7cc9978");
	...
	НомерКода.GroupName = "";
	НомерКода.Guid = NsgService.StringToGuid("b9043c16-c30a-4b52-893e-4c47fe228f18");
	...
	Код.GroupName = "";
	Код.Guid = NsgService.StringToGuid("b927c8bf-6e4d-4a4c-87c1-73aaab0b32b8");
	...
	Наименование.Guid = NsgService.StringToGuid("10c225ee-a4a4-403b-b62a-3ccc5344b97b");
	...
	СостояниеДокумента.Guid = NsgService.StringToGuid("460efdbd-4559-4478-8700-1faac2df5c73");
	...
	Name = "ВидыРабот";
	Visible = true;
	Guid = NsgService.StringToGuid("efc64d82-62f9-4226-ac23-9974342dfb0e");
	DefaultSortingName = "";
	...
	GroupName = "Справочники";
        ...
        public override NsgMultipleObjectDescriptor Descriptor
        {
            get
            {
                if (descriptor == null)
                {
                    ...
                    descriptor.Name = "ВидыРабот";
                    descriptor.GroupName = "Справочники";
                }
                return descriptor;
            }
            set
        ...
        public ВидыРабот Родитель
        {
            get
            {
                return base.Parent as ВидыРабот;
            }
            set
            {
                base.Parent = value;
        ...
        private ВидыРабот[] convertArray(NsgMultipleObject[] array)
        {
            ВидыРабот[] res = new ВидыРабот[array.Length];
            array.CopyTo(res, 0);
            return res;
        }
        ...
        public new virtual ВидыРабот[] FindAll(NsgCompare compare)
        {
        ...
        /// <returns>Список найденных объектов.</returns>
        public new virtual ВидыРабот[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, NsgCompare compare)
        {
        ...
        /// <returns>Список найденных объектов.</returns>
        public new virtual ВидыРабот[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, string inName, object inValue)
        {
        ...
        /// <param name="inValue">Значение для поиска. Условие поиска - полное совпадение.</param>
        /// <returns>Список найденных объектов.</returns>
        public new virtual ВидыРабот[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, NsgDataFixedFields inName,
            object inValue)
        {
            return convertArray(base.FindAll(ref count, row_start, sorting, inName, inValue));
        }
        ...
        public override NsgObject CloneObject
        {
            get
            {
                return new ВидыРабот(this as NsgObject);
            }
        }
        ...
        public new class ColumnDescriptor : NsgSoft.Forms.NsgColumnDescriptor
        {
			...
			public new ВидыРабот Value
            {
                get
                {
                    return (ВидыРабот)base.Value;
                }
                set
                {
                    base.Value = value;
