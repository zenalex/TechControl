...
namespace TechControl.Метаданные.Справочники
{
    ...
    [NsgTypeName("NsgDataDictionary", Guid = "16e9af5a-7164-4875-89ae-bb40b1992a24")]
    public partial class ШаблоныВидовРабот : NsgSoft.DataObjects.NsgDataDictionary
    {
        #region Данные
        ...
        /// </summary>
        protected ШаблоныВидовРабот(NsgObject obj)
            : base(obj)
        {
        }
        ...
        public static ШаблоныВидовРабот Новый()
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("16e9af5a-7164-4875-89ae-bb40b1992a24"));
            if (obj == null)
                obj = new ШаблоныВидовРабот();
            return obj as ШаблоныВидовРабот;
        }
	...
	Идентификатор.Guid = NsgService.StringToGuid("a9f404f6-bd54-456b-8051-8172b1c0007d");
	...
	Автоинкремент.Guid = NsgService.StringToGuid("e5d7e69a-685e-4c44-9b31-9c3e8b93eb43");
	...
	ЭтоГруппа.GroupName = "";
	ЭтоГруппа.Guid = NsgService.StringToGuid("8f4fb84b-88b0-4e31-93e3-2f330afc1dc9");
	...
	ИдентификаторРодителя.Guid = NsgService.StringToGuid("f1f301ea-fb15-4a1e-8039-e13767c99894");
	...
	Уровень.GroupName = "";
	Уровень.Guid = NsgService.StringToGuid("5d1fb825-228e-4b76-a429-e47c8961a0b1");
	...
	ПрефиксКода.Guid = NsgService.StringToGuid("4d9e500c-d42b-46bc-ae46-a7544bd29e13");
	...
	НомерКода.GroupName = "";
	НомерКода.Guid = NsgService.StringToGuid("8335d0c6-c818-4814-ac5c-09b7ebb6bd1b");
	...
	Код.GroupName = "";
	Код.Guid = NsgService.StringToGuid("1c91ffc8-202e-4621-b278-60fc5bac1cf5");
	...
	Наименование.Guid = NsgService.StringToGuid("1c4e7618-00d5-49fd-97ba-605f8ada6236");
	...
	СостояниеДокумента.Guid = NsgService.StringToGuid("9b1c4165-c00d-4c91-b6b0-13dbbf493eea");
	...
	Автор.GroupName = "";
	Автор.Guid = NsgService.StringToGuid("d7eba014-1c1f-4c53-ab6a-6725b5abd124");
			...
			#region создание _SystemTables.СправочникиШаблоныВидовРаботВидыРабот ВидыРабот
			{  
                NsgDataTableReference ВидыРабот = null;
				if (ObjectList.Contains("ВидыРабот"))
                    ВидыРабот = ObjectList["ВидыРабот"] as NsgDataTableReference;
                else
                    ВидыРабот = new NsgDataTableReference();
	//NsgDataTableReference
	ВидыРабот.IsLoadedFromDll = true;
	ВидыРабот.Name = "ВидыРабот";
	ВидыРабот.SaveInDatabase = false;
	ВидыРабот.ReferentGroup = "_SystemTables";
	ВидыРабот.ReferentName = "СправочникиШаблоныВидовРаботВидыРабот";
	ВидыРабот.OwnerName = "";
	ВидыРабот.AllowEmptyOwner = false;
	ВидыРабот.StringFormat = "";
	ВидыРабот.SubType = NsgSoft.Common.NsgRekvisitSubType.Tables;
	ВидыРабот.IncludeInPredefined = false;
	ВидыРабот.PeriodicType = NsgSoft.Database.PeriodicTypes.None;
	ВидыРабот.Required = false;
	ВидыРабот.EmptyValue = "";
	ВидыРабот.NullAllow = false;
	ВидыРабот.IndexType = NsgSoft.Database.NsgRekvisitIndexType.None;
	ВидыРабот.FieldName = "VidyRabot";
	ВидыРабот.InformMetaDataOnValueChanged = false;
	ВидыРабот.Visible = true;
	ВидыРабот.Presentation = new NsgSoft.DataObjects.NsgLanguageString(new System.String[]{"(Default)"},
		 new System.Object[]{""});
	ВидыРабот.Description = "Виды работ";
	ВидыРабот.EditorVisible = NsgSoft.DataObjects.NsgDataObjectEditorAccess.Full;
	ВидыРабот.GroupName = "";
	ВидыРабот.Guid = NsgService.StringToGuid("97623e3a-6624-4e0c-8f88-621ea00f11f5");
	
				if (!ObjectList.Contains("ВидыРабот"))
                    ObjectList.Add(ВидыРабот);
			}
			#endregion //создание _SystemTables.СправочникиШаблоныВидовРаботВидыРабот ВидыРабот
	...
	Name = "ШаблоныВидовРабот";
	Visible = true;
	Guid = NsgService.StringToGuid("16e9af5a-7164-4875-89ae-bb40b1992a24");
	DefaultSortingName = "";
	...
	TableName = "_dic_SHablonyVidovRabot";
	...
	GroupName = "Справочники";
        ...
        public new partial class Names// :NsgSoft.DataObjects.NsgDataDictionary.Names
        {
            ...
            /// Виды работ
            /// </summary>
            public static String ВидыРабот
            {
                get
                {
                    return "ВидыРабот";
        ...
        public override NsgMultipleObjectDescriptor Descriptor
        {
            get
            {
                if (descriptor == null)
                {
                    ...
                    descriptor.Name = "ШаблоныВидовРабот";
        ...
        {
            return "Справочники.ШаблоныВидовРабот";
        }
        ...
        public _SystemTables.СправочникиШаблоныВидовРаботВидыРабот ВидыРабот
        {
            get
            {
				 NsgDataTableReference __ВидыРабот = ObjectList["ВидыРабот"] as NsgDataTableReference;
                 return (_SystemTables.СправочникиШаблоныВидовРаботВидыРабот)__ВидыРабот.Referent;
            }
            set
            {
                NsgDataTableReference __ВидыРабот = ObjectList["ВидыРабот"] as NsgDataTableReference;
                __ВидыРабот.Referent = value;
            }
        }
        ...
        [NsgView(NsgViewTypes.DesignTime)]
        [NsgTypeName("NsgDataDictionary")]
        public ШаблоныВидовРабот Родитель
        {
            get
            {
                return base.Parent as ШаблоныВидовРабот;
            }
            set
            {
                base.Parent = value;
        ...
        private ШаблоныВидовРабот[] convertArray(NsgMultipleObject[] array)
        {
            ШаблоныВидовРабот[] res = new ШаблоныВидовРабот[array.Length];
            array.CopyTo(res, 0);
            return res;
        }
        ...
        public new virtual ШаблоныВидовРабот[] FindAll(NsgCompare compare)
        {
        ...
        /// <returns>Список найденных объектов.</returns>
        public new virtual ШаблоныВидовРабот[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, NsgCompare compare)
        {
        ...
        /// <returns>Список найденных объектов.</returns>
        public new virtual ШаблоныВидовРабот[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, string inName, object inValue)
        {
        ...
        /// <param name="inValue">Значение для поиска. Условие поиска - полное совпадение.</param>
        /// <returns>Список найденных объектов.</returns>
        public new virtual ШаблоныВидовРабот[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, NsgDataFixedFields inName,
            object inValue)
        {
            return convertArray(base.FindAll(ref count, row_start, sorting, inName, inValue));
        }
        ...
        public override NsgObject CloneObject
        {
            get
            {
                return new ШаблоныВидовРабот(this as NsgObject);
            }
        }
        ...
        public new class ColumnDescriptor : NsgSoft.Forms.NsgColumnDescriptor
        {
            public ColumnDescriptor()
                : base()
            {
                base.NSGType = typeof(ШаблоныВидовРабот);
            }
			...
			public new ШаблоныВидовРабот Value
            {
                get
                {
                    return (ШаблоныВидовРабот)base.Value;
                }
                set
                {
                    base.Value = value;
