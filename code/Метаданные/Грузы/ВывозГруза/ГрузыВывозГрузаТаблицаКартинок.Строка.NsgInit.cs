...
{
    public partial class ГрузыВывозГрузаТаблицаКартинок
{
    [NsgTypeName("NsgDataTableRow", Guid = "db815534-babd-4d36-8a67-03fe4ae5957c")]
    public partial class Строка : NsgSoft.DataObjects.NsgDataTableRow
    {
        ...
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("db815534-babd-4d36-8a67-03fe4ae5957c"));
            if (obj == null)
                obj = new Строка();
        ...
        public override NsgMultipleObjectDescriptor Descriptor
        {
            get
            {
                if (descriptor == null)
                {
                    ...
                    descriptor.Name = "ГрузыВывозГрузаТаблицаКартинок";
        ...
        [NsgReferentsFilterAttribute("Грузы.ВывозГруза")]
