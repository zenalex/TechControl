...
namespace TechControl.Метаданные.Грузы
{
    ...
    [NsgTypeName("NsgDataDictionary", Guid = "1c04f903-5f58-4ce5-ac9a-3aeb5d5b4315")]
    public partial class ВидыГрузов : NsgSoft.DataObjects.NsgDataDictionary
    {
        #region Данные
        ...
        /// </summary>
        protected ВидыГрузов(NsgObject obj)
            : base(obj)
        {
        }
        ...
        public static ВидыГрузов Новый()
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("1c04f903-5f58-4ce5-ac9a-3aeb5d5b4315"));
            if (obj == null)
                obj = new ВидыГрузов();
            return obj as ВидыГрузов;
        }
	...
	Идентификатор.Guid = NsgService.StringToGuid("a8501ee7-1cc7-48de-94ec-d7151dad505e");
	...
	Автоинкремент.Guid = NsgService.StringToGuid("31814ec5-1b0d-4050-9b34-22c89264932e");
	...
	ЭтоГруппа.GroupName = "";
	ЭтоГруппа.Guid = NsgService.StringToGuid("4e8c8042-281f-460d-a6cf-3608bb68862a");
	...
	ИдентификаторРодителя.Guid = NsgService.StringToGuid("0c3d710b-46cd-435c-ab88-4e4a770303f8");
	...
	Уровень.GroupName = "";
	Уровень.Guid = NsgService.StringToGuid("8f73f289-6a29-4290-aa30-f8d1e7159c2c");
	...
	ПрефиксКода.Guid = NsgService.StringToGuid("0f9790dc-11ee-4167-bd88-3c472b8386c1");
	...
	НомерКода.GroupName = "";
	НомерКода.Guid = NsgService.StringToGuid("09a7361a-8bc6-46e0-85b1-8aec792f282e");
	...
	Код.GroupName = "";
	Код.Guid = NsgService.StringToGuid("49c47d87-1e7c-4bda-a87f-34c59d7ea0d9");
	...
	Наименование.Guid = NsgService.StringToGuid("7fbcb751-7c30-46d9-83aa-9a4dfb2840f9");
	...
	СостояниеДокумента.Guid = NsgService.StringToGuid("f1b7395a-a193-4395-b899-5c99a0551d82");
	...
	Name = "ВидыГрузов";
	Visible = true;
	Guid = NsgService.StringToGuid("1c04f903-5f58-4ce5-ac9a-3aeb5d5b4315");
	DefaultSortingName = "";
	...
	GroupName = "Грузы";
        ...
        public ВидыГрузов Родитель
        {
            get
            {
                return base.Parent as ВидыГрузов;
            }
            set
            {
                base.Parent = value;
        ...
        private ВидыГрузов[] convertArray(NsgMultipleObject[] array)
        {
            ВидыГрузов[] res = new ВидыГрузов[array.Length];
            array.CopyTo(res, 0);
            return res;
        }
        ...
        public new virtual ВидыГрузов[] FindAll(NsgCompare compare)
        {
        ...
        /// <returns>Список найденных объектов.</returns>
        public new virtual ВидыГрузов[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, NsgCompare compare)
        {
        ...
        /// <returns>Список найденных объектов.</returns>
        public new virtual ВидыГрузов[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, string inName, object inValue)
        {
        ...
        /// <param name="inValue">Значение для поиска. Условие поиска - полное совпадение.</param>
        /// <returns>Список найденных объектов.</returns>
        public new virtual ВидыГрузов[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, NsgDataFixedFields inName,
            object inValue)
        {
            return convertArray(base.FindAll(ref count, row_start, sorting, inName, inValue));
        }
        ...
        public override NsgObject CloneObject
        {
            get
            {
                return new ВидыГрузов(this as NsgObject);
            }
        }
        ...
        public new class ColumnDescriptor : NsgSoft.Forms.NsgColumnDescriptor
        {
            public ColumnDescriptor()
                : base()
            {
                base.NSGType = typeof(ВидыГрузов);
            }
			...
			public new ВидыГрузов Value
            {
                get
                {
                    return (ВидыГрузов)base.Value;
                }
                set
                {
                    base.Value = value;
