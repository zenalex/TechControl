...
{
    public partial class ГрузыДокументыВыездаТаблицаФотографии
{
    [NsgTypeName("NsgDataTableRow", Guid = "cf0f7797-1053-400e-8dc7-dd76e13a7b3c")]
    public partial class Строка : NsgSoft.DataObjects.NsgDataTableRow
    {
        ...
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("cf0f7797-1053-400e-8dc7-dd76e13a7b3c"));
            if (obj == null)
                obj = new Строка();
        ...
        public override NsgMultipleObjectDescriptor Descriptor
        {
            get
            {
                if (descriptor == null)
                {
                    ...
                    descriptor.Name = "ГрузыДокументыВыездаТаблицаФотографии";
        ...
        [NsgReferentsFilterAttribute("Грузы.ДокументыВыезда")]
