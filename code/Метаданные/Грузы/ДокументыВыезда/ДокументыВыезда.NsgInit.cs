...
namespace TechControl.Метаданные.Грузы
{
    ...
    [NsgTypeName("NsgDataDocument", Guid = "276d5a4e-8707-46ae-b278-c452fc832f5b")]
    public partial class ДокументыВыезда : NsgSoft.DataObjects.NsgDataDocument
    {
        #region Данные
        ...
        /// </summary>
        protected ДокументыВыезда(NsgObject obj)
            : base(obj)
        {
        }
        ...
        public static ДокументыВыезда Новый()
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("276d5a4e-8707-46ae-b278-c452fc832f5b"));
            if (obj == null)
                obj = new ДокументыВыезда();
            return obj as ДокументыВыезда;
        }
	...
	Идентификатор.Guid = NsgService.StringToGuid("d62f38f7-b00f-492a-b5f6-1ae11ec81e83");
	...
	Автоинкремент.Guid = NsgService.StringToGuid("6915f0b8-e905-4b13-b3f9-15389798bdf5");
	...
	ПрефиксКода.Guid = NsgService.StringToGuid("4df5841e-72c3-4743-bc4b-6284b535efca");
	...
	НомерКода.GroupName = "";
	НомерКода.Guid = NsgService.StringToGuid("fa031dc1-a3de-4826-b8a2-f8a8fdf4fcb3");
	...
	НомерДокумента.Guid = NsgService.StringToGuid("5969aa9c-d48d-46c8-90bb-d880c13663a6");
	...
	ДатаДокумента.Guid = NsgService.StringToGuid("ad811b59-f966-490a-9f87-d4386c06b80a");
	...
	Индекс.GroupName = "";
	Индекс.Guid = NsgService.StringToGuid("40e2bc21-d2b9-478a-b55e-2d823808f3ff");
	...
	ДокументОснование.Guid = NsgService.StringToGuid("1a2edef3-ba42-4434-ab19-834aa21218a7");
	...
	Комментарий.Guid = NsgService.StringToGuid("984b06eb-3ec8-4a6d-b832-c11c2a3c8482");
	...
	СостояниеДокумента.Guid = NsgService.StringToGuid("0b3b76df-a20c-4331-b2e4-b0809474b437");
	...
	Техника.GroupName = "";
	Техника.Guid = NsgService.StringToGuid("828c09e9-5101-4f2c-af96-137bf07e0316");
	...
	КПП.StringFormat = "";
	КПП.SubType = NsgSoft.Common.NsgRekvisitSubType.Common;
	...
	КПП.GroupName = "";
	КПП.Guid = NsgService.StringToGuid("8378c9b9-3727-497a-8a01-9ff18e8fd411");
	...
	Объект.GroupName = "";
	Объект.Guid = NsgService.StringToGuid("d8a1dafd-4912-48d2-b524-6a56c0db00ac");
			...
			#region создание УчетСотрудников.ФизЛица Водитель
			{  
	...
	Водитель.ReferentGroup = "УчетСотрудников";
	...
	Водитель.GroupName = "";
	Водитель.Guid = NsgService.StringToGuid("84099636-676e-44b9-8c96-236e4fec9ca1");
	
				if (!ObjectList.Contains("Водитель"))
                    ObjectList.Add(Водитель);
			}
			#endregion //создание УчетСотрудников.ФизЛица Водитель
			
			#region создание _SystemTables.ГрузыДокументыВыездаТаблицаФотографии ТаблицаФотографии
			{  
                NsgDataTableReference ТаблицаФотографии = null;
				if (ObjectList.Contains("ТаблицаФотографии"))
                    ТаблицаФотографии = ObjectList["ТаблицаФотографии"] as NsgDataTableReference;
                else
                    ТаблицаФотографии = new NsgDataTableReference();
	//NsgDataTableReference
	ТаблицаФотографии.IsLoadedFromDll = true;
	ТаблицаФотографии.Name = "ТаблицаФотографии";
	ТаблицаФотографии.SaveInDatabase = false;
	ТаблицаФотографии.ReferentGroup = "_SystemTables";
	ТаблицаФотографии.ReferentName = "ГрузыДокументыВыездаТаблицаФотографии";
	ТаблицаФотографии.OwnerName = "";
	ТаблицаФотографии.AllowEmptyOwner = false;
	ТаблицаФотографии.StringFormat = "";
	ТаблицаФотографии.SubType = NsgSoft.Common.NsgRekvisitSubType.Tables;
	ТаблицаФотографии.IncludeInPredefined = false;
	ТаблицаФотографии.PeriodicType = NsgSoft.Database.PeriodicTypes.None;
	ТаблицаФотографии.Required = false;
	ТаблицаФотографии.EmptyValue = "";
	ТаблицаФотографии.NullAllow = false;
	ТаблицаФотографии.IndexType = NsgSoft.Database.NsgRekvisitIndexType.None;
	ТаблицаФотографии.FieldName = "TablicaFotografii";
	ТаблицаФотографии.InformMetaDataOnValueChanged = false;
	ТаблицаФотографии.Visible = true;
	ТаблицаФотографии.Presentation = new NsgSoft.DataObjects.NsgLanguageString(new System.String[]{"(Default)"},
		 new System.Object[]{""});
	ТаблицаФотографии.Description = "Таблица фотографии";
	ТаблицаФотографии.EditorVisible = NsgSoft.DataObjects.NsgDataObjectEditorAccess.Full;
	ТаблицаФотографии.GroupName = "";
	ТаблицаФотографии.Guid = NsgService.StringToGuid("6bef3934-7692-4036-8222-14468ae034a9");
	
				if (!ObjectList.Contains("ТаблицаФотографии"))
                    ObjectList.Add(ТаблицаФотографии);
			}
			#endregion //создание _SystemTables.ГрузыДокументыВыездаТаблицаФотографии ТаблицаФотографии
			
			#region создание TechControl.Метаданные.Грузы.ДокументыВыездаФормаЭлемента ФормаЭлемента
			{  
	...
	ФормаЭлемента.FormClassName = "TechControl.Метаданные.Грузы.ДокументыВыездаФормаЭлемента";
	...
	ФормаЭлемента.Guid = NsgService.StringToGuid("7257ea77-424e-40a4-bd69-5538ea33dd16");
	
				if (!ObjectList.Contains("ФормаЭлемента"))
                    ObjectList.Add(ФормаЭлемента);
			}
			#endregion //создание TechControl.Метаданные.Грузы.ДокументыВыездаФормаЭлемента ФормаЭлемента
	...
	UsedRegistersForConfigurator = new NsgSoft.DataObjects.NsgPropertyCollection(new System.String[]{"Сервис.ПечатныеФормы", "Мониторинг.РегистрМониторингТехники", "Мониторинг.ФиксацияИстории", "Сервис.ПраваПользователей", "Мониторинг.МониторирнгТехники", "Мониторинг.РегистрОтработанногоВремени", "Мониторинг.РегистрСмен", "Мониторинг.РегистрЗаправок", "Мониторинг.РегистрПоставокТоплива", "Мониторинг.ФиксацияИсторииСотрудников", "Учет.ОстаткиНоменклатуры", "УчетСпецодеждыИСИЗ.РегистрУчетСпецодежды", "УчетИнструмента.РегистрУчетИнструмента", "Учет.РегистрЦен", "УчетСпецодеждыИСИЗ.РегистрРезерваЗнС", "УчетСпецодеждыИСИЗ.РегистрРезерваЗП", "УчетСотрудников.РегистрУчетСотрудников", "Регистры.РегистрПерсоналОбъекта", "Регистры.РегистрТехникаОбъекта", "Регистры.РегистрТарифыПерсоналаОбъекта", "Регистры.РегистрТарифыТехникиОбъекта", "Грузы.РегистрПеремещениеЧерезКПП"},
		 new System.Object[]{NsgSoft.DataObjects.NsgDataDocument.RegisterHandleRegime.None, NsgSoft.DataObjects.NsgDataDocument.RegisterHandleRegime.None, NsgSoft.DataObjects.NsgDataDocument.RegisterHandleRegime.None, NsgSoft.DataObjects.NsgDataDocument.RegisterHandleRegime.None, NsgSoft.DataObjects.NsgDataDocument.RegisterHandleRegime.None, NsgSoft.DataObjects.NsgDataDocument.RegisterHandleRegime.None, NsgSoft.DataObjects.NsgDataDocument.RegisterHandleRegime.None, NsgSoft.DataObjects.NsgDataDocument.RegisterHandleRegime.None, NsgSoft.DataObjects.NsgDataDocument.RegisterHandleRegime.None, NsgSoft.DataObjects.NsgDataDocument.RegisterHandleRegime.None, NsgSoft.DataObjects.NsgDataDocument.RegisterHandleRegime.None, NsgSoft.DataObjects.NsgDataDocument.RegisterHandleRegime.None, NsgSoft.DataObjects.NsgDataDocument.RegisterHandleRegime.None, NsgSoft.DataObjects.NsgDataDocument.RegisterHandleRegime.None, NsgSoft.DataObjects.NsgDataDocument.RegisterHandleRegime.None, NsgSoft.DataObjects.NsgDataDocument.RegisterHandleRegime.None, NsgSoft.DataObjects.NsgDataDocument.RegisterHandleRegime.None, NsgSoft.DataObjects.NsgDataDocument.RegisterHandleRegime.None, NsgSoft.DataObjects.NsgDataDocument.RegisterHandleRegime.None, NsgSoft.DataObjects.NsgDataDocument.RegisterHandleRegime.None, NsgSoft.DataObjects.NsgDataDocument.RegisterHandleRegime.None, NsgSoft.DataObjects.NsgDataDocument.RegisterHandleRegime.Write});
	...
	Name = "ДокументыВыезда";
	Visible = true;
	Guid = NsgService.StringToGuid("276d5a4e-8707-46ae-b278-c452fc832f5b");
	DefaultSortingName = "";
	...
	TableName = "_doc_DokumentyVyezda";
	...
	GroupName = "Грузы";
        ...
        public new partial class Names// :NsgSoft.DataObjects.NsgDataDocument.Names
        {
            ...
            /// Таблица фотографии
            /// </summary>
            public static String ТаблицаФотографии
            {
                get
                {
                    return "ТаблицаФотографии";
                }
            }
        ...
        public override NsgMultipleObjectDescriptor Descriptor
        {
            get
            {
                if (descriptor == null)
                {
                    ...
                    descriptor.Name = "ДокументыВыезда";
        ...
        public УчетСотрудников.ФизЛица Водитель
        {
            get
            {
				 NsgDataTypedReference __Водитель = ObjectList["Водитель"] as NsgDataTypedReference;
                 return (УчетСотрудников.ФизЛица)__Водитель.Referent;
            }
            set
            {
                NsgDataTypedReference __Водитель = ObjectList["Водитель"] as NsgDataTypedReference;
        ...
        public _SystemTables.ГрузыДокументыВыездаТаблицаФотографии ТаблицаФотографии
        {
            get
            {
				 NsgDataTableReference __ТаблицаФотографии = ObjectList["ТаблицаФотографии"] as NsgDataTableReference;
                 return (_SystemTables.ГрузыДокументыВыездаТаблицаФотографии)__ТаблицаФотографии.Referent;
            }
            set
            {
                NsgDataTableReference __ТаблицаФотографии = ObjectList["ТаблицаФотографии"] as NsgDataTableReference;
                __ТаблицаФотографии.Referent = value;
            }
        }
        ...
        private ДокументыВыезда[] convertArray(NsgMultipleObject[] array)
        {
            ДокументыВыезда[] res = new ДокументыВыезда[array.Length];
            array.CopyTo(res, 0);
            return res;
        }
        ...
        public new virtual ДокументыВыезда[] FindAll(NsgCompare compare)
        {
        ...
        /// <returns>Список найденных объектов.</returns>
        public new virtual ДокументыВыезда[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, NsgCompare compare)
        {
        ...
        /// <returns>Список найденных объектов.</returns>
        public new virtual ДокументыВыезда[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, string inName, object inValue)
        {
        ...
        /// <param name="inValue">Значение для поиска. Условие поиска - полное совпадение.</param>
        /// <returns>Список найденных объектов.</returns>
        public new virtual ДокументыВыезда[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, NsgDataFixedFields inName,
            object inValue)
        {
            return convertArray(base.FindAll(ref count, row_start, sorting, inName, inValue));
        }
        ...
        public override NsgObject CloneObject
        {
            get
            {
                return new ДокументыВыезда(this as NsgObject);
            }
        }
        ...
        public new class ColumnDescriptor : NsgSoft.Forms.NsgColumnDescriptor
        {
            public ColumnDescriptor()
                : base()
            {
                base.NSGType = typeof(ДокументыВыезда);
            }
			...
			public new ДокументыВыезда Value
            {
                get
                {
                    return (ДокументыВыезда)base.Value;
                }
                set
                {
                    base.Value = value;
