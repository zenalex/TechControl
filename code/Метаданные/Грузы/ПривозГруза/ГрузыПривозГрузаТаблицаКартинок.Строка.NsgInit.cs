...
{
    public partial class ГрузыПривозГрузаТаблицаКартинок
{
    [NsgTypeName("NsgDataTableRow", Guid = "d1492cd3-2e40-4fb7-a5af-9bffc9f923b4")]
    public partial class Строка : NsgSoft.DataObjects.NsgDataTableRow
    {
        ...
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("d1492cd3-2e40-4fb7-a5af-9bffc9f923b4"));
            if (obj == null)
                obj = new Строка();
        ...
        public override NsgMultipleObjectDescriptor Descriptor
        {
            get
            {
                if (descriptor == null)
                {
                    ...
                    descriptor.Name = "ГрузыПривозГрузаТаблицаКартинок";
        ...
        [NsgReferentsFilterAttribute("Грузы.ПривозГруза")]
