...
namespace TechControl.Метаданные.Грузы
{
    ...
    {
        public string ТекущийСтатусАвтомобиля( NsgDataDocument документВъездаВыезда, Техника техника, Объекты объект)
        {
            ...
            if (документВъездаВыезда is ДокументыВъезда въезд)
            {
                if (reg.НахождениеНаОбъекте >= 1)
                {
                    статус = $"{техника} уже на объекте. Оформление въезда запрещено. Свяжитесь с офисом!";
                }
            }
            else if (документВъездаВыезда is ДокументыВыезда выезд)
            {
                if (reg.НахождениеНаОбъекте <= 0)
                {
                    статус = $"{техника} уже выехала с объекта. Оформление выезда запрещено. Свяжитесь с офисом!";
                }
            }
