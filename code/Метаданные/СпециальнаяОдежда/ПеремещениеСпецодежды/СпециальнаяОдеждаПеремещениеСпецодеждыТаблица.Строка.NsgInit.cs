...
{
    public partial class СпециальнаяОдеждаПеремещениеСпецодеждыТаблица
{
    [NsgTypeName("NsgDataTableRow", Guid = "a7f4462f-268e-42b4-a65a-679690a5219a")]
    public partial class Строка : NsgSoft.DataObjects.NsgDataTableRow
    {
        ...
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("a7f4462f-268e-42b4-a65a-679690a5219a"));
            if (obj == null)
                obj = new Строка();
        ...
        public override NsgMultipleObjectDescriptor Descriptor
        {
            get
            {
                if (descriptor == null)
                {
                    ...
                    descriptor.Name = "СпециальнаяОдеждаПеремещениеСпецодеждыТаблица";
        ...
        [NsgReferentsFilterAttribute("СпециальнаяОдежда.ПеремещениеСпецодежды")]
        ...
        public СпециальнаяОдежда.Размеры Размер
        {
            get
            {
				 NsgDataTypedReference __Размер = ObjectList["Размер"] as NsgDataTypedReference;
                 return (СпециальнаяОдежда.Размеры)__Размер.Referent;
            }
            set
            {
                NsgDataTypedReference __Размер = ObjectList["Размер"] as NsgDataTypedReference;
