...
namespace TechControl.Метаданные._SystemTables
{
    ...
    [NsgTypeName("NsgDataTable", Guid = "a7f4462f-268e-42b4-a65a-679690a5219a")]
    public partial class СпециальнаяОдеждаПеремещениеСпецодеждыТаблица : NsgSoft.DataObjects.NsgDataTable
    {
        #region Данные
        ...
        /// Создание объекта
        /// </summary>
        protected СпециальнаяОдеждаПеремещениеСпецодеждыТаблица()
            : base()
        {
        }
        ...
        /// </summary>
        protected СпециальнаяОдеждаПеремещениеСпецодеждыТаблица(NsgObject obj)
            : base(obj)
        {
        }
        ...
        public static СпециальнаяОдеждаПеремещениеСпецодеждыТаблица Новый()
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("a7f4462f-268e-42b4-a65a-679690a5219a"));
            if (obj == null)
                obj = new СпециальнаяОдеждаПеремещениеСпецодеждыТаблица();
            return obj as СпециальнаяОдеждаПеремещениеСпецодеждыТаблица;
        }
	...
	Идентификатор.Guid = NsgService.StringToGuid("ba68b94b-996f-4715-b6c3-71e274e18628");
	...
	Автоинкремент.Guid = NsgService.StringToGuid("b525fe24-a3ce-4497-9d28-d13ad6712329");
	...
	Владелец.FilterForConfigurator = "СпециальнаяОдежда.ПеремещениеСпецодежды";
	...
	Владелец.GroupName = "";
	Владелец.Guid = NsgService.StringToGuid("82cdf580-c08a-4dbe-9f4c-f45d13018e0b");
	...
	НомерСтроки.Guid = NsgService.StringToGuid("8a3e846b-eede-473e-94fa-2b96192b6ed7");
			...
			#region создание СпециальнаяОдежда.Размеры Размер
			{  
	...
	Размер.ReferentGroup = "СпециальнаяОдежда";
	...
	Размер.GroupName = "";
	Размер.Guid = NsgService.StringToGuid("fc1727b1-0277-479c-a5d8-39f794835d77");
	
				if (!ObjectList.Contains("Размер"))
                    ObjectList.Add(Размер);
			}
			#endregion //создание СпециальнаяОдежда.Размеры Размер
	...
	Спецодежда.Guid = NsgService.StringToGuid("7deb1022-b906-47bf-9107-69a2915325d0");
	...
	Сотрудник.GroupName = "";
	Сотрудник.Guid = NsgService.StringToGuid("e1a0b745-6c1d-40b4-b198-ff05fc21a88f");
	...
	Стоимость.GroupName = "";
	Стоимость.Guid = NsgService.StringToGuid("a8d01e42-34e0-4798-a7c9-c45202befe83");
	...
	Цена.GroupName = "";
	Цена.Guid = NsgService.StringToGuid("d5ca071e-f4e1-4884-a638-5a2f9a54b614");
	...
	Количество.Guid = NsgService.StringToGuid("38f2c6a1-462b-49d5-a66e-317caefc62eb");
	...
	OwnerFullName = "СпециальнаяОдежда.ПеремещениеСпецодежды";
	RegisterPeriod = NsgSoft.Common.NsgPeriod.None;
	RegisterPeriodCount = 0;
	TableSubType = NsgSoft.Common.NsgTableSubType.TablePart;
	EntityType = NsgSoft.DataObjects.NsgInterfacedObject.EntityTypes.Object;
	Name = "СпециальнаяОдеждаПеремещениеСпецодеждыТаблица";
	Visible = true;
	Guid = NsgService.StringToGuid("a7f4462f-268e-42b4-a65a-679690a5219a");
	DefaultSortingName = "";
	...
	TableName = "_tab_SpecialnajaOdezhdaP";
	Presentation = new NsgSoft.DataObjects.NsgLanguageString(new System.String[]{"(Default)"},
		 new System.Object[]{""});
	Description = "Специальная одежда перемещение спецодежды таблица";
	...
	GroupName = "_SystemTables";
        ...
        {
            return "_SystemTables.СпециальнаяОдеждаПеремещениеСпецодеждыТаблица";
        }
        ...
        /// </summary>
        public new СпециальнаяОдеждаПеремещениеСпецодеждыТаблица.Строка NewRow()
        {
            return newRow(null) as СпециальнаяОдеждаПеремещениеСпецодеждыТаблица.Строка;
        }
        ...
        {
            if (row == null)
                row = new СпециальнаяОдеждаПеремещениеСпецодеждыТаблица.Строка(this);
            return base.newRow(row) as СпециальнаяОдеждаПеремещениеСпецодеждыТаблица.Строка;
        }

        /// <summary>
        /// Добавить новую строку в таблицу путем копирования переданной строки
        /// </summary>
        public СпециальнаяОдеждаПеремещениеСпецодеждыТаблица.Строка NewRow(СпециальнаяОдеждаПеремещениеСпецодеждыТаблица.Строка inRow)
        {
            СпециальнаяОдеждаПеремещениеСпецодеждыТаблица.Строка row = inRow.Clone as СпециальнаяОдеждаПеремещениеСпецодеждыТаблица.Строка;
            return base.newRow(row) as СпециальнаяОдеждаПеремещениеСпецодеждыТаблица.Строка;
        }
        ...
        /// </summary>
        public new СпециальнаяОдеждаПеремещениеСпецодеждыТаблица.Строка GetRow(int rowNumber)
        {
            return base.GetRow(rowNumber) as СпециальнаяОдеждаПеремещениеСпецодеждыТаблица.Строка;
        }

        /// <summary>
        /// Возвращает новую строку таблицы, но в саму таблицу ее не включает (эталонная строка)
        /// </summary>
        public new СпециальнаяОдеждаПеремещениеСпецодеждыТаблица.Строка GetEtalonRow()
        {
            СпециальнаяОдеждаПеремещениеСпецодеждыТаблица.Строка row = new СпециальнаяОдеждаПеремещениеСпецодеждыТаблица.Строка(this);
            row.MetaData = MetaData;
            return row;
        }

        private СпециальнаяОдеждаПеремещениеСпецодеждыТаблица.Строка[] convertRowsArray(NsgDataTableRow[] array)
        {
            СпециальнаяОдеждаПеремещениеСпецодеждыТаблица.Строка[] res = new СпециальнаяОдеждаПеремещениеСпецодеждыТаблица.Строка[array.Length];
            array.CopyTo(res, 0);
            return res;
        }
        ...
        public new СпециальнаяОдеждаПеремещениеСпецодеждыТаблица.Строка FindRowByTag(object Tag)
        {
            return base.FindRowByTag(Tag) as СпециальнаяОдеждаПеремещениеСпецодеждыТаблица.Строка;
        }
        ...
        /// <param name="compare">Критерии поиска.</param>
        /// <returns>Найденные строки.</returns>
        public new СпециальнаяОдеждаПеремещениеСпецодеждыТаблица.Строка[] FindRowsByTag(object Tag)
        {
        ...
        /// <param name="compare">Критерии поиска.</param>
        /// <returns>Найденные строки.</returns>
        public new СпециальнаяОдеждаПеремещениеСпецодеждыТаблица.Строка FindRow(NsgCompare compare)
        {
            return base.FindRow(compare) as СпециальнаяОдеждаПеремещениеСпецодеждыТаблица.Строка;
        }
        ...
        /// <returns>Найденные строки.</returns>
        public new СпециальнаяОдеждаПеремещениеСпецодеждыТаблица.Строка FindRow(string inName, object inValue)
        {
            return base.FindRow(inName, inValue) as СпециальнаяОдеждаПеремещениеСпецодеждыТаблица.Строка;
        }
        ...
        /// <param name="inValue">Значение поля.</param>
        /// <returns>Найденные строки.</returns>
        public new СпециальнаяОдеждаПеремещениеСпецодеждыТаблица.Строка FindRow(NsgDataFixedFields inName, object inValue)
        {
            return base.FindRow(inName, inValue) as СпециальнаяОдеждаПеремещениеСпецодеждыТаблица.Строка;
        }
        ...
        /// <param name="compare">Критерии поиска.</param>
        /// <returns>Найденные строки.</returns>
        public new СпециальнаяОдеждаПеремещениеСпецодеждыТаблица.Строка[] FindRows(NsgCompare compare)
        {
        ...
        /// <param name="inValue">Значение поля.</param>
        /// <returns>Найденные строки.</returns>
        public new СпециальнаяОдеждаПеремещениеСпецодеждыТаблица.Строка[] FindRows(string inName, object inValue)
        {
        ...
        /// <param name="inValue">Значение поля.</param>
        /// <returns>Найденные строки.</returns>
        public new СпециальнаяОдеждаПеремещениеСпецодеждыТаблица.Строка[] FindRows(NsgDataFixedFields inName, object inValue)
        {
            return convertRowsArray(base.FindRows(inName, inValue));
        }
        ...
        /// </summary>
        public  NsgVirtualCursor<СпециальнаяОдеждаПеремещениеСпецодеждыТаблица> GetNewVirtualCursor()
        {
            return base.GetNewVirtualCursor<СпециальнаяОдеждаПеремещениеСпецодеждыТаблица>();
        }

        /// <summary>
        /// Получить все строки таблицы с учетом наложенного фильтра. Для получения всех сьтрок без учета фильтра используется свойство AllRows
        /// </summary>
        public new СпециальнаяОдеждаПеремещениеСпецодеждыТаблица.Строка[] Rows
        {
            get
            {
        ...
        /// </summary>
        public new СпециальнаяОдеждаПеремещениеСпецодеждыТаблица.Строка[] AllRows
        {
            get
            {
        ...
        /// <returns>Найденные строки.</returns>
        public new СпециальнаяОдеждаПеремещениеСпецодеждыТаблица.Строка GetRow(Guid inID)
        {
            return base.GetRow(inID) as СпециальнаяОдеждаПеремещениеСпецодеждыТаблица.Строка;
        }
        #endregion
        ...
        private СпециальнаяОдеждаПеремещениеСпецодеждыТаблица[] convertArray(NsgMultipleObject[] array)
        {
            СпециальнаяОдеждаПеремещениеСпецодеждыТаблица[] res = new СпециальнаяОдеждаПеремещениеСпецодеждыТаблица[array.Length];
            array.CopyTo(res, 0);
            return res;
        }
        ...
        public new virtual СпециальнаяОдеждаПеремещениеСпецодеждыТаблица[] FindAll(NsgCompare compare)
        {
        ...
        /// <returns>Список найденных объектов.</returns>
        public new virtual СпециальнаяОдеждаПеремещениеСпецодеждыТаблица[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, NsgCompare compare)
        {
        ...
        /// <returns>Список найденных объектов.</returns>
        public new virtual СпециальнаяОдеждаПеремещениеСпецодеждыТаблица[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, string inName, object inValue)
        {
        ...
        /// <param name="inValue">Значение для поиска. Условие поиска - полное совпадение.</param>
        /// <returns>Список найденных объектов.</returns>
        public new virtual СпециальнаяОдеждаПеремещениеСпецодеждыТаблица[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, NsgDataFixedFields inName,
            object inValue)
        {
            return convertArray(base.FindAll(ref count, row_start, sorting, inName, inValue));
        }
        ...
        public override NsgObject CloneObject
        {
            get
            {
                return new СпециальнаяОдеждаПеремещениеСпецодеждыТаблица(this as NsgObject);
            }
        }
        ...
        public new class ColumnDescriptor : NsgSoft.Forms.NsgColumnDescriptor
        {
            public ColumnDescriptor()
                : base()
            {
                base.NSGType = typeof(СпециальнаяОдеждаПеремещениеСпецодеждыТаблица);
            }
			...
			public new СпециальнаяОдеждаПеремещениеСпецодеждыТаблица Value
            {
                get
                {
                    return (СпециальнаяОдеждаПеремещениеСпецодеждыТаблица)base.Value;
                }
                set
                {
                    base.Value = value;
