...

{
    ...
    public partial class КатегорииСпецодеждыФормаЭлемента:NsgSoft.Forms.NsgMultipleObjectElementForm
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(КатегорииСпецодеждыФормаЭлемента));
            ...
            this.Сезон = new TechControl.Метаданные.СпециальнаяОдежда.Сезонность.ColumnDescriptor();
            this.Родитель = new TechControl.Метаданные.СпециальнаяОдежда.КатегорииСпецодежды.ColumnDescriptor();
            ...
            this.Comment.FullName = "СпециальнаяОдежда.КатегорииСпецодежды.Идентификатор";
            ...
            this.nsgVisualMultipleObject.Columns.Collection.Add(this.Сезон);
            ...
            this.nsgVisualMultipleObject.FullName = "СпециальнаяОдежда.КатегорииСпецодежды";
            // 
            // Идентификатор
            // 
            ...
            // Сезон
            // 
            this.Сезон.AutoGenerated = true;
            this.Сезон.Caption = "Сезон";
            this.Сезон.Creator = typeof(NsgSoft.Forms.NsgMultipleObjectElementForm);
            this.Сезон.Name = "Сезон";
            this.Сезон.NSGType = typeof(TechControl.Метаданные.СпециальнаяОдежда.Сезонность);
            this.Сезон.PropertyType = typeof(TechControl.Метаданные.СпециальнаяОдежда.Сезонность);
            this.Сезон.SearchCondition.OwnerComponent = this.Сезон;
            this.Сезон.SearchCondition.Parameters = new NsgSoft.DataObjects.NsgCompareParam[0];
            // 
            // Родитель
            // 
            ...
            this.Родитель.NSGType = typeof(TechControl.Метаданные.СпециальнаяОдежда.КатегорииСпецодежды);
            this.Родитель.PropertyType = typeof(TechControl.Метаданные.СпециальнаяОдежда.КатегорииСпецодежды);
            ...
            this.nsgInput1.FullName = "СпециальнаяОдежда.КатегорииСпецодежды.Наименование";
            ...
            this.nsgInput1.Location = new System.Drawing.Point(111, 23);
            ...
            this.nsgInput1.Size = new System.Drawing.Size(386, 20);
            ...
            this.nsgInput2.FullName = "СпециальнаяОдежда.КатегорииСпецодежды.Сезон";
            ...
            this.nsgInput2.Location = new System.Drawing.Point(111, 62);
            ...
            // 
            // КатегорииСпецодеждыФормаЭлемента
            // 
            this.AllowDrop = true;
        ...
        protected Сезонность.ColumnDescriptor Сезон;
        protected КатегорииСпецодежды.ColumnDescriptor Родитель;
