...

{
    ...
    public partial class ИнструментФормаЭлемента:NsgSoft.Forms.NsgMultipleObjectElementForm
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ИнструментФормаЭлемента));
            ...
            this.Родитель = new TechControl.Метаданные.СпециальнаяОдежда.Инструмент.ColumnDescriptor();
            ...
            this.Comment.FullName = "СпециальнаяОдежда.Инструмент.Идентификатор";
            ...
            this.nsgVisualMultipleObject.FullName = "СпециальнаяОдежда.Инструмент";
            // 
            // Идентификатор
            // 
            ...
            this.Родитель.NSGType = typeof(TechControl.Метаданные.СпециальнаяОдежда.Инструмент);
            this.Родитель.PropertyType = typeof(TechControl.Метаданные.СпециальнаяОдежда.Инструмент);
            ...
            this.nsgInput1.Location = new System.Drawing.Point(116, 24);
            ...
            this.nsgInput1.Size = new System.Drawing.Size(190, 20);
            ...
            this.nsgInput2.Location = new System.Drawing.Point(116, 72);
        ...
        protected Инструмент.ColumnDescriptor Родитель;
