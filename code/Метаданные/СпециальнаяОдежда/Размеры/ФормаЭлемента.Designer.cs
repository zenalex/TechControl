...

{
    ...
    public partial class РазмерыФормаЭлемента:NsgSoft.Forms.NsgMultipleObjectElementForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.Родитель = new TechControl.Метаданные.СпециальнаяОдежда.Размеры.ColumnDescriptor();
            ...
            this.Comment.FullName = "СпециальнаяОдежда.Размеры.Идентификатор";
            ...
            this.nsgVisualMultipleObject.FullName = "СпециальнаяОдежда.Размеры";
            // 
            // Идентификатор
            // 
            ...
            this.Родитель.NSGType = typeof(TechControl.Метаданные.СпециальнаяОдежда.Размеры);
            this.Родитель.PropertyType = typeof(TechControl.Метаданные.СпециальнаяОдежда.Размеры);
            ...
            this.label2.Text = "Вид спецодежды:";
            // 
            // nsgInput1
            // 
            ...
            this.nsgInput2.Requsite = "ВидСпецодежды";
