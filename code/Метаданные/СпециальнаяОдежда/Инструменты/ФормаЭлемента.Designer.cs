...

{
    ...
    public partial class ИнструментыФормаЭлемента:NsgSoft.Forms.NsgMultipleObjectElementForm
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ИнструментыФормаЭлемента));
            ...
            this.Родитель = new TechControl.Метаданные.СпециальнаяОдежда.Инструменты.ColumnDescriptor();
            ...
            this.Comment.FullName = "СпециальнаяОдежда.Инструменты.Идентификатор";
            ...
            this.nsgVisualMultipleObject.FullName = "СпециальнаяОдежда.Инструменты";
            // 
            // label1
            // 
            ...
            this.nsgInput1.FullName = "СпециальнаяОдежда.Инструменты.Наименование";
            ...
            this.nsgInput1.Location = new System.Drawing.Point(146, 23);
            ...
            this.nsgInput1.Size = new System.Drawing.Size(176, 20);
            ...
            this.nsgInput2.FullName = "СпециальнаяОдежда.Инструменты.СрокЭксплуатации";
            ...
            this.nsgInput2.Location = new System.Drawing.Point(146, 53);
            ...
            this.nsgInput2.Requsite = "СрокЭксплуатации";
            ...
            this.Родитель.NSGType = typeof(TechControl.Метаданные.СпециальнаяОдежда.Инструменты);
            this.Родитель.PropertyType = typeof(TechControl.Метаданные.СпециальнаяОдежда.Инструменты);
        ...
        protected Инструменты.ColumnDescriptor Родитель;
    }
}