...
namespace TechControl.Метаданные.СпециальнаяОдежда
{
    ...
    public partial class Инструменты : NsgSoft.DataObjects.NsgDataDictionary
    {
        #region Данные
        ...
        /// </summary>
        protected Инструменты(NsgObject obj)
            : base(obj)
        {
        }
        ...
        public static Инструменты Новый()
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("3ddb6d64-52ff-47c0-a46a-551e52746337"));
            if (obj == null)
                obj = new Инструменты();
            return obj as Инструменты;
        }
	...
	Идентификатор.Guid = NsgService.StringToGuid("8032fbc6-1193-4d91-a148-a05ff74eb66b");
	...
	Автоинкремент.Guid = NsgService.StringToGuid("6fff5ac7-2b15-49cd-92fe-c2ea97184be1");
	...
	ЭтоГруппа.GroupName = "";
	ЭтоГруппа.Guid = NsgService.StringToGuid("cca158ce-13e4-434c-85dc-8ffd1c145afe");
	...
	ИдентификаторРодителя.Guid = NsgService.StringToGuid("d2b1ec0b-0d65-4b49-a60b-3407aa9e15f3");
	...
	Уровень.GroupName = "";
	Уровень.Guid = NsgService.StringToGuid("a6e73b35-ef03-42a3-9cb2-c54377d2bf52");
	...
	ПрефиксКода.Guid = NsgService.StringToGuid("d1fb1365-dd4f-4ecb-92bd-8cb8d8bfcd48");
	...
	НомерКода.GroupName = "";
	НомерКода.Guid = NsgService.StringToGuid("eca1e7fa-437b-48c8-ad20-e5736a001c6f");
	...
	Код.GroupName = "";
	Код.Guid = NsgService.StringToGuid("0f816469-d16f-44d0-b6f3-8f5229701984");
	...
	Наименование.Guid = NsgService.StringToGuid("d76be813-6dea-4926-80b5-813502ac571c");
	...
	СостояниеДокумента.Guid = NsgService.StringToGuid("f4d1fc4e-7fc8-4c31-be02-f07fd4afb203");
	...
	ФормаЭлемента.Guid = NsgService.StringToGuid("3b064923-52e3-4245-ab7f-fe871e8b4e65");
			...
			{  
                NsgDataInteger СрокЭксплуатации = null;
				if (ObjectList.Contains("СрокЭксплуатации"))
                    СрокЭксплуатации = ObjectList["СрокЭксплуатации"] as NsgDataInteger;
                else
                    СрокЭксплуатации = new NsgDataInteger();
	//NsgDataInteger
	СрокЭксплуатации.IsLoadedFromDll = true;
	СрокЭксплуатации.DefaultValue = 0M;
	СрокЭксплуатации.MinValue = 0M;
	СрокЭксплуатации.MaxValue = 0M;
	СрокЭксплуатации.UseCalculator = true;
	СрокЭксплуатации.StringFormat = "";
	СрокЭксплуатации.SubType = NsgSoft.Common.NsgRekvisitSubType.Element;
	СрокЭксплуатации.IncludeInPredefined = false;
	СрокЭксплуатации.PeriodicType = NsgSoft.Database.PeriodicTypes.None;
	СрокЭксплуатации.Required = false;
	СрокЭксплуатации.EmptyValue = "";
	СрокЭксплуатации.NullAllow = false;
	СрокЭксплуатации.IndexType = NsgSoft.Database.NsgRekvisitIndexType.None;
	СрокЭксплуатации.FieldName = "SrokEHkspluatacii";
	СрокЭксплуатации.SaveInDatabase = true;
	СрокЭксплуатации.InformMetaDataOnValueChanged = false;
	СрокЭксплуатации.Visible = true;
	СрокЭксплуатации.Name = "СрокЭксплуатации";
	СрокЭксплуатации.Presentation = new NsgSoft.DataObjects.NsgLanguageString(new System.String[]{"(Default)"},
		 new System.Object[]{""});
	СрокЭксплуатации.Description = "Срок эксплуатации";
	СрокЭксплуатации.EditorVisible = NsgSoft.DataObjects.NsgDataObjectEditorAccess.Full;
	СрокЭксплуатации.GroupName = "";
	СрокЭксплуатации.Guid = NsgService.StringToGuid("6e033ba6-d8f7-41f3-850a-8c596067e12a");
	
				if (!ObjectList.Contains("СрокЭксплуатации"))
                    ObjectList.Add(СрокЭксплуатации);
			}
			#endregion //создание System.Int64 СрокЭксплуатации
	...
	Name = "Инструменты";
	Visible = true;
	Guid = NsgService.StringToGuid("3ddb6d64-52ff-47c0-a46a-551e52746337");
	DefaultSortingName = "";
	...
	GroupName = "СпециальнаяОдежда";
        ...
        public new partial class Names// :NsgSoft.DataObjects.NsgDataDictionary.Names
        {
            ...
            /// Срок эксплуатации
            /// </summary>
            public static String СрокЭксплуатации
            {
                get
                {
                    return "СрокЭксплуатации";
                }
            }
        ...
        public System.Int64 СрокЭксплуатации
        {
            get
            {
				 NsgDataInteger __СрокЭксплуатации = ObjectList["СрокЭксплуатации"] as NsgDataInteger;
                 return (System.Int64)__СрокЭксплуатации.Value;
            }
            set
            {
                NsgDataInteger __СрокЭксплуатации = ObjectList["СрокЭксплуатации"] as NsgDataInteger;
                __СрокЭксплуатации.Value = value;
            }
        }
        ...
        public Инструменты Родитель
        {
            get
            {
                return base.Parent as Инструменты;
            }
            set
            {
                base.Parent = value;
        ...
        private Инструменты[] convertArray(NsgMultipleObject[] array)
        {
            Инструменты[] res = new Инструменты[array.Length];
            array.CopyTo(res, 0);
            return res;
        }
        ...
        public new virtual Инструменты[] FindAll(NsgCompare compare)
        {
        ...
        /// <returns>Список найденных объектов.</returns>
        public new virtual Инструменты[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, NsgCompare compare)
        {
        ...
        /// <returns>Список найденных объектов.</returns>
        public new virtual Инструменты[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, string inName, object inValue)
        {
        ...
        /// <param name="inValue">Значение для поиска. Условие поиска - полное совпадение.</param>
        /// <returns>Список найденных объектов.</returns>
        public new virtual Инструменты[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, NsgDataFixedFields inName,
            object inValue)
        {
            return convertArray(base.FindAll(ref count, row_start, sorting, inName, inValue));
        }
        ...
        public override NsgObject CloneObject
        {
            get
            {
                return new Инструменты(this as NsgObject);
            }
        }
        ...
        public new class ColumnDescriptor : NsgSoft.Forms.NsgColumnDescriptor
        {
            public ColumnDescriptor()
                : base()
            {
                base.NSGType = typeof(Инструменты);
            }
			...
			public new Инструменты Value
            {
                get
                {
                    return (Инструменты)base.Value;
                }
                set
                {
                    base.Value = value;
