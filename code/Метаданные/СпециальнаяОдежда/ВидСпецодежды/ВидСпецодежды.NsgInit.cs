...
namespace TechControl.Метаданные.СпециальнаяОдежда
{
    ...
    public partial class ВидСпецодежды : NsgSoft.DataObjects.NsgDataDictionary
    {
        #region Данные
        ...
        /// </summary>
        protected ВидСпецодежды(NsgObject obj)
            : base(obj)
        {
        }
	...
	СостояниеДокумента.Guid = NsgService.StringToGuid("079fb7fd-1036-4b9f-9478-57c088c38c00");
			...
			#region создание TechControl.Метаданные.СпециальнаяОдежда.ВидСпецодеждыФормаЭлемента ФормаЭлемента
			{  
	...
	ФормаЭлемента.FormClassName = "TechControl.Метаданные.СпециальнаяОдежда.ВидСпецодеждыФормаЭлемента";
	...
	ФормаЭлемента.Guid = NsgService.StringToGuid("8b1ff02f-9f24-4d7b-a2b9-f0f31dd93f59");
			...
			#endregion //создание TechControl.Метаданные.СпециальнаяОдежда.ВидСпецодеждыФормаЭлемента ФормаЭлемента
	...
	GroupName = "СпециальнаяОдежда";
        ...
        {
            return "СпециальнаяОдежда.ВидСпецодежды";
        }
        ...
        public ВидСпецодежды Родитель
        {
            get
            {
                return base.Parent as ВидСпецодежды;
            }
            set
            {
                base.Parent = value;
        ...
        private ВидСпецодежды[] convertArray(NsgMultipleObject[] array)
        {
            ВидСпецодежды[] res = new ВидСпецодежды[array.Length];
            array.CopyTo(res, 0);
            return res;
        }
        ...
        public new virtual ВидСпецодежды[] FindAll(NsgCompare compare)
        {
        ...
        /// <returns>Список найденных объектов.</returns>
        public new virtual ВидСпецодежды[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, NsgCompare compare)
        {
        ...
        /// <returns>Список найденных объектов.</returns>
        public new virtual ВидСпецодежды[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, string inName, object inValue)
        {
        ...
        /// <param name="inValue">Значение для поиска. Условие поиска - полное совпадение.</param>
        /// <returns>Список найденных объектов.</returns>
        public new virtual ВидСпецодежды[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, NsgDataFixedFields inName,
            object inValue)
        {
            return convertArray(base.FindAll(ref count, row_start, sorting, inName, inValue));
        }
        ...
        public override NsgObject CloneObject
        {
            get
            {
                return new ВидСпецодежды(this as NsgObject);
            }
        }
        ...
        public new class ColumnDescriptor : NsgSoft.Forms.NsgColumnDescriptor
        {
            public ColumnDescriptor()
                : base()
            {
                base.NSGType = typeof(ВидСпецодежды);
            }
			...
			public new ВидСпецодежды Value
            {
                get
                {
                    return (ВидСпецодежды)base.Value;
                }
                set
                {
                    base.Value = value;
