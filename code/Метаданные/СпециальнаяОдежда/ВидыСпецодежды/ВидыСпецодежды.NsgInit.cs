...
namespace TechControl.Метаданные.СпециальнаяОдежда
{
    ...
    [NsgTypeName("NsgDataDictionary", Guid = "ae77d704-e702-43d9-9884-d6abbcd3a08c")]
    public partial class ВидыСпецодежды : NsgSoft.DataObjects.NsgDataDictionary
    {
        #region Данные
        ...
        /// </summary>
        protected ВидыСпецодежды(NsgObject obj)
            : base(obj)
        {
        }
        ...
        public static ВидыСпецодежды Новый()
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("ae77d704-e702-43d9-9884-d6abbcd3a08c"));
            if (obj == null)
                obj = new ВидыСпецодежды();
            return obj as ВидыСпецодежды;
        }
	...
	Идентификатор.Guid = NsgService.StringToGuid("1a9a87e0-bf59-4742-a611-dd897f139ae5");
	...
	Автоинкремент.Guid = NsgService.StringToGuid("8eb0c25b-91bd-407f-9e90-6614281b8b63");
	...
	ЭтоГруппа.GroupName = "";
	ЭтоГруппа.Guid = NsgService.StringToGuid("e7c4eb1d-ad6a-4d44-87a2-21f0875c64f1");
	...
	ИдентификаторРодителя.Guid = NsgService.StringToGuid("3bab84e6-6714-407a-a254-0538547876b3");
	...
	Уровень.GroupName = "";
	Уровень.Guid = NsgService.StringToGuid("5e31a466-e563-4a4d-9629-ebdceceadac8");
	...
	ПрефиксКода.Guid = NsgService.StringToGuid("a62ab862-3462-484c-9638-5192f97c2586");
	...
	НомерКода.GroupName = "";
	НомерКода.Guid = NsgService.StringToGuid("0713d132-5d1a-4a64-a6d9-29c7f099d9e2");
	...
	Код.GroupName = "";
	Код.Guid = NsgService.StringToGuid("24392b71-ac08-4a42-a4a5-fc8abc8496ac");
	...
	Наименование.Guid = NsgService.StringToGuid("fbce9cf0-efdf-47f2-ae85-26897c436f08");
	...
	СостояниеДокумента.Guid = NsgService.StringToGuid("079fb7fd-1036-4b9f-9478-57c088c38c00");
			...
			#region создание TechControl.Метаданные.СпециальнаяОдежда.ВидыСпецодеждыФормаЭлемента ФормаЭлемента
			{  
	...
	ФормаЭлемента.FormClassName = "TechControl.Метаданные.СпециальнаяОдежда.ВидыСпецодеждыФормаЭлемента";
	...
	ФормаЭлемента.Guid = NsgService.StringToGuid("8b1ff02f-9f24-4d7b-a2b9-f0f31dd93f59");
	
				if (!ObjectList.Contains("ФормаЭлемента"))
                    ObjectList.Add(ФормаЭлемента);
			}
			#endregion //создание TechControl.Метаданные.СпециальнаяОдежда.ВидыСпецодеждыФормаЭлемента ФормаЭлемента
	...
	Name = "ВидыСпецодежды";
	Visible = true;
	Guid = NsgService.StringToGuid("ae77d704-e702-43d9-9884-d6abbcd3a08c");
	DefaultSortingName = "";
	...
	TableName = "_dic_VidySpecodezhdy";
	Presentation = new NsgSoft.DataObjects.NsgLanguageString(new System.String[]{"(Default)"},
		 new System.Object[]{""});
	Description = "Виды спецодежды";
	...
	GroupName = "СпециальнаяОдежда";
        ...
        public override NsgMultipleObjectDescriptor Descriptor
        {
            get
            {
                if (descriptor == null)
                {
                    ...
                    descriptor.Name = "ВидыСпецодежды";
        ...
        {
            return "СпециальнаяОдежда.ВидыСпецодежды";
        }
        ...
        public ВидыСпецодежды Родитель
        {
            get
            {
                return base.Parent as ВидыСпецодежды;
            }
            set
            {
                base.Parent = value;
        ...
        private ВидыСпецодежды[] convertArray(NsgMultipleObject[] array)
        {
            ВидыСпецодежды[] res = new ВидыСпецодежды[array.Length];
            array.CopyTo(res, 0);
            return res;
        }
        ...
        public new virtual ВидыСпецодежды[] FindAll(NsgCompare compare)
        {
        ...
        /// <returns>Список найденных объектов.</returns>
        public new virtual ВидыСпецодежды[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, NsgCompare compare)
        {
        ...
        /// <returns>Список найденных объектов.</returns>
        public new virtual ВидыСпецодежды[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, string inName, object inValue)
        {
        ...
        /// <param name="inValue">Значение для поиска. Условие поиска - полное совпадение.</param>
        /// <returns>Список найденных объектов.</returns>
        public new virtual ВидыСпецодежды[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, NsgDataFixedFields inName,
            object inValue)
        {
            return convertArray(base.FindAll(ref count, row_start, sorting, inName, inValue));
        }
        ...
        public override NsgObject CloneObject
        {
            get
            {
                return new ВидыСпецодежды(this as NsgObject);
            }
        }
        ...
        public new class ColumnDescriptor : NsgSoft.Forms.NsgColumnDescriptor
        {
            public ColumnDescriptor()
                : base()
            {
                base.NSGType = typeof(ВидыСпецодежды);
            }
			...
			public new ВидыСпецодежды Value
            {
                get
                {
                    return (ВидыСпецодежды)base.Value;
                }
                set
                {
                    base.Value = value;
