...

{
    ...
    public partial class ВидыСпецодеждыФормаЭлемента:NsgSoft.Forms.NsgMultipleObjectElementForm
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ВидыСпецодеждыФормаЭлемента));
            ...
            this.Родитель = new TechControl.Метаданные.СпециальнаяОдежда.ВидыСпецодежды.ColumnDescriptor();
            ...
            this.Comment.FullName = "СпециальнаяОдежда.ВидыСпецодежды.Идентификатор";
            ...
            this.nsgVisualMultipleObject.FullName = "СпециальнаяОдежда.ВидыСпецодежды";
            // 
            // Идентификатор
            // 
            ...
            this.Родитель.NSGType = typeof(TechControl.Метаданные.СпециальнаяОдежда.ВидыСпецодежды);
            this.Родитель.PropertyType = typeof(TechControl.Метаданные.СпециальнаяОдежда.ВидыСпецодежды);
            ...
            this.nsgInput1.FullName = "СпециальнаяОдежда.ВидыСпецодежды.Наименование";
            ...
            this.nsgInput1.Location = new System.Drawing.Point(120, 24);
            ...
            this.nsgInput1.Size = new System.Drawing.Size(365, 20);
        ...
        private ВидыСпецодежды.ColumnDescriptor Родитель;
