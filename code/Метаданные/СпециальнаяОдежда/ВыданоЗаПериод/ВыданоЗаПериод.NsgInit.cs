...
namespace TechControl.Метаданные.СпециальнаяОдежда
{
    ...
    [NsgTypeName("NsgReportObject", Guid = "ac9ab8c5-3159-4c40-b8fb-fcc12931b95e")]
    public partial class ВыданоЗаПериод : NsgSoft.DataObjects.NsgReportObject
    {
        #region Данные
        ...
        /// </summary>
        protected ВыданоЗаПериод(NsgObject obj)
            : base(obj)
        {
        }
        ...
        public static ВыданоЗаПериод Новый()
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("ac9ab8c5-3159-4c40-b8fb-fcc12931b95e"));
            if (obj == null)
                obj = new ВыданоЗаПериод();
            return obj as ВыданоЗаПериод;
        }
	...
	Автоинкремент.Guid = NsgService.StringToGuid("1cdc92c4-0898-40ff-b995-492b9502df3e");
			...
			#region создание TechControl.Метаданные.СпециальнаяОдежда.ВыданоЗаПериодФорма Форма
			{  
	...
	Форма.FormClassName = "TechControl.Метаданные.СпециальнаяОдежда.ВыданоЗаПериодФорма";
	...
	Форма.GroupName = "";
	Форма.Guid = NsgService.StringToGuid("0b91943b-753b-4cd0-8386-77f2e4670742");
	
				if (!ObjectList.Contains("Форма"))
                    ObjectList.Add(Форма);
			}
			#endregion //создание TechControl.Метаданные.СпециальнаяОдежда.ВыданоЗаПериодФорма Форма
	...
	Name = "ВыданоЗаПериод";
	Visible = true;
	Guid = NsgService.StringToGuid("ac9ab8c5-3159-4c40-b8fb-fcc12931b95e");
	DefaultSortingName = "";
	...
	TableName = "_report_VydanoZaPeriod";
	Presentation = new NsgSoft.DataObjects.NsgLanguageString(new System.String[]{"(Default)"},
		 new System.Object[]{""});
	Description = "Выдано за период";
	...
	GroupName = "СпециальнаяОдежда";
        ...
        public override NsgMultipleObjectDescriptor Descriptor
        {
            get
            {
                if (descriptor == null)
                {
                    ...
                    descriptor.Name = "ВыданоЗаПериод";
        ...
        {
            return "СпециальнаяОдежда.ВыданоЗаПериод";
        }
        ...
        private ВыданоЗаПериод[] convertArray(NsgMultipleObject[] array)
        {
            ВыданоЗаПериод[] res = new ВыданоЗаПериод[array.Length];
            array.CopyTo(res, 0);
            return res;
        }
        ...
        public new virtual ВыданоЗаПериод[] FindAll(NsgCompare compare)
        {
        ...
        /// <returns>Список найденных объектов.</returns>
        public new virtual ВыданоЗаПериод[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, NsgCompare compare)
        {
        ...
        /// <returns>Список найденных объектов.</returns>
        public new virtual ВыданоЗаПериод[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, string inName, object inValue)
        {
        ...
        /// <param name="inValue">Значение для поиска. Условие поиска - полное совпадение.</param>
        /// <returns>Список найденных объектов.</returns>
        public new virtual ВыданоЗаПериод[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, NsgDataFixedFields inName,
            object inValue)
        {
            return convertArray(base.FindAll(ref count, row_start, sorting, inName, inValue));
        }
        ...
        public override NsgObject CloneObject
        {
            get
            {
                return new ВыданоЗаПериод(this as NsgObject);
            }
        }
        ...
        public new class ColumnDescriptor : NsgSoft.Forms.NsgColumnDescriptor
        {
            public ColumnDescriptor()
                : base()
            {
                base.NSGType = typeof(ВыданоЗаПериод);
            }
			...
			public new ВыданоЗаПериод Value
            {
                get
                {
                    return (ВыданоЗаПериод)base.Value;
                }
                set
                {
                    base.Value = value;
