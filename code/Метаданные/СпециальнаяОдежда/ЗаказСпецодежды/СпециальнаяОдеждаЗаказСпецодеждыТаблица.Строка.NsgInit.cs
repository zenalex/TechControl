...
{
    public partial class СпециальнаяОдеждаЗаказСпецодеждыТаблица
{
    [NsgTypeName("NsgDataTableRow", Guid = "f3e30649-9841-4d65-841c-eb6903729b0f")]
    public partial class Строка : NsgSoft.DataObjects.NsgDataTableRow
    {
        ...
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("f3e30649-9841-4d65-841c-eb6903729b0f"));
            if (obj == null)
                obj = new Строка();
        ...
        public override NsgMultipleObjectDescriptor Descriptor
        {
            get
            {
                if (descriptor == null)
                {
                    ...
                    descriptor.Name = "СпециальнаяОдеждаЗаказСпецодеждыТаблица";
        ...
        [NsgReferentsFilterAttribute("СпециальнаяОдежда.ЗаказСпецодежды")]
