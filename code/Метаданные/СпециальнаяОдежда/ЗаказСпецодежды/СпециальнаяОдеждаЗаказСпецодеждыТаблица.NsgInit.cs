...
namespace TechControl.Метаданные._SystemTables
{
    ...
    [NsgTypeName("NsgDataTable", Guid = "f3e30649-9841-4d65-841c-eb6903729b0f")]
    public partial class СпециальнаяОдеждаЗаказСпецодеждыТаблица : NsgSoft.DataObjects.NsgDataTable
    {
        #region Данные
        ...
        /// Создание объекта
        /// </summary>
        protected СпециальнаяОдеждаЗаказСпецодеждыТаблица()
            : base()
        {
        }
        ...
        /// </summary>
        protected СпециальнаяОдеждаЗаказСпецодеждыТаблица(NsgObject obj)
            : base(obj)
        {
        }
        ...
        public static СпециальнаяОдеждаЗаказСпецодеждыТаблица Новый()
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("f3e30649-9841-4d65-841c-eb6903729b0f"));
            if (obj == null)
                obj = new СпециальнаяОдеждаЗаказСпецодеждыТаблица();
            return obj as СпециальнаяОдеждаЗаказСпецодеждыТаблица;
        }
	...
	Идентификатор.Guid = NsgService.StringToGuid("985ddccd-7baf-43d2-b43d-fb1933e8e9c8");
	...
	Автоинкремент.Guid = NsgService.StringToGuid("64bd8721-2da2-4ec2-bbf5-80a8e3650501");
	...
	Владелец.FilterForConfigurator = "СпециальнаяОдежда.ЗаказСпецодежды";
	...
	Владелец.GroupName = "";
	Владелец.Guid = NsgService.StringToGuid("2538c7ba-ce3a-4ad4-8ccd-d6e8ab6a4c0b");
	...
	НомерСтроки.Guid = NsgService.StringToGuid("ed23faef-2400-442b-98bc-b51a932d19f3");
	...
	Цена.GroupName = "";
	Цена.Guid = NsgService.StringToGuid("b4e30be5-4e6b-4dae-9b9c-0eba85b96cd4");
	...
	Стоимость.GroupName = "";
	Стоимость.Guid = NsgService.StringToGuid("d0ed8dca-dbf7-424e-b13b-0c3b2c757b8a");
	...
	Размер.GroupName = "";
	Размер.Guid = NsgService.StringToGuid("68f8ae54-b7a0-4721-aa26-bb5db8ac3e81");
	...
	Сотрудник.GroupName = "";
	Сотрудник.Guid = NsgService.StringToGuid("97b9bed7-f1c6-44a7-907f-c0799bfbcc60");
	...
	Спецодежда.Guid = NsgService.StringToGuid("edff5efc-cba0-4da2-8c22-e7c5fa95e900");
	...
	Количество.Guid = NsgService.StringToGuid("1adefb57-da9b-4f81-896c-b5ce54cd45e1");
	...
	OwnerFullName = "СпециальнаяОдежда.ЗаказСпецодежды";
	RegisterPeriod = NsgSoft.Common.NsgPeriod.None;
	RegisterPeriodCount = 0;
	TableSubType = NsgSoft.Common.NsgTableSubType.TablePart;
	EntityType = NsgSoft.DataObjects.NsgInterfacedObject.EntityTypes.Object;
	Name = "СпециальнаяОдеждаЗаказСпецодеждыТаблица";
	Visible = true;
	Guid = NsgService.StringToGuid("f3e30649-9841-4d65-841c-eb6903729b0f");
	DefaultSortingName = "";
	...
	TableName = "_tab_SpecialnajaOdezhdaZ";
	Presentation = new NsgSoft.DataObjects.NsgLanguageString(new System.String[]{"(Default)"},
		 new System.Object[]{""});
	Description = "Специальная одежда заказ спецодежды таблица";
	...
	GroupName = "_SystemTables";
        ...
        {
            return "_SystemTables.СпециальнаяОдеждаЗаказСпецодеждыТаблица";
        }
        ...
        /// </summary>
        public new СпециальнаяОдеждаЗаказСпецодеждыТаблица.Строка NewRow()
        {
            return newRow(null) as СпециальнаяОдеждаЗаказСпецодеждыТаблица.Строка;
        }
        ...
        {
            if (row == null)
                row = new СпециальнаяОдеждаЗаказСпецодеждыТаблица.Строка(this);
            return base.newRow(row) as СпециальнаяОдеждаЗаказСпецодеждыТаблица.Строка;
        }

        /// <summary>
        /// Добавить новую строку в таблицу путем копирования переданной строки
        /// </summary>
        public СпециальнаяОдеждаЗаказСпецодеждыТаблица.Строка NewRow(СпециальнаяОдеждаЗаказСпецодеждыТаблица.Строка inRow)
        {
            СпециальнаяОдеждаЗаказСпецодеждыТаблица.Строка row = inRow.Clone as СпециальнаяОдеждаЗаказСпецодеждыТаблица.Строка;
            return base.newRow(row) as СпециальнаяОдеждаЗаказСпецодеждыТаблица.Строка;
        }
        ...
        /// </summary>
        public new СпециальнаяОдеждаЗаказСпецодеждыТаблица.Строка GetRow(int rowNumber)
        {
            return base.GetRow(rowNumber) as СпециальнаяОдеждаЗаказСпецодеждыТаблица.Строка;
        }

        /// <summary>
        /// Возвращает новую строку таблицы, но в саму таблицу ее не включает (эталонная строка)
        /// </summary>
        public new СпециальнаяОдеждаЗаказСпецодеждыТаблица.Строка GetEtalonRow()
        {
            СпециальнаяОдеждаЗаказСпецодеждыТаблица.Строка row = new СпециальнаяОдеждаЗаказСпецодеждыТаблица.Строка(this);
            row.MetaData = MetaData;
            return row;
        }

        private СпециальнаяОдеждаЗаказСпецодеждыТаблица.Строка[] convertRowsArray(NsgDataTableRow[] array)
        {
            СпециальнаяОдеждаЗаказСпецодеждыТаблица.Строка[] res = new СпециальнаяОдеждаЗаказСпецодеждыТаблица.Строка[array.Length];
            array.CopyTo(res, 0);
            return res;
        }
        ...
        public new СпециальнаяОдеждаЗаказСпецодеждыТаблица.Строка FindRowByTag(object Tag)
        {
            return base.FindRowByTag(Tag) as СпециальнаяОдеждаЗаказСпецодеждыТаблица.Строка;
        }
        ...
        /// <param name="compare">Критерии поиска.</param>
        /// <returns>Найденные строки.</returns>
        public new СпециальнаяОдеждаЗаказСпецодеждыТаблица.Строка[] FindRowsByTag(object Tag)
        {
        ...
        /// <param name="compare">Критерии поиска.</param>
        /// <returns>Найденные строки.</returns>
        public new СпециальнаяОдеждаЗаказСпецодеждыТаблица.Строка FindRow(NsgCompare compare)
        {
            return base.FindRow(compare) as СпециальнаяОдеждаЗаказСпецодеждыТаблица.Строка;
        }
        ...
        /// <returns>Найденные строки.</returns>
        public new СпециальнаяОдеждаЗаказСпецодеждыТаблица.Строка FindRow(string inName, object inValue)
        {
            return base.FindRow(inName, inValue) as СпециальнаяОдеждаЗаказСпецодеждыТаблица.Строка;
        }
        ...
        /// <param name="inValue">Значение поля.</param>
        /// <returns>Найденные строки.</returns>
        public new СпециальнаяОдеждаЗаказСпецодеждыТаблица.Строка FindRow(NsgDataFixedFields inName, object inValue)
        {
            return base.FindRow(inName, inValue) as СпециальнаяОдеждаЗаказСпецодеждыТаблица.Строка;
        }
        ...
        /// <param name="compare">Критерии поиска.</param>
        /// <returns>Найденные строки.</returns>
        public new СпециальнаяОдеждаЗаказСпецодеждыТаблица.Строка[] FindRows(NsgCompare compare)
        {
        ...
        /// <param name="inValue">Значение поля.</param>
        /// <returns>Найденные строки.</returns>
        public new СпециальнаяОдеждаЗаказСпецодеждыТаблица.Строка[] FindRows(string inName, object inValue)
        {
        ...
        /// <param name="inValue">Значение поля.</param>
        /// <returns>Найденные строки.</returns>
        public new СпециальнаяОдеждаЗаказСпецодеждыТаблица.Строка[] FindRows(NsgDataFixedFields inName, object inValue)
        {
            return convertRowsArray(base.FindRows(inName, inValue));
        }
        ...
        /// </summary>
        public  NsgVirtualCursor<СпециальнаяОдеждаЗаказСпецодеждыТаблица> GetNewVirtualCursor()
        {
            return base.GetNewVirtualCursor<СпециальнаяОдеждаЗаказСпецодеждыТаблица>();
        }

        /// <summary>
        /// Получить все строки таблицы с учетом наложенного фильтра. Для получения всех сьтрок без учета фильтра используется свойство AllRows
        /// </summary>
        public new СпециальнаяОдеждаЗаказСпецодеждыТаблица.Строка[] Rows
        {
            get
            {
        ...
        /// </summary>
        public new СпециальнаяОдеждаЗаказСпецодеждыТаблица.Строка[] AllRows
        {
            get
            {
        ...
        /// <returns>Найденные строки.</returns>
        public new СпециальнаяОдеждаЗаказСпецодеждыТаблица.Строка GetRow(Guid inID)
        {
            return base.GetRow(inID) as СпециальнаяОдеждаЗаказСпецодеждыТаблица.Строка;
        }
        #endregion
        ...
        private СпециальнаяОдеждаЗаказСпецодеждыТаблица[] convertArray(NsgMultipleObject[] array)
        {
            СпециальнаяОдеждаЗаказСпецодеждыТаблица[] res = new СпециальнаяОдеждаЗаказСпецодеждыТаблица[array.Length];
            array.CopyTo(res, 0);
            return res;
        }
        ...
        public new virtual СпециальнаяОдеждаЗаказСпецодеждыТаблица[] FindAll(NsgCompare compare)
        {
        ...
        /// <returns>Список найденных объектов.</returns>
        public new virtual СпециальнаяОдеждаЗаказСпецодеждыТаблица[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, NsgCompare compare)
        {
        ...
        /// <returns>Список найденных объектов.</returns>
        public new virtual СпециальнаяОдеждаЗаказСпецодеждыТаблица[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, string inName, object inValue)
        {
        ...
        /// <param name="inValue">Значение для поиска. Условие поиска - полное совпадение.</param>
        /// <returns>Список найденных объектов.</returns>
        public new virtual СпециальнаяОдеждаЗаказСпецодеждыТаблица[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, NsgDataFixedFields inName,
            object inValue)
        {
            return convertArray(base.FindAll(ref count, row_start, sorting, inName, inValue));
        }
        ...
        public override NsgObject CloneObject
        {
            get
            {
                return new СпециальнаяОдеждаЗаказСпецодеждыТаблица(this as NsgObject);
            }
        }
        ...
        public new class ColumnDescriptor : NsgSoft.Forms.NsgColumnDescriptor
        {
            public ColumnDescriptor()
                : base()
            {
                base.NSGType = typeof(СпециальнаяОдеждаЗаказСпецодеждыТаблица);
            }
			...
			public new СпециальнаяОдеждаЗаказСпецодеждыТаблица Value
            {
                get
                {
                    return (СпециальнаяОдеждаЗаказСпецодеждыТаблица)base.Value;
                }
                set
                {
                    base.Value = value;
