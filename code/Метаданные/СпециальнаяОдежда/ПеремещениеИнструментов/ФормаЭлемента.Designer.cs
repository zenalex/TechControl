...

{
    ...
    public partial class ПеремещениеИнструментовФормаЭлемента:NsgSoft.Forms.NsgMultipleObjectElementForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.vmoТабличЧасть = new NsgSoft.Forms.NsgVisualMultipleObject(this.components);
            ...
            this.Таблица = new TechControl.Метаданные._SystemTables.СпециальнаяОдеждаПеремещениеИнструментовТаблица.ColumnDescriptor();
            ...
            ((System.ComponentModel.ISupportInitialize)(this.vmoТабличЧасть)).BeginInit();
            this.SuspendLayout();
            // 
            // nsgEdit
            // 
            ...
            this.Comment.FullName = "СпециальнаяОдежда.ПеремещениеИнструментов.Идентификатор";
            ...
            this.nsgVisualMultipleObject.FullName = "СпециальнаяОдежда.ПеремещениеИнструментов";
            // 
            // nsgInput1
            // 
            ...
            this.nsgInput1.Location = new System.Drawing.Point(107, 21);
            ...
            this.nsgInput2.Location = new System.Drawing.Point(342, 21);
            ...
            this.nsgInput3.Location = new System.Drawing.Point(538, 21);
            ...
            this.nsgInput4.Location = new System.Drawing.Point(107, 57);
            ...
            this.nsgInput4.Size = new System.Drawing.Size(561, 20);
        ...
        "Visible"};
            ...
            this.nsgIGrid1.Size = new System.Drawing.Size(723, 225);
            this.nsgIGrid1.SourceObject = this.vmoТабличЧасть;
            ...
            this.vmoТабличЧасть.DataSourceType = NsgSoft.Forms.NsgDataSourceType.MasterComponent;
            nsgObjectDescriptor2.ConfigurationName = "TechControl";
            this.vmoТабличЧасть.MetaDataName = "Метаданные";
            this.vmoТабличЧасть.FullName = "_SystemTables.СпециальнаяОдеждаПеремещениеИнструментовТаблица.Владелец";
            // 
            // vmoТабличЧасть
            // 
            nsgObjectDescriptor1.ConfigurationName = "TechControl";
            nsgObjectDescriptor1.FullName = "_SystemTables.СпециальнаяОдеждаПеремещениеИнструментовТаблица.Владелец";
            nsgObjectDescriptor1.MetaDataName = "Метаданные";
            nsgMasterDetailBinding1.DetailField = nsgObjectDescriptor1;
            nsgObjectDescriptor2.FullName = "СпециальнаяОдежда.ПеремещениеИнструментов.Таблица";
            ...
            this.vmoТабличЧасть.Columns.Collection.Add(this.Идентификатор_vmoТабличЧасть);
            this.vmoТабличЧасть.Columns.Collection.Add(this.Автоинкремент_vmoТабличЧасть);
            this.vmoТабличЧасть.Columns.Collection.Add(this.Владелец);
            this.vmoТабличЧасть.Columns.Collection.Add(this.НомерСтроки);
            this.vmoТабличЧасть.Columns.Collection.Add(this.Инструмент);
            this.vmoТабличЧасть.Columns.Collection.Add(this.Цена);
            this.vmoТабличЧасть.Columns.Collection.Add(this.Количество);
            this.vmoТабличЧасть.Columns.Collection.Add(this.Сумма);
            this.vmoТабличЧасть.IsActive = true;
            this.vmoТабличЧасть.MasterComponent = this.nsgVisualMultipleObject;
            this.vmoТабличЧасть.Binding = nsgMasterDetailBinding1;
            // 
            // label1
            // 
            ...
            this.Таблица.NSGType = typeof(TechControl.Метаданные._SystemTables.СпециальнаяОдеждаПеремещениеИнструментовТаблица);
            this.Таблица.PropertyType = typeof(TechControl.Метаданные._SystemTables.СпециальнаяОдеждаПеремещениеИнструментовТаблица);
            ...
            ((System.ComponentModel.ISupportInitialize)(this.vmoТабличЧасть)).EndInit();
        ...
        protected NsgVisualMultipleObject vmoТабличЧасть;
        ...
        protected _SystemTables.СпециальнаяОдеждаПеремещениеИнструментовТаблица.ColumnDescriptor Таблица;
