...

{
    ...
    public partial class ПеремещениеИнструментаФормаЭлемента:NsgSoft.Forms.NsgMultipleObjectElementForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.vmoТаблЧасть = new NsgSoft.Forms.NsgVisualMultipleObject(this.components);
            this.Идентификатор_vmoТаблЧасть = new NsgSoft.Forms.NsgColumnDescriptor.Guid();
            this.Автоинкремент_vmoТаблЧасть = new NsgSoft.Forms.NsgColumnDescriptor.Int64();
            ...
            this.Таблица = new TechControl.Метаданные._SystemTables.СпециальнаяОдеждаПеремещениеИнструментаТаблица.ColumnDescriptor();
            ...
            ((System.ComponentModel.ISupportInitialize)(this.vmoТаблЧасть)).BeginInit();
            ...
            this.Comment.FullName = "СпециальнаяОдежда.ПеремещениеИнструмента.Идентификатор";
            ...
            this.nsgVisualMultipleObject.FullName = "СпециальнаяОдежда.ПеремещениеИнструмента";
            // 
            // nsgIGrid1
            // 
        ...
        "Visible"};
            ...
            this.nsgIGrid1.Location = new System.Drawing.Point(12, 60);
            ...
            this.nsgIGrid1.Size = new System.Drawing.Size(700, 216);
            this.nsgIGrid1.SourceObject = this.vmoТаблЧасть;
            ...
            this.vmoТаблЧасть.DataSourceType = NsgSoft.Forms.NsgDataSourceType.MasterComponent;
            nsgObjectDescriptor2.ConfigurationName = "TechControl";
            this.vmoТаблЧасть.MetaDataName = "Метаданные";
            this.vmoТаблЧасть.FullName = "_SystemTables.СпециальнаяОдеждаПеремещениеИнструментаТаблица.Владелец";
            // 
            // vmoТаблЧасть
            // 
            nsgObjectDescriptor1.ConfigurationName = "TechControl";
            nsgObjectDescriptor1.FullName = "_SystemTables.СпециальнаяОдеждаПеремещениеИнструментаТаблица.Владелец";
            nsgObjectDescriptor1.MetaDataName = "Метаданные";
            nsgMasterDetailBinding1.DetailField = nsgObjectDescriptor1;
            nsgObjectDescriptor2.FullName = "СпециальнаяОдежда.ПеремещениеИнструмента.Таблица";
            ...
            this.vmoТаблЧасть.Columns.Collection.Add(this.Идентификатор_vmoТаблЧасть);
            this.vmoТаблЧасть.Columns.Collection.Add(this.Автоинкремент_vmoТаблЧасть);
            this.vmoТаблЧасть.Columns.Collection.Add(this.Владелец);
            this.vmoТаблЧасть.Columns.Collection.Add(this.НомерСтроки);
            this.vmoТаблЧасть.Columns.Collection.Add(this.Инструмент);
            this.vmoТаблЧасть.Columns.Collection.Add(this.Количество);
            this.vmoТаблЧасть.Columns.Collection.Add(this.Сумма);
            this.vmoТаблЧасть.Columns.Collection.Add(this.Цена);
            this.vmoТаблЧасть.IsActive = true;
            this.vmoТаблЧасть.MasterComponent = this.nsgVisualMultipleObject;
            this.vmoТаблЧасть.Binding = nsgMasterDetailBinding1;
            // 
            // Идентификатор_vmoТаблЧасть
            // 
            this.Идентификатор_vmoТаблЧасть.AutoGenerated = true;
            this.Идентификатор_vmoТаблЧасть.Caption = "Идентификатор";
            this.Идентификатор_vmoТаблЧасть.Creator = typeof(NsgSoft.Forms.NsgMultipleObjectElementForm);
            this.Идентификатор_vmoТаблЧасть.Name = "Идентификатор";
            this.Идентификатор_vmoТаблЧасть.NSGType = typeof(NsgSoft.DataObjects.NsgDataGuid);
            this.Идентификатор_vmoТаблЧасть.PropertyType = typeof(System.Guid);
            this.Идентификатор_vmoТаблЧасть.SearchCondition.OwnerComponent = this.Идентификатор_vmoТаблЧасть;
            this.Идентификатор_vmoТаблЧасть.SearchCondition.Parameters = new NsgSoft.DataObjects.NsgCompareParam[0];
            this.Идентификатор_vmoТаблЧасть.Visible = false;
            // 
            // Автоинкремент_vmoТаблЧасть
            // 
            this.Автоинкремент_vmoТаблЧасть.AutoGenerated = true;
            this.Автоинкремент_vmoТаблЧасть.CalcTotal = false;
            this.Автоинкремент_vmoТаблЧасть.Caption = "Автоинкремент";
            this.Автоинкремент_vmoТаблЧасть.Creator = typeof(NsgSoft.Forms.NsgMultipleObjectElementForm);
            this.Автоинкремент_vmoТаблЧасть.Name = "Автоинкремент";
            this.Автоинкремент_vmoТаблЧасть.NSGType = typeof(NsgSoft.DataObjects.NsgDataInteger);
            this.Автоинкремент_vmoТаблЧасть.PropertyType = typeof(long);
            this.Автоинкремент_vmoТаблЧасть.SearchCondition.OwnerComponent = this.Автоинкремент_vmoТаблЧасть;
            this.Автоинкремент_vmoТаблЧасть.SearchCondition.Parameters = new NsgSoft.DataObjects.NsgCompareParam[0];
            this.Автоинкремент_vmoТаблЧасть.Visible = false;
            // 
            // Владелец
            // 
            ...
            this.nsgInput1.Location = new System.Drawing.Point(117, 26);
            ...
            this.nsgInput1.Size = new System.Drawing.Size(109, 20);
            ...
            this.nsgInput2.Location = new System.Drawing.Point(325, 26);
            ...
            this.nsgInput2.Size = new System.Drawing.Size(153, 20);
            this.nsgInput2.SourceObject = this.nsgVisualMultipleObject;
            this.nsgInput2.TabIndex = 14;
            ...
            this.nsgInput3.Location = new System.Drawing.Point(532, 26);
            ...
            this.nsgInput4.FullName = "Комментарий";
            ...
            this.nsgInput4.Location = new System.Drawing.Point(96, 298);
            ...
            this.nsgInput4.Size = new System.Drawing.Size(620, 20);
            ...
            this.Таблица.NSGType = typeof(TechControl.Метаданные._SystemTables.СпециальнаяОдеждаПеремещениеИнструментаТаблица);
            this.Таблица.PropertyType = typeof(TechControl.Метаданные._SystemTables.СпециальнаяОдеждаПеремещениеИнструментаТаблица);
            ...
            ((System.ComponentModel.ISupportInitialize)(this.vmoТаблЧасть)).EndInit();
        ...
        protected _SystemTables.СпециальнаяОдеждаПеремещениеИнструментаТаблица.ColumnDescriptor Таблица;
        protected Мониторинг.Объекты.ColumnDescriptor Объект;
        protected NsgColumnDescriptor.Guid Идентификатор_vmoТаблЧасть;
        private NsgColumnDescriptor.Int64 Автоинкремент_vmoТаблЧасть;
        private NsgColumnDescriptor.MultipleObject Владелец;
        private NsgColumnDescriptor.Int64 НомерСтроки;
        private Инструменты.ColumnDescriptor Инструмент;
        ...
        private NsgVisualMultipleObject vmoТаблЧасть;
