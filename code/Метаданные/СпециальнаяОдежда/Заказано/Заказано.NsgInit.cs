...
namespace TechControl.Метаданные.СпециальнаяОдежда
{
    ...
    [NsgTypeName("NsgReportObject", Guid = "85b4f588-a0c7-443b-be2c-65c2187ae4a0")]
    public partial class Заказано : NsgSoft.DataObjects.NsgReportObject
    {
        #region Данные
        ...
        /// </summary>
        protected Заказано(NsgObject obj)
            : base(obj)
        {
        }
        ...
        public static Заказано Новый()
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("85b4f588-a0c7-443b-be2c-65c2187ae4a0"));
            if (obj == null)
                obj = new Заказано();
            return obj as Заказано;
        }
	...
	Автоинкремент.Guid = NsgService.StringToGuid("1cdc92c4-0898-40ff-b995-492b9502df3e");
			...
			#region создание TechControl.Метаданные.СпециальнаяОдежда.ЗаказаноФорма Форма
			{  
	...
	Форма.FormClassName = "TechControl.Метаданные.СпециальнаяОдежда.ЗаказаноФорма";
	...
	Форма.GroupName = "";
	Форма.Guid = NsgService.StringToGuid("e0cd0b35-95f2-4850-b332-522d6b4b4f18");
	
				if (!ObjectList.Contains("Форма"))
                    ObjectList.Add(Форма);
			}
			#endregion //создание TechControl.Метаданные.СпециальнаяОдежда.ЗаказаноФорма Форма
	...
	Name = "Заказано";
	Visible = true;
	Guid = NsgService.StringToGuid("85b4f588-a0c7-443b-be2c-65c2187ae4a0");
	DefaultSortingName = "";
	...
	GroupName = "СпециальнаяОдежда";
        ...
        {
            return "СпециальнаяОдежда.Заказано";
        }
        ...
        private Заказано[] convertArray(NsgMultipleObject[] array)
        {
            Заказано[] res = new Заказано[array.Length];
            array.CopyTo(res, 0);
            return res;
        }
        ...
        public new virtual Заказано[] FindAll(NsgCompare compare)
        {
        ...
        /// <returns>Список найденных объектов.</returns>
        public new virtual Заказано[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, NsgCompare compare)
        {
        ...
        /// <returns>Список найденных объектов.</returns>
        public new virtual Заказано[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, string inName, object inValue)
        {
        ...
        /// <param name="inValue">Значение для поиска. Условие поиска - полное совпадение.</param>
        /// <returns>Список найденных объектов.</returns>
        public new virtual Заказано[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, NsgDataFixedFields inName,
            object inValue)
        {
            return convertArray(base.FindAll(ref count, row_start, sorting, inName, inValue));
        }
        ...
        public override NsgObject CloneObject
        {
            get
            {
                return new Заказано(this as NsgObject);
            }
        }
        ...
        public new class ColumnDescriptor : NsgSoft.Forms.NsgColumnDescriptor
        {
			...
			public new Заказано Value
            {
                get
                {
                    return (Заказано)base.Value;
                }
                set
                {
                    base.Value = value;
