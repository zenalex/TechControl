...
namespace TechControl.Метаданные.СпециальнаяОдежда
{
    ...
    [NsgTypeName("NsgReportObject", Guid = "9db9530e-b0b8-4748-bc2d-8c9262e0b851")]
    public partial class ПолученоЗаПериод : NsgSoft.DataObjects.NsgReportObject
    {
        #region Данные
        ...
        /// </summary>
        protected ПолученоЗаПериод(NsgObject obj)
            : base(obj)
        {
        }
        ...
        public static ПолученоЗаПериод Новый()
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("9db9530e-b0b8-4748-bc2d-8c9262e0b851"));
            if (obj == null)
                obj = new ПолученоЗаПериод();
            return obj as ПолученоЗаПериод;
        }
	...
	Автоинкремент.Guid = NsgService.StringToGuid("1cdc92c4-0898-40ff-b995-492b9502df3e");
			...
			#region создание TechControl.Метаданные.СпециальнаяОдежда.ПолученоЗаПериодФорма Форма
			{  
	...
	Форма.FormClassName = "TechControl.Метаданные.СпециальнаяОдежда.ПолученоЗаПериодФорма";
	...
	Форма.GroupName = "";
	Форма.Guid = NsgService.StringToGuid("9891ec65-2a8b-444d-b635-ca8666596924");
	
				if (!ObjectList.Contains("Форма"))
                    ObjectList.Add(Форма);
			}
			#endregion //создание TechControl.Метаданные.СпециальнаяОдежда.ПолученоЗаПериодФорма Форма
			

			#region заполнение полей класса
				//NsgReportObject
	IsLoadedFromDll = true;
	Name = "ПолученоЗаПериод";
	Visible = true;
	Guid = NsgService.StringToGuid("9db9530e-b0b8-4748-bc2d-8c9262e0b851");
	DefaultSortingName = "";
	...
	TableName = "_report_PoluchenoZaPeriod";
	Presentation = new NsgSoft.DataObjects.NsgLanguageString(new System.String[]{"(Default)"},
		 new System.Object[]{""});
	Description = "Получено за период";
	...
	GroupName = "СпециальнаяОдежда";
        ...
        public override NsgMultipleObjectDescriptor Descriptor
        {
            get
            {
                if (descriptor == null)
                {
                    ...
                    descriptor.Name = "ПолученоЗаПериод";
        ...
        {
            return "СпециальнаяОдежда.ПолученоЗаПериод";
        }
        ...
        private ПолученоЗаПериод[] convertArray(NsgMultipleObject[] array)
        {
            ПолученоЗаПериод[] res = new ПолученоЗаПериод[array.Length];
            array.CopyTo(res, 0);
            return res;
        }
        ...
        public new virtual ПолученоЗаПериод[] FindAll(NsgCompare compare)
        {
        ...
        /// <returns>Список найденных объектов.</returns>
        public new virtual ПолученоЗаПериод[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, NsgCompare compare)
        {
        ...
        /// <returns>Список найденных объектов.</returns>
        public new virtual ПолученоЗаПериод[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, string inName, object inValue)
        {
        ...
        /// <param name="inValue">Значение для поиска. Условие поиска - полное совпадение.</param>
        /// <returns>Список найденных объектов.</returns>
        public new virtual ПолученоЗаПериод[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, NsgDataFixedFields inName,
            object inValue)
        {
            return convertArray(base.FindAll(ref count, row_start, sorting, inName, inValue));
        }
        ...
        public override NsgObject CloneObject
        {
            get
            {
                return new ПолученоЗаПериод(this as NsgObject);
            }
        }
        ...
        public new class ColumnDescriptor : NsgSoft.Forms.NsgColumnDescriptor
        {
            public ColumnDescriptor()
                : base()
            {
                base.NSGType = typeof(ПолученоЗаПериод);
            }
			...
			public new ПолученоЗаПериод Value
            {
                get
                {
                    return (ПолученоЗаПериод)base.Value;
                }
                set
                {
                    base.Value = value;
