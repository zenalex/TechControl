...
namespace TechControl.Метаданные._SystemTables
{
    ...
    [NsgTypeName("NsgDataTable", Guid = "b9e86340-bd69-4b40-91fd-c1a9035345ec")]
    public partial class СпециальнаяОдеждаПремещениеИнструментаТаблица : NsgSoft.DataObjects.NsgDataTable
    {
        #region Данные
        ...
        /// Создание объекта
        /// </summary>
        protected СпециальнаяОдеждаПремещениеИнструментаТаблица()
            : base()
        {
        }
        ...
        /// </summary>
        protected СпециальнаяОдеждаПремещениеИнструментаТаблица(NsgObject obj)
            : base(obj)
        {
        }
        ...
        public static СпециальнаяОдеждаПремещениеИнструментаТаблица Новый()
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("b9e86340-bd69-4b40-91fd-c1a9035345ec"));
            if (obj == null)
                obj = new СпециальнаяОдеждаПремещениеИнструментаТаблица();
            return obj as СпециальнаяОдеждаПремещениеИнструментаТаблица;
        }
	...
	Идентификатор.Guid = NsgService.StringToGuid("f693977b-642b-447b-8ffb-83ff8a4753b3");
	...
	Автоинкремент.Guid = NsgService.StringToGuid("e88f0b27-ac7c-460c-a5bf-784291d499a4");
	...
	Владелец.FilterForConfigurator = "СпециальнаяОдежда.ПремещениеИнструмента";
	...
	Владелец.GroupName = "";
	Владелец.Guid = NsgService.StringToGuid("41573f48-240a-4508-be66-927a87fdb24a");
	...
	НомерСтроки.Guid = NsgService.StringToGuid("35aba2aa-bb3d-48b3-81e5-3cacbebcac02");
			...
			#region создание СпециальнаяОдежда.Инструмент Инструмент
			{  
	...
	Инструмент.IndexType = NsgSoft.Database.NsgRekvisitIndexType.None;
	...
	Инструмент.Guid = NsgService.StringToGuid("05459fa4-166d-4722-ba08-1fa972643387");
	
				if (!ObjectList.Contains("Инструмент"))
                    ObjectList.Add(Инструмент);
			}
			#endregion //создание СпециальнаяОдежда.Инструмент Инструмент
	...
	Цена.GroupName = "";
	Цена.Guid = NsgService.StringToGuid("cb6c1205-dd6f-4348-bfe9-b865c66d7e38");
	...
	Сумма.GroupName = "";
	Сумма.Guid = NsgService.StringToGuid("681262d8-4932-4554-9437-13345d0265b4");
	...
	Количество.Guid = NsgService.StringToGuid("4c229011-a833-4c23-9c95-8d8fb35cffce");
	...
	OwnerFullName = "СпециальнаяОдежда.ПремещениеИнструмента";
	RegisterPeriod = NsgSoft.Common.NsgPeriod.None;
	RegisterPeriodCount = 0;
	TableSubType = NsgSoft.Common.NsgTableSubType.TablePart;
	EntityType = NsgSoft.DataObjects.NsgInterfacedObject.EntityTypes.Object;
	Name = "СпециальнаяОдеждаПремещениеИнструментаТаблица";
	Visible = true;
	Guid = NsgService.StringToGuid("b9e86340-bd69-4b40-91fd-c1a9035345ec");
	DefaultSortingName = "";
	...
	Presentation = new NsgSoft.DataObjects.NsgLanguageString(new System.String[]{"(Default)"},
		 new System.Object[]{""});
	Description = "Специальная одежда премещение инструмента таблица";
	...
	GroupName = "_SystemTables";
        ...
        public override NsgMultipleObjectDescriptor Descriptor
        {
            get
            {
                if (descriptor == null)
                {
                    ...
                    descriptor.Name = "СпециальнаяОдеждаПремещениеИнструментаТаблица";
        ...
        {
            return "_SystemTables.СпециальнаяОдеждаПремещениеИнструментаТаблица";
        }
        ...
        [NsgReferentsFilterAttribute("СпециальнаяОдежда.ПремещениеИнструмента")]
        ...
        /// </summary>
        public new СпециальнаяОдеждаПремещениеИнструментаТаблица.Строка NewRow()
        {
            return newRow(null) as СпециальнаяОдеждаПремещениеИнструментаТаблица.Строка;
        }
        ...
        {
            if (row == null)
                row = new СпециальнаяОдеждаПремещениеИнструментаТаблица.Строка(this);
            return base.newRow(row) as СпециальнаяОдеждаПремещениеИнструментаТаблица.Строка;
        }

        /// <summary>
        /// Добавить новую строку в таблицу путем копирования переданной строки
        /// </summary>
        public СпециальнаяОдеждаПремещениеИнструментаТаблица.Строка NewRow(СпециальнаяОдеждаПремещениеИнструментаТаблица.Строка inRow)
        {
            СпециальнаяОдеждаПремещениеИнструментаТаблица.Строка row = inRow.Clone as СпециальнаяОдеждаПремещениеИнструментаТаблица.Строка;
            return base.newRow(row) as СпециальнаяОдеждаПремещениеИнструментаТаблица.Строка;
        }
        ...
        /// </summary>
        public new СпециальнаяОдеждаПремещениеИнструментаТаблица.Строка GetRow(int rowNumber)
        {
            return base.GetRow(rowNumber) as СпециальнаяОдеждаПремещениеИнструментаТаблица.Строка;
        }

        /// <summary>
        /// Возвращает новую строку таблицы, но в саму таблицу ее не включает (эталонная строка)
        /// </summary>
        public new СпециальнаяОдеждаПремещениеИнструментаТаблица.Строка GetEtalonRow()
        {
            СпециальнаяОдеждаПремещениеИнструментаТаблица.Строка row = new СпециальнаяОдеждаПремещениеИнструментаТаблица.Строка(this);
            row.MetaData = MetaData;
            return row;
        }

        private СпециальнаяОдеждаПремещениеИнструментаТаблица.Строка[] convertRowsArray(NsgDataTableRow[] array)
        {
            СпециальнаяОдеждаПремещениеИнструментаТаблица.Строка[] res = new СпециальнаяОдеждаПремещениеИнструментаТаблица.Строка[array.Length];
            array.CopyTo(res, 0);
            return res;
        }
        ...
        public new СпециальнаяОдеждаПремещениеИнструментаТаблица.Строка FindRowByTag(object Tag)
        {
            return base.FindRowByTag(Tag) as СпециальнаяОдеждаПремещениеИнструментаТаблица.Строка;
        }
        ...
        /// <param name="compare">Критерии поиска.</param>
        /// <returns>Найденные строки.</returns>
        public new СпециальнаяОдеждаПремещениеИнструментаТаблица.Строка[] FindRowsByTag(object Tag)
        {
        ...
        /// <param name="compare">Критерии поиска.</param>
        /// <returns>Найденные строки.</returns>
        public new СпециальнаяОдеждаПремещениеИнструментаТаблица.Строка FindRow(NsgCompare compare)
        {
            return base.FindRow(compare) as СпециальнаяОдеждаПремещениеИнструментаТаблица.Строка;
        }
        ...
        /// <returns>Найденные строки.</returns>
        public new СпециальнаяОдеждаПремещениеИнструментаТаблица.Строка FindRow(string inName, object inValue)
        {
            return base.FindRow(inName, inValue) as СпециальнаяОдеждаПремещениеИнструментаТаблица.Строка;
        }
        ...
        /// <param name="inValue">Значение поля.</param>
        /// <returns>Найденные строки.</returns>
        public new СпециальнаяОдеждаПремещениеИнструментаТаблица.Строка FindRow(NsgDataFixedFields inName, object inValue)
        {
            return base.FindRow(inName, inValue) as СпециальнаяОдеждаПремещениеИнструментаТаблица.Строка;
        }
        ...
        /// <param name="compare">Критерии поиска.</param>
        /// <returns>Найденные строки.</returns>
        public new СпециальнаяОдеждаПремещениеИнструментаТаблица.Строка[] FindRows(NsgCompare compare)
        {
        ...
        /// <param name="inValue">Значение поля.</param>
        /// <returns>Найденные строки.</returns>
        public new СпециальнаяОдеждаПремещениеИнструментаТаблица.Строка[] FindRows(string inName, object inValue)
        {
        ...
        /// <param name="inValue">Значение поля.</param>
        /// <returns>Найденные строки.</returns>
        public new СпециальнаяОдеждаПремещениеИнструментаТаблица.Строка[] FindRows(NsgDataFixedFields inName, object inValue)
        {
            return convertRowsArray(base.FindRows(inName, inValue));
        }
        ...
        /// </summary>
        public  NsgVirtualCursor<СпециальнаяОдеждаПремещениеИнструментаТаблица> GetNewVirtualCursor()
        {
            return base.GetNewVirtualCursor<СпециальнаяОдеждаПремещениеИнструментаТаблица>();
        }

        /// <summary>
        /// Получить все строки таблицы с учетом наложенного фильтра. Для получения всех сьтрок без учета фильтра используется свойство AllRows
        /// </summary>
        public new СпециальнаяОдеждаПремещениеИнструментаТаблица.Строка[] Rows
        {
            get
            {
        ...
        /// </summary>
        public new СпециальнаяОдеждаПремещениеИнструментаТаблица.Строка[] AllRows
        {
            get
            {
        ...
        /// <returns>Найденные строки.</returns>
        public new СпециальнаяОдеждаПремещениеИнструментаТаблица.Строка GetRow(Guid inID)
        {
            return base.GetRow(inID) as СпециальнаяОдеждаПремещениеИнструментаТаблица.Строка;
        }
        #endregion
        ...
        private СпециальнаяОдеждаПремещениеИнструментаТаблица[] convertArray(NsgMultipleObject[] array)
        {
            СпециальнаяОдеждаПремещениеИнструментаТаблица[] res = new СпециальнаяОдеждаПремещениеИнструментаТаблица[array.Length];
            array.CopyTo(res, 0);
            return res;
        }
        ...
        public new virtual СпециальнаяОдеждаПремещениеИнструментаТаблица[] FindAll(NsgCompare compare)
        {
        ...
        /// <returns>Список найденных объектов.</returns>
        public new virtual СпециальнаяОдеждаПремещениеИнструментаТаблица[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, NsgCompare compare)
        {
        ...
        /// <returns>Список найденных объектов.</returns>
        public new virtual СпециальнаяОдеждаПремещениеИнструментаТаблица[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, string inName, object inValue)
        {
        ...
        /// <param name="inValue">Значение для поиска. Условие поиска - полное совпадение.</param>
        /// <returns>Список найденных объектов.</returns>
        public new virtual СпециальнаяОдеждаПремещениеИнструментаТаблица[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, NsgDataFixedFields inName,
            object inValue)
        {
            return convertArray(base.FindAll(ref count, row_start, sorting, inName, inValue));
        }
        ...
        public override NsgObject CloneObject
        {
            get
            {
                return new СпециальнаяОдеждаПремещениеИнструментаТаблица(this as NsgObject);
            }
        }
        ...
        public new class ColumnDescriptor : NsgSoft.Forms.NsgColumnDescriptor
        {
            public ColumnDescriptor()
                : base()
            {
                base.NSGType = typeof(СпециальнаяОдеждаПремещениеИнструментаТаблица);
            }
			...
			public new СпециальнаяОдеждаПремещениеИнструментаТаблица Value
            {
                get
                {
                    return (СпециальнаяОдеждаПремещениеИнструментаТаблица)base.Value;
                }
                set
                {
                    base.Value = value;
