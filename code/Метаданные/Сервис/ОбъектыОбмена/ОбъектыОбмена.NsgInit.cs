...
namespace TT.Метаданные.Сервис
{
    ...
    [NsgTypeName("NsgDataDictionary", Guid = "cb04f28e-c9f2-4d57-9e1d-83784009e9bc")]
    public partial class ОбъектыОбмена : NsgSoft.DataObjects.NsgDataDictionary
    {
        #region Данные
        ...
        /// </summary>
        protected ОбъектыОбмена(NsgObject obj)
            : base(obj)
        {
        }
        ...
        public static ОбъектыОбмена Новый()
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("cb04f28e-c9f2-4d57-9e1d-83784009e9bc"));
            if (obj == null)
                obj = new ОбъектыОбмена();
            return obj as ОбъектыОбмена;
        }
	...
	Идентификатор.Guid = NsgService.StringToGuid("08ea44eb-718c-439c-93ca-798e0bc3d693");
	...
	Автоинкремент.Guid = NsgService.StringToGuid("34069c3f-b1b3-42b2-a59d-7d818f90fa81");
	...
	ЭтоГруппа.GroupName = "";
	ЭтоГруппа.Guid = NsgService.StringToGuid("6a1e3da5-7842-4dbc-80dc-8a9d4a20e774");
	...
	ИдентификаторРодителя.Guid = NsgService.StringToGuid("e68649e6-b442-4bed-b0dc-4fb263ed61cc");
	...
	Уровень.GroupName = "";
	Уровень.Guid = NsgService.StringToGuid("0f8ad422-732a-41ff-8eb4-514d9f8046d4");
	...
	ПрефиксКода.Guid = NsgService.StringToGuid("4ceb8809-3fba-4f72-b188-02bf9c851764");
	...
	НомерКода.GroupName = "";
	НомерКода.Guid = NsgService.StringToGuid("fa51bca0-f67d-494d-8d40-729075f526d9");
	...
	Код.GroupName = "";
	Код.Guid = NsgService.StringToGuid("e1cb1fc7-a941-4503-847c-56ebbc0ba37f");
	...
	СостояниеДокумента.Guid = NsgService.StringToGuid("780a58ef-acdb-4909-b722-d3369602ff83");
			...
			#region создание NsgSoft.DataObjects.NsgReferencedObject ОбъектОбмена
			{  
                NsgDataUntypedReference ОбъектОбмена = null;
				if (ObjectList.Contains("ОбъектОбмена"))
                    ОбъектОбмена = ObjectList["ОбъектОбмена"] as NsgDataUntypedReference;
                else
                    ОбъектОбмена = new NsgDataUntypedReference();
	//NsgDataUntypedReference
	ОбъектОбмена.IsLoadedFromDll = true;
	ОбъектОбмена.FilterTypeForConfigurator = NsgSoft.DataObjects.NsgFiltration.None;
	ОбъектОбмена.FilterForConfigurator = "";
	ОбъектОбмена.ReferentName = "";
	ОбъектОбмена.ReferentGroup = "";
	ОбъектОбмена.TypeSelectorName = "";
	ОбъектОбмена.SaveInDatabase = true;
	ОбъектОбмена.OwnerName = "";
	ОбъектОбмена.AllowEmptyOwner = false;
	ОбъектОбмена.StringFormat = "";
	ОбъектОбмена.SubType = NsgSoft.Common.NsgRekvisitSubType.Element;
	ОбъектОбмена.IncludeInPredefined = false;
	ОбъектОбмена.PeriodicType = NsgSoft.Database.PeriodicTypes.None;
	ОбъектОбмена.Required = false;
	ОбъектОбмена.EmptyValue = "";
	ОбъектОбмена.NullAllow = false;
	ОбъектОбмена.IndexType = NsgSoft.Database.NsgRekvisitIndexType.None;
	ОбъектОбмена.FieldName = "ObektObmena";
	ОбъектОбмена.InformMetaDataOnValueChanged = false;
	ОбъектОбмена.Visible = true;
	ОбъектОбмена.Name = "ОбъектОбмена";
	ОбъектОбмена.Presentation = new NsgSoft.DataObjects.NsgLanguageString(new System.String[]{"(Default)"},
		 new System.Object[]{"Объект обмена"});
	ОбъектОбмена.Description = "Объект обмена";
	ОбъектОбмена.EditorVisible = NsgSoft.DataObjects.NsgDataObjectEditorAccess.Limited;
	ОбъектОбмена.GroupName = "";
	ОбъектОбмена.Guid = NsgService.StringToGuid("eed6dcfa-ed20-4de2-9f93-2ae8a3727019");
	
				if (!ObjectList.Contains("ОбъектОбмена"))
                    ObjectList.Add(ОбъектОбмена);
			}
			#endregion //создание NsgSoft.DataObjects.NsgReferencedObject ОбъектОбмена
	...
	БазаПолучатель.Guid = NsgService.StringToGuid("22c3c770-ec59-49e5-b93a-9abe68d1e74f");
	...
	НомерОбмена.EditorVisible = NsgSoft.DataObjects.NsgDataObjectEditorAccess.Limited;
	НомерОбмена.GroupName = "";
	НомерОбмена.Guid = NsgService.StringToGuid("4b0e5fa5-425f-46ab-a44b-9dbd5c27dc14");
	...
	Name = "ОбъектыОбмена";
	Visible = true;
	Guid = NsgService.StringToGuid("cb04f28e-c9f2-4d57-9e1d-83784009e9bc");
	DefaultSortingName = "";
	...
	TableName = "ExchangeDBDataObjects";
	Presentation = new NsgSoft.DataObjects.NsgLanguageString(new System.String[]{"(Default)"},
		 new System.Object[]{"Объекты обмена"});
	Description = "Объекты обмена";
	...
	GroupName = "Сервис";
        ...
        public new partial class Names// :NsgSoft.DataObjects.NsgDataDictionary.Names
        {
            ...
            /// Объект обмена
            /// </summary>
            public static String ОбъектОбмена
            {
                get
                {
                    return "ОбъектОбмена";
        ...
        public NsgSoft.DataObjects.NsgReferencedObject ОбъектОбмена
        {
            get
            {
				 NsgDataUntypedReference __ОбъектОбмена = ObjectList["ОбъектОбмена"] as NsgDataUntypedReference;
                 return (NsgSoft.DataObjects.NsgReferencedObject)__ОбъектОбмена.Referent;
            }
            set
            {
                NsgDataUntypedReference __ОбъектОбмена = ObjectList["ОбъектОбмена"] as NsgDataUntypedReference;
                __ОбъектОбмена.Referent = value;
            }
        }
        ...
        [NsgView(NsgViewTypes.DesignTime)]
        [NsgTypeName("NsgDataDictionary")]
        public ОбъектыОбмена Родитель
        {
            get
            {
                return base.Parent as ОбъектыОбмена;
            }
            set
            {
                base.Parent = value;
        ...
        private ОбъектыОбмена[] convertArray(NsgMultipleObject[] array)
        {
            ОбъектыОбмена[] res = new ОбъектыОбмена[array.Length];
            array.CopyTo(res, 0);
            return res;
        }
        ...
        public new virtual ОбъектыОбмена[] FindAll(NsgCompare compare)
        {
        ...
        /// <returns>Список найденных объектов.</returns>
        public new virtual ОбъектыОбмена[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, NsgCompare compare)
        {
        ...
        /// <returns>Список найденных объектов.</returns>
        public new virtual ОбъектыОбмена[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, string inName, object inValue)
        {
        ...
        /// <param name="inValue">Значение для поиска. Условие поиска - полное совпадение.</param>
        /// <returns>Список найденных объектов.</returns>
        public new virtual ОбъектыОбмена[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, NsgDataFixedFields inName,
            object inValue)
        {
            return convertArray(base.FindAll(ref count, row_start, sorting, inName, inValue));
        }
        ...
        public override NsgObject CloneObject
        {
            get
            {
                return new ОбъектыОбмена(this as NsgObject);
            }
        }
        ...
        public new class ColumnDescriptor : NsgSoft.Forms.NsgColumnDescriptor
        {
            public ColumnDescriptor()
                : base()
            {
                base.NSGType = typeof(ОбъектыОбмена);
            }
			...
			public new ОбъектыОбмена Value
            {
                get
                {
                    return (ОбъектыОбмена)base.Value;
                }
                set
                {
                    base.Value = value;
