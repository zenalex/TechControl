...
namespace TT.Метаданные.Сервис
{
    ...
    [NsgTypeName("NsgDataDictionary", Guid = "6c00a591-9110-48cd-bc58-3b8751f59580")]
    public partial class ТипыОбмена : NsgSoft.DataObjects.NsgDataDictionary
    {
        #region Данные
        ...
        /// </summary>
        protected ТипыОбмена(NsgObject obj)
            : base(obj)
        {
        }
        ...
        public static ТипыОбмена Новый()
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("6c00a591-9110-48cd-bc58-3b8751f59580"));
            if (obj == null)
                obj = new ТипыОбмена();
            return obj as ТипыОбмена;
        }
	...
	Идентификатор.Guid = NsgService.StringToGuid("30c5f513-3af1-46c2-afa6-7047bd691d9c");
	...
	Автоинкремент.Guid = NsgService.StringToGuid("8941d4aa-7a92-4b79-b096-45a9b9965105");
	...
	ЭтоГруппа.GroupName = "";
	ЭтоГруппа.Guid = NsgService.StringToGuid("f1a1082a-2ca4-4a6a-b2d9-5d74f83af233");
	...
	ИдентификаторРодителя.Guid = NsgService.StringToGuid("801da8ff-e317-4e22-8ccb-2eaab37aad86");
	...
	Уровень.GroupName = "";
	Уровень.Guid = NsgService.StringToGuid("eac357f2-1de4-4de4-9575-7b1a0699be43");
	...
	ПрефиксКода.Guid = NsgService.StringToGuid("5263f0de-efa8-4ecd-8201-8f4ce4ae48fb");
	...
	НомерКода.GroupName = "";
	НомерКода.Guid = NsgService.StringToGuid("9c3f1b21-facb-4a29-bb0b-efd58e5cffd8");
	...
	Код.GroupName = "";
	Код.Guid = NsgService.StringToGuid("f8b20f49-351a-4b75-8bd9-f653cfe55716");
	...
	СостояниеДокумента.Guid = NsgService.StringToGuid("b5afda25-984e-480b-96c5-81507a2e39a2");
	...
	Наименование.Guid = NsgService.StringToGuid("c65b3322-4910-4819-9a1f-9b4d716d5959");
			...
			#region создание Сервис.ТипыОбмена Файл
			{  
                NsgDataPredefinedReference Файл = null;
				if (ObjectList.Contains("Файл"))
                    Файл = ObjectList["Файл"] as NsgDataPredefinedReference;
                else
                    Файл = new NsgDataPredefinedReference();
	//NsgDataPredefinedReference
	Файл.IsLoadedFromDll = true;
	Файл.SaveInDatabase = false;
	Файл.RequisiteValues = new NsgSoft.DataObjects.NsgPropertyCollection(new System.String[]{"Наименование"},
		 new System.Object[]{"Файл"});
	Файл.Guid = NsgService.StringToGuid("55f4482d-e3d3-408e-808e-0952c86bc607");
	Файл.ReferentGroup = "Сервис";
	Файл.ReferentName = "ТипыОбмена";
	Файл.OwnerName = "";
	Файл.AllowEmptyOwner = false;
	Файл.StringFormat = "";
	Файл.SubType = NsgSoft.Common.NsgRekvisitSubType.Predefined;
	Файл.IncludeInPredefined = false;
	Файл.PeriodicType = NsgSoft.Database.PeriodicTypes.None;
	Файл.Required = false;
	Файл.EmptyValue = "";
	Файл.NullAllow = false;
	Файл.IndexType = NsgSoft.Database.NsgRekvisitIndexType.None;
	Файл.FieldName = "Faijl";
	Файл.InformMetaDataOnValueChanged = false;
	Файл.Visible = true;
	Файл.Name = "Файл";
	Файл.Presentation = new NsgSoft.DataObjects.NsgLanguageString(new System.String[]{"(Default)"},
		 new System.Object[]{"Файл"});
	Файл.Description = "SQL";
	Файл.EditorVisible = NsgSoft.DataObjects.NsgDataObjectEditorAccess.Limited;
	Файл.GroupName = "";
	
				if (!ObjectList.Contains("Файл"))
                    ObjectList.Add(Файл);
			}
			#endregion //создание Сервис.ТипыОбмена Файл
			
			#region создание Сервис.ТипыОбмена Email
			{  
                NsgDataPredefinedReference Email = null;
				if (ObjectList.Contains("Email"))
                    Email = ObjectList["Email"] as NsgDataPredefinedReference;
                else
                    Email = new NsgDataPredefinedReference();
	//NsgDataPredefinedReference
	Email.IsLoadedFromDll = true;
	Email.SaveInDatabase = false;
	Email.RequisiteValues = new NsgSoft.DataObjects.NsgPropertyCollection(new System.String[]{"Наименование"},
		 new System.Object[]{"E-mail"});
	Email.Guid = NsgService.StringToGuid("3fb13c52-7588-4679-bf41-35a4dc3a4261");
	Email.ReferentGroup = "Сервис";
	Email.ReferentName = "ТипыОбмена";
	Email.OwnerName = "";
	Email.AllowEmptyOwner = false;
	Email.StringFormat = "";
	Email.SubType = NsgSoft.Common.NsgRekvisitSubType.Predefined;
	Email.IncludeInPredefined = false;
	Email.PeriodicType = NsgSoft.Database.PeriodicTypes.None;
	Email.Required = false;
	Email.EmptyValue = "";
	Email.NullAllow = false;
	Email.IndexType = NsgSoft.Database.NsgRekvisitIndexType.None;
	Email.FieldName = "Email";
	Email.InformMetaDataOnValueChanged = false;
	Email.Visible = true;
	Email.Name = "Email";
	Email.Presentation = new NsgSoft.DataObjects.NsgLanguageString(new System.String[]{"(Default)"},
		 new System.Object[]{"E-mail"});
	Email.Description = "E-mail";
	Email.EditorVisible = NsgSoft.DataObjects.NsgDataObjectEditorAccess.Limited;
	Email.GroupName = "";
	
				if (!ObjectList.Contains("Email"))
                    ObjectList.Add(Email);
			}
			#endregion //создание Сервис.ТипыОбмена Email
			
			#region создание Сервис.ТипыОбмена SQL
			{  
                NsgDataPredefinedReference SQL = null;
				if (ObjectList.Contains("SQL"))
                    SQL = ObjectList["SQL"] as NsgDataPredefinedReference;
                else
                    SQL = new NsgDataPredefinedReference();
	//NsgDataPredefinedReference
	SQL.IsLoadedFromDll = true;
	SQL.SaveInDatabase = false;
	SQL.RequisiteValues = new NsgSoft.DataObjects.NsgPropertyCollection(new System.String[]{"Наименование"},
		 new System.Object[]{"SQL"});
	SQL.Guid = NsgService.StringToGuid("d7e5a58d-7503-436e-ad0a-7db8da8b1a94");
	SQL.ReferentGroup = "Сервис";
	SQL.ReferentName = "ТипыОбмена";
	SQL.OwnerName = "";
	SQL.AllowEmptyOwner = false;
	SQL.StringFormat = "";
	SQL.SubType = NsgSoft.Common.NsgRekvisitSubType.Predefined;
	SQL.IncludeInPredefined = false;
	SQL.PeriodicType = NsgSoft.Database.PeriodicTypes.None;
	SQL.Required = false;
	SQL.EmptyValue = "";
	SQL.NullAllow = false;
	SQL.IndexType = NsgSoft.Database.NsgRekvisitIndexType.None;
	SQL.FieldName = "SQL";
	SQL.InformMetaDataOnValueChanged = false;
	SQL.Visible = true;
	SQL.Name = "SQL";
	SQL.Presentation = new NsgSoft.DataObjects.NsgLanguageString(new System.String[]{"(Default)"},
		 new System.Object[]{"SQL"});
	SQL.Description = "SQL";
	SQL.EditorVisible = NsgSoft.DataObjects.NsgDataObjectEditorAccess.Limited;
	SQL.GroupName = "";
	
				if (!ObjectList.Contains("SQL"))
                    ObjectList.Add(SQL);
			}
			#endregion //создание Сервис.ТипыОбмена SQL
	...
	Name = "ТипыОбмена";
	Visible = true;
	Guid = NsgService.StringToGuid("6c00a591-9110-48cd-bc58-3b8751f59580");
	DefaultSortingName = "";
	...
	TableName = "ExchangeTypes";
	Presentation = new NsgSoft.DataObjects.NsgLanguageString(new System.String[]{"(Default)"},
		 new System.Object[]{"Типы обмена"});
	Description = "Типы обмена";
	...
	GroupName = "Сервис";
        ...
        public ТипыОбмена Родитель
        {
            get
            {
                return base.Parent as ТипыОбмена;
            }
            set
            {
                base.Parent = value;
        ...
        [NsgView(NsgViewTypes.DesignTime)]
        [NsgTypeName("NsgDataDictionary")]
        public static ТипыОбмена Файл
        {
            get
            {
                return (ТипыОбмена)getPredefined(NsgService.StringToGuid("6c00a591-9110-48cd-bc58-3b8751f59580"), NsgService.StringToGuid("55f4482d-e3d3-408e-808e-0952c86bc607"));
            }
        }
        ...
        [NsgView(NsgViewTypes.DesignTime)]
        [NsgTypeName("NsgDataDictionary")]
        public static ТипыОбмена Email
        {
            get
            {
                return (ТипыОбмена)getPredefined(NsgService.StringToGuid("6c00a591-9110-48cd-bc58-3b8751f59580"), NsgService.StringToGuid("3fb13c52-7588-4679-bf41-35a4dc3a4261"));
            }
        }
        ...
        [NsgView(NsgViewTypes.DesignTime)]
        [NsgTypeName("NsgDataDictionary")]
        public static ТипыОбмена SQL
        {
            get
            {
                return (ТипыОбмена)getPredefined(NsgService.StringToGuid("6c00a591-9110-48cd-bc58-3b8751f59580"), NsgService.StringToGuid("d7e5a58d-7503-436e-ad0a-7db8da8b1a94"));
            }
        }
        ...
        private ТипыОбмена[] convertArray(NsgMultipleObject[] array)
        {
            ТипыОбмена[] res = new ТипыОбмена[array.Length];
            array.CopyTo(res, 0);
            return res;
        }
        ...
        public new virtual ТипыОбмена[] FindAll(NsgCompare compare)
        {
        ...
        /// <returns>Список найденных объектов.</returns>
        public new virtual ТипыОбмена[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, NsgCompare compare)
        {
        ...
        /// <returns>Список найденных объектов.</returns>
        public new virtual ТипыОбмена[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, string inName, object inValue)
        {
        ...
        /// <param name="inValue">Значение для поиска. Условие поиска - полное совпадение.</param>
        /// <returns>Список найденных объектов.</returns>
        public new virtual ТипыОбмена[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, NsgDataFixedFields inName,
            object inValue)
        {
            return convertArray(base.FindAll(ref count, row_start, sorting, inName, inValue));
        }
        ...
        public override NsgObject CloneObject
        {
            get
            {
                return new ТипыОбмена(this as NsgObject);
            }
        }
        ...
        public new class ColumnDescriptor : NsgSoft.Forms.NsgColumnDescriptor
        {
            public ColumnDescriptor()
                : base()
            {
                base.NSGType = typeof(ТипыОбмена);
            }
			...
			public new ТипыОбмена Value
            {
                get
                {
                    return (ТипыОбмена)base.Value;
                }
                set
                {
                    base.Value = value;
