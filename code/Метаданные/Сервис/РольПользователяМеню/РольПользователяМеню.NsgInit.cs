...
namespace TechControl.Метаданные.Сервис
{
    ...
    [NsgTypeName("NsgDataDictionary", Guid = "ee7283b8-d5a5-47d9-bf36-55612f093050")]
    public partial class РольПользователяМеню : NsgSoft.DataObjects.NsgDataDictionary
    {
        #region Данные
        ...
        /// Создание объекта
        /// </summary>
        protected РольПользователяМеню()
            : base()
        {
        }
        ...
        /// </summary>
        protected РольПользователяМеню(NsgObject obj)
            : base(obj)
        {
        }
        ...
        public static РольПользователяМеню Новый()
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("ee7283b8-d5a5-47d9-bf36-55612f093050"));
            if (obj == null)
                obj = new РольПользователяМеню();
            return obj as РольПользователяМеню;
        }
	...
	Идентификатор.Guid = NsgService.StringToGuid("03bce47d-de51-48d9-9605-c82194a06878");
	...
	Автоинкремент.Guid = NsgService.StringToGuid("682a8395-e86c-49a7-a620-6a746a019253");
	...
	ЭтоГруппа.GroupName = "";
	ЭтоГруппа.Guid = NsgService.StringToGuid("688575ca-98aa-49ea-832c-39f4e73b6068");
	...
	ИдентификаторРодителя.Guid = NsgService.StringToGuid("4786ff25-15a0-49b2-ac30-1769db0a95dd");
	...
	Уровень.GroupName = "";
	Уровень.Guid = NsgService.StringToGuid("548fe0be-e65d-447c-86c9-4f29beb9b035");
	...
	ПрефиксКода.Guid = NsgService.StringToGuid("ea163232-665c-45f9-8b59-42bc98dce059");
	...
	НомерКода.GroupName = "";
	НомерКода.Guid = NsgService.StringToGuid("e53b6230-032f-4efe-bd70-021aaa6c3ab6");
	...
	Код.GroupName = "";
	Код.Guid = NsgService.StringToGuid("191b9ce4-a1cf-4596-a923-cd0370dca571");
	...
	СостояниеДокумента.Guid = NsgService.StringToGuid("d8a7e56f-1469-417d-a0c2-3f05915310e1");
	...
	Наименование.Guid = NsgService.StringToGuid("a7af2dbd-d5a4-4fd0-92f9-d8f129826fdd");
	...
	Таблица.GroupName = "";
	Таблица.Guid = NsgService.StringToGuid("1b8fb68a-1d61-4f64-afb5-9d9b3ecf6549");
	...
	Visible = true;
	Guid = NsgService.StringToGuid("ee7283b8-d5a5-47d9-bf36-55612f093050");
	DefaultSortingName = "";
	...
	GroupName = "Сервис";
        ...
        public override NsgMultipleObjectDescriptor Descriptor
        {
            get
            {
                if (descriptor == null)
                {
                    ...
                    descriptor.Name = "РольПользователяМеню";
        ...
        {
            return "Сервис.РольПользователяМеню";
        }
        ...
        public Сервис.ТаблицаРолиМенюПользователя Таблица
        {
            get
            {
				 NsgDataTableReference __Таблица = ObjectList["Таблица"] as NsgDataTableReference;
                 return (Сервис.ТаблицаРолиМенюПользователя)__Таблица.Referent;
            }
            set
            {
                NsgDataTableReference __Таблица = ObjectList["Таблица"] as NsgDataTableReference;
        ...
        public РольПользователяМеню Родитель
        {
            get
            {
                return base.Parent as РольПользователяМеню;
            }
            set
            {
                base.Parent = value;
        ...
        private РольПользователяМеню[] convertArray(NsgMultipleObject[] array)
        {
            РольПользователяМеню[] res = new РольПользователяМеню[array.Length];
            array.CopyTo(res, 0);
            return res;
        }
        ...
        public new virtual РольПользователяМеню[] FindAll(NsgCompare compare)
        {
        ...
        /// <returns>Список найденных объектов.</returns>
        public new virtual РольПользователяМеню[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, NsgCompare compare)
        {
        ...
        /// <returns>Список найденных объектов.</returns>
        public new virtual РольПользователяМеню[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, string inName, object inValue)
        {
        ...
        /// <param name="inValue">Значение для поиска. Условие поиска - полное совпадение.</param>
        /// <returns>Список найденных объектов.</returns>
        public new virtual РольПользователяМеню[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, NsgDataFixedFields inName,
            object inValue)
        {
            return convertArray(base.FindAll(ref count, row_start, sorting, inName, inValue));
        }
        ...
        public override NsgObject CloneObject
        {
            get
            {
                return new РольПользователяМеню(this as NsgObject);
            }
        }
        ...
        public new class ColumnDescriptor : NsgSoft.Forms.NsgColumnDescriptor
        {
            public ColumnDescriptor()
                : base()
            {
                base.NSGType = typeof(РольПользователяМеню);
            }
			...
			public new РольПользователяМеню Value
            {
                get
                {
                    return (РольПользователяМеню)base.Value;
                }
                set
                {
                    base.Value = value;
