...
{
    public partial class ТаблицаРолиМенюПользователя
{
    [NsgTypeName("NsgDataTableRow", Guid = "af2194fd-105a-46a2-be54-b4b46f766d52")]
    public partial class Строка : NsgSoft.DataObjects.NsgDataTableRow
    {
        ...
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("af2194fd-105a-46a2-be54-b4b46f766d52"));
            if (obj == null)
                obj = new Строка();
        ...
        public override NsgMultipleObjectDescriptor Descriptor
        {
            get
            {
                if (descriptor == null)
                {
                    ...
                    descriptor.Name = "ТаблицаРолиМенюПользователя";
        ...
        [NsgReferentsFilterAttribute("Сервис.РольПользователяМеню")]
