...
namespace TT.Метаданные.Сервис
{
    ...
    [NsgTypeName("NsgReportObject", Guid = "769300f6-0f9f-444f-b23f-6b0193dc06cf")]
    public partial class ОбменДанными : NsgSoft.DataObjects.NsgReportObject
    {
        ...
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("769300f6-0f9f-444f-b23f-6b0193dc06cf"));
            if (obj == null)
	...
	Идентификатор.Guid = NsgService.StringToGuid("98327eb5-4cd5-4141-bfa0-9df9c9d14f14");
	...
	Автоинкремент.Guid = NsgService.StringToGuid("0e1258c1-f07e-47e2-8960-b79e7c71bbb7");
	...
	ФормаЭлемента.Guid = NsgService.StringToGuid("3019cc90-c577-4b14-b138-441756f7b972");
	...
	Name = "ОбменДанными";
	Visible = true;
	Guid = NsgService.StringToGuid("769300f6-0f9f-444f-b23f-6b0193dc06cf");
	DefaultSortingName = "";
