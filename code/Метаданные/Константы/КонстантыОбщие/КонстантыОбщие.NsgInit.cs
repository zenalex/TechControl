...
namespace TechControl.Метаданные.Константы
{
    
    [NsgTypeName("NsgDataDictionary", Guid = "533c190d-ff27-4aa9-a141-4fe393888e31")]
    public partial class КонстантыОбщие : NsgSoft.DataObjects.NsgDataDictionary
    {
        #region Данные
        ...
        /// </summary>
        protected КонстантыОбщие(NsgObject obj)
            : base(obj)
        {
        }
        ...
        public static КонстантыОбщие Новый()
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("533c190d-ff27-4aa9-a141-4fe393888e31"));
            if (obj == null)
                obj = new КонстантыОбщие();
            return obj as КонстантыОбщие;
        }
	...
	Идентификатор.Guid = NsgService.StringToGuid("6204745f-42ea-486e-8100-beab9726578e");
	...
	Автоинкремент.Guid = NsgService.StringToGuid("c3fcbe72-7dc5-4ad6-8ae5-9f6bcfb48fda");
	...
	ЭтоГруппа.GroupName = "";
	ЭтоГруппа.Guid = NsgService.StringToGuid("3d9373b4-94cd-4769-a6a2-dce7f4596068");
	...
	ИдентификаторРодителя.Guid = NsgService.StringToGuid("131042b0-3301-40e9-98f4-c9d3719cffdf");
	...
	Уровень.GroupName = "";
	Уровень.Guid = NsgService.StringToGuid("95aa9ad0-86d0-45d3-9b66-6c9e071b5ff2");
	...
	ПрефиксКода.Guid = NsgService.StringToGuid("cdbae35a-258b-4a55-9ee1-b823e8ea8af7");
	...
	НомерКода.GroupName = "";
	НомерКода.Guid = NsgService.StringToGuid("85ff8780-d9fe-4c29-9ffd-29ca4cf14c82");
	...
	Код.GroupName = "";
	Код.Guid = NsgService.StringToGuid("261eae7d-a7a6-4652-b184-c0207a5bcd6b");
	...
	Наименование.Guid = NsgService.StringToGuid("2678109e-f09e-48b0-8095-88466194387a");
	...
	СостояниеДокумента.Guid = NsgService.StringToGuid("f87213f7-3584-4bd3-8be6-d2e7c07e3391");
			...
			#region создание Константы.КонстантыОбщие ДляВсехПользователей
			{  
	...
	ДляВсехПользователей.RequisiteValues = new NsgSoft.DataObjects.NsgPropertyCollection(new System.String[]{"Наименование"},
		 new System.Object[]{"ДляВсехПользователей"});
	ДляВсехПользователей.Guid = NsgService.StringToGuid("96054a66-46c3-41a1-a1fb-cf46fce614d0");
	ДляВсехПользователей.ReferentGroup = "";
	ДляВсехПользователей.ReferentName = "";
	...
	ДляВсехПользователей.GroupName = "";
			...
			#endregion //создание Константы.КонстантыОбщие ДляВсехПользователей
	...
	Name = "КонстантыОбщие";
	Visible = true;
	Guid = NsgService.StringToGuid("533c190d-ff27-4aa9-a141-4fe393888e31");
	DefaultSortingName = "";
	...
	TableName = "_dic_KonstantyObschie";
	...
	GroupName = "Константы";
        ...
        public override NsgMultipleObjectDescriptor Descriptor
        {
            get
            {
                if (descriptor == null)
                {
                    ...
                    descriptor.Name = "КонстантыОбщие";
                    descriptor.GroupName = "Константы";
                }
                return descriptor;
            }
            set
        ...
        {
            return "Константы.КонстантыОбщие";
        }
        ...
        public КонстантыОбщие Родитель
        {
            get
            {
                return base.Parent as КонстантыОбщие;
            }
            set
            {
                base.Parent = value;
        ...
        [NsgView(NsgViewTypes.DesignTime)]
        [NsgTypeName("NsgDataDictionary")]
        public static КонстантыОбщие ДляВсехПользователей
        {
            get
            {
                return (КонстантыОбщие)getPredefined(NsgService.StringToGuid("533c190d-ff27-4aa9-a141-4fe393888e31"), NsgService.StringToGuid("96054a66-46c3-41a1-a1fb-cf46fce614d0"));
            }
        }
        ...
        private КонстантыОбщие[] convertArray(NsgMultipleObject[] array)
        {
            КонстантыОбщие[] res = new КонстантыОбщие[array.Length];
            array.CopyTo(res, 0);
            return res;
        }
        ...
        public new virtual КонстантыОбщие[] FindAll(NsgCompare compare)
        {
        ...
        /// <returns>Список найденных объектов.</returns>
        public new virtual КонстантыОбщие[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, NsgCompare compare)
        {
        ...
        /// <returns>Список найденных объектов.</returns>
        public new virtual КонстантыОбщие[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, string inName, object inValue)
        {
        ...
        /// <param name="inValue">Значение для поиска. Условие поиска - полное совпадение.</param>
        /// <returns>Список найденных объектов.</returns>
        public new virtual КонстантыОбщие[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, NsgDataFixedFields inName,
            object inValue)
        {
            return convertArray(base.FindAll(ref count, row_start, sorting, inName, inValue));
        }
        ...
        public override NsgObject CloneObject
        {
            get
            {
                return new КонстантыОбщие(this as NsgObject);
            }
        }
        ...
        public new class ColumnDescriptor : NsgSoft.Forms.NsgColumnDescriptor
        {
            public ColumnDescriptor()
                : base()
            {
                base.NSGType = typeof(КонстантыОбщие);
            }
			...
			public new КонстантыОбщие Value
            {
                get
                {
                    return (КонстантыОбщие)base.Value;
                }
                set
                {
                    base.Value = value;
