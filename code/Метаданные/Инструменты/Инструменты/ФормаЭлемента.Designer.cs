...

{
    ...
    public partial class ИнструментыФормаЭлемента:NsgSoft.Forms.NsgMultipleObjectElementForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.Родитель = new TechControl.Метаданные.Инструменты.Инструменты.ColumnDescriptor();
            ...
            this.Comment.FullName = "Инструменты.Инструменты.Идентификатор";
            ...
            this.nsgVisualMultipleObject.FullName = "Инструменты.Инструменты";
            // 
            // Идентификатор
            // 
            ...
            this.Родитель.NSGType = typeof(TechControl.Метаданные.Инструменты.Инструменты);
            this.Родитель.PropertyType = typeof(TechControl.Метаданные.Инструменты.Инструменты);
            ...
            this.nsgInput1.Location = new System.Drawing.Point(106, 30);
            ...
            this.nsgInput2.Location = new System.Drawing.Point(427, 30);
            ...
            this.nsgInput2.Size = new System.Drawing.Size(88, 20);
