...
namespace TechControl.Метаданные._SystemTables
{
    ...
    [NsgTypeName("NsgDataTable", Guid = "c7a869ab-94fc-4689-9701-6b3bf5089ebf")]
    public partial class ИнструментыУчетИнструментовНакопления : NsgSoft.DataObjects.NsgDataTable
    {
        #region Данные
        ...
        /// Создание объекта
        /// </summary>
        protected ИнструментыУчетИнструментовНакопления()
            : base()
        {
        }
        ...
        /// </summary>
        protected ИнструментыУчетИнструментовНакопления(NsgObject obj)
            : base(obj)
        {
        }
        ...
        public static ИнструментыУчетИнструментовНакопления Новый()
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("c7a869ab-94fc-4689-9701-6b3bf5089ebf"));
            if (obj == null)
                obj = new ИнструментыУчетИнструментовНакопления();
            return obj as ИнструментыУчетИнструментовНакопления;
        }
	...
	Автоинкремент.Guid = NsgService.StringToGuid("38376a00-73b0-4f33-92fd-6af23f5dfc87");
	...
	Name = "ИнструментыУчетИнструментовНакопления";
	Visible = true;
	Guid = NsgService.StringToGuid("c7a869ab-94fc-4689-9701-6b3bf5089ebf");
	DefaultSortingName = "";
	...
	TableName = "_tab_InstrumentyUchetIns1";
	Presentation = new NsgSoft.DataObjects.NsgLanguageString(new System.String[]{"(Default)"},
		 new System.Object[]{""});
	Description = "Инструменты учет инструментов накопления";
	...
	GroupName = "_SystemTables";
        ...
        {
            return "_SystemTables.ИнструментыУчетИнструментовНакопления";
        }
        ...
        /// </summary>
        public new ИнструментыУчетИнструментовНакопления.Строка NewRow()
        {
            return newRow(null) as ИнструментыУчетИнструментовНакопления.Строка;
        }
        ...
        {
            if (row == null)
                row = new ИнструментыУчетИнструментовНакопления.Строка(this);
            return base.newRow(row) as ИнструментыУчетИнструментовНакопления.Строка;
        }

        /// <summary>
        /// Добавить новую строку в таблицу путем копирования переданной строки
        /// </summary>
        public ИнструментыУчетИнструментовНакопления.Строка NewRow(ИнструментыУчетИнструментовНакопления.Строка inRow)
        {
            ИнструментыУчетИнструментовНакопления.Строка row = inRow.Clone as ИнструментыУчетИнструментовНакопления.Строка;
            return base.newRow(row) as ИнструментыУчетИнструментовНакопления.Строка;
        }
        ...
        /// </summary>
        public new ИнструментыУчетИнструментовНакопления.Строка GetRow(int rowNumber)
        {
            return base.GetRow(rowNumber) as ИнструментыУчетИнструментовНакопления.Строка;
        }

        /// <summary>
        /// Возвращает новую строку таблицы, но в саму таблицу ее не включает (эталонная строка)
        /// </summary>
        public new ИнструментыУчетИнструментовНакопления.Строка GetEtalonRow()
        {
            ИнструментыУчетИнструментовНакопления.Строка row = new ИнструментыУчетИнструментовНакопления.Строка(this);
            row.MetaData = MetaData;
            return row;
        }

        private ИнструментыУчетИнструментовНакопления.Строка[] convertRowsArray(NsgDataTableRow[] array)
        {
            ИнструментыУчетИнструментовНакопления.Строка[] res = new ИнструментыУчетИнструментовНакопления.Строка[array.Length];
            array.CopyTo(res, 0);
            return res;
        }
        ...
        public new ИнструментыУчетИнструментовНакопления.Строка FindRowByTag(object Tag)
        {
            return base.FindRowByTag(Tag) as ИнструментыУчетИнструментовНакопления.Строка;
        }
        ...
        /// <param name="compare">Критерии поиска.</param>
        /// <returns>Найденные строки.</returns>
        public new ИнструментыУчетИнструментовНакопления.Строка[] FindRowsByTag(object Tag)
        {
        ...
        /// <param name="compare">Критерии поиска.</param>
        /// <returns>Найденные строки.</returns>
        public new ИнструментыУчетИнструментовНакопления.Строка FindRow(NsgCompare compare)
        {
            return base.FindRow(compare) as ИнструментыУчетИнструментовНакопления.Строка;
        }
        ...
        /// <returns>Найденные строки.</returns>
        public new ИнструментыУчетИнструментовНакопления.Строка FindRow(string inName, object inValue)
        {
            return base.FindRow(inName, inValue) as ИнструментыУчетИнструментовНакопления.Строка;
        }
        ...
        /// <param name="inValue">Значение поля.</param>
        /// <returns>Найденные строки.</returns>
        public new ИнструментыУчетИнструментовНакопления.Строка FindRow(NsgDataFixedFields inName, object inValue)
        {
            return base.FindRow(inName, inValue) as ИнструментыУчетИнструментовНакопления.Строка;
        }
        ...
        /// <param name="compare">Критерии поиска.</param>
        /// <returns>Найденные строки.</returns>
        public new ИнструментыУчетИнструментовНакопления.Строка[] FindRows(NsgCompare compare)
        {
        ...
        /// <param name="inValue">Значение поля.</param>
        /// <returns>Найденные строки.</returns>
        public new ИнструментыУчетИнструментовНакопления.Строка[] FindRows(string inName, object inValue)
        {
        ...
        /// <param name="inValue">Значение поля.</param>
        /// <returns>Найденные строки.</returns>
        public new ИнструментыУчетИнструментовНакопления.Строка[] FindRows(NsgDataFixedFields inName, object inValue)
        {
            return convertRowsArray(base.FindRows(inName, inValue));
        }
        ...
        /// </summary>
        public  NsgVirtualCursor<ИнструментыУчетИнструментовНакопления> GetNewVirtualCursor()
        {
            return base.GetNewVirtualCursor<ИнструментыУчетИнструментовНакопления>();
        }

        /// <summary>
        /// Получить все строки таблицы с учетом наложенного фильтра. Для получения всех сьтрок без учета фильтра используется свойство AllRows
        /// </summary>
        public new ИнструментыУчетИнструментовНакопления.Строка[] Rows
        {
            get
            {
        ...
        /// </summary>
        public new ИнструментыУчетИнструментовНакопления.Строка[] AllRows
        {
            get
            {
        ...
        /// <returns>Найденные строки.</returns>
        public new ИнструментыУчетИнструментовНакопления.Строка GetRow(Guid inID)
        {
            return base.GetRow(inID) as ИнструментыУчетИнструментовНакопления.Строка;
        }
        #endregion
        ...
        private ИнструментыУчетИнструментовНакопления[] convertArray(NsgMultipleObject[] array)
        {
            ИнструментыУчетИнструментовНакопления[] res = new ИнструментыУчетИнструментовНакопления[array.Length];
            array.CopyTo(res, 0);
            return res;
        }
        ...
        public new virtual ИнструментыУчетИнструментовНакопления[] FindAll(NsgCompare compare)
        {
        ...
        /// <returns>Список найденных объектов.</returns>
        public new virtual ИнструментыУчетИнструментовНакопления[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, NsgCompare compare)
        {
        ...
        /// <returns>Список найденных объектов.</returns>
        public new virtual ИнструментыУчетИнструментовНакопления[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, string inName, object inValue)
        {
        ...
        /// <param name="inValue">Значение для поиска. Условие поиска - полное совпадение.</param>
        /// <returns>Список найденных объектов.</returns>
        public new virtual ИнструментыУчетИнструментовНакопления[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, NsgDataFixedFields inName,
            object inValue)
        {
            return convertArray(base.FindAll(ref count, row_start, sorting, inName, inValue));
        }
        ...
        public override NsgObject CloneObject
        {
            get
            {
                return new ИнструментыУчетИнструментовНакопления(this as NsgObject);
            }
        }
        ...
        public new class ColumnDescriptor : NsgSoft.Forms.NsgColumnDescriptor
        {
            public ColumnDescriptor()
                : base()
            {
                base.NSGType = typeof(ИнструментыУчетИнструментовНакопления);
            }
			...
			public new ИнструментыУчетИнструментовНакопления Value
            {
                get
                {
                    return (ИнструментыУчетИнструментовНакопления)base.Value;
                }
                set
                {
                    base.Value = value;
