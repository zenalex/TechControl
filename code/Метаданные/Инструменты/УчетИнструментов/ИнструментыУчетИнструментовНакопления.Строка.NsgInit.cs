...
{
    public partial class ИнструментыУчетИнструментовНакопления
{
    [NsgTypeName("NsgDataTableRow", Guid = "c7a869ab-94fc-4689-9701-6b3bf5089ebf")]
    public partial class Строка : NsgSoft.DataObjects.NsgDataTableRow
    {
        ...
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("c7a869ab-94fc-4689-9701-6b3bf5089ebf"));
            if (obj == null)
                obj = new Строка();
        ...
        public override NsgMultipleObjectDescriptor Descriptor
        {
            get
            {
                if (descriptor == null)
                {
                    ...
                    descriptor.Name = "ИнструментыУчетИнструментовНакопления";
