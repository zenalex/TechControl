...
namespace TechControl.Метаданные.ПечатныеФормыДокументов
{
    ...
    [NsgTypeName("NsgReportObject", Guid = "fa407f4b-e571-4f59-86d1-47889dd77285")]
    public partial class ПФЗаявкаПоставщику : NsgSoft.DataObjects.NsgReportObject
    {
        #region Данные
        ...
        /// </summary>
        protected ПФЗаявкаПоставщику(NsgObject obj)
            : base(obj)
        {
        }
        ...
        public static ПФЗаявкаПоставщику Новый()
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("fa407f4b-e571-4f59-86d1-47889dd77285"));
            if (obj == null)
                obj = new ПФЗаявкаПоставщику();
            return obj as ПФЗаявкаПоставщику;
        }
	...
	Идентификатор.Guid = NsgService.StringToGuid("72c1ff8b-cab1-4b4e-838d-a399650b3251");
	...
	Автоинкремент.Guid = NsgService.StringToGuid("173f00e6-8025-49c1-98c7-3a403c4e510a");
			...
			#region создание TechControl.Метаданные.ПечатныеФормыДокументов.ПФЗаявкаПоставщикуФорма Форма
			{  
	...
	Форма.FormClassName = "TechControl.Метаданные.ПечатныеФормыДокументов.ПФЗаявкаПоставщикуФорма";
	...
	Форма.GroupName = "";
	Форма.Guid = NsgService.StringToGuid("8a3cd159-3c3d-4fca-a928-b843bda94236");
	
				if (!ObjectList.Contains("Форма"))
                    ObjectList.Add(Форма);
			}
			#endregion //создание TechControl.Метаданные.ПечатныеФормыДокументов.ПФЗаявкаПоставщикуФорма Форма
			

			#region заполнение полей класса
				//NsgReportObject
	IsLoadedFromDll = true;
	Name = "ПФЗаявкаПоставщику";
	Visible = true;
	Guid = NsgService.StringToGuid("fa407f4b-e571-4f59-86d1-47889dd77285");
	DefaultSortingName = "";
	...
	TableName = "_report_PFZajavkaPostavs";
	Presentation = new NsgSoft.DataObjects.NsgLanguageString(new System.String[]{"(Default)"},
		 new System.Object[]{""});
	Description = "ПФ Заявка поставщику";
	...
	GroupName = "ПечатныеФормыДокументов";
        ...
        public override NsgMultipleObjectDescriptor Descriptor
        {
            get
            {
                if (descriptor == null)
                {
                    ...
                    descriptor.Name = "ПФЗаявкаПоставщику";
        ...
        {
            return "ПечатныеФормыДокументов.ПФЗаявкаПоставщику";
        }
        ...
        private ПФЗаявкаПоставщику[] convertArray(NsgMultipleObject[] array)
        {
            ПФЗаявкаПоставщику[] res = new ПФЗаявкаПоставщику[array.Length];
            array.CopyTo(res, 0);
            return res;
        }
        ...
        public new virtual ПФЗаявкаПоставщику[] FindAll(NsgCompare compare)
        {
        ...
        /// <returns>Список найденных объектов.</returns>
        public new virtual ПФЗаявкаПоставщику[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, NsgCompare compare)
        {
        ...
        /// <returns>Список найденных объектов.</returns>
        public new virtual ПФЗаявкаПоставщику[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, string inName, object inValue)
        {
        ...
        /// <param name="inValue">Значение для поиска. Условие поиска - полное совпадение.</param>
        /// <returns>Список найденных объектов.</returns>
        public new virtual ПФЗаявкаПоставщику[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, NsgDataFixedFields inName,
            object inValue)
        {
            return convertArray(base.FindAll(ref count, row_start, sorting, inName, inValue));
        }
        ...
        public override NsgObject CloneObject
        {
            get
            {
                return new ПФЗаявкаПоставщику(this as NsgObject);
            }
        }
        ...
        public new class ColumnDescriptor : NsgSoft.Forms.NsgColumnDescriptor
        {
            public ColumnDescriptor()
                : base()
            {
                base.NSGType = typeof(ПФЗаявкаПоставщику);
            }
			...
			public new ПФЗаявкаПоставщику Value
            {
                get
                {
                    return (ПФЗаявкаПоставщику)base.Value;
                }
                set
                {
                    base.Value = value;
