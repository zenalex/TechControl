...
namespace TechControl.Метаданные.ПечатныеФормыДокументов
{
    ...
    [NsgTypeName("NsgReportObject", Guid = "d7876d16-f741-444f-8825-30b34d6d0823")]
    public partial class ПФЭСМ : NsgSoft.DataObjects.NsgReportObject
    {
        #region Данные
        ...
        public static ПФЭСМ Новый()
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("d7876d16-f741-444f-8825-30b34d6d0823"));
            if (obj == null)
                obj = new ПФЭСМ();
            return obj as ПФЭСМ;
        }
	...
	Идентификатор.Guid = NsgService.StringToGuid("b54c33fd-6a93-412c-a19d-a42551f1c236");
	...
	Автоинкремент.Guid = NsgService.StringToGuid("7697b3b5-2927-4be8-9c1a-e4c5ea6676e8");
			...
			#region создание TechControl.Метаданные.ПечатныеФормыДокументов.ПФЭСМФорма Форма
			{  
	...
	Форма.FormClassName = "TechControl.Метаданные.ПечатныеФормыДокументов.ПФЭСМФорма";
	...
	Форма.GroupName = "";
	Форма.Guid = NsgService.StringToGuid("88b2b136-d723-45db-85c5-cda67d06e4a5");
	
				if (!ObjectList.Contains("Форма"))
                    ObjectList.Add(Форма);
			}
			#endregion //создание TechControl.Метаданные.ПечатныеФормыДокументов.ПФЭСМФорма Форма
	...
	Name = "ПФЭСМ";
	Visible = true;
	Guid = NsgService.StringToGuid("d7876d16-f741-444f-8825-30b34d6d0823");
	DefaultSortingName = "";
	...
	GroupName = "ПечатныеФормыДокументов";
        ...
        {
            return "ПечатныеФормыДокументов.ПФЭСМ";
        }
        ...
        private ПФЭСМ[] convertArray(NsgMultipleObject[] array)
        {
            ПФЭСМ[] res = new ПФЭСМ[array.Length];
            array.CopyTo(res, 0);
            return res;
        }
        ...
        public new virtual ПФЭСМ[] FindAll(NsgCompare compare)
        {
        ...
        /// <returns>Список найденных объектов.</returns>
        public new virtual ПФЭСМ[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, NsgCompare compare)
        {
        ...
        /// <returns>Список найденных объектов.</returns>
        public new virtual ПФЭСМ[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, string inName, object inValue)
        {
        ...
        /// <param name="inValue">Значение для поиска. Условие поиска - полное совпадение.</param>
        /// <returns>Список найденных объектов.</returns>
        public new virtual ПФЭСМ[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, NsgDataFixedFields inName,
            object inValue)
        {
            return convertArray(base.FindAll(ref count, row_start, sorting, inName, inValue));
        }
        ...
        public override NsgObject CloneObject
        {
            get
            {
                return new ПФЭСМ(this as NsgObject);
            }
        }
        ...
        public new class ColumnDescriptor : NsgSoft.Forms.NsgColumnDescriptor
        {
			...
			public new ПФЭСМ Value
            {
                get
                {
                    return (ПФЭСМ)base.Value;
                }
                set
                {
                    base.Value = value;
