...
namespace TechControl.Метаданные.ПечатныеФормыДокументов
{
    ...
    [NsgTypeName("NsgReportObject", Guid = "4e707588-f4d2-422e-a6f1-35a671e0b9e5")]
    public partial class ПФОтработанныеМесяцы : NsgSoft.DataObjects.NsgReportObject
    {
        #region Данные
        ...
        /// Создание объекта
        /// </summary>
        protected ПФОтработанныеМесяцы()
            : base()
        {
        }
        ...
        /// </summary>
        protected ПФОтработанныеМесяцы(NsgObject obj)
            : base(obj)
        {
        }
        ...
        public static ПФОтработанныеМесяцы Новый()
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("4e707588-f4d2-422e-a6f1-35a671e0b9e5"));
            if (obj == null)
                obj = new ПФОтработанныеМесяцы();
            return obj as ПФОтработанныеМесяцы;
        }
	...
	Идентификатор.Guid = NsgService.StringToGuid("a5ea0f5d-18ba-478d-b85e-4309f27a8b4e");
	...
	Автоинкремент.Guid = NsgService.StringToGuid("93dff47e-3050-4c88-9881-d878d902c761");
			...
			#region создание TechControl.Метаданные.ПечатныеФормыДокументов.ПФОтработанныеМесяцыФорма Форма
			{  
	...
	Форма.FormClassName = "TechControl.Метаданные.ПечатныеФормыДокументов.ПФОтработанныеМесяцыФорма";
	...
	Форма.GroupName = "";
	Форма.Guid = NsgService.StringToGuid("92cd6675-1cc4-4056-a8b3-671278af7125");
	
				if (!ObjectList.Contains("Форма"))
                    ObjectList.Add(Форма);
			}
			#endregion //создание TechControl.Метаданные.ПечатныеФормыДокументов.ПФОтработанныеМесяцыФорма Форма
			

			#region заполнение полей класса
				//NsgReportObject
	IsLoadedFromDll = true;
	Name = "ПФОтработанныеМесяцы";
	Visible = true;
	Guid = NsgService.StringToGuid("4e707588-f4d2-422e-a6f1-35a671e0b9e5");
	DefaultSortingName = "";
	...
	TableName = "_report_PFOtrabotannyeMe";
	Presentation = new NsgSoft.DataObjects.NsgLanguageString(new System.String[]{"(Default)"},
		 new System.Object[]{""});
	Description = "ПФОтработанныеМесяцы";
	...
	GroupName = "ПечатныеФормыДокументов";
        ...
        public override NsgMultipleObjectDescriptor Descriptor
        {
            get
            {
                if (descriptor == null)
                {
                    ...
                    descriptor.Name = "ПФОтработанныеМесяцы";
        ...
        {
            return "ПечатныеФормыДокументов.ПФОтработанныеМесяцы";
        }
        ...
        private ПФОтработанныеМесяцы[] convertArray(NsgMultipleObject[] array)
        {
            ПФОтработанныеМесяцы[] res = new ПФОтработанныеМесяцы[array.Length];
            array.CopyTo(res, 0);
            return res;
        }
        ...
        public new virtual ПФОтработанныеМесяцы[] FindAll(NsgCompare compare)
        {
        ...
        /// <returns>Список найденных объектов.</returns>
        public new virtual ПФОтработанныеМесяцы[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, NsgCompare compare)
        {
        ...
        /// <returns>Список найденных объектов.</returns>
        public new virtual ПФОтработанныеМесяцы[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, string inName, object inValue)
        {
        ...
        /// <param name="inValue">Значение для поиска. Условие поиска - полное совпадение.</param>
        /// <returns>Список найденных объектов.</returns>
        public new virtual ПФОтработанныеМесяцы[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, NsgDataFixedFields inName,
            object inValue)
        {
            return convertArray(base.FindAll(ref count, row_start, sorting, inName, inValue));
        }
        ...
        public override NsgObject CloneObject
        {
            get
            {
                return new ПФОтработанныеМесяцы(this as NsgObject);
            }
        }
        ...
        public new class ColumnDescriptor : NsgSoft.Forms.NsgColumnDescriptor
        {
            public ColumnDescriptor()
                : base()
            {
                base.NSGType = typeof(ПФОтработанныеМесяцы);
            }
			...
			public new ПФОтработанныеМесяцы Value
            {
                get
                {
                    return (ПФОтработанныеМесяцы)base.Value;
                }
                set
                {
                    base.Value = value;
