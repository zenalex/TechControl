...
namespace TechControl.Метаданные.Мониторинг
{
	...
	РежимРаботы.Guid = NsgService.StringToGuid("a14d979e-9ae6-4454-9fae-00ed6f631aae");
	...
	Описание.GroupName = "";
	Описание.Guid = NsgService.StringToGuid("f2b17c66-24d6-4427-aed0-a1e0237d8712");
			...
			#region создание System.Boolean СтаршийПоОбъекту
			{  
                NsgDataBoolean СтаршийПоОбъекту = null;
				if (ObjectList.Contains("СтаршийПоОбъекту"))
                    СтаршийПоОбъекту = ObjectList["СтаршийПоОбъекту"] as NsgDataBoolean;
                else
                    СтаршийПоОбъекту = new NsgDataBoolean();
	//NsgDataBoolean
	СтаршийПоОбъекту.IsLoadedFromDll = true;
	СтаршийПоОбъекту.DefaultValue = false;
	СтаршийПоОбъекту.TrueString = new NsgSoft.DataObjects.NsgLanguageString(new System.String[]{"(Default)"},
		 new System.Object[]{""});
	СтаршийПоОбъекту.FalseString = new NsgSoft.DataObjects.NsgLanguageString(new System.String[]{"(Default)"},
		 new System.Object[]{""});
	СтаршийПоОбъекту.StringFormat = "";
	СтаршийПоОбъекту.SubType = NsgSoft.Common.NsgRekvisitSubType.Common;
	СтаршийПоОбъекту.IncludeInPredefined = false;
	СтаршийПоОбъекту.PeriodicType = NsgSoft.Database.PeriodicTypes.None;
	СтаршийПоОбъекту.Required = false;
	СтаршийПоОбъекту.EmptyValue = "";
	СтаршийПоОбъекту.NullAllow = false;
	СтаршийПоОбъекту.IndexType = NsgSoft.Database.NsgRekvisitIndexType.None;
	СтаршийПоОбъекту.FieldName = "StarshiijPoObektu";
	СтаршийПоОбъекту.SaveInDatabase = true;
	СтаршийПоОбъекту.InformMetaDataOnValueChanged = false;
	СтаршийПоОбъекту.Visible = true;
	СтаршийПоОбъекту.Name = "СтаршийПоОбъекту";
	СтаршийПоОбъекту.Presentation = new NsgSoft.DataObjects.NsgLanguageString(new System.String[]{"(Default)"},
		 new System.Object[]{""});
	СтаршийПоОбъекту.Description = "Старший по объекту";
	СтаршийПоОбъекту.EditorVisible = NsgSoft.DataObjects.NsgDataObjectEditorAccess.Full;
	СтаршийПоОбъекту.GroupName = "";
	СтаршийПоОбъекту.Guid = NsgService.StringToGuid("fa222119-409a-4ed3-b113-3c36790feb69");
	
				if (!ObjectList.Contains("СтаршийПоОбъекту"))
                    ObjectList.Add(СтаршийПоОбъекту);
			}
			#endregion //создание System.Boolean СтаршийПоОбъекту
	...
	GroupName = "Мониторинг";
        ...
        public new partial class Names// :NsgSoft.DataObjects.NsgDataDictionary.Names
        {
            ...
            /// Старший по объекту
            /// </summary>
            public static String СтаршийПоОбъекту
            {
                get
                {
                    return "СтаршийПоОбъекту";
                }
            }
        ...
        public System.Boolean СтаршийПоОбъекту
        {
            get
            {
				 NsgDataBoolean __СтаршийПоОбъекту = ObjectList["СтаршийПоОбъекту"] as NsgDataBoolean;
                 return (System.Boolean)__СтаршийПоОбъекту.Value;
            }
            set
            {
                NsgDataBoolean __СтаршийПоОбъекту = ObjectList["СтаршийПоОбъекту"] as NsgDataBoolean;
                __СтаршийПоОбъекту.Value = value;
            }
        }
