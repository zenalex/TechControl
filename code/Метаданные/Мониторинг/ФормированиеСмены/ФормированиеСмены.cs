...
namespace TechControl.Метаданные.Мониторинг
{
    ...
    public partial class ФормированиеСмены
    {
        ...
        public void ЗаполнитьИтоговуюТаблицу() 
        {
            ...
            var датаНачалаСмены = ДатаДокумента;

            Таблица.DeleteAll();

            var cmpТехн = new NsgCompare();
            cmpТехн.Add(МониторингФиксацияИсторииДвижения.Names.Объект, Объект);
            cmpТехн.Add(МониторингФиксацияИсторииДвижения.Names.Смена, this);
            cmpТехн.Add(МониторингФиксацияИсторииДвижения.Names.Дата, датаНачалаСмены, NsgComparison.GreaterOrEqual);
            cmpТехн.Add(МониторингФиксацияИсторииДвижения.Names.Дата, ДатаОкончанияСмены, NsgComparison.LessOrEqual);
                ...
                foreach (var сотрудник in сотрудникиНаТехнике[техника])
                {
                    ...
                    for (int i = 0; i < движенияПоТехнике.Length; i += 2)
                    {
                        ...
                        if (конец != null)
                        {
                            ...
                            row.ВремяОкончанияСменыТехники = конец.Дата;
                            row.СтатусТехники = СтатусТехники.НеРаботает;
                        }
                        row.Post();
                    }
                }
            ...
            cmpСотр.Add(МониторингФиксацияИсторииСотрудниковДвижения.Names.Смена, this);
