...

{
    ...
    public partial class ФормированиеСменыФормаЭлемента:NsgSoft.Forms.NsgMultipleObjectElementForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.Идентификатор_т = new NsgSoft.Forms.NsgColumnDescriptor.Guid();
            this.Автоинкремент_т = new NsgSoft.Forms.NsgColumnDescriptor.Int64();
            this.Владелец_т = new NsgSoft.Forms.NsgColumnDescriptor.MultipleObject();
            this.НомерСтроки_т = new NsgSoft.Forms.NsgColumnDescriptor.Int64();
            this.Техника_т = new TechControl.Метаданные.Мониторинг.Техника.ColumnDescriptor();
            this.Сотрудник_т = new TechControl.Метаданные.Мониторинг.ФизЛица.ColumnDescriptor();
            this.СтатусТехники_т = new TechControl.Метаданные.Мониторинг.СтатусТехники.ColumnDescriptor();
            this.Время_т = new NsgSoft.Forms.NsgColumnDescriptor.DateTime();
            this.Тариф_т = new TechControl.Метаданные.Мониторинг.Тарифы.ColumnDescriptor();
            this.НомерСмены_т = new NsgSoft.Forms.NsgColumnDescriptor.Int64();
            this.Длительность_т = new NsgSoft.Forms.NsgColumnDescriptor.Decimal();
            ...
            this.ВремяОкончанияСменыТехники = new NsgSoft.Forms.NsgColumnDescriptor.DateTime();
            ...
            this.Сотрудник_vmoТаблицаПерсонал = new TechControl.Метаданные.Мониторинг.ФизЛица.ColumnDescriptor();
            ...
            this.КодГруппы = new NsgSoft.Forms.NsgColumnDescriptor.String();
            this.ВремяУхода = new NsgSoft.Forms.NsgColumnDescriptor.DateTime();
            ...
            this.ИтогоЧасовТехника = new NsgSoft.Forms.NsgColumnDescriptor.Decimal();
            this.ИтогоЧасовПерсонал = new NsgSoft.Forms.NsgColumnDescriptor.Decimal();
            this.КоличествоТехники = new NsgSoft.Forms.NsgColumnDescriptor.Int64();
            this.ВсегоТехникиВРаботе = new NsgSoft.Forms.NsgColumnDescriptor.Int64();
            this.ВсегоТехникиНеВРаботе = new NsgSoft.Forms.NsgColumnDescriptor.Int64();
            this.ВсегоТехникиСломано = new NsgSoft.Forms.NsgColumnDescriptor.Int64();
            this.ВсегоТехникиВРемонте = new NsgSoft.Forms.NsgColumnDescriptor.Int64();
            this.ПровереноАвтоматически = new NsgSoft.Forms.NsgColumnDescriptor.Boolean();
            ...
            this.nsgVisualMultipleObject.Columns.Collection.Add(this.ИтогоЧасовТехника);
            this.nsgVisualMultipleObject.Columns.Collection.Add(this.ИтогоЧасовПерсонал);
            this.nsgVisualMultipleObject.Columns.Collection.Add(this.КоличествоТехники);
            this.nsgVisualMultipleObject.Columns.Collection.Add(this.ВсегоТехникиВРаботе);
            this.nsgVisualMultipleObject.Columns.Collection.Add(this.ВсегоТехникиНеВРаботе);
            this.nsgVisualMultipleObject.Columns.Collection.Add(this.ВсегоТехникиСломано);
            this.nsgVisualMultipleObject.Columns.Collection.Add(this.ВсегоТехникиВРемонте);
            this.nsgVisualMultipleObject.Columns.Collection.Add(this.ПровереноАвтоматически);
        ...
        "Visible"};
            ...
            this.vmoТаблица.Columns.Collection.Add(this.Идентификатор_т);
            this.vmoТаблица.Columns.Collection.Add(this.Автоинкремент_т);
            this.vmoТаблица.Columns.Collection.Add(this.Владелец_т);
            this.vmoТаблица.Columns.Collection.Add(this.НомерСтроки_т);
            this.vmoТаблица.Columns.Collection.Add(this.Техника_т);
            this.vmoТаблица.Columns.Collection.Add(this.Сотрудник_т);
            this.vmoТаблица.Columns.Collection.Add(this.СтатусТехники_т);
            this.vmoТаблица.Columns.Collection.Add(this.Время_т);
            this.vmoТаблица.Columns.Collection.Add(this.Тариф_т);
            this.vmoТаблица.Columns.Collection.Add(this.НомерСмены_т);
            this.vmoТаблица.Columns.Collection.Add(this.Длительность_т);
            ...
            this.vmoТаблица.Columns.Collection.Add(this.ВремяОкончанияСменыТехники);
            this.vmoТаблица.MasterComponent = this.nsgVisualMultipleObject;
            this.vmoТаблица.Binding = nsgMasterDetailBinding1;
            // 
            // Идентификатор_т
            // 
            this.Идентификатор_т.AutoGenerated = true;
            this.Идентификатор_т.Caption = "Идентификатор";
            this.Идентификатор_т.Creator = typeof(NsgSoft.Forms.NsgMultipleObjectElementForm);
            this.Идентификатор_т.Name = "Идентификатор";
            this.Идентификатор_т.NSGType = typeof(NsgSoft.DataObjects.NsgDataGuid);
            this.Идентификатор_т.PropertyType = typeof(System.Guid);
            this.Идентификатор_т.SearchCondition.OwnerComponent = this.Идентификатор_т;
            this.Идентификатор_т.SearchCondition.Parameters = new NsgSoft.DataObjects.NsgCompareParam[0];
            this.Идентификатор_т.Visible = false;
            // 
            // Автоинкремент_т
            // 
            this.Автоинкремент_т.AutoGenerated = true;
            this.Автоинкремент_т.CalcTotal = false;
            this.Автоинкремент_т.Caption = "Автоинкремент";
            this.Автоинкремент_т.Creator = typeof(NsgSoft.Forms.NsgMultipleObjectElementForm);
            this.Автоинкремент_т.Name = "Автоинкремент";
            this.Автоинкремент_т.NSGType = typeof(NsgSoft.DataObjects.NsgDataInteger);
            this.Автоинкремент_т.PropertyType = typeof(long);
            this.Автоинкремент_т.SearchCondition.OwnerComponent = this.Автоинкремент_т;
            this.Автоинкремент_т.SearchCondition.Parameters = new NsgSoft.DataObjects.NsgCompareParam[0];
            this.Автоинкремент_т.Visible = false;
            // 
            // Владелец_т
            // 
            this.Владелец_т.AutoGenerated = true;
            this.Владелец_т.Caption = "Владелец";
            this.Владелец_т.Creator = typeof(NsgSoft.Forms.NsgMultipleObjectElementForm);
            this.Владелец_т.Name = "Владелец";
            this.Владелец_т.NSGType = typeof(NsgSoft.DataObjects.NsgReferencedObject);
            this.Владелец_т.PropertyType = typeof(NsgSoft.DataObjects.NsgReferencedObject);
            this.Владелец_т.SearchCondition.OwnerComponent = this.Владелец_т;
            this.Владелец_т.SearchCondition.Parameters = new NsgSoft.DataObjects.NsgCompareParam[0];
            // 
            // НомерСтроки_т
            // 
            this.НомерСтроки_т.AutoGenerated = true;
            this.НомерСтроки_т.CalcTotal = false;
            this.НомерСтроки_т.Caption = "НомерСтроки";
            this.НомерСтроки_т.Creator = typeof(NsgSoft.Forms.NsgMultipleObjectElementForm);
            this.НомерСтроки_т.Name = "НомерСтроки";
            this.НомерСтроки_т.NSGType = typeof(NsgSoft.DataObjects.NsgDataInteger);
            this.НомерСтроки_т.PropertyType = typeof(long);
            this.НомерСтроки_т.SearchCondition.OwnerComponent = this.НомерСтроки_т;
            this.НомерСтроки_т.SearchCondition.Parameters = new NsgSoft.DataObjects.NsgCompareParam[0];
            this.НомерСтроки_т.Visible = false;
            // 
            // Техника_т
            // 
            this.Техника_т.AutoGenerated = true;
            this.Техника_т.Caption = "Техника";
            this.Техника_т.Creator = typeof(NsgSoft.Forms.NsgMultipleObjectElementForm);
            this.Техника_т.Name = "Техника";
            this.Техника_т.NSGType = typeof(TechControl.Метаданные.Мониторинг.Техника);
            this.Техника_т.PropertyType = typeof(TechControl.Метаданные.Мониторинг.Техника);
            this.Техника_т.SearchCondition.OwnerComponent = this.Техника_т;
            this.Техника_т.SearchCondition.Parameters = new NsgSoft.DataObjects.NsgCompareParam[0];
            // 
            // Сотрудник_т
            // 
            this.Сотрудник_т.AutoGenerated = true;
            this.Сотрудник_т.Caption = "Сотрудник";
            this.Сотрудник_т.Creator = typeof(NsgSoft.Forms.NsgMultipleObjectElementForm);
            ...
            // СтатусТехники_т
            // 
            this.СтатусТехники_т.AutoGenerated = true;
            this.СтатусТехники_т.Caption = "СтатусТехники";
            this.СтатусТехники_т.Creator = typeof(NsgSoft.Forms.NsgMultipleObjectElementForm);
            this.СтатусТехники_т.Name = "СтатусТехники";
            this.СтатусТехники_т.NSGType = typeof(TechControl.Метаданные.Мониторинг.СтатусТехники);
            this.СтатусТехники_т.PropertyType = typeof(TechControl.Метаданные.Мониторинг.СтатусТехники);
            this.СтатусТехники_т.SearchCondition.OwnerComponent = this.СтатусТехники_т;
            this.СтатусТехники_т.SearchCondition.Parameters = new NsgSoft.DataObjects.NsgCompareParam[0];
            // 
            // Время_т
            // 
            this.Время_т.AutoGenerated = true;
            this.Время_т.Caption = "Время";
            this.Время_т.Creator = typeof(NsgSoft.Forms.NsgMultipleObjectElementForm);
            this.Время_т.Name = "Время";
            this.Время_т.NSGType = typeof(NsgSoft.DataObjects.NsgDataDateTime);
            this.Время_т.PropertyType = typeof(System.DateTime);
            this.Время_т.SearchCondition.OwnerComponent = this.Время_т;
            this.Время_т.SearchCondition.Parameters = new NsgSoft.DataObjects.NsgCompareParam[0];
            // 
            // Тариф_т
            // 
            this.Тариф_т.AutoGenerated = true;
            this.Тариф_т.Caption = "Тариф";
            this.Тариф_т.Creator = typeof(NsgSoft.Forms.NsgMultipleObjectElementForm);
            this.Тариф_т.Name = "Тариф";
            this.Тариф_т.NSGType = typeof(TechControl.Метаданные.Мониторинг.Тарифы);
            this.Тариф_т.PropertyType = typeof(TechControl.Метаданные.Мониторинг.Тарифы);
            this.Тариф_т.SearchCondition.OwnerComponent = this.Тариф_т;
            this.Тариф_т.SearchCondition.Parameters = new NsgSoft.DataObjects.NsgCompareParam[0];
            // 
            // НомерСмены_т
            // 
            this.НомерСмены_т.AutoGenerated = true;
            this.НомерСмены_т.CalcTotal = false;
            this.НомерСмены_т.Caption = "НомерСмены";
            this.НомерСмены_т.Creator = typeof(NsgSoft.Forms.NsgMultipleObjectElementForm);
            this.НомерСмены_т.Name = "НомерСмены";
            this.НомерСмены_т.NSGType = typeof(NsgSoft.DataObjects.NsgDataInteger);
            this.НомерСмены_т.PropertyType = typeof(long);
            this.НомерСмены_т.SearchCondition.OwnerComponent = this.НомерСмены_т;
            this.НомерСмены_т.SearchCondition.Parameters = new NsgSoft.DataObjects.NsgCompareParam[0];
            // 
            // Длительность_т
            // 
            this.Длительность_т.AutoGenerated = true;
            this.Длительность_т.CalcTotal = false;
            this.Длительность_т.Caption = "Длительность";
            this.Длительность_т.Creator = typeof(NsgSoft.Forms.NsgMultipleObjectElementForm);
            this.Длительность_т.Name = "Длительность";
            this.Длительность_т.NSGType = typeof(NsgSoft.DataObjects.NsgDataFloat);
            this.Длительность_т.PropertyType = typeof(decimal);
            this.Длительность_т.SearchCondition.OwnerComponent = this.Длительность_т;
            this.Длительность_т.SearchCondition.Parameters = new NsgSoft.DataObjects.NsgCompareParam[0];
            // 
            // Должность_vmoТаблица
            // 
            this.Должность_vmoТаблица.AutoGenerated = true;
            this.Должность_vmoТаблица.Caption = "Должность";
            this.Должность_vmoТаблица.Creator = typeof(NsgSoft.Forms.NsgMultipleObjectElementForm);
            ...
            // 
            this.КодГруппы_vmoТаблица.AutoGenerated = true;
            this.КодГруппы_vmoТаблица.Caption = "КодГруппы";
            this.КодГруппы_vmoТаблица.Creator = typeof(NsgSoft.Forms.NsgMultipleObjectElementForm);
            ...
            // 
            // ВремяОкончанияСменыТехники
            // 
            this.ВремяОкончанияСменыТехники.AutoGenerated = true;
            this.ВремяОкончанияСменыТехники.Caption = "ВремяОкончанияСменыТехники";
            this.ВремяОкончанияСменыТехники.Creator = typeof(NsgSoft.Forms.NsgMultipleObjectElementForm);
            this.ВремяОкончанияСменыТехники.Name = "ВремяОкончанияСменыТехники";
            this.ВремяОкончанияСменыТехники.NSGType = typeof(NsgSoft.DataObjects.NsgDataDateTime);
            this.ВремяОкончанияСменыТехники.PropertyType = typeof(System.DateTime);
            this.ВремяОкончанияСменыТехники.SearchCondition.OwnerComponent = this.ВремяОкончанияСменыТехники;
            this.ВремяОкончанияСменыТехники.SearchCondition.Parameters = new NsgSoft.DataObjects.NsgCompareParam[0];
            // 
            // gridПерсонал
            // 
        ...
        "Visible"};
            ...
            this.gridПерсонал.Columns.Collection.Add(nsgIGridColumn16);
            this.gridПерсонал.Columns.Collection.Add(nsgIGridColumn17);
            this.gridПерсонал.Columns.Collection.Add(nsgIGridColumn18);
            ...
            this.vmoТаблицаПерсонал.Columns.Collection.Add(this.Должность);
            this.vmoТаблицаПерсонал.Columns.Collection.Add(this.КодГруппы);
            this.vmoТаблицаПерсонал.Columns.Collection.Add(this.ВремяУхода);
            ...
            this.Сотрудник_vmoТаблицаПерсонал.NSGType = typeof(TechControl.Метаданные.Мониторинг.ФизЛица);
            this.Сотрудник_vmoТаблицаПерсонал.PropertyType = typeof(TechControl.Метаданные.Мониторинг.ФизЛица);
            ...
            // КодГруппы
            // 
            this.КодГруппы.AutoGenerated = true;
            this.КодГруппы.Caption = "КодГруппы";
            this.КодГруппы.Creator = typeof(NsgSoft.Forms.NsgMultipleObjectElementForm);
            this.КодГруппы.Name = "КодГруппы";
            this.КодГруппы.NSGType = typeof(NsgSoft.DataObjects.NsgDataString);
            this.КодГруппы.PropertyType = typeof(string);
            this.КодГруппы.SearchCondition.OwnerComponent = this.КодГруппы;
            this.КодГруппы.SearchCondition.Parameters = new NsgSoft.DataObjects.NsgCompareParam[0];
            // 
            // ВремяУхода
            // 
            this.ВремяУхода.AutoGenerated = true;
            this.ВремяУхода.Caption = "ВремяУхода";
            this.ВремяУхода.Creator = typeof(NsgSoft.Forms.NsgMultipleObjectElementForm);
            this.ВремяУхода.Name = "ВремяУхода";
            this.ВремяУхода.NSGType = typeof(NsgSoft.DataObjects.NsgDataDateTime);
            this.ВремяУхода.PropertyType = typeof(System.DateTime);
            this.ВремяУхода.SearchCondition.OwnerComponent = this.ВремяУхода;
            this.ВремяУхода.SearchCondition.Parameters = new NsgSoft.DataObjects.NsgCompareParam[0];
            // 
            // nsgInput1
            // 
            ...
            // ИтогоЧасовТехника
            // 
            this.ИтогоЧасовТехника.AutoGenerated = true;
            this.ИтогоЧасовТехника.CalcTotal = false;
            this.ИтогоЧасовТехника.Caption = "ИтогоЧасовТехника";
            this.ИтогоЧасовТехника.Creator = typeof(NsgSoft.Forms.NsgMultipleObjectElementForm);
            this.ИтогоЧасовТехника.Name = "ИтогоЧасовТехника";
            this.ИтогоЧасовТехника.NSGType = typeof(NsgSoft.DataObjects.NsgDataFloat);
            this.ИтогоЧасовТехника.PropertyType = typeof(decimal);
            this.ИтогоЧасовТехника.SearchCondition.OwnerComponent = this.ИтогоЧасовТехника;
            this.ИтогоЧасовТехника.SearchCondition.Parameters = new NsgSoft.DataObjects.NsgCompareParam[0];
            // 
            // ИтогоЧасовПерсонал
            // 
            this.ИтогоЧасовПерсонал.AutoGenerated = true;
            this.ИтогоЧасовПерсонал.CalcTotal = false;
            this.ИтогоЧасовПерсонал.Caption = "ИтогоЧасовПерсонал";
            this.ИтогоЧасовПерсонал.Creator = typeof(NsgSoft.Forms.NsgMultipleObjectElementForm);
            this.ИтогоЧасовПерсонал.Name = "ИтогоЧасовПерсонал";
            this.ИтогоЧасовПерсонал.NSGType = typeof(NsgSoft.DataObjects.NsgDataFloat);
            this.ИтогоЧасовПерсонал.PropertyType = typeof(decimal);
            this.ИтогоЧасовПерсонал.SearchCondition.OwnerComponent = this.ИтогоЧасовПерсонал;
            this.ИтогоЧасовПерсонал.SearchCondition.Parameters = new NsgSoft.DataObjects.NsgCompareParam[0];
            // 
            // КоличествоТехники
            // 
            this.КоличествоТехники.AutoGenerated = true;
            this.КоличествоТехники.CalcTotal = false;
            this.КоличествоТехники.Caption = "КоличествоТехники";
            this.КоличествоТехники.Creator = typeof(NsgSoft.Forms.NsgMultipleObjectElementForm);
            this.КоличествоТехники.Name = "КоличествоТехники";
            this.КоличествоТехники.NSGType = typeof(NsgSoft.DataObjects.NsgDataInteger);
            this.КоличествоТехники.PropertyType = typeof(long);
            this.КоличествоТехники.SearchCondition.OwnerComponent = this.КоличествоТехники;
            this.КоличествоТехники.SearchCondition.Parameters = new NsgSoft.DataObjects.NsgCompareParam[0];
            // 
            // ВсегоТехникиВРаботе
            // 
            this.ВсегоТехникиВРаботе.AutoGenerated = true;
            this.ВсегоТехникиВРаботе.CalcTotal = false;
            this.ВсегоТехникиВРаботе.Caption = "ВсегоТехникиВРаботе";
            this.ВсегоТехникиВРаботе.Creator = typeof(NsgSoft.Forms.NsgMultipleObjectElementForm);
            this.ВсегоТехникиВРаботе.Name = "ВсегоТехникиВРаботе";
            this.ВсегоТехникиВРаботе.NSGType = typeof(NsgSoft.DataObjects.NsgDataInteger);
            this.ВсегоТехникиВРаботе.PropertyType = typeof(long);
            this.ВсегоТехникиВРаботе.SearchCondition.OwnerComponent = this.ВсегоТехникиВРаботе;
            this.ВсегоТехникиВРаботе.SearchCondition.Parameters = new NsgSoft.DataObjects.NsgCompareParam[0];
            // 
            // ВсегоТехникиНеВРаботе
            // 
            this.ВсегоТехникиНеВРаботе.AutoGenerated = true;
            this.ВсегоТехникиНеВРаботе.CalcTotal = false;
            this.ВсегоТехникиНеВРаботе.Caption = "ВсегоТехникиНеВРаботе";
            this.ВсегоТехникиНеВРаботе.Creator = typeof(NsgSoft.Forms.NsgMultipleObjectElementForm);
            this.ВсегоТехникиНеВРаботе.Name = "ВсегоТехникиНеВРаботе";
            this.ВсегоТехникиНеВРаботе.NSGType = typeof(NsgSoft.DataObjects.NsgDataInteger);
            this.ВсегоТехникиНеВРаботе.PropertyType = typeof(long);
            this.ВсегоТехникиНеВРаботе.SearchCondition.OwnerComponent = this.ВсегоТехникиНеВРаботе;
            this.ВсегоТехникиНеВРаботе.SearchCondition.Parameters = new NsgSoft.DataObjects.NsgCompareParam[0];
            // 
            // ВсегоТехникиСломано
            // 
            this.ВсегоТехникиСломано.AutoGenerated = true;
            this.ВсегоТехникиСломано.CalcTotal = false;
            this.ВсегоТехникиСломано.Caption = "ВсегоТехникиСломано";
            this.ВсегоТехникиСломано.Creator = typeof(NsgSoft.Forms.NsgMultipleObjectElementForm);
            this.ВсегоТехникиСломано.Name = "ВсегоТехникиСломано";
            this.ВсегоТехникиСломано.NSGType = typeof(NsgSoft.DataObjects.NsgDataInteger);
            this.ВсегоТехникиСломано.PropertyType = typeof(long);
            this.ВсегоТехникиСломано.SearchCondition.OwnerComponent = this.ВсегоТехникиСломано;
            this.ВсегоТехникиСломано.SearchCondition.Parameters = new NsgSoft.DataObjects.NsgCompareParam[0];
            // 
            // ВсегоТехникиВРемонте
            // 
            this.ВсегоТехникиВРемонте.AutoGenerated = true;
            this.ВсегоТехникиВРемонте.CalcTotal = false;
            this.ВсегоТехникиВРемонте.Caption = "ВсегоТехникиВРемонте";
            this.ВсегоТехникиВРемонте.Creator = typeof(NsgSoft.Forms.NsgMultipleObjectElementForm);
            this.ВсегоТехникиВРемонте.Name = "ВсегоТехникиВРемонте";
            this.ВсегоТехникиВРемонте.NSGType = typeof(NsgSoft.DataObjects.NsgDataInteger);
            this.ВсегоТехникиВРемонте.PropertyType = typeof(long);
            this.ВсегоТехникиВРемонте.SearchCondition.OwnerComponent = this.ВсегоТехникиВРемонте;
            this.ВсегоТехникиВРемонте.SearchCondition.Parameters = new NsgSoft.DataObjects.NsgCompareParam[0];
            // 
            // ПровереноАвтоматически
            // 
            this.ПровереноАвтоматически.AutoGenerated = true;
            this.ПровереноАвтоматически.Caption = "ПровереноАвтоматически";
            this.ПровереноАвтоматически.Creator = typeof(NsgSoft.Forms.NsgMultipleObjectElementForm);
            this.ПровереноАвтоматически.Name = "ПровереноАвтоматически";
            this.ПровереноАвтоматически.NSGType = typeof(NsgSoft.DataObjects.NsgDataBoolean);
            this.ПровереноАвтоматически.PropertyType = typeof(bool);
            this.ПровереноАвтоматически.SearchCondition.OwnerComponent = this.ПровереноАвтоматически;
            this.ПровереноАвтоматически.SearchCondition.Parameters = new NsgSoft.DataObjects.NsgCompareParam[0];
            // 
            // nsgInput3
            // 
            ...
            this.nsgInput3.FullName = "Мониторинг.ФормированиеСмены.ПровереноАвтоматически";
            ...
            this.nsgInput3.Location = new System.Drawing.Point(771, 29);
        ...
        protected NsgColumnDescriptor.Decimal ИтогоЧасовТехника;
        protected NsgColumnDescriptor.Decimal ИтогоЧасовПерсонал;
        protected NsgColumnDescriptor.Int64 КоличествоТехники;
        protected NsgColumnDescriptor.Int64 ВсегоТехникиВРаботе;
        protected NsgColumnDescriptor.Int64 ВсегоТехникиНеВРаботе;
        protected NsgColumnDescriptor.Int64 ВсегоТехникиСломано;
        protected NsgColumnDescriptor.Int64 ВсегоТехникиВРемонте;
        protected NsgColumnDescriptor.Boolean ПровереноАвтоматически;
        private NsgColumnDescriptor.Guid Идентификатор_т;
        private NsgColumnDescriptor.Int64 Автоинкремент_т;
        private NsgColumnDescriptor.MultipleObject Владелец_т;
        private NsgColumnDescriptor.Int64 НомерСтроки_т;
        private Техника.ColumnDescriptor Техника_т;
        private ФизЛица.ColumnDescriptor Сотрудник_т;
        private СтатусТехники.ColumnDescriptor СтатусТехники_т;
        private NsgColumnDescriptor.DateTime Время_т;
        private Тарифы.ColumnDescriptor Тариф_т;
        private NsgColumnDescriptor.Int64 НомерСмены_т;
        private NsgColumnDescriptor.Decimal Длительность_т;
        private Должности.ColumnDescriptor Должность_vmoТаблица;
        private NsgColumnDescriptor.String КодГруппы_vmoТаблица;
        protected NsgColumnDescriptor.DateTime ВремяОкончанияСменыТехники;
        protected NsgColumnDescriptor.Guid Идентификатор_vmoТаблицаПерсонал;
        private NsgColumnDescriptor.Int64 Автоинкремент_vmoТаблицаПерсонал;
        private NsgColumnDescriptor.MultipleObject Владелец_vmoТаблицаПерсонал;
        private NsgColumnDescriptor.Int64 НомерСтроки_vmoТаблицаПерсонал;
        private СтатусСотрудника.ColumnDescriptor СтатусСотрудника;
        private NsgColumnDescriptor.DateTime Время_vmoТаблицаПерсонал;
        private NsgColumnDescriptor.Int64 НомерСмены_vmoТаблицаПерсонал;
        private ФизЛица.ColumnDescriptor Сотрудник_vmoТаблицаПерсонал;
        private Тарифы.ColumnDescriptor Тариф_vmoТаблицаПерсонал;
        protected NsgColumnDescriptor.Decimal Длительность_vmoТаблицаПерсонал;
        private Должности.ColumnDescriptor Должность;
        private NsgColumnDescriptor.String КодГруппы;
        private NsgColumnDescriptor.DateTime ВремяУхода;
    }
}