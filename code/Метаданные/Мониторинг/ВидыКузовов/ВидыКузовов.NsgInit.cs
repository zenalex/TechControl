...
namespace TechControl.Метаданные.Мониторинг
{
    ...
    [NsgTypeName("NsgDataDictionary", Guid = "71504a28-e703-48cc-a49f-53db244ddb77")]
    public partial class ВидыКузовов : NsgSoft.DataObjects.NsgDataDictionary
    {
        #region Данные
        ...
        /// </summary>
        protected ВидыКузовов(NsgObject obj)
            : base(obj)
        {
        }
        ...
        public static ВидыКузовов Новый()
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("71504a28-e703-48cc-a49f-53db244ddb77"));
            if (obj == null)
                obj = new ВидыКузовов();
            return obj as ВидыКузовов;
        }
	...
	Идентификатор.Guid = NsgService.StringToGuid("1d0086a2-f520-4894-ada3-276be7782103");
	...
	Автоинкремент.Guid = NsgService.StringToGuid("d3c56cc3-78d5-4201-9556-153f0d1310e4");
	...
	ЭтоГруппа.GroupName = "";
	ЭтоГруппа.Guid = NsgService.StringToGuid("238ecefa-5319-4b60-bfc1-f4769839eac1");
	...
	ИдентификаторРодителя.Guid = NsgService.StringToGuid("b687f1cc-3bb9-4566-b219-d16ef3f29555");
	...
	Уровень.GroupName = "";
	Уровень.Guid = NsgService.StringToGuid("e055bf25-61eb-4b1d-83ea-53d24df489f1");
	...
	ПрефиксКода.Guid = NsgService.StringToGuid("c74a0b8d-63f7-4645-837b-77ef23dcd017");
	...
	НомерКода.GroupName = "";
	НомерКода.Guid = NsgService.StringToGuid("f26ec173-6ae5-470f-af3e-becb1b41c382");
	...
	Код.GroupName = "";
	Код.Guid = NsgService.StringToGuid("b4aed790-34c9-400b-8c8a-4fb29c3b8d9b");
	...
	Наименование.Guid = NsgService.StringToGuid("95710e37-83b3-497b-a6c7-ea783b0b8e56");
	...
	СостояниеДокумента.Guid = NsgService.StringToGuid("e657d490-7cbe-4e76-a188-02b02c58c92e");
	...
	Name = "ВидыКузовов";
	Visible = true;
	Guid = NsgService.StringToGuid("71504a28-e703-48cc-a49f-53db244ddb77");
	DefaultSortingName = "";
	...
	GroupName = "Мониторинг";
        ...
        public ВидыКузовов Родитель
        {
            get
            {
                return base.Parent as ВидыКузовов;
            }
            set
            {
                base.Parent = value;
        ...
        private ВидыКузовов[] convertArray(NsgMultipleObject[] array)
        {
            ВидыКузовов[] res = new ВидыКузовов[array.Length];
            array.CopyTo(res, 0);
            return res;
        }
        ...
        public new virtual ВидыКузовов[] FindAll(NsgCompare compare)
        {
        ...
        /// <returns>Список найденных объектов.</returns>
        public new virtual ВидыКузовов[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, NsgCompare compare)
        {
        ...
        /// <returns>Список найденных объектов.</returns>
        public new virtual ВидыКузовов[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, string inName, object inValue)
        {
        ...
        /// <param name="inValue">Значение для поиска. Условие поиска - полное совпадение.</param>
        /// <returns>Список найденных объектов.</returns>
        public new virtual ВидыКузовов[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, NsgDataFixedFields inName,
            object inValue)
        {
            return convertArray(base.FindAll(ref count, row_start, sorting, inName, inValue));
        }
        ...
        public override NsgObject CloneObject
        {
            get
            {
                return new ВидыКузовов(this as NsgObject);
            }
        }
        ...
        public new class ColumnDescriptor : NsgSoft.Forms.NsgColumnDescriptor
        {
            public ColumnDescriptor()
                : base()
            {
                base.NSGType = typeof(ВидыКузовов);
            }
			...
			public new ВидыКузовов Value
            {
                get
                {
                    return (ВидыКузовов)base.Value;
                }
                set
                {
                    base.Value = value;
