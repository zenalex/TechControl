...
namespace TT.Метаданные.Мониторинг
{
    ...
    [NsgTypeName("NsgDataDictionary", Guid = "dfba4c3c-685a-4296-98f4-a85fae574aa6")]
    public partial class Марка : NsgSoft.DataObjects.NsgDataDictionary
    {
        #region Данные
        ...
        public static Марка Новый()
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("dfba4c3c-685a-4296-98f4-a85fae574aa6"));
            if (obj == null)
                obj = new Марка();
            return obj as Марка;
        }
	...
	Наименование.Guid = NsgService.StringToGuid("44f5e06d-ea25-4f5a-83eb-81d998569d26");
	...
	СостояниеДокумента.Guid = NsgService.StringToGuid("d0917aea-a2ec-45b5-a155-596adb1a6357");
	...
	Name = "Марка";
	Visible = true;
	Guid = NsgService.StringToGuid("dfba4c3c-685a-4296-98f4-a85fae574aa6");
	DefaultSortingName = "";
	...
	GroupName = "Мониторинг";
        ...
        public Марка Родитель
        {
            get
            {
                return base.Parent as Марка;
            }
            set
            {
                base.Parent = value;
        ...
        private Марка[] convertArray(NsgMultipleObject[] array)
        {
            Марка[] res = new Марка[array.Length];
            array.CopyTo(res, 0);
            return res;
        }
        ...
        public new virtual Марка[] FindAll(NsgCompare compare)
        {
        ...
        /// <returns>Список найденных объектов.</returns>
        public new virtual Марка[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, NsgCompare compare)
        {
        ...
        /// <returns>Список найденных объектов.</returns>
        public new virtual Марка[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, string inName, object inValue)
        {
        ...
        /// <param name="inValue">Значение для поиска. Условие поиска - полное совпадение.</param>
        /// <returns>Список найденных объектов.</returns>
        public new virtual Марка[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, NsgDataFixedFields inName,
            object inValue)
        {
            return convertArray(base.FindAll(ref count, row_start, sorting, inName, inValue));
        }
        ...
        public override NsgObject CloneObject
        {
            get
            {
                return new Марка(this as NsgObject);
            }
        }
        ...
        public new class ColumnDescriptor : NsgSoft.Forms.NsgColumnDescriptor
        {
			...
			public new Марка Value
            {
                get
                {
                    return (Марка)base.Value;
                }
                set
                {
                    base.Value = value;
