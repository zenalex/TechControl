...

{
    ...
    public partial class МаркаФормаЭлемента:NsgSoft.Forms.NsgMultipleObjectElementForm
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(МаркаФормаЭлемента));
            ...
            this.Родитель = new TechControl.Метаданные.Мониторинг.Марка.ColumnDescriptor();
            ...
            this.Comment.FullName = "Мониторинг.Марка.Идентификатор";
            ...
            this.nsgVisualMultipleObject.FullName = "Мониторинг.Марка";
            // 
            // Идентификатор
            // 
            ...
            this.Родитель.NSGType = typeof(TechControl.Метаданные.Мониторинг.Марка);
            this.Родитель.PropertyType = typeof(TechControl.Метаданные.Мониторинг.Марка);
            ...
            this.nsgInput1.Location = new System.Drawing.Point(106, 11);
            ...
            this.nsgInput1.Size = new System.Drawing.Size(170, 20);
        ...
        private Марка.ColumnDescriptor Родитель;
