...
namespace TechControl.Метаданные.Мониторинг
{
    ...
    [NsgTypeName("NsgDataDictionary", Guid = "21529712-8785-4ebe-86d3-59936e877ae2")]
    public partial class ГруппыСпецТехники : NsgSoft.DataObjects.NsgDataDictionary
    {
        #region Данные
        ...
        /// </summary>
        protected ГруппыСпецТехники(NsgObject obj)
            : base(obj)
        {
        }
        ...
        public static ГруппыСпецТехники Новый()
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("21529712-8785-4ebe-86d3-59936e877ae2"));
            if (obj == null)
                obj = new ГруппыСпецТехники();
            return obj as ГруппыСпецТехники;
        }
	...
	Идентификатор.Guid = NsgService.StringToGuid("5b7d7a88-7c7a-46fe-958e-6e3e6db97d30");
	...
	Автоинкремент.Guid = NsgService.StringToGuid("9cb8933e-efc2-4ad5-a2f5-b28f0693766b");
	...
	ЭтоГруппа.GroupName = "";
	ЭтоГруппа.Guid = NsgService.StringToGuid("55694168-48bd-45c2-a45a-09790ea34428");
	...
	ИдентификаторРодителя.Guid = NsgService.StringToGuid("01cf9f63-74e6-494d-b9b5-40c09ec739a4");
	...
	Уровень.GroupName = "";
	Уровень.Guid = NsgService.StringToGuid("e78faa26-6cab-4d55-92c6-4140971c355d");
	...
	ПрефиксКода.Guid = NsgService.StringToGuid("0724b920-f840-493d-ae37-07ac829a39f9");
	...
	НомерКода.GroupName = "";
	НомерКода.Guid = NsgService.StringToGuid("48a48451-717a-4b3d-bbc2-611b06276ad0");
	...
	Код.GroupName = "";
	Код.Guid = NsgService.StringToGuid("f58f5d4d-2aa4-4207-ba88-f5cb175b581f");
	...
	Наименование.Guid = NsgService.StringToGuid("e2e5e7f5-fe9d-4f89-9c88-ccf13934ec54");
	...
	СостояниеДокумента.Guid = NsgService.StringToGuid("c6cfcece-12bf-4240-9ba0-238b9ecc132d");
			...
			#region создание System.Int64 Приоритет
			{  
                NsgDataInteger Приоритет = null;
				if (ObjectList.Contains("Приоритет"))
                    Приоритет = ObjectList["Приоритет"] as NsgDataInteger;
                else
                    Приоритет = new NsgDataInteger();
	//NsgDataInteger
	Приоритет.IsLoadedFromDll = true;
	Приоритет.DefaultValue = 0M;
	Приоритет.MinValue = 0M;
	Приоритет.MaxValue = 0M;
	Приоритет.UseCalculator = true;
	Приоритет.StringFormat = "";
	Приоритет.SubType = NsgSoft.Common.NsgRekvisitSubType.Common;
	Приоритет.IncludeInPredefined = false;
	Приоритет.PeriodicType = NsgSoft.Database.PeriodicTypes.None;
	Приоритет.Required = false;
	Приоритет.EmptyValue = "";
	Приоритет.NullAllow = false;
	Приоритет.IndexType = NsgSoft.Database.NsgRekvisitIndexType.None;
	Приоритет.FieldName = "Prioritet";
	Приоритет.SaveInDatabase = true;
	Приоритет.InformMetaDataOnValueChanged = false;
	Приоритет.Visible = true;
	Приоритет.Name = "Приоритет";
	Приоритет.Presentation = new NsgSoft.DataObjects.NsgLanguageString(new System.String[]{"(Default)"},
		 new System.Object[]{""});
	Приоритет.Description = "Приоритет";
	Приоритет.EditorVisible = NsgSoft.DataObjects.NsgDataObjectEditorAccess.Full;
	Приоритет.GroupName = "";
	Приоритет.Guid = NsgService.StringToGuid("262a9cb9-6435-42c9-8df6-5120f18253ff");
	
				if (!ObjectList.Contains("Приоритет"))
                    ObjectList.Add(Приоритет);
			}
			#endregion //создание System.Int64 Приоритет
	...
	Name = "ГруппыСпецТехники";
	Visible = true;
	Guid = NsgService.StringToGuid("21529712-8785-4ebe-86d3-59936e877ae2");
	DefaultSortingName = "";
	...
	TableName = "_dic_GruppySpecTekhniki";
	...
	GroupName = "Мониторинг";
        ...
        public new partial class Names// :NsgSoft.DataObjects.NsgDataDictionary.Names
        {
            ...
            /// Приоритет
            /// </summary>
            public static String Приоритет
            {
                get
                {
                    return "Приоритет";
        ...
        public override NsgMultipleObjectDescriptor Descriptor
        {
            get
            {
                if (descriptor == null)
                {
                    ...
                    descriptor.Name = "ГруппыСпецТехники";
        ...
        {
            return "Мониторинг.ГруппыСпецТехники";
        }
        ...
        public System.Int64 Приоритет
        {
            get
            {
				 NsgDataInteger __Приоритет = ObjectList["Приоритет"] as NsgDataInteger;
                 return (System.Int64)__Приоритет.Value;
            }
            set
            {
                NsgDataInteger __Приоритет = ObjectList["Приоритет"] as NsgDataInteger;
                __Приоритет.Value = value;
            }
        }
        ...
        public ГруппыСпецТехники Родитель
        {
            get
            {
                return base.Parent as ГруппыСпецТехники;
            }
            set
            {
                base.Parent = value;
        ...
        private ГруппыСпецТехники[] convertArray(NsgMultipleObject[] array)
        {
            ГруппыСпецТехники[] res = new ГруппыСпецТехники[array.Length];
            array.CopyTo(res, 0);
            return res;
        }
        ...
        public new virtual ГруппыСпецТехники[] FindAll(NsgCompare compare)
        {
        ...
        /// <returns>Список найденных объектов.</returns>
        public new virtual ГруппыСпецТехники[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, NsgCompare compare)
        {
        ...
        /// <returns>Список найденных объектов.</returns>
        public new virtual ГруппыСпецТехники[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, string inName, object inValue)
        {
        ...
        /// <param name="inValue">Значение для поиска. Условие поиска - полное совпадение.</param>
        /// <returns>Список найденных объектов.</returns>
        public new virtual ГруппыСпецТехники[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, NsgDataFixedFields inName,
            object inValue)
        {
            return convertArray(base.FindAll(ref count, row_start, sorting, inName, inValue));
        }
        ...
        public override NsgObject CloneObject
        {
            get
            {
                return new ГруппыСпецТехники(this as NsgObject);
            }
        }
        ...
        public new class ColumnDescriptor : NsgSoft.Forms.NsgColumnDescriptor
        {
            public ColumnDescriptor()
                : base()
            {
                base.NSGType = typeof(ГруппыСпецТехники);
            }
			...
			public new ГруппыСпецТехники Value
            {
                get
                {
                    return (ГруппыСпецТехники)base.Value;
                }
                set
                {
                    base.Value = value;
