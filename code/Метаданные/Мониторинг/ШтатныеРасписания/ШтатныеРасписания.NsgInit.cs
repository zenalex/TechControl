...
namespace TechControl.Метаданные.Мониторинг
{
    ...
    [NsgTypeName("NsgDataDictionary", Guid = "29a55aa8-1f80-4a47-981f-efb9c23fb86c")]
    public partial class ШтатныеРасписания : NsgSoft.DataObjects.NsgDataDictionary
    {
        #region Данные
        ...
        /// </summary>
        protected ШтатныеРасписания(NsgObject obj)
            : base(obj)
        {
        }
        ...
        public static ШтатныеРасписания Новый()
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("29a55aa8-1f80-4a47-981f-efb9c23fb86c"));
            if (obj == null)
                obj = new ШтатныеРасписания();
            return obj as ШтатныеРасписания;
        }
	...
	Наименование.Guid = NsgService.StringToGuid("134cc70d-b5e0-425d-abad-b5af906e9b62");
	...
	СостояниеДокумента.Guid = NsgService.StringToGuid("da202618-9a75-4e9d-b110-e2e625a631bf");
	...
	Name = "ШтатныеРасписания";
	Visible = true;
	Guid = NsgService.StringToGuid("29a55aa8-1f80-4a47-981f-efb9c23fb86c");
	DefaultSortingName = "";
	...
	TableName = "_dic_SHtatnyeRaspisanija";
	Presentation = new NsgSoft.DataObjects.NsgLanguageString(new System.String[]{"(Default)"},
		 new System.Object[]{""});
	Description = "Штатные расписания";
	...
	GroupName = "Мониторинг";
        ...
        public override NsgMultipleObjectDescriptor Descriptor
        {
            get
            {
                if (descriptor == null)
                {
                    ...
                    descriptor.Name = "ШтатныеРасписания";
        ...
        {
            return "Мониторинг.ШтатныеРасписания";
        }
        ...
        public ШтатныеРасписания Родитель
        {
            get
            {
                return base.Parent as ШтатныеРасписания;
            }
            set
            {
                base.Parent = value;
        ...
        private ШтатныеРасписания[] convertArray(NsgMultipleObject[] array)
        {
            ШтатныеРасписания[] res = new ШтатныеРасписания[array.Length];
            array.CopyTo(res, 0);
            return res;
        }
        ...
        public new virtual ШтатныеРасписания[] FindAll(NsgCompare compare)
        {
        ...
        /// <returns>Список найденных объектов.</returns>
        public new virtual ШтатныеРасписания[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, NsgCompare compare)
        {
        ...
        /// <returns>Список найденных объектов.</returns>
        public new virtual ШтатныеРасписания[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, string inName, object inValue)
        {
        ...
        /// <param name="inValue">Значение для поиска. Условие поиска - полное совпадение.</param>
        /// <returns>Список найденных объектов.</returns>
        public new virtual ШтатныеРасписания[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, NsgDataFixedFields inName,
            object inValue)
        {
            return convertArray(base.FindAll(ref count, row_start, sorting, inName, inValue));
        }
        ...
        public override NsgObject CloneObject
        {
            get
            {
                return new ШтатныеРасписания(this as NsgObject);
            }
        }
        ...
        public new class ColumnDescriptor : NsgSoft.Forms.NsgColumnDescriptor
        {
            public ColumnDescriptor()
                : base()
            {
                base.NSGType = typeof(ШтатныеРасписания);
            }
			...
			public new ШтатныеРасписания Value
            {
                get
                {
                    return (ШтатныеРасписания)base.Value;
                }
                set
                {
                    base.Value = value;
