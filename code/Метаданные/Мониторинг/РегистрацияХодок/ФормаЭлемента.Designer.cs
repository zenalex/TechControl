...

{
    ...
    public partial class РегистрацияХодокФормаЭлемента:NsgSoft.Forms.NsgMultipleObjectElementForm
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(РегистрацияХодокФормаЭлемента));
            ...
            this.ТабличнаяЧасть = new TechControl.Метаданные._SystemTables.МониторингРегистрацияХодокТабличнаяЧасть.ColumnDescriptor();
            this.ТаблицаКоличестваХодок = new TechControl.Метаданные._SystemTables.МониторингРегистрацияХодокТаблицаКоличестваХодок.ColumnDescriptor();
            ...
            this.КоличествоХодок = new NsgSoft.Forms.NsgColumnDescriptor.Int64();
            ...
            this.Техника_vmoТабличнаяЧасть = new TechControl.Метаданные.Мониторинг.Техника.ColumnDescriptor();
            ...
            this.Объект_vmoТабличнаяЧасть = new TechControl.Метаданные.Мониторинг.Объекты.ColumnDescriptor();
            this.Геозона_vmoТабличнаяЧасть = new TechControl.Метаданные.Мониторинг.Геозоны.ColumnDescriptor();
            ...
            this.Comment.FullName = "Мониторинг.РегистрацияХодок.Идентификатор";
            ...
            this.nsgVisualMultipleObject.Columns.Collection.Add(this.ТабличнаяЧасть);
            this.nsgVisualMultipleObject.Columns.Collection.Add(this.ТаблицаКоличестваХодок);
            this.nsgVisualMultipleObject.IsActive = true;
            this.nsgVisualMultipleObject.MetaDataName = "Метаданные";
            this.nsgVisualMultipleObject.FullName = "Мониторинг.РегистрацияХодок";
            // 
            // Идентификатор
            // 
            ...
            // ТабличнаяЧасть
            // 
            this.ТабличнаяЧасть.AutoGenerated = true;
            this.ТабличнаяЧасть.Caption = "ТабличнаяЧасть";
            this.ТабличнаяЧасть.Creator = typeof(NsgSoft.Forms.NsgMultipleObjectElementForm);
            this.ТабличнаяЧасть.Name = "ТабличнаяЧасть";
            this.ТабличнаяЧасть.NSGType = typeof(TechControl.Метаданные._SystemTables.МониторингРегистрацияХодокТабличнаяЧасть);
            this.ТабличнаяЧасть.PropertyType = typeof(TechControl.Метаданные._SystemTables.МониторингРегистрацияХодокТабличнаяЧасть);
            this.ТабличнаяЧасть.SearchCondition.OwnerComponent = this.ТабличнаяЧасть;
            this.ТабличнаяЧасть.SearchCondition.Parameters = new NsgSoft.DataObjects.NsgCompareParam[0];
            this.ТабличнаяЧасть.Visible = false;
            // 
            // ТаблицаКоличестваХодок
            // 
            this.ТаблицаКоличестваХодок.AutoGenerated = true;
            this.ТаблицаКоличестваХодок.Caption = "ТаблицаКоличестваХодок";
            this.ТаблицаКоличестваХодок.Creator = typeof(NsgSoft.Forms.NsgMultipleObjectElementForm);
            this.ТаблицаКоличестваХодок.Name = "ТаблицаКоличестваХодок";
            this.ТаблицаКоличестваХодок.NSGType = typeof(TechControl.Метаданные._SystemTables.МониторингРегистрацияХодокТаблицаКоличестваХодок);
            this.ТаблицаКоличестваХодок.PropertyType = typeof(TechControl.Метаданные._SystemTables.МониторингРегистрацияХодокТаблицаКоличестваХодок);
            this.ТаблицаКоличестваХодок.SearchCondition.OwnerComponent = this.ТаблицаКоличестваХодок;
            this.ТаблицаКоличестваХодок.SearchCondition.Parameters = new NsgSoft.DataObjects.NsgCompareParam[0];
            this.ТаблицаКоличестваХодок.Visible = false;
            // 
            // label1
            // 
            ...
            this.tabControl1.Size = new System.Drawing.Size(713, 234);
            ...
            this.tabPage1.Size = new System.Drawing.Size(705, 208);
            this.tabPage1.TabIndex = 0;
            this.tabPage1.Text = "Табличная часть";
            ...
            this.tabPage2.Size = new System.Drawing.Size(705, 208);
            ...
            this.nsgInput1.FullName = "НомерДокумента";
            ...
            this.nsgInput1.Location = new System.Drawing.Point(117, 33);
            ...
            this.nsgInput2.FullName = "ДатаДокумента";
            ...
            this.nsgInput2.Location = new System.Drawing.Point(372, 33);
            ...
            this.vmoКоличествоХодок.FullName = "_SystemTables.МониторингРегистрацияХодокТаблицаКоличестваХодок.Владелец";
            // 
            // vmoКоличествоХодок
            // 
            nsgObjectDescriptor1.ConfigurationName = "TechControl";
            nsgObjectDescriptor1.FullName = "_SystemTables.МониторингРегистрацияХодокТаблицаКоличестваХодок.Владелец";
            nsgObjectDescriptor1.MetaDataName = "Метаданные";
            nsgMasterDetailBinding1.DetailField = nsgObjectDescriptor1;
            nsgObjectDescriptor2.FullName = "Мониторинг.РегистрацияХодок.ТаблицаКоличестваХодок";
            ...
            this.vmoКоличествоХодок.Columns.Collection.Add(this.Владелец);
            this.vmoКоличествоХодок.Columns.Collection.Add(this.НомерСтроки);
            this.vmoКоличествоХодок.Columns.Collection.Add(this.КоличествоХодок);
            this.vmoКоличествоХодок.Columns.Collection.Add(this.Объект);
            this.vmoКоличествоХодок.Columns.Collection.Add(this.Техника);
            this.vmoКоличествоХодок.Columns.Collection.Add(this.Геозона);
            ...
            this.vmoТабличнаяЧасть.FullName = "_SystemTables.МониторингРегистрацияХодокТабличнаяЧасть.Владелец";
            // 
            // vmoТабличнаяЧасть
            // 
            nsgObjectDescriptor3.ConfigurationName = "TechControl";
            nsgObjectDescriptor3.FullName = "_SystemTables.МониторингРегистрацияХодокТабличнаяЧасть.Владелец";
            nsgObjectDescriptor3.MetaDataName = "Метаданные";
            nsgMasterDetailBinding2.DetailField = nsgObjectDescriptor3;
            nsgObjectDescriptor4.FullName = "Мониторинг.РегистрацияХодок.ТабличнаяЧасть";
            ...
            this.vmoТабличнаяЧасть.Columns.Collection.Add(this.Владелец_vmoТабличнаяЧасть);
            this.vmoТабличнаяЧасть.Columns.Collection.Add(this.НомерСтроки_vmoТабличнаяЧасть);
            this.vmoТабличнаяЧасть.Columns.Collection.Add(this.Техника_vmoТабличнаяЧасть);
            ...
            this.vmoТабличнаяЧасть.Columns.Collection.Add(this.Объект_vmoТабличнаяЧасть);
            this.vmoТабличнаяЧасть.Columns.Collection.Add(this.Геозона_vmoТабличнаяЧасть);
        ...
        "Index"};
            ...
            this.nsgIGrid1.Location = new System.Drawing.Point(6, 9);
            ...
            this.nsgIGrid1.Size = new System.Drawing.Size(693, 193);
        ...
        "Index"};
            ...
            this.nsgIGrid2.Location = new System.Drawing.Point(6, 12);
            ...
            this.nsgIGrid2.Size = new System.Drawing.Size(693, 190);
            ...
            this.КоличествоХодок.CalcTotal = false;
            ...
            this.КоличествоХодок.NSGType = typeof(NsgSoft.DataObjects.NsgDataInteger);
            this.КоличествоХодок.PropertyType = typeof(long);
            ...
            // 
            // Техника_vmoТабличнаяЧасть
            // 
            this.Техника_vmoТабличнаяЧасть.AutoGenerated = true;
            this.Техника_vmoТабличнаяЧасть.Caption = "Техника";
            this.Техника_vmoТабличнаяЧасть.Creator = typeof(NsgSoft.Forms.NsgMultipleObjectElementForm);
            this.Техника_vmoТабличнаяЧасть.Name = "Техника";
            this.Техника_vmoТабличнаяЧасть.NSGType = typeof(TechControl.Метаданные.Мониторинг.Техника);
            this.Техника_vmoТабличнаяЧасть.PropertyType = typeof(TechControl.Метаданные.Мониторинг.Техника);
            this.Техника_vmoТабличнаяЧасть.SearchCondition.OwnerComponent = this.Техника_vmoТабличнаяЧасть;
            this.Техника_vmoТабличнаяЧасть.SearchCondition.Parameters = new NsgSoft.DataObjects.NsgCompareParam[0];
            // 
            ...
            // 
            // Объект_vmoТабличнаяЧасть
            // 
            this.Объект_vmoТабличнаяЧасть.AutoGenerated = true;
            this.Объект_vmoТабличнаяЧасть.Caption = "Объект";
            this.Объект_vmoТабличнаяЧасть.Creator = typeof(NsgSoft.Forms.NsgMultipleObjectElementForm);
            this.Объект_vmoТабличнаяЧасть.Name = "Объект";
            this.Объект_vmoТабличнаяЧасть.NSGType = typeof(TechControl.Метаданные.Мониторинг.Объекты);
            this.Объект_vmoТабличнаяЧасть.PropertyType = typeof(TechControl.Метаданные.Мониторинг.Объекты);
            this.Объект_vmoТабличнаяЧасть.SearchCondition.OwnerComponent = this.Объект_vmoТабличнаяЧасть;
            this.Объект_vmoТабличнаяЧасть.SearchCondition.Parameters = new NsgSoft.DataObjects.NsgCompareParam[0];
            // 
            // Геозона_vmoТабличнаяЧасть
            // 
            this.Геозона_vmoТабличнаяЧасть.AutoGenerated = true;
            this.Геозона_vmoТабличнаяЧасть.Caption = "Геозона";
            this.Геозона_vmoТабличнаяЧасть.Creator = typeof(NsgSoft.Forms.NsgMultipleObjectElementForm);
            this.Геозона_vmoТабличнаяЧасть.Name = "Геозона";
            this.Геозона_vmoТабличнаяЧасть.NSGType = typeof(TechControl.Метаданные.Мониторинг.Геозоны);
            this.Геозона_vmoТабличнаяЧасть.PropertyType = typeof(TechControl.Метаданные.Мониторинг.Геозоны);
            this.Геозона_vmoТабличнаяЧасть.SearchCondition.OwnerComponent = this.Геозона_vmoТабличнаяЧасть;
            this.Геозона_vmoТабличнаяЧасть.SearchCondition.Parameters = new NsgSoft.DataObjects.NsgCompareParam[0];
            // 
            // РегистрацияХодокФормаЭлемента
            // 
            this.AllowDrop = true;
        ...
        protected _SystemTables.МониторингРегистрацияХодокТабличнаяЧасть.ColumnDescriptor ТабличнаяЧасть;
        protected _SystemTables.МониторингРегистрацияХодокТаблицаКоличестваХодок.ColumnDescriptor ТаблицаКоличестваХодок;
        private System.Windows.Forms.Label label1;
        private System.Windows.Forms.Label label2;
        private System.Windows.Forms.TabControl tabControl1;
        private System.Windows.Forms.TabPage tabPage1;
        protected NsgIGrid nsgIGrid1;
        protected NsgVisualMultipleObject vmoКоличествоХодок;
        protected NsgColumnDescriptor.Guid Идентификатор_vmoКоличествоХодок;
        protected NsgColumnDescriptor.Int64 Автоинкремент_vmoКоличествоХодок;
        protected NsgColumnDescriptor.MultipleObject Владелец;
        protected NsgColumnDescriptor.Int64 НомерСтроки;
        protected NsgColumnDescriptor.Int64 КоличествоХодок;
        ...
        protected NsgVisualMultipleObject vmoТабличнаяЧасть;
        ...
        private Техника.ColumnDescriptor Техника_vmoТабличнаяЧасть;
        private NsgColumnDescriptor.DateTime ВремяПриездаНаГеозону;
        private NsgColumnDescriptor.DateTime ВремяВыездаИзГеозоны;
        private NsgColumnDescriptor.DateTime ВремяПриездаНаОбъект;
        private NsgColumnDescriptor.DateTime ВремяВыездаИзОбъекта;
        private Объекты.ColumnDescriptor Объект_vmoТабличнаяЧасть;
        protected Геозоны.ColumnDescriptor Геозона_vmoТабличнаяЧасть;
