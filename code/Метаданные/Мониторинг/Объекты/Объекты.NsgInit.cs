...
namespace TechControl.Метаданные.Мониторинг
{
	...
	Адрес.Guid = NsgService.StringToGuid("4494107e-50e7-4053-9db9-211c2248f425");
			...
			#region создание Мониторинг.Фирмы Заказчик
			{  
	...
	Заказчик.GroupName = "";
	Заказчик.Guid = NsgService.StringToGuid("40a5ed97-07d8-4da1-846f-b70948d43fef");
	
				if (!ObjectList.Contains("Заказчик"))
                    ObjectList.Add(Заказчик);
			}
			#endregion //создание Мониторинг.Фирмы Заказчик
