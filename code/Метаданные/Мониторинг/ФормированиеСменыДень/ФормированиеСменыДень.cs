...
namespace TechControl.Метаданные.Мониторинг
{
    ...
    public partial class ФормированиеСменыДень
    {
        protected override List<Guid> BasePost()
        {
            ...
            {
                if (смена.ObjectState == NsgObjectStates.New) 
                {
                    ...
                    if (смена.ДатаДокумента > ДатаДокумента) 
                    {
                        смена.ДатаДокумента = ДатаДокумента;
                    }
            ...
            if (ЗавершаетСмену)
            {
                if (смена != null && смена.Selected && смена.ДатаОкончанияСмены != ДатаДокумента) 
                {
                    ...
                    смена.СтатусДокументаСмены = СтатусыДокументовСмен.АвтоматическиЗавершено;
                    смена.UpdateArray(new NsgCompare().Add(ФормированиеСмены.Names.Идентификатор, смена.Идентификатор),
                    смена.ObjectList[ФормированиеСмены.Names.СтатусДокументаСмены]);
                }
