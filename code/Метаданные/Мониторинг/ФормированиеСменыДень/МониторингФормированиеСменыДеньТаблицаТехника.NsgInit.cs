...
namespace TechControl.Метаданные._SystemTables
{
    ...
    [NsgTypeName("NsgDataTable", Guid = "c6fe5227-728c-45ee-bb2b-38c7b2246d9c")]
    public partial class МониторингФормированиеСменыДеньТаблицаТехника : NsgSoft.DataObjects.NsgDataTable
    {
        #region Данные
        ...
        /// Создание объекта
        /// </summary>
        protected МониторингФормированиеСменыДеньТаблицаТехника()
            : base()
        {
        }
        ...
        /// </summary>
        protected МониторингФормированиеСменыДеньТаблицаТехника(NsgObject obj)
            : base(obj)
        {
        }
        ...
        public static МониторингФормированиеСменыДеньТаблицаТехника Новый()
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("c6fe5227-728c-45ee-bb2b-38c7b2246d9c"));
            if (obj == null)
                obj = new МониторингФормированиеСменыДеньТаблицаТехника();
            return obj as МониторингФормированиеСменыДеньТаблицаТехника;
        }
	...
	Идентификатор.Guid = NsgService.StringToGuid("ef7c2c3d-8551-40d6-a61d-5f2ff0413f75");
	...
	Автоинкремент.Guid = NsgService.StringToGuid("e8e88c0e-47c2-4df9-a61e-607006e13f22");
	...
	Владелец.GroupName = "";
	Владелец.Guid = NsgService.StringToGuid("f373ff6c-324f-4a4f-8b1d-982a4b5ff320");
	...
	НомерСтроки.Guid = NsgService.StringToGuid("63b7de9f-dd4b-4e90-8b5b-c7805fb3771f");
	...
	СтатусТехники.Guid = NsgService.StringToGuid("a0c1a899-9da1-45ac-be03-5b40aa15507e");
	...
	Время.GroupName = "";
	Время.Guid = NsgService.StringToGuid("f37692ad-b17e-4f83-815a-6cc9deadca5b");
	...
	НомерСмены.Guid = NsgService.StringToGuid("462fb7d4-4b04-437a-b1d8-ae864338ab15");
	...
	Сотрудник.GroupName = "";
	Сотрудник.Guid = NsgService.StringToGuid("d46510ab-74e2-4f07-b48e-ba4d058fad5c");
	...
	Техника.GroupName = "";
	Техника.Guid = NsgService.StringToGuid("47793f1f-e030-403f-8282-6c70590bc96e");
	...
	Тариф.GroupName = "";
	Тариф.Guid = NsgService.StringToGuid("1b60d712-dde1-42dc-947c-b9fd6e2d89bf");
	...
	Name = "МониторингФормированиеСменыДеньТаблицаТехника";
	Visible = true;
	Guid = NsgService.StringToGuid("c6fe5227-728c-45ee-bb2b-38c7b2246d9c");
	DefaultSortingName = "";
	...
	TableName = "_tab_MonitoringFormirova3";
	Presentation = new NsgSoft.DataObjects.NsgLanguageString(new System.String[]{"(Default)"},
		 new System.Object[]{""});
	Description = "Мониторинг формирование смены переходное таблица техники";
	...
	GroupName = "_SystemTables";
        ...
        {
            return "_SystemTables.МониторингФормированиеСменыДеньТаблицаТехника";
        }
        ...
        /// </summary>
        public new МониторингФормированиеСменыДеньТаблицаТехника.Строка NewRow()
        {
            return newRow(null) as МониторингФормированиеСменыДеньТаблицаТехника.Строка;
        }
        ...
        {
            if (row == null)
                row = new МониторингФормированиеСменыДеньТаблицаТехника.Строка(this);
            return base.newRow(row) as МониторингФормированиеСменыДеньТаблицаТехника.Строка;
        }

        /// <summary>
        /// Добавить новую строку в таблицу путем копирования переданной строки
        /// </summary>
        public МониторингФормированиеСменыДеньТаблицаТехника.Строка NewRow(МониторингФормированиеСменыДеньТаблицаТехника.Строка inRow)
        {
            МониторингФормированиеСменыДеньТаблицаТехника.Строка row = inRow.Clone as МониторингФормированиеСменыДеньТаблицаТехника.Строка;
            return base.newRow(row) as МониторингФормированиеСменыДеньТаблицаТехника.Строка;
        }
        ...
        /// </summary>
        public new МониторингФормированиеСменыДеньТаблицаТехника.Строка GetRow(int rowNumber)
        {
            return base.GetRow(rowNumber) as МониторингФормированиеСменыДеньТаблицаТехника.Строка;
        }

        /// <summary>
        /// Возвращает новую строку таблицы, но в саму таблицу ее не включает (эталонная строка)
        /// </summary>
        public new МониторингФормированиеСменыДеньТаблицаТехника.Строка GetEtalonRow()
        {
            МониторингФормированиеСменыДеньТаблицаТехника.Строка row = new МониторингФормированиеСменыДеньТаблицаТехника.Строка(this);
            row.MetaData = MetaData;
            return row;
        }

        private МониторингФормированиеСменыДеньТаблицаТехника.Строка[] convertRowsArray(NsgDataTableRow[] array)
        {
            МониторингФормированиеСменыДеньТаблицаТехника.Строка[] res = new МониторингФормированиеСменыДеньТаблицаТехника.Строка[array.Length];
            array.CopyTo(res, 0);
            return res;
        }
        ...
        public new МониторингФормированиеСменыДеньТаблицаТехника.Строка FindRowByTag(object Tag)
        {
            return base.FindRowByTag(Tag) as МониторингФормированиеСменыДеньТаблицаТехника.Строка;
        }
        ...
        /// <param name="compare">Критерии поиска.</param>
        /// <returns>Найденные строки.</returns>
        public new МониторингФормированиеСменыДеньТаблицаТехника.Строка[] FindRowsByTag(object Tag)
        {
        ...
        /// <param name="compare">Критерии поиска.</param>
        /// <returns>Найденные строки.</returns>
        public new МониторингФормированиеСменыДеньТаблицаТехника.Строка FindRow(NsgCompare compare)
        {
            return base.FindRow(compare) as МониторингФормированиеСменыДеньТаблицаТехника.Строка;
        }
        ...
        /// <returns>Найденные строки.</returns>
        public new МониторингФормированиеСменыДеньТаблицаТехника.Строка FindRow(string inName, object inValue)
        {
            return base.FindRow(inName, inValue) as МониторингФормированиеСменыДеньТаблицаТехника.Строка;
        }
        ...
        /// <param name="inValue">Значение поля.</param>
        /// <returns>Найденные строки.</returns>
        public new МониторингФормированиеСменыДеньТаблицаТехника.Строка FindRow(NsgDataFixedFields inName, object inValue)
        {
            return base.FindRow(inName, inValue) as МониторингФормированиеСменыДеньТаблицаТехника.Строка;
        }
        ...
        /// <param name="compare">Критерии поиска.</param>
        /// <returns>Найденные строки.</returns>
        public new МониторингФормированиеСменыДеньТаблицаТехника.Строка[] FindRows(NsgCompare compare)
        {
        ...
        /// <param name="inValue">Значение поля.</param>
        /// <returns>Найденные строки.</returns>
        public new МониторингФормированиеСменыДеньТаблицаТехника.Строка[] FindRows(string inName, object inValue)
        {
        ...
        /// <param name="inValue">Значение поля.</param>
        /// <returns>Найденные строки.</returns>
        public new МониторингФормированиеСменыДеньТаблицаТехника.Строка[] FindRows(NsgDataFixedFields inName, object inValue)
        {
            return convertRowsArray(base.FindRows(inName, inValue));
        }
        ...
        /// </summary>
        public  NsgVirtualCursor<МониторингФормированиеСменыДеньТаблицаТехника> GetNewVirtualCursor()
        {
            return base.GetNewVirtualCursor<МониторингФормированиеСменыДеньТаблицаТехника>();
        }

        /// <summary>
        /// Получить все строки таблицы с учетом наложенного фильтра. Для получения всех сьтрок без учета фильтра используется свойство AllRows
        /// </summary>
        public new МониторингФормированиеСменыДеньТаблицаТехника.Строка[] Rows
        {
            get
            {
        ...
        /// </summary>
        public new МониторингФормированиеСменыДеньТаблицаТехника.Строка[] AllRows
        {
            get
            {
        ...
        /// <returns>Найденные строки.</returns>
        public new МониторингФормированиеСменыДеньТаблицаТехника.Строка GetRow(Guid inID)
        {
            return base.GetRow(inID) as МониторингФормированиеСменыДеньТаблицаТехника.Строка;
        }
        #endregion
        ...
        private МониторингФормированиеСменыДеньТаблицаТехника[] convertArray(NsgMultipleObject[] array)
        {
            МониторингФормированиеСменыДеньТаблицаТехника[] res = new МониторингФормированиеСменыДеньТаблицаТехника[array.Length];
            array.CopyTo(res, 0);
            return res;
        }
        ...
        public new virtual МониторингФормированиеСменыДеньТаблицаТехника[] FindAll(NsgCompare compare)
        {
        ...
        /// <returns>Список найденных объектов.</returns>
        public new virtual МониторингФормированиеСменыДеньТаблицаТехника[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, NsgCompare compare)
        {
        ...
        /// <returns>Список найденных объектов.</returns>
        public new virtual МониторингФормированиеСменыДеньТаблицаТехника[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, string inName, object inValue)
        {
        ...
        /// <param name="inValue">Значение для поиска. Условие поиска - полное совпадение.</param>
        /// <returns>Список найденных объектов.</returns>
        public new virtual МониторингФормированиеСменыДеньТаблицаТехника[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, NsgDataFixedFields inName,
            object inValue)
        {
            return convertArray(base.FindAll(ref count, row_start, sorting, inName, inValue));
        }
        ...
        public override NsgObject CloneObject
        {
            get
            {
                return new МониторингФормированиеСменыДеньТаблицаТехника(this as NsgObject);
            }
        }
        ...
        public new class ColumnDescriptor : NsgSoft.Forms.NsgColumnDescriptor
        {
            public ColumnDescriptor()
                : base()
            {
                base.NSGType = typeof(МониторингФормированиеСменыДеньТаблицаТехника);
            }
			...
			public new МониторингФормированиеСменыДеньТаблицаТехника Value
            {
                get
                {
                    return (МониторингФормированиеСменыДеньТаблицаТехника)base.Value;
                }
                set
                {
                    base.Value = value;
