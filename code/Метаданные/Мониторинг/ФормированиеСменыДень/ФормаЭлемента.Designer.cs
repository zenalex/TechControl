...

{
    ...
    public partial class ФормированиеСменыДеньФормаЭлемента:NsgSoft.Forms.NsgMultipleObjectElementForm
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            this.vmoТаблицаТехника = new NsgSoft.Forms.NsgVisualMultipleObject(this.components);
            ...
            this.ТаблицаТехника = new TechControl.Метаданные._SystemTables.МониторингФормированиеСменыДеньТаблицаТехника.ColumnDescriptor();
            ...
            this.ТаблицаПерсонал = new TechControl.Метаданные._SystemTables.МониторингФормированиеСменыДеньТаблицаПерсонал.ColumnDescriptor();
            ...
            ((System.ComponentModel.ISupportInitialize)(this.vmoТаблицаТехника)).BeginInit();
            ...
            this.Comment.FullName = "Мониторинг.ФормированиеСменыДень.Идентификатор";
            ...
            this.nsgVisualMultipleObject.FullName = "Мониторинг.ФормированиеСменыДень";
            // 
            // gridТехника
            // 
        ...
        "Visible"};
            ...
            this.gridТехника.SourceObject = this.vmoТаблицаТехника;
            ...
            this.vmoТаблицаТехника.DataSourceType = NsgSoft.Forms.NsgDataSourceType.MasterComponent;
            nsgObjectDescriptor2.ConfigurationName = "TechControl";
            this.vmoТаблицаТехника.MetaDataName = "Метаданные";
            this.vmoТаблицаТехника.FullName = "_SystemTables.МониторингФормированиеСменыДеньТаблицаТехника.Владелец";
            // 
            // vmoТаблицаТехника
            // 
            nsgObjectDescriptor1.ConfigurationName = "TechControl";
            nsgObjectDescriptor1.FullName = "_SystemTables.МониторингФормированиеСменыДеньТаблицаТехника.Владелец";
            nsgObjectDescriptor1.MetaDataName = "Метаданные";
            nsgMasterDetailBinding1.DetailField = nsgObjectDescriptor1;
            nsgObjectDescriptor2.FullName = "Мониторинг.ФормированиеСменыДень.ТаблицаТехника";
            ...
            this.vmoТаблицаТехника.Columns.Collection.Add(this.Идентификатор_т);
            this.vmoТаблицаТехника.Columns.Collection.Add(this.Автоинкремент_т);
            this.vmoТаблицаТехника.Columns.Collection.Add(this.Владелец_т);
            this.vmoТаблицаТехника.Columns.Collection.Add(this.НомерСтроки_т);
            this.vmoТаблицаТехника.Columns.Collection.Add(this.СтатусТехники_т);
            this.vmoТаблицаТехника.Columns.Collection.Add(this.Время_т);
            this.vmoТаблицаТехника.Columns.Collection.Add(this.НомерСмены_т);
            this.vmoТаблицаТехника.Columns.Collection.Add(this.Сотрудник_т);
            this.vmoТаблицаТехника.Columns.Collection.Add(this.Техника_т);
            this.vmoТаблицаТехника.Columns.Collection.Add(this.Тариф_т);
            this.vmoТаблицаТехника.MasterComponent = this.nsgVisualMultipleObject;
            this.vmoТаблицаТехника.Binding = nsgMasterDetailBinding1;
            // 
            // gridПерсонал
            // 
        ...
        "Visible"};
            ...
            this.vmoТаблицаПерсонал.FullName = "_SystemTables.МониторингФормированиеСменыДеньТаблицаПерсонал.Владелец";
            // 
            // vmoТаблицаПерсонал
            // 
            nsgObjectDescriptor3.ConfigurationName = "TechControl";
            nsgObjectDescriptor3.FullName = "_SystemTables.МониторингФормированиеСменыДеньТаблицаПерсонал.Владелец";
            nsgObjectDescriptor3.MetaDataName = "Метаданные";
            nsgMasterDetailBinding2.DetailField = nsgObjectDescriptor3;
            nsgObjectDescriptor4.FullName = "Мониторинг.ФормированиеСменыДень.ТаблицаПерсонал";
            ...
            this.nsgInput1.FullName = "Мониторинг.ФормированиеСменыДень.ДатаДокумента";
            ...
            this.nsgInput2.FullName = "Мониторинг.ФормированиеСменыДень.ДокументОснование";
            ...
            this.nsgInput4.FullName = "Мониторинг.ФормированиеСменыДень.Объект";
            ...
            this.nsgInput5.FullName = "Мониторинг.ФормированиеСменыДень.Ответственный";
            ...
            this.nsgInput6.FullName = "Мониторинг.ФормированиеСменыДень.НомерДокумента";
            ...
            this.ТаблицаТехника.NSGType = typeof(TechControl.Метаданные._SystemTables.МониторингФормированиеСменыДеньТаблицаТехника);
            this.ТаблицаТехника.PropertyType = typeof(TechControl.Метаданные._SystemTables.МониторингФормированиеСменыДеньТаблицаТехника);
            ...
            this.ТаблицаПерсонал.NSGType = typeof(TechControl.Метаданные._SystemTables.МониторингФормированиеСменыДеньТаблицаПерсонал);
            this.ТаблицаПерсонал.PropertyType = typeof(TechControl.Метаданные._SystemTables.МониторингФормированиеСменыДеньТаблицаПерсонал);
            ...
            // 
            // ФормированиеСменыДеньФормаЭлемента
            // 
            this.AllowDrop = true;
            ...
            ((System.ComponentModel.ISupportInitialize)(this.vmoТаблицаТехника)).EndInit();
        ...
        private NsgVisualMultipleObject vmoТаблицаТехника;
        ...
        private _SystemTables.МониторингФормированиеСменыДеньТаблицаТехника.ColumnDescriptor ТаблицаТехника;
        private NsgColumnDescriptor.Int64 ВсегоТехникиВРаботе;
        private NsgColumnDescriptor.Int64 ВсегоТехникиВРемонте;
        private NsgColumnDescriptor.Int64 ВсегоТехникиНеВРаботе;
        private NsgColumnDescriptor.Int64 ВсегоТехникиСломано;
        private NsgColumnDescriptor.Int64 КоличествоТехники;
        private Объекты.ColumnDescriptor Объект;
        private ФизЛица.ColumnDescriptor Ответственный;
        private _SystemTables.МониторингФормированиеСменыДеньТаблицаПерсонал.ColumnDescriptor ТаблицаПерсонал;
        ...
        private NsgColumnDescriptor.Guid Идентификатор_vmoТаблицаПерсонал;
