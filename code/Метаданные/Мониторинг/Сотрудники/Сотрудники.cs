...
namespace TechControl.Метаданные.Мониторинг
{
    ...
    public partial class Сотрудники
    {
        ...
        public Размеры ПолучитьРазмер(Номенклатура номенклатураОдежды, ВидыРазмернойСетки видРазмернойСетки = null, ВидСвойствНоменклатуры видНоменклатуры = null) 
        {
            ...
            else if (подходящиеРазмеры.Length > 1)
            {
            ...
            else 
            {
                ...
                else if (ближайшиеБольшиеРазмеры.Length > 1)
                {
                    ...
                    foreach (var разм in ближайшиеБольшиеРазмеры)
                    {
                        ...
                        if (разм.БоковаяДлинаБрюкМин > мерка.БоковаяДлинаБрюк && мерка.БоковаяДлинаБрюк != 0 && разм.БоковаяДлинаБрюкМин == ближайшиеБольшиеРазмеры.Where(x => x.БоковаяДлинаБрюкМин > мерка.БоковаяДлинаБрюк).OrderBy(x => x.БоковаяДлинаБрюкМин).First().БоковаяДлинаБрюкМин)
                            совпадения[разм]++;

                        if (разм.ВнутренняяДлинаБрюкМин > мерка.ДлинаБрюкПоВнутреннемуШву && мерка.ДлинаБрюкПоВнутреннемуШву != 0 && разм.ВнутренняяДлинаБрюкМин == ближайшиеБольшиеРазмеры.Where(x => x.ВнутренняяДлинаБрюкМин > мерка.ДлинаБрюкПоВнутреннемуШву).OrderBy(x => x.ВнутренняяДлинаБрюкМин).First().ВнутренняяДлинаБрюкМин)
                            совпадения[разм]++;

                        if (разм.ДлинаРукаваМин > мерка.ДлинаРукава && мерка.ДлинаРукава != 0 && разм.ДлинаРукаваМин == ближайшиеБольшиеРазмеры.Where(x => x.ДлинаРукаваМин > мерка.ДлинаРукава).OrderBy(x => x.ДлинаРукаваМин).First().ДлинаРукаваМин)
                            совпадения[разм]++;

                        if (разм.ДлинаСтупниМин > мерка.ДлинаСтопы && мерка.ДлинаСтопы != 0 && разм.ДлинаСтупниМин == ближайшиеБольшиеРазмеры.Where(x => x.ДлинаСтупниМин > мерка.ДлинаСтопы).OrderBy(x => x.ДлинаСтупниМин).First().ДлинаСтупниМин)
                            совпадения[разм]++;

                        if (разм.ОбхватБедерМин > мерка.ОбхватБедер && мерка.ОбхватБедер != 0 && разм.ОбхватБедерМин == ближайшиеБольшиеРазмеры.Where(x => x.ОбхватБедерМин > мерка.ОбхватБедер).OrderBy(x => x.ОбхватБедерМин).First().ОбхватБедерМин)
                            совпадения[разм]++;

                        if (разм.ОбхватГрудиМин > мерка.ОбхватГруди && мерка.ОбхватГруди != 0 && разм.ОбхватГрудиМин == ближайшиеБольшиеРазмеры.Where(x => x.ОбхватГрудиМин > мерка.ОбхватГруди).OrderBy(x => x.ОбхватГрудиМин).First().ОбхватГрудиМин)
                            совпадения[разм]++;

                        if (разм.ОбхватТалииМин > мерка.ОбхватТалии && мерка.ОбхватТалии != 0 && разм.ОбхватТалииМин == ближайшиеБольшиеРазмеры.Where(x => x.ОбхватТалииМин > мерка.ОбхватТалии).OrderBy(x => x.ОбхватТалииМин).First().ОбхватТалииМин)
                            совпадения[разм]++;

                        if (разм.ОбхватШеиМин > мерка.ОбхватШеи && мерка.ОбхватШеи != 0 && разм.ОбхватШеиМин == ближайшиеБольшиеРазмеры.Where(x => x.ОбхватШеиМин > мерка.ОбхватШеи).OrderBy(x => x.ОбхватШеиМин).First().ОбхватШеиМин)
                            совпадения[разм]++;
                        ...
                        if (разм.ОбхватГоловыМин > мерка.ОбхватГоловы && мерка.ОбхватГоловы != 0 && разм.ОбхватГоловыМин == ближайшиеБольшиеРазмеры.Where(x => x.ОбхватГоловыМин > мерка.ОбхватГоловы).OrderBy(x => x.ОбхватГоловыМин).First().ОбхватГоловыМин)
                            совпадения[разм]++;
                    }
