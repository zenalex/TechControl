...

{
    ...
    public partial class СотрудникиФормаЭлемента:NsgSoft.Forms.NsgMultipleObjectElementForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.Идентификатор_nsgVisualMultipleObject1_1 = new NsgSoft.Forms.NsgColumnDescriptor.Guid();
            this.Автоинкремент_nsgVisualMultipleObject1_1 = new NsgSoft.Forms.NsgColumnDescriptor.Int64();
            this.ЭтоГруппа_nsgVisualMultipleObject1_1 = new NsgSoft.Forms.NsgColumnDescriptor.Boolean();
            this.ИдентификаторРодителя_nsgVisualMultipleObject1_1 = new NsgSoft.Forms.NsgColumnDescriptor.Guid();
            this.Уровень_nsgVisualMultipleObject1_1 = new NsgSoft.Forms.NsgColumnDescriptor.Byte();
            this.ПрефиксКода_nsgVisualMultipleObject1_1 = new NsgSoft.Forms.NsgColumnDescriptor.String();
            this.НомерКода_nsgVisualMultipleObject1_1 = new NsgSoft.Forms.NsgColumnDescriptor.Int64();
            this.Код_nsgVisualMultipleObject1_1 = new NsgSoft.Forms.NsgColumnDescriptor.String();
            this.Наименование_nsgVisualMultipleObject1_1 = new NsgSoft.Forms.NsgColumnDescriptor.String();
            this.СостояниеДокумента_nsgVisualMultipleObject1_1 = new TechControl.Метаданные.Сервис.СостоянияОбъекта.ColumnDescriptor();
            this.Владелец_nsgVisualMultipleObject1_1 = new NsgSoft.Forms.NsgColumnDescriptor.MultipleObject();
        ...
        "Visible"};
            ...
            this.vmoДокументы.Columns.Collection.Add(this.Идентификатор_nsgVisualMultipleObject1_1);
            this.vmoДокументы.Columns.Collection.Add(this.Автоинкремент_nsgVisualMultipleObject1_1);
            this.vmoДокументы.Columns.Collection.Add(this.ЭтоГруппа_nsgVisualMultipleObject1_1);
            this.vmoДокументы.Columns.Collection.Add(this.ИдентификаторРодителя_nsgVisualMultipleObject1_1);
            this.vmoДокументы.Columns.Collection.Add(this.Уровень_nsgVisualMultipleObject1_1);
            this.vmoДокументы.Columns.Collection.Add(this.ПрефиксКода_nsgVisualMultipleObject1_1);
            this.vmoДокументы.Columns.Collection.Add(this.НомерКода_nsgVisualMultipleObject1_1);
            this.vmoДокументы.Columns.Collection.Add(this.Код_nsgVisualMultipleObject1_1);
            this.vmoДокументы.Columns.Collection.Add(this.Наименование_nsgVisualMultipleObject1_1);
            this.vmoДокументы.Columns.Collection.Add(this.СостояниеДокумента_nsgVisualMultipleObject1_1);
            this.vmoДокументы.Columns.Collection.Add(this.Владелец_nsgVisualMultipleObject1_1);
            ...
            this.vmoДокументы.Columns.Collection.Add(this.Родитель_nsgVisualMultipleObject1_1);
            ...
            // 
            // Идентификатор_nsgVisualMultipleObject1_1
            // 
            this.Идентификатор_nsgVisualMultipleObject1_1.AutoGenerated = true;
            this.Идентификатор_nsgVisualMultipleObject1_1.Caption = "Идентификатор";
            this.Идентификатор_nsgVisualMultipleObject1_1.Creator = typeof(NsgSoft.Forms.NsgMultipleObjectElementForm);
            this.Идентификатор_nsgVisualMultipleObject1_1.Name = "Идентификатор";
            this.Идентификатор_nsgVisualMultipleObject1_1.NSGType = typeof(NsgSoft.DataObjects.NsgDataGuid);
            this.Идентификатор_nsgVisualMultipleObject1_1.PropertyType = typeof(System.Guid);
            this.Идентификатор_nsgVisualMultipleObject1_1.SearchCondition.OwnerComponent = this.Идентификатор_nsgVisualMultipleObject1_1;
            this.Идентификатор_nsgVisualMultipleObject1_1.SearchCondition.Parameters = new NsgSoft.DataObjects.NsgCompareParam[0];
            this.Идентификатор_nsgVisualMultipleObject1_1.Visible = false;
            // 
            // Автоинкремент_nsgVisualMultipleObject1_1
            // 
            this.Автоинкремент_nsgVisualMultipleObject1_1.AutoGenerated = true;
            this.Автоинкремент_nsgVisualMultipleObject1_1.CalcTotal = false;
            this.Автоинкремент_nsgVisualMultipleObject1_1.Caption = "Автоинкремент";
            this.Автоинкремент_nsgVisualMultipleObject1_1.Creator = typeof(NsgSoft.Forms.NsgMultipleObjectElementForm);
            this.Автоинкремент_nsgVisualMultipleObject1_1.Name = "Автоинкремент";
            this.Автоинкремент_nsgVisualMultipleObject1_1.NSGType = typeof(NsgSoft.DataObjects.NsgDataInteger);
            this.Автоинкремент_nsgVisualMultipleObject1_1.PropertyType = typeof(long);
            this.Автоинкремент_nsgVisualMultipleObject1_1.SearchCondition.OwnerComponent = this.Автоинкремент_nsgVisualMultipleObject1_1;
            this.Автоинкремент_nsgVisualMultipleObject1_1.SearchCondition.Parameters = new NsgSoft.DataObjects.NsgCompareParam[0];
            this.Автоинкремент_nsgVisualMultipleObject1_1.Visible = false;
            // 
            // ЭтоГруппа_nsgVisualMultipleObject1_1
            // 
            this.ЭтоГруппа_nsgVisualMultipleObject1_1.AutoGenerated = true;
            this.ЭтоГруппа_nsgVisualMultipleObject1_1.Caption = "ЭтоГруппа";
            this.ЭтоГруппа_nsgVisualMultipleObject1_1.Creator = typeof(NsgSoft.Forms.NsgMultipleObjectElementForm);
            this.ЭтоГруппа_nsgVisualMultipleObject1_1.Name = "ЭтоГруппа";
            this.ЭтоГруппа_nsgVisualMultipleObject1_1.NSGType = typeof(NsgSoft.DataObjects.NsgDataBoolean);
            this.ЭтоГруппа_nsgVisualMultipleObject1_1.PropertyType = typeof(bool);
            this.ЭтоГруппа_nsgVisualMultipleObject1_1.SearchCondition.OwnerComponent = this.ЭтоГруппа_nsgVisualMultipleObject1_1;
            this.ЭтоГруппа_nsgVisualMultipleObject1_1.SearchCondition.Parameters = new NsgSoft.DataObjects.NsgCompareParam[0];
            this.ЭтоГруппа_nsgVisualMultipleObject1_1.Visible = false;
            // 
            // ИдентификаторРодителя_nsgVisualMultipleObject1_1
            // 
            this.ИдентификаторРодителя_nsgVisualMultipleObject1_1.AutoGenerated = true;
            this.ИдентификаторРодителя_nsgVisualMultipleObject1_1.Caption = "ИдентификаторРодителя";
            this.ИдентификаторРодителя_nsgVisualMultipleObject1_1.Creator = typeof(NsgSoft.Forms.NsgMultipleObjectElementForm);
            this.ИдентификаторРодителя_nsgVisualMultipleObject1_1.Name = "ИдентификаторРодителя";
            this.ИдентификаторРодителя_nsgVisualMultipleObject1_1.NSGType = typeof(NsgSoft.DataObjects.NsgDataGuid);
            this.ИдентификаторРодителя_nsgVisualMultipleObject1_1.PropertyType = typeof(System.Guid);
            this.ИдентификаторРодителя_nsgVisualMultipleObject1_1.SearchCondition.OwnerComponent = this.ИдентификаторРодителя_nsgVisualMultipleObject1_1;
            this.ИдентификаторРодителя_nsgVisualMultipleObject1_1.SearchCondition.Parameters = new NsgSoft.DataObjects.NsgCompareParam[0];
            this.ИдентификаторРодителя_nsgVisualMultipleObject1_1.Visible = false;
            // 
            // Уровень_nsgVisualMultipleObject1_1
            // 
            this.Уровень_nsgVisualMultipleObject1_1.AutoGenerated = true;
            this.Уровень_nsgVisualMultipleObject1_1.Caption = "Уровень";
            this.Уровень_nsgVisualMultipleObject1_1.Creator = typeof(NsgSoft.Forms.NsgMultipleObjectElementForm);
            this.Уровень_nsgVisualMultipleObject1_1.Name = "Уровень";
            this.Уровень_nsgVisualMultipleObject1_1.NSGType = typeof(NsgSoft.DataObjects.NsgDataByte);
            this.Уровень_nsgVisualMultipleObject1_1.PropertyType = typeof(byte);
            this.Уровень_nsgVisualMultipleObject1_1.SearchCondition.OwnerComponent = this.Уровень_nsgVisualMultipleObject1_1;
            this.Уровень_nsgVisualMultipleObject1_1.SearchCondition.Parameters = new NsgSoft.DataObjects.NsgCompareParam[0];
            this.Уровень_nsgVisualMultipleObject1_1.Visible = false;
            // 
            // ПрефиксКода_nsgVisualMultipleObject1_1
            // 
            this.ПрефиксКода_nsgVisualMultipleObject1_1.AutoGenerated = true;
            this.ПрефиксКода_nsgVisualMultipleObject1_1.Caption = "ПрефиксКода";
            this.ПрефиксКода_nsgVisualMultipleObject1_1.Creator = typeof(NsgSoft.Forms.NsgMultipleObjectElementForm);
            this.ПрефиксКода_nsgVisualMultipleObject1_1.Name = "ПрефиксКода";
            this.ПрефиксКода_nsgVisualMultipleObject1_1.NSGType = typeof(NsgSoft.DataObjects.NsgDataString);
            this.ПрефиксКода_nsgVisualMultipleObject1_1.PropertyType = typeof(string);
            this.ПрефиксКода_nsgVisualMultipleObject1_1.SearchCondition.OwnerComponent = this.ПрефиксКода_nsgVisualMultipleObject1_1;
            this.ПрефиксКода_nsgVisualMultipleObject1_1.SearchCondition.Parameters = new NsgSoft.DataObjects.NsgCompareParam[0];
            this.ПрефиксКода_nsgVisualMultipleObject1_1.Visible = false;
            // 
            // НомерКода_nsgVisualMultipleObject1_1
            // 
            this.НомерКода_nsgVisualMultipleObject1_1.AutoGenerated = true;
            this.НомерКода_nsgVisualMultipleObject1_1.CalcTotal = false;
            this.НомерКода_nsgVisualMultipleObject1_1.Caption = "НомерКода";
            this.НомерКода_nsgVisualMultipleObject1_1.Creator = typeof(NsgSoft.Forms.NsgMultipleObjectElementForm);
            this.НомерКода_nsgVisualMultipleObject1_1.Name = "НомерКода";
            this.НомерКода_nsgVisualMultipleObject1_1.NSGType = typeof(NsgSoft.DataObjects.NsgDataInteger);
            this.НомерКода_nsgVisualMultipleObject1_1.PropertyType = typeof(long);
            this.НомерКода_nsgVisualMultipleObject1_1.SearchCondition.OwnerComponent = this.НомерКода_nsgVisualMultipleObject1_1;
            this.НомерКода_nsgVisualMultipleObject1_1.SearchCondition.Parameters = new NsgSoft.DataObjects.NsgCompareParam[0];
            this.НомерКода_nsgVisualMultipleObject1_1.Visible = false;
            // 
            // Код_nsgVisualMultipleObject1_1
            // 
            this.Код_nsgVisualMultipleObject1_1.AutoGenerated = true;
            this.Код_nsgVisualMultipleObject1_1.Caption = "Код";
            this.Код_nsgVisualMultipleObject1_1.Creator = typeof(NsgSoft.Forms.NsgMultipleObjectElementForm);
            this.Код_nsgVisualMultipleObject1_1.Name = "Код";
            this.Код_nsgVisualMultipleObject1_1.NSGType = typeof(NsgSoft.DataObjects.NsgDataString);
            this.Код_nsgVisualMultipleObject1_1.PropertyType = typeof(string);
            this.Код_nsgVisualMultipleObject1_1.SearchCondition.OwnerComponent = this.Код_nsgVisualMultipleObject1_1;
            this.Код_nsgVisualMultipleObject1_1.SearchCondition.Parameters = new NsgSoft.DataObjects.NsgCompareParam[0];
            // 
            // Наименование_nsgVisualMultipleObject1_1
            // 
            this.Наименование_nsgVisualMultipleObject1_1.AutoGenerated = true;
            this.Наименование_nsgVisualMultipleObject1_1.Caption = "Наименование";
            this.Наименование_nsgVisualMultipleObject1_1.Creator = typeof(NsgSoft.Forms.NsgMultipleObjectElementForm);
            this.Наименование_nsgVisualMultipleObject1_1.Name = "Наименование";
            this.Наименование_nsgVisualMultipleObject1_1.NSGType = typeof(NsgSoft.DataObjects.NsgDataString);
            this.Наименование_nsgVisualMultipleObject1_1.PropertyType = typeof(string);
            this.Наименование_nsgVisualMultipleObject1_1.SearchCondition.OwnerComponent = this.Наименование_nsgVisualMultipleObject1_1;
            this.Наименование_nsgVisualMultipleObject1_1.SearchCondition.Parameters = new NsgSoft.DataObjects.NsgCompareParam[0];
            // 
            // СостояниеДокумента_nsgVisualMultipleObject1_1
            // 
            this.СостояниеДокумента_nsgVisualMultipleObject1_1.AutoGenerated = true;
            this.СостояниеДокумента_nsgVisualMultipleObject1_1.Caption = "СостояниеДокумента";
            this.СостояниеДокумента_nsgVisualMultipleObject1_1.Creator = typeof(NsgSoft.Forms.NsgMultipleObjectElementForm);
            this.СостояниеДокумента_nsgVisualMultipleObject1_1.Name = "СостояниеДокумента";
            this.СостояниеДокумента_nsgVisualMultipleObject1_1.NSGType = typeof(TechControl.Метаданные.Сервис.СостоянияОбъекта);
            this.СостояниеДокумента_nsgVisualMultipleObject1_1.PropertyType = typeof(TechControl.Метаданные.Сервис.СостоянияОбъекта);
            this.СостояниеДокумента_nsgVisualMultipleObject1_1.SearchCondition.OwnerComponent = this.СостояниеДокумента_nsgVisualMultipleObject1_1;
            this.СостояниеДокумента_nsgVisualMultipleObject1_1.SearchCondition.Parameters = new NsgSoft.DataObjects.NsgCompareParam[0];
            // 
            // Владелец_nsgVisualMultipleObject1_1
            // 
            this.Владелец_nsgVisualMultipleObject1_1.AutoGenerated = true;
            this.Владелец_nsgVisualMultipleObject1_1.Caption = "Владелец";
            this.Владелец_nsgVisualMultipleObject1_1.Creator = typeof(NsgSoft.Forms.NsgMultipleObjectElementForm);
            this.Владелец_nsgVisualMultipleObject1_1.Name = "Владелец";
            this.Владелец_nsgVisualMultipleObject1_1.NSGType = typeof(NsgSoft.DataObjects.NsgReferencedObject);
            this.Владелец_nsgVisualMultipleObject1_1.PropertyType = typeof(NsgSoft.DataObjects.NsgReferencedObject);
            this.Владелец_nsgVisualMultipleObject1_1.SearchCondition.OwnerComponent = this.Владелец_nsgVisualMultipleObject1_1;
            this.Владелец_nsgVisualMultipleObject1_1.SearchCondition.Parameters = new NsgSoft.DataObjects.NsgCompareParam[0];
            // 
            // ВидДокумента
            // 
            ...
            // 
            // Родитель_nsgVisualMultipleObject1_1
            // 
            this.Родитель_nsgVisualMultipleObject1_1.AutoGenerated = true;
            ...
            this.nsgInput26.FullName = "Мониторинг.Сотрудники.КартинкаПодпись";
            ...
            this.nsgInput25.FullName = "Мониторинг.Сотрудники.ФИОРодительныйПадеж";
            ...
            this.nsgInput24.FullName = "Мониторинг.Сотрудники.ФИО";
            ...
            this.nsgInput23.FullName = "Мониторинг.Сотрудники.ТабельныйНомер";
            ...
            this.nsgInput22.FullName = "Мониторинг.Сотрудники.ДатаПриемаНаРаботу";
            ...
            this.nsgInput21.FullName = "Мониторинг.Сотрудники.ДатаПриемаНаРаботу";
            ...
            this.nsgInput20.FullName = "Мониторинг.Сотрудники.ДатаРождения";
            ...
            nsgObjectDescriptor7.FullName = "_SystemTables.МониторингСотрудникиТаблицаСовмещаемыхДолжностей.Владелец";
            nsgObjectDescriptor7.MetaDataName = "Метаданные";
            nsgMasterDetailBinding4.DetailField = nsgObjectDescriptor7;
            nsgObjectDescriptor8.FullName = "Мониторинг.Сотрудники.ТаблицаСовмещаемыхДолжностей";
        ...
        protected NsgColumnDescriptor.Guid Идентификатор_nsgVisualMultipleObject1_1;
        protected NsgColumnDescriptor.Int64 Автоинкремент_nsgVisualMultipleObject1_1;
        protected NsgColumnDescriptor.Boolean ЭтоГруппа_nsgVisualMultipleObject1_1;
        protected NsgColumnDescriptor.Guid ИдентификаторРодителя_nsgVisualMultipleObject1_1;
        protected NsgColumnDescriptor.Byte Уровень_nsgVisualMultipleObject1_1;
        protected NsgColumnDescriptor.String ПрефиксКода_nsgVisualMultipleObject1_1;
        protected NsgColumnDescriptor.Int64 НомерКода_nsgVisualMultipleObject1_1;
        protected NsgColumnDescriptor.String Код_nsgVisualMultipleObject1_1;
        protected NsgColumnDescriptor.String Наименование_nsgVisualMultipleObject1_1;
        protected Сервис.СостоянияОбъекта.ColumnDescriptor СостояниеДокумента_nsgVisualMultipleObject1_1;
        protected NsgColumnDescriptor.MultipleObject Владелец_nsgVisualMultipleObject1_1;
        protected УчетСотрудников.ВидыДокументов.ColumnDescriptor ВидДокумента;
