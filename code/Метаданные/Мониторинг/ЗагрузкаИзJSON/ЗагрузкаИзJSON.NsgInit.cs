...
namespace TechControl.Метаданные.Мониторинг
{
    ...
    [NsgTypeName("NsgReportObject", Guid = "a5a25d60-5e4a-4e8d-9870-883814bb2574")]
    public partial class ЗагрузкаИзJSON : NsgSoft.DataObjects.NsgReportObject
    {
        #region Данные
        ...
        /// </summary>
        protected ЗагрузкаИзJSON(NsgObject obj)
            : base(obj)
        {
        }
        ...
        public static ЗагрузкаИзJSON Новый()
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("a5a25d60-5e4a-4e8d-9870-883814bb2574"));
            if (obj == null)
                obj = new ЗагрузкаИзJSON();
            return obj as ЗагрузкаИзJSON;
        }
	...
	Идентификатор.Guid = NsgService.StringToGuid("f6e0eafe-8177-499c-8e62-2d56c2d07984");
	...
	Автоинкремент.Guid = NsgService.StringToGuid("99f156ad-52d5-4871-8e29-f955a64038d9");
			...
			#region создание TechControl.Метаданные.Мониторинг.ЗагрузкаИзJSONФорма Форма
			{  
	...
	Форма.FormClassName = "TechControl.Метаданные.Мониторинг.ЗагрузкаИзJSONФорма";
	...
	Форма.GroupName = "";
	Форма.Guid = NsgService.StringToGuid("7cad64be-c7c8-4640-9371-ad1319f43dd6");
	
				if (!ObjectList.Contains("Форма"))
                    ObjectList.Add(Форма);
			}
			#endregion //создание TechControl.Метаданные.Мониторинг.ЗагрузкаИзJSONФорма Форма
	...
	Name = "ЗагрузкаИзJSON";
	Visible = true;
	Guid = NsgService.StringToGuid("a5a25d60-5e4a-4e8d-9870-883814bb2574");
	DefaultSortingName = "";
	...
	TableName = "_report_ZagruzkaIzJSON";
	...
	GroupName = "Мониторинг";
        ...
        public override NsgMultipleObjectDescriptor Descriptor
        {
            get
            {
                if (descriptor == null)
                {
                    ...
                    descriptor.Name = "ЗагрузкаИзJSON";
        ...
        {
            return "Мониторинг.ЗагрузкаИзJSON";
        }
        ...
        private ЗагрузкаИзJSON[] convertArray(NsgMultipleObject[] array)
        {
            ЗагрузкаИзJSON[] res = new ЗагрузкаИзJSON[array.Length];
            array.CopyTo(res, 0);
            return res;
        }
        ...
        public new virtual ЗагрузкаИзJSON[] FindAll(NsgCompare compare)
        {
        ...
        /// <returns>Список найденных объектов.</returns>
        public new virtual ЗагрузкаИзJSON[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, NsgCompare compare)
        {
        ...
        /// <returns>Список найденных объектов.</returns>
        public new virtual ЗагрузкаИзJSON[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, string inName, object inValue)
        {
        ...
        /// <param name="inValue">Значение для поиска. Условие поиска - полное совпадение.</param>
        /// <returns>Список найденных объектов.</returns>
        public new virtual ЗагрузкаИзJSON[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, NsgDataFixedFields inName,
            object inValue)
        {
            return convertArray(base.FindAll(ref count, row_start, sorting, inName, inValue));
        }
        ...
        public override NsgObject CloneObject
        {
            get
            {
                return new ЗагрузкаИзJSON(this as NsgObject);
            }
        }
        ...
        public new class ColumnDescriptor : NsgSoft.Forms.NsgColumnDescriptor
        {
            public ColumnDescriptor()
                : base()
            {
                base.NSGType = typeof(ЗагрузкаИзJSON);
            }
			...
			public new ЗагрузкаИзJSON Value
            {
                get
                {
                    return (ЗагрузкаИзJSON)base.Value;
                }
                set
                {
                    base.Value = value;
