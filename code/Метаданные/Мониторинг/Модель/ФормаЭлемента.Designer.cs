...

{
    ...
    public partial class МодельФормаЭлемента:NsgSoft.Forms.NsgMultipleObjectElementForm
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(МодельФормаЭлемента));
            ...
            this.Родитель = new TechControl.Метаданные.Мониторинг.Модель.ColumnDescriptor();
            ...
            this.Comment.FullName = "Мониторинг.Модель.Идентификатор";
            ...
            this.nsgVisualMultipleObject.FullName = "Мониторинг.Модель";
            // 
            // label1
            // 
            ...
            this.nsgInput1.FullName = "Мониторинг.Модель.Наименование";
            ...
            this.nsgInput1.Location = new System.Drawing.Point(110, 18);
            ...
            this.nsgInput1.Size = new System.Drawing.Size(194, 20);
            ...
            this.nsgInput2.FullName = "Владелец";
            ...
            this.Родитель.NSGType = typeof(TechControl.Метаданные.Мониторинг.Модель);
            this.Родитель.PropertyType = typeof(TechControl.Метаданные.Мониторинг.Модель);
        ...
        protected Модель.ColumnDescriptor Родитель;
    }
}