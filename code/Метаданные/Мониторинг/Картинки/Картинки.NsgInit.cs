...
namespace TechControl.Метаданные.Мониторинг
{
    ...
    [NsgTypeName("NsgDataDictionary", Guid = "3be3cf62-104f-4102-8c1a-fba6a67c3de9")]
    public partial class Картинки : NsgSoft.DataObjects.NsgDataDictionary
    {
        #region Данные
        ...
        /// </summary>
        protected Картинки(NsgObject obj)
            : base(obj)
        {
        }
        ...
        public static Картинки Новый()
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("3be3cf62-104f-4102-8c1a-fba6a67c3de9"));
            if (obj == null)
                obj = new Картинки();
            return obj as Картинки;
        }
	...
	Идентификатор.Guid = NsgService.StringToGuid("01f293e1-f5bc-4388-885b-841ab7ba076e");
	...
	Автоинкремент.Guid = NsgService.StringToGuid("17ee5b79-7936-4d47-a94e-91e68c403fca");
	...
	ЭтоГруппа.GroupName = "";
	ЭтоГруппа.Guid = NsgService.StringToGuid("f12c7321-86a6-4695-8ff8-78e5ecbaca89");
	...
	ИдентификаторРодителя.Guid = NsgService.StringToGuid("b0d73173-28ae-4d68-b513-fb013103e1e9");
	...
	Уровень.GroupName = "";
	Уровень.Guid = NsgService.StringToGuid("bd97e714-43c0-4bc3-a235-d00a6b9ee872");
	...
	ПрефиксКода.Guid = NsgService.StringToGuid("36f68084-8197-4a3b-9a63-864a6634cf71");
	...
	НомерКода.GroupName = "";
	НомерКода.Guid = NsgService.StringToGuid("7a774a62-bf4b-415b-9d02-fb04303f82a5");
	...
	Код.GroupName = "";
	Код.Guid = NsgService.StringToGuid("239db757-b0ea-4f57-89ef-321b4f3331f2");
	...
	Наименование.Guid = NsgService.StringToGuid("b8bc854c-282c-4dfd-aa11-65e50b9d0963");
	...
	СостояниеДокумента.Guid = NsgService.StringToGuid("e1717193-4751-48c1-b469-cabd6937114a");
	...
	Владелец.FilterForConfigurator = "Мониторинг.Объекты,Мониторинг.Техника";
	...
	Владелец.GroupName = "";
	Владелец.Guid = NsgService.StringToGuid("3345b586-4fac-41f6-97d6-929f41107995");
			...
			#region создание TechControl.Метаданные.Мониторинг.КартинкиФормаЭлемента ФормаЭлемента
			{  
	...
	ФормаЭлемента.FormClassName = "TechControl.Метаданные.Мониторинг.КартинкиФормаЭлемента";
	...
	ФормаЭлемента.Guid = NsgService.StringToGuid("3348b2ed-dd15-42fc-a26d-0f60ff3588d6");
	
				if (!ObjectList.Contains("ФормаЭлемента"))
                    ObjectList.Add(ФормаЭлемента);
			}
			#endregion //создание TechControl.Метаданные.Мониторинг.КартинкиФормаЭлемента ФормаЭлемента
			
			#region создание System.Drawing.Image Картинка
			{  
                NsgDataImage Картинка = null;
				if (ObjectList.Contains("Картинка"))
                    Картинка = ObjectList["Картинка"] as NsgDataImage;
                else
                    Картинка = new NsgDataImage();
	//NsgDataImage
	Картинка.IsLoadedFromDll = true;
	Картинка.MaximumSize = new Size(2000,2000);
	Картинка.MinimumSize = new Size(10,10);
	Картинка.StretchImage = false;
	Картинка.IndexType = NsgSoft.Database.NsgRekvisitIndexType.None;
	Картинка.NullAllow = true;
	Картинка.StringFormat = "";
	Картинка.SubType = NsgSoft.Common.NsgRekvisitSubType.Common;
	Картинка.IncludeInPredefined = false;
	Картинка.PeriodicType = NsgSoft.Database.PeriodicTypes.None;
	Картинка.Required = false;
	Картинка.EmptyValue = "";
	Картинка.FieldName = "Kartinka";
	Картинка.SaveInDatabase = true;
	Картинка.InformMetaDataOnValueChanged = false;
	Картинка.Visible = true;
	Картинка.Name = "Картинка";
	Картинка.Presentation = new NsgSoft.DataObjects.NsgLanguageString(new System.String[]{"(Default)"},
		 new System.Object[]{""});
	Картинка.Description = "Картинка";
	Картинка.EditorVisible = NsgSoft.DataObjects.NsgDataObjectEditorAccess.Full;
	Картинка.GroupName = "";
	Картинка.Guid = NsgService.StringToGuid("715eee39-0445-4fc8-9662-2d56edfdf210");
	
				if (!ObjectList.Contains("Картинка"))
                    ObjectList.Add(Картинка);
			}
			#endregion //создание System.Drawing.Image Картинка
	...
	Name = "Картинки";
	Visible = true;
	Guid = NsgService.StringToGuid("3be3cf62-104f-4102-8c1a-fba6a67c3de9");
	DefaultSortingName = "Наименование";
	...
	GroupName = "Мониторинг";
        ...
        [NsgReferentsFilterAttribute("Мониторинг.Объекты,Мониторинг.Техника")]
        ...
        public System.Drawing.Image Картинка
        {
            get
            {
				 NsgDataImage __Картинка = ObjectList["Картинка"] as NsgDataImage;
                 return (System.Drawing.Image)__Картинка.Value;
            }
            set
            {
                NsgDataImage __Картинка = ObjectList["Картинка"] as NsgDataImage;
                __Картинка.Value = value;
            }
        }
        ...
        public Картинки Родитель
        {
            get
            {
                return base.Parent as Картинки;
            }
            set
            {
                base.Parent = value;
        ...
        private Картинки[] convertArray(NsgMultipleObject[] array)
        {
            Картинки[] res = new Картинки[array.Length];
            array.CopyTo(res, 0);
            return res;
        }
        ...
        public new virtual Картинки[] FindAll(NsgCompare compare)
        {
        ...
        /// <returns>Список найденных объектов.</returns>
        public new virtual Картинки[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, NsgCompare compare)
        {
        ...
        /// <returns>Список найденных объектов.</returns>
        public new virtual Картинки[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, string inName, object inValue)
        {
        ...
        /// <param name="inValue">Значение для поиска. Условие поиска - полное совпадение.</param>
        /// <returns>Список найденных объектов.</returns>
        public new virtual Картинки[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, NsgDataFixedFields inName,
            object inValue)
        {
            return convertArray(base.FindAll(ref count, row_start, sorting, inName, inValue));
        }
        ...
        public override NsgObject CloneObject
        {
            get
            {
                return new Картинки(this as NsgObject);
            }
        }
        ...
        public new class ColumnDescriptor : NsgSoft.Forms.NsgColumnDescriptor
        {
			...
			public new Картинки Value
            {
                get
                {
                    return (Картинки)base.Value;
                }
                set
                {
                    base.Value = value;
