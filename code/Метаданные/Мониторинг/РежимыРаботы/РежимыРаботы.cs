...
namespace TechControl.Метаданные.Мониторинг
{
    ...
    public partial class РежимыРаботы
    {
        ...
        protected override List<Guid> BasePost()
        {
            ...
            if (ТаблицаГрафик.AllRows.Any(x => x.ВремяНачалаСмены1 == NsgService.MinDate || x.ВремяОкончанияСмены1 == NsgService.MinDate))
            {
            ...
            if (ТаблицаГрафик.AllRows.Any(x => x.ВремяОкончанияСмены1 > x.ВремяКонцаРабочегоДня || x.ВремяОкончанияСмены2 > x.ВремяКонцаРабочегоДня || x.ВремяОкончанияСмены3 > x.ВремяКонцаРабочегоДня))
            {
                foreach (var item in ТаблицаГрафик.AllRows)
                {
                    if (item.ВремяОкончанияСмены1 > item.ВремяКонцаРабочегоДня)
                    {
                        item.ВремяОкончанияСмены1 = item.ВремяКонцаРабочегоДня;
                    }
                    if (item.ВремяОкончанияСмены2 > item.ВремяКонцаРабочегоДня)
                    {
                        item.ВремяОкончанияСмены2 = item.ВремяКонцаРабочегоДня;
                    }
                    if (item.ВремяОкончанияСмены3 > item.ВремяКонцаРабочегоДня)
                    {
                        item.ВремяОкончанияСмены3 = item.ВремяКонцаРабочегоДня;
                    }
                }
            }
