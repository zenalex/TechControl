...

{
    ...
    public partial class РежимыРаботыФормаЭлемента:NsgSoft.Forms.NsgMultipleObjectElementForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.nsgInput1.Size = new System.Drawing.Size(149, 20);
        ...
        "Visible"};
            ...
            nsgIGridColumn1.SortDirection = NsgSoft.Database.NsgSortDirection.Ascending;
        ...
        "Visible"};
            ...
            nsgIGridColumn4.Name = "ВремяНачалаРабочегоДня";
        ...
        "Visible"};
            ...
            nsgIGridColumn5.Name = "ВремяКонцаРабочегоДня";
        ...
        "Visible"};
            ...
            nsgIGridColumn6.Name = "ВремяНачалаПерерыва";
        ...
        "Visible"};
            ...
            nsgIGridColumn7.Name = "ВремяКонцаПерерыва";
            ...
            this.nsgIGrid1.Location = new System.Drawing.Point(21, 50);
            ...
            this.nsgIGrid1.Size = new System.Drawing.Size(696, 261);
        ...
        private ДеньНедели.ColumnDescriptor ДеньНедели;
        private NsgColumnDescriptor.DateTime ВремяНачалаРабочегоДня;
        private NsgColumnDescriptor.DateTime ВремяКонцаРабочегоДня;
        private NsgColumnDescriptor.DateTime ВремяНачалаПерерыва;
