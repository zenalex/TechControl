...
namespace TechControl.Метаданные.Мониторинг
{
    ...
    [NsgTypeName("NsgDataDictionary", Guid = "8b823161-133b-44cd-95c8-543c94c21569")]
    public partial class РежимыРаботы : NsgSoft.DataObjects.NsgDataDictionary
    {
        #region Данные
        ...
        /// </summary>
        protected РежимыРаботы(NsgObject obj)
            : base(obj)
        {
        }
        ...
        public static РежимыРаботы Новый()
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("8b823161-133b-44cd-95c8-543c94c21569"));
            if (obj == null)
                obj = new РежимыРаботы();
            return obj as РежимыРаботы;
        }
	...
	Наименование.Guid = NsgService.StringToGuid("0342c492-c264-44b2-a9dc-f6d6fa9589ad");
	...
	СостояниеДокумента.Guid = NsgService.StringToGuid("5495437f-1dba-44de-b98a-1b7d4c9fdc0f");
	...
	Name = "РежимыРаботы";
	Visible = true;
	Guid = NsgService.StringToGuid("8b823161-133b-44cd-95c8-543c94c21569");
	DefaultSortingName = "";
	...
	GroupName = "Мониторинг";
        ...
        {
            return "Мониторинг.РежимыРаботы";
        }
        ...
        public РежимыРаботы Родитель
        {
            get
            {
                return base.Parent as РежимыРаботы;
            }
            set
            {
                base.Parent = value;
        ...
        private РежимыРаботы[] convertArray(NsgMultipleObject[] array)
        {
            РежимыРаботы[] res = new РежимыРаботы[array.Length];
            array.CopyTo(res, 0);
            return res;
        }
        ...
        public new virtual РежимыРаботы[] FindAll(NsgCompare compare)
        {
        ...
        /// <returns>Список найденных объектов.</returns>
        public new virtual РежимыРаботы[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, NsgCompare compare)
        {
        ...
        /// <returns>Список найденных объектов.</returns>
        public new virtual РежимыРаботы[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, string inName, object inValue)
        {
        ...
        /// <param name="inValue">Значение для поиска. Условие поиска - полное совпадение.</param>
        /// <returns>Список найденных объектов.</returns>
        public new virtual РежимыРаботы[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, NsgDataFixedFields inName,
            object inValue)
        {
            return convertArray(base.FindAll(ref count, row_start, sorting, inName, inValue));
        }
        ...
        public override NsgObject CloneObject
        {
            get
            {
                return new РежимыРаботы(this as NsgObject);
            }
        }
        ...
        public new class ColumnDescriptor : NsgSoft.Forms.NsgColumnDescriptor
        {
            public ColumnDescriptor()
                : base()
            {
                base.NSGType = typeof(РежимыРаботы);
            }
			...
			public new РежимыРаботы Value
            {
                get
                {
                    return (РежимыРаботы)base.Value;
                }
                set
                {
                    base.Value = value;
