...
namespace TechControl.Метаданные.Мониторинг
{
    ...
    [NsgTypeName("NsgReportObject", Guid = "c319148e-2197-4e21-85bd-70d09526193d")]
    public partial class ПолучениеДанныхСПИК : NsgSoft.DataObjects.NsgReportObject
    {
        #region Данные
        ...
        /// </summary>
        protected ПолучениеДанныхСПИК(NsgObject obj)
            : base(obj)
        {
        }
        ...
        public static ПолучениеДанныхСПИК Новый()
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("c319148e-2197-4e21-85bd-70d09526193d"));
            if (obj == null)
                obj = new ПолучениеДанныхСПИК();
            return obj as ПолучениеДанныхСПИК;
        }
	...
	Идентификатор.Guid = NsgService.StringToGuid("d4cf08ef-d868-46b3-be5e-a1d3eee0cf96");
	...
	Автоинкремент.Guid = NsgService.StringToGuid("7c8291b8-d321-44d7-9025-f89e2bc33755");
			...
			#region создание TechControl.Метаданные.Мониторинг.ПолучениеДанныхСПИКФорма Форма
			{  
	...
	Форма.FormClassName = "TechControl.Метаданные.Мониторинг.ПолучениеДанныхСПИКФорма";
	...
	Форма.GroupName = "";
	Форма.Guid = NsgService.StringToGuid("fbb2fc98-b214-4e52-afaa-1076b68be257");
	
				if (!ObjectList.Contains("Форма"))
                    ObjectList.Add(Форма);
			}
			#endregion //создание TechControl.Метаданные.Мониторинг.ПолучениеДанныхСПИКФорма Форма
			

			#region заполнение полей класса
				//NsgReportObject
	IsLoadedFromDll = true;
	Name = "ПолучениеДанныхСПИК";
	Visible = true;
	Guid = NsgService.StringToGuid("c319148e-2197-4e21-85bd-70d09526193d");
	DefaultSortingName = "";
	...
	TableName = "_report_PoluchenieDannyk";
	Presentation = new NsgSoft.DataObjects.NsgLanguageString(new System.String[]{"(Default)"},
		 new System.Object[]{""});
	Description = "Получение данных СПИК";
	...
	GroupName = "Мониторинг";
        ...
        public override NsgMultipleObjectDescriptor Descriptor
        {
            get
            {
                if (descriptor == null)
                {
                    ...
                    descriptor.Name = "ПолучениеДанныхСПИК";
        ...
        {
            return "Мониторинг.ПолучениеДанныхСПИК";
        }
        ...
        private ПолучениеДанныхСПИК[] convertArray(NsgMultipleObject[] array)
        {
            ПолучениеДанныхСПИК[] res = new ПолучениеДанныхСПИК[array.Length];
            array.CopyTo(res, 0);
            return res;
        }
        ...
        public new virtual ПолучениеДанныхСПИК[] FindAll(NsgCompare compare)
        {
        ...
        /// <returns>Список найденных объектов.</returns>
        public new virtual ПолучениеДанныхСПИК[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, NsgCompare compare)
        {
        ...
        /// <returns>Список найденных объектов.</returns>
        public new virtual ПолучениеДанныхСПИК[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, string inName, object inValue)
        {
        ...
        /// <param name="inValue">Значение для поиска. Условие поиска - полное совпадение.</param>
        /// <returns>Список найденных объектов.</returns>
        public new virtual ПолучениеДанныхСПИК[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, NsgDataFixedFields inName,
            object inValue)
        {
            return convertArray(base.FindAll(ref count, row_start, sorting, inName, inValue));
        }
        ...
        public override NsgObject CloneObject
        {
            get
            {
                return new ПолучениеДанныхСПИК(this as NsgObject);
            }
        }
        ...
        public new class ColumnDescriptor : NsgSoft.Forms.NsgColumnDescriptor
        {
            public ColumnDescriptor()
                : base()
            {
                base.NSGType = typeof(ПолучениеДанныхСПИК);
            }
			...
			public new ПолучениеДанныхСПИК Value
            {
                get
                {
                    return (ПолучениеДанныхСПИК)base.Value;
                }
                set
                {
                    base.Value = value;
