...
namespace TechControl.Метаданные.Мониторинг
{
    ...
    public partial class ВидОперацииЗаправки : NsgSoft.DataObjects.NsgDataEnum
	{
		#region Данные
	...
	GroupName = "Мониторинг";
		...
		public static ВидОперацииЗаправки Новый()
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("487e357b-cc2b-4d47-b0ac-6b8f822d2802"));
            if (obj == null)
                obj = new ВидОперацииЗаправки();
            return obj as ВидОперацииЗаправки;
        }

        /// <summary>
		/// Создание объекта
        /// </summary>
        protected ВидОперацииЗаправки()
            : base()
        {
        }
		...
		/// Создание объекта
        /// </summary>
        protected  ВидОперацииЗаправки(NsgObject obj)
            : base(obj)
        {
        ...
        {
            return "Мониторинг.ВидОперацииЗаправки";
        }
        ...
        public static ВидОперацииЗаправки Заправка
        {
            get
            {
                ВидОперацииЗаправки res = ВидОперацииЗаправки.Новый();
                res.Value = 0;
                return res;
            }
        }
        ...
        [NsgView(NsgViewTypes.DesignTime)]
        [NsgTypeName("NsgDataEnumElement")]
        public static ВидОперацииЗаправки Слив
        {
            get
            {
                ВидОперацииЗаправки res = ВидОперацииЗаправки.Новый();
        ...
        public static ВидОперацииЗаправки Parse(string str)
        {
            ВидОперацииЗаправки res = ВидОперацииЗаправки.Новый();
		...
		public override NsgObject CloneObject
        {
            get
            {
                return new ВидОперацииЗаправки(this as NsgObject);
            }
        }
        ...
        public new class ColumnDescriptor : NsgSoft.Forms.NsgColumnDescriptor
        {
            public ColumnDescriptor()
                : base()
            {
                base.NSGType = typeof(ВидОперацииЗаправки);
            }
            ...
            public new ВидОперацииЗаправки Value
            {
                get
                {
                    return (ВидОперацииЗаправки)base.Value;
                }
                set
                {
                    base.Value = value;
