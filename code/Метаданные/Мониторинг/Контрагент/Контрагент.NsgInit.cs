...
namespace TechControl.Метаданные.Мониторинг
{
    ...
    public partial class Контрагент : NsgSoft.DataObjects.NsgDataDictionary
    {
        #region Данные
        ...
        /// </summary>
        protected Контрагент(NsgObject obj)
            : base(obj)
        {
        }
	...
	GroupName = "Мониторинг";
        ...
        public Контрагент Родитель
        {
            get
            {
                return base.Parent as Контрагент;
            }
            set
            {
                base.Parent = value;
        ...
        private Контрагент[] convertArray(NsgMultipleObject[] array)
        {
            Контрагент[] res = new Контрагент[array.Length];
            array.CopyTo(res, 0);
            return res;
        }
        ...
        public new virtual Контрагент[] FindAll(NsgCompare compare)
        {
        ...
        /// <returns>Список найденных объектов.</returns>
        public new virtual Контрагент[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, NsgCompare compare)
        {
        ...
        /// <returns>Список найденных объектов.</returns>
        public new virtual Контрагент[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, string inName, object inValue)
        {
        ...
        /// <param name="inValue">Значение для поиска. Условие поиска - полное совпадение.</param>
        /// <returns>Список найденных объектов.</returns>
        public new virtual Контрагент[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, NsgDataFixedFields inName,
            object inValue)
        {
            return convertArray(base.FindAll(ref count, row_start, sorting, inName, inValue));
        }
        ...
        public override NsgObject CloneObject
        {
            get
            {
                return new Контрагент(this as NsgObject);
            }
        }
        ...
        public new class ColumnDescriptor : NsgSoft.Forms.NsgColumnDescriptor
        {
            public ColumnDescriptor()
                : base()
            {
                base.NSGType = typeof(Контрагент);
            }
			...
			public new Контрагент Value
            {
                get
                {
                    return (Контрагент)base.Value;
                }
                set
                {
                    base.Value = value;
