...

{
    ...
    public partial class СистемаМониторингаФормаЭлемента:NsgSoft.Forms.NsgMultipleObjectElementForm
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(СистемаМониторингаФормаЭлемента));
            ...
            this.Пароль = new NsgSoft.Forms.NsgColumnDescriptor.String();
            this.Адрес = new NsgSoft.Forms.NsgColumnDescriptor.String();
            this.Логин = new NsgSoft.Forms.NsgColumnDescriptor.String();
            this.Родитель = new TechControl.Метаданные.Мониторинг.СистемаМониторинга.ColumnDescriptor();
            ...
            this.Comment.FullName = "Мониторинг.СистемаМониторинга.Идентификатор";
            ...
            this.nsgVisualMultipleObject.Columns.Collection.Add(this.Пароль);
            this.nsgVisualMultipleObject.Columns.Collection.Add(this.Адрес);
            this.nsgVisualMultipleObject.Columns.Collection.Add(this.Логин);
            ...
            this.nsgVisualMultipleObject.FullName = "Мониторинг.СистемаМониторинга";
            // 
            // Идентификатор
            // 
            ...
            // Пароль
            // 
            this.Пароль.AutoGenerated = true;
            this.Пароль.Caption = "Пароль";
            this.Пароль.Creator = typeof(NsgSoft.Forms.NsgMultipleObjectElementForm);
            this.Пароль.Name = "Пароль";
            this.Пароль.NSGType = typeof(NsgSoft.DataObjects.NsgDataString);
            this.Пароль.PropertyType = typeof(string);
            this.Пароль.SearchCondition.OwnerComponent = this.Пароль;
            this.Пароль.SearchCondition.Parameters = new NsgSoft.DataObjects.NsgCompareParam[0];
            // 
            // Адрес
            // 
            ...
            // Логин
            // 
            this.Логин.AutoGenerated = true;
            this.Логин.Caption = "Логин";
            this.Логин.Creator = typeof(NsgSoft.Forms.NsgMultipleObjectElementForm);
            this.Логин.Name = "Логин";
            this.Логин.NSGType = typeof(NsgSoft.DataObjects.NsgDataString);
            this.Логин.PropertyType = typeof(string);
            this.Логин.SearchCondition.OwnerComponent = this.Логин;
            this.Логин.SearchCondition.Parameters = new NsgSoft.DataObjects.NsgCompareParam[0];
            // 
            // Родитель
            // 
            ...
            this.Родитель.NSGType = typeof(TechControl.Метаданные.Мониторинг.СистемаМониторинга);
            this.Родитель.PropertyType = typeof(TechControl.Метаданные.Мониторинг.СистемаМониторинга);
            ...
            this.nsgInput1.Location = new System.Drawing.Point(110, 21);
            ...
            this.nsgInput1.Size = new System.Drawing.Size(228, 20);
            ...
            this.nsgInput2.Location = new System.Drawing.Point(110, 48);
            ...
            this.nsgInput3.FullName = "Пароль";
            ...
            this.nsgInput3.Location = new System.Drawing.Point(110, 81);
            ...
            this.nsgInput4.Location = new System.Drawing.Point(110, 111);
            ...
            // 
            // СистемаМониторингаФормаЭлемента
            // 
            this.AllowDrop = true;
        ...
        protected NsgColumnDescriptor.String Пароль;
        protected NsgColumnDescriptor.String Адрес;
        protected NsgColumnDescriptor.String Логин;
        protected СистемаМониторинга.ColumnDescriptor Родитель;
