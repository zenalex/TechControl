...
namespace TT.Метаданные.Мониторинг
{
    ...
    [NsgTypeName("NsgDataDictionary", Guid = "0ef0b85b-1da6-4056-bea8-4d3b1f6452cb")]
    public partial class СистемаМониторинга : NsgSoft.DataObjects.NsgDataDictionary
    {
        #region Данные
        ...
        /// </summary>
        protected СистемаМониторинга(NsgObject obj)
            : base(obj)
        {
        }
        ...
        public static СистемаМониторинга Новый()
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("0ef0b85b-1da6-4056-bea8-4d3b1f6452cb"));
            if (obj == null)
                obj = new СистемаМониторинга();
            return obj as СистемаМониторинга;
        }
	...
	Наименование.Guid = NsgService.StringToGuid("db5f3216-edd2-458b-a0fb-cf5edc5c3c44");
	...
	СостояниеДокумента.Guid = NsgService.StringToGuid("33a570c3-681b-4708-9ed9-f4eb17b52fec");
	...
	Пароль.GroupName = "";
	Пароль.Guid = NsgService.StringToGuid("5072ead5-168a-47cc-8ac8-85f4707c257c");
	...
	Адрес.GroupName = "";
	Адрес.Guid = NsgService.StringToGuid("5ac6145d-6140-4f3d-a079-06bd19f1ec3d");
	...
	Логин.IncludeInPredefined = false;
	...
	Логин.EditorVisible = NsgSoft.DataObjects.NsgDataObjectEditorAccess.Full;
	Логин.GroupName = "";
	Логин.Guid = NsgService.StringToGuid("ace7430d-37b3-47fd-a2a7-2a33ca2020be");
	...
	Name = "СистемаМониторинга";
	Visible = true;
	Guid = NsgService.StringToGuid("0ef0b85b-1da6-4056-bea8-4d3b1f6452cb");
	DefaultSortingName = "";
	...
	TableName = "_dic_SistemaMonitoringa";
	...
	GroupName = "Мониторинг";
        ...
        public override NsgMultipleObjectDescriptor Descriptor
        {
            get
            {
                if (descriptor == null)
                {
                    ...
                    descriptor.Name = "СистемаМониторинга";
        ...
        {
            return "Мониторинг.СистемаМониторинга";
        }
        ...
        public СистемаМониторинга Родитель
        {
            get
            {
                return base.Parent as СистемаМониторинга;
            }
            set
            {
                base.Parent = value;
        ...
        private СистемаМониторинга[] convertArray(NsgMultipleObject[] array)
        {
            СистемаМониторинга[] res = new СистемаМониторинга[array.Length];
            array.CopyTo(res, 0);
            return res;
        }
        ...
        public new virtual СистемаМониторинга[] FindAll(NsgCompare compare)
        {
        ...
        /// <returns>Список найденных объектов.</returns>
        public new virtual СистемаМониторинга[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, NsgCompare compare)
        {
        ...
        /// <returns>Список найденных объектов.</returns>
        public new virtual СистемаМониторинга[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, string inName, object inValue)
        {
        ...
        /// <param name="inValue">Значение для поиска. Условие поиска - полное совпадение.</param>
        /// <returns>Список найденных объектов.</returns>
        public new virtual СистемаМониторинга[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, NsgDataFixedFields inName,
            object inValue)
        {
            return convertArray(base.FindAll(ref count, row_start, sorting, inName, inValue));
        }
        ...
        public override NsgObject CloneObject
        {
            get
            {
                return new СистемаМониторинга(this as NsgObject);
            }
        }
        ...
        public new class ColumnDescriptor : NsgSoft.Forms.NsgColumnDescriptor
        {
            public ColumnDescriptor()
                : base()
            {
                base.NSGType = typeof(СистемаМониторинга);
            }
			...
			public new СистемаМониторинга Value
            {
                get
                {
                    return (СистемаМониторинга)base.Value;
                }
                set
                {
                    base.Value = value;
