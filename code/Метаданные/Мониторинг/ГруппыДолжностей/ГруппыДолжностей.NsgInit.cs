...
namespace TechControl.Метаданные.Мониторинг
{
    ...
    [NsgTypeName("NsgDataDictionary", Guid = "18057bf2-50e9-4d0c-bc3a-ec0cbfa12cea")]
    public partial class ГруппыДолжностей : NsgSoft.DataObjects.NsgDataDictionary
    {
        #region Данные
        ...
        /// </summary>
        protected ГруппыДолжностей(NsgObject obj)
            : base(obj)
        {
        }
        ...
        public static ГруппыДолжностей Новый()
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("18057bf2-50e9-4d0c-bc3a-ec0cbfa12cea"));
            if (obj == null)
                obj = new ГруппыДолжностей();
            return obj as ГруппыДолжностей;
        }
	...
	Идентификатор.Guid = NsgService.StringToGuid("b0354cfa-a818-4b7a-8587-05b8a0e18783");
	...
	Автоинкремент.Guid = NsgService.StringToGuid("51ce7b68-4a06-4c09-8f1d-53098ad6e2b3");
	...
	ЭтоГруппа.GroupName = "";
	ЭтоГруппа.Guid = NsgService.StringToGuid("c7af5262-fd2f-4ba8-8391-9849e9633cb8");
	...
	ИдентификаторРодителя.Guid = NsgService.StringToGuid("a6e881b9-b68f-4fcd-a061-cd29cc0343a4");
	...
	Уровень.GroupName = "";
	Уровень.Guid = NsgService.StringToGuid("5492bf68-05d0-4687-a608-9141969a7434");
	...
	ПрефиксКода.Guid = NsgService.StringToGuid("297599bc-c2c6-43c6-873e-d95ef7321bd5");
	...
	НомерКода.GroupName = "";
	НомерКода.Guid = NsgService.StringToGuid("32f57f2d-8a75-4477-b161-24a70d54a09b");
	...
	Код.GroupName = "";
	Код.Guid = NsgService.StringToGuid("bd78759c-16b6-4fde-8a10-bad41ee15e21");
	...
	Наименование.Guid = NsgService.StringToGuid("e9092bac-2e49-4fde-9381-895227830036");
	...
	СостояниеДокумента.Guid = NsgService.StringToGuid("9193266e-0351-4951-bd6d-4c2371df89b6");
	...
	Приоритет.GroupName = "";
	Приоритет.Guid = NsgService.StringToGuid("f6d20fe4-3468-444d-a196-ab5d4ee7a783");
	...
	Name = "ГруппыДолжностей";
	Visible = true;
	Guid = NsgService.StringToGuid("18057bf2-50e9-4d0c-bc3a-ec0cbfa12cea");
	DefaultSortingName = "";
	...
	TableName = "_dic_GruppyDolzhnosteij";
	...
	GroupName = "Мониторинг";
        ...
        public override NsgMultipleObjectDescriptor Descriptor
        {
            get
            {
                if (descriptor == null)
                {
                    ...
                    descriptor.Name = "ГруппыДолжностей";
        ...
        {
            return "Мониторинг.ГруппыДолжностей";
        }
        ...
        public ГруппыДолжностей Родитель
        {
            get
            {
                return base.Parent as ГруппыДолжностей;
            }
            set
            {
                base.Parent = value;
        ...
        private ГруппыДолжностей[] convertArray(NsgMultipleObject[] array)
        {
            ГруппыДолжностей[] res = new ГруппыДолжностей[array.Length];
            array.CopyTo(res, 0);
            return res;
        }
        ...
        public new virtual ГруппыДолжностей[] FindAll(NsgCompare compare)
        {
        ...
        /// <returns>Список найденных объектов.</returns>
        public new virtual ГруппыДолжностей[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, NsgCompare compare)
        {
        ...
        /// <returns>Список найденных объектов.</returns>
        public new virtual ГруппыДолжностей[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, string inName, object inValue)
        {
        ...
        /// <param name="inValue">Значение для поиска. Условие поиска - полное совпадение.</param>
        /// <returns>Список найденных объектов.</returns>
        public new virtual ГруппыДолжностей[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, NsgDataFixedFields inName,
            object inValue)
        {
            return convertArray(base.FindAll(ref count, row_start, sorting, inName, inValue));
        }
        ...
        public override NsgObject CloneObject
        {
            get
            {
                return new ГруппыДолжностей(this as NsgObject);
            }
        }
        ...
        public new class ColumnDescriptor : NsgSoft.Forms.NsgColumnDescriptor
        {
            public ColumnDescriptor()
                : base()
            {
                base.NSGType = typeof(ГруппыДолжностей);
            }
			...
			public new ГруппыДолжностей Value
            {
                get
                {
                    return (ГруппыДолжностей)base.Value;
                }
                set
                {
                    base.Value = value;
