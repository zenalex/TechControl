...
namespace TechControl.Метаданные.Мониторинг
{
    ...
    [NsgTypeName("NsgDataDocument", Guid = "b9e3f94b-ccb6-4ede-a669-1c557c3921a0")]
    public partial class ЗакрытиеСмены : NsgSoft.DataObjects.NsgDataDocument
    {
        #region Данные
        ...
        /// </summary>
        protected ЗакрытиеСмены(NsgObject obj)
            : base(obj)
        {
        }
        ...
        public static ЗакрытиеСмены Новый()
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("b9e3f94b-ccb6-4ede-a669-1c557c3921a0"));
            if (obj == null)
                obj = new ЗакрытиеСмены();
            return obj as ЗакрытиеСмены;
        }
	...
	Идентификатор.Guid = NsgService.StringToGuid("6840f5e8-f83c-41e2-9116-c2f57c26e049");
	...
	Автоинкремент.Guid = NsgService.StringToGuid("b4aa3578-bcc4-4087-b206-5f6ff166a6fd");
	...
	ПрефиксКода.Guid = NsgService.StringToGuid("279087c5-368c-455c-9a4e-37958297216b");
	...
	НомерКода.GroupName = "";
	НомерКода.Guid = NsgService.StringToGuid("c6d735a0-63ef-4925-b525-dd62cc7a27ed");
	...
	НомерДокумента.Guid = NsgService.StringToGuid("13fd66a3-f626-4928-a9c4-f060507d3b0f");
	...
	ДатаДокумента.Guid = NsgService.StringToGuid("cd0d87d2-1a7b-424f-8049-f00b44abfe92");
	...
	Индекс.GroupName = "";
	Индекс.Guid = NsgService.StringToGuid("9f0f518e-45fe-4af1-b5ec-c707d94671cc");
	...
	ДокументОснование.Guid = NsgService.StringToGuid("e7cdc98b-5f61-4b87-8976-611c58194a5e");
	...
	Комментарий.Guid = NsgService.StringToGuid("549ca13b-0182-4e78-a3fa-8e1672232bd4");
	...
	СостояниеДокумента.Guid = NsgService.StringToGuid("46d5f59c-1393-437a-acb2-ac1db7ecbd9c");
	...
	Время.GroupName = "";
	Время.Guid = NsgService.StringToGuid("f93b56da-0f63-4581-b514-6e601e95f26f");
	...
	Техника.GroupName = "";
	Техника.Guid = NsgService.StringToGuid("8945c1fc-ef55-43c9-8db0-80524a8f2e15");
	...
	Объект.GroupName = "";
	Объект.Guid = NsgService.StringToGuid("5d590c31-a1ad-4bfb-8f4d-d9d0dcafa07a");
	...
	UsedRegistersForConfigurator = new NsgSoft.DataObjects.NsgPropertyCollection(new System.String[]{"Сервис.ПечатныеФормы", "Мониторинг.РегистрМониторингТехники", "Мониторинг.ФиксацияИстории", "Сервис.ПраваПользователей", "Мониторинг.МониторирнгТехники", "Мониторинг.РегистрОтработанногоВремени", "Мониторинг.РегистрЗакрытиеСмены"},
		 new System.Object[]{NsgSoft.DataObjects.NsgDataDocument.RegisterHandleRegime.None, NsgSoft.DataObjects.NsgDataDocument.RegisterHandleRegime.None, NsgSoft.DataObjects.NsgDataDocument.RegisterHandleRegime.None, NsgSoft.DataObjects.NsgDataDocument.RegisterHandleRegime.None, NsgSoft.DataObjects.NsgDataDocument.RegisterHandleRegime.None, NsgSoft.DataObjects.NsgDataDocument.RegisterHandleRegime.None, NsgSoft.DataObjects.NsgDataDocument.RegisterHandleRegime.None});
	...
	Name = "ЗакрытиеСмены";
	Visible = true;
	Guid = NsgService.StringToGuid("b9e3f94b-ccb6-4ede-a669-1c557c3921a0");
	DefaultSortingName = "";
	...
	GroupName = "Мониторинг";
        ...
        {
            return "Мониторинг.ЗакрытиеСмены";
        }
        ...
        private ЗакрытиеСмены[] convertArray(NsgMultipleObject[] array)
        {
            ЗакрытиеСмены[] res = new ЗакрытиеСмены[array.Length];
            array.CopyTo(res, 0);
            return res;
        }
        ...
        public new virtual ЗакрытиеСмены[] FindAll(NsgCompare compare)
        {
        ...
        /// <returns>Список найденных объектов.</returns>
        public new virtual ЗакрытиеСмены[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, NsgCompare compare)
        {
        ...
        /// <returns>Список найденных объектов.</returns>
        public new virtual ЗакрытиеСмены[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, string inName, object inValue)
        {
        ...
        /// <param name="inValue">Значение для поиска. Условие поиска - полное совпадение.</param>
        /// <returns>Список найденных объектов.</returns>
        public new virtual ЗакрытиеСмены[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, NsgDataFixedFields inName,
            object inValue)
        {
            return convertArray(base.FindAll(ref count, row_start, sorting, inName, inValue));
        }
        ...
        public override NsgObject CloneObject
        {
            get
            {
                return new ЗакрытиеСмены(this as NsgObject);
            }
        }
        ...
        public new class ColumnDescriptor : NsgSoft.Forms.NsgColumnDescriptor
        {
            public ColumnDescriptor()
                : base()
            {
                base.NSGType = typeof(ЗакрытиеСмены);
            }
			...
			public new ЗакрытиеСмены Value
            {
                get
                {
                    return (ЗакрытиеСмены)base.Value;
                }
                set
                {
                    base.Value = value;
