    ...
    public partial class ЗакрытиеСмены
    {
        protected override bool Handling()
        {
            ...
            foreach (var i in allRests.Rows)
            {
                ...
                регистрСмен.Сотрудник = фиксацияИстории.Сотрудник = i[ФиксацияИстории.Names.Сотрудник].ToReferent() as ФизЛица;
                ...
                var all = регистрСмен.GetCirculate(this.Время.AddSeconds(1), NsgService.MaxDate, new NsgCompare()
                    ...
                    .Add(РегистрСмен.Names.Сотрудник, i[ФиксацияИстории.Names.Сотрудник].ToReferent() as ФизЛица)
            ...
            foreach (var i in allRests.Rows)
            {
                ...
                регистрСмен.Сотрудник = фиксацияИсторииСотрудников.Сотрудник = i[ФиксацияИсторииСотрудников.Names.Сотрудник].ToReferent() as ФизЛица;
                ...
                фиксацияИсторииСотрудников.Сотрудник = i[ФиксацияИсторииСотрудников.Names.Сотрудник].ToReferent() as ФизЛица;
                ...
                var all = регистрСмен.GetCirculate(this.Время.AddSeconds(1), NsgService.MaxDate, new NsgCompare()
                    ...
                    .Add(РегистрСмен.Names.Сотрудник, i[ФиксацияИсторииСотрудников.Names.Сотрудник].ToReferent() as ФизЛица)
