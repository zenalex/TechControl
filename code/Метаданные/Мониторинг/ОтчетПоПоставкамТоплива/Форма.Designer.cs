...

{
    ...
    public partial class ОтчетПоПоставкамТопливаФорма:NsgSoft.Forms.NsgReportForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.СтоимостьЗаЛитр_ = new NsgSoft.Forms.NsgColumnDescriptor.Decimal();
            this.ИтогоЛ_ = new NsgSoft.Forms.NsgColumnDescriptor.Decimal();
            this.ИтогоРуб_ = new NsgSoft.Forms.NsgColumnDescriptor.Decimal();
            ...
            this.nsgVisualMultipleObject.Columns.Collection.Add(this.СтоимостьЗаЛитр_);
            this.nsgVisualMultipleObject.Columns.Collection.Add(this.ИтогоЛ_);
            this.nsgVisualMultipleObject.Columns.Collection.Add(this.ИтогоРуб_);
        ...
        "NsgSoft.CityGuide.Dll"};
            ...
            this.nsgReport1.ReportGuid = "3787ae81d4b64f709050cb86ff1cbdde";
        ...
        "Visible"};
            ...
            // СтоимостьЗаЛитр_
            // 
            this.СтоимостьЗаЛитр_.CalcTotal = false;
            this.СтоимостьЗаЛитр_.Caption = "СтоимостьЗаЛитр";
            this.СтоимостьЗаЛитр_.Creator = typeof(NsgSoft.Forms.NsgReportForm);
            this.СтоимостьЗаЛитр_.Name = "СтоимостьЗаЛитр";
            this.СтоимостьЗаЛитр_.NSGType = typeof(NsgSoft.DataObjects.NsgDataFloat);
            this.СтоимостьЗаЛитр_.PropertyType = typeof(decimal);
            this.СтоимостьЗаЛитр_.SearchCondition.OwnerComponent = this.СтоимостьЗаЛитр_;
            this.СтоимостьЗаЛитр_.SearchCondition.Parameters = new NsgSoft.DataObjects.NsgCompareParam[0];
            // 
            // ИтогоЛ_
            // 
            this.ИтогоЛ_.CalcTotal = false;
            this.ИтогоЛ_.Caption = "ИтогоЛ";
            this.ИтогоЛ_.Creator = typeof(NsgSoft.Forms.NsgReportForm);
            this.ИтогоЛ_.Name = "ИтогоЛ";
            this.ИтогоЛ_.NSGType = typeof(NsgSoft.DataObjects.NsgDataFloat);
            this.ИтогоЛ_.PropertyType = typeof(decimal);
            this.ИтогоЛ_.SearchCondition.OwnerComponent = this.ИтогоЛ_;
            this.ИтогоЛ_.SearchCondition.Parameters = new NsgSoft.DataObjects.NsgCompareParam[0];
            // 
            // ИтогоРуб_
            // 
            this.ИтогоРуб_.CalcTotal = false;
            this.ИтогоРуб_.Caption = "ИтогоРуб";
            this.ИтогоРуб_.Creator = typeof(NsgSoft.Forms.NsgReportForm);
            this.ИтогоРуб_.Name = "ИтогоРуб";
            this.ИтогоРуб_.NSGType = typeof(NsgSoft.DataObjects.NsgDataFloat);
            this.ИтогоРуб_.PropertyType = typeof(decimal);
            this.ИтогоРуб_.SearchCondition.OwnerComponent = this.ИтогоРуб_;
            this.ИтогоРуб_.SearchCondition.Parameters = new NsgSoft.DataObjects.NsgCompareParam[0];
            // 
            // Поставщик_
            // 
        ...
        protected NsgColumnDescriptor.Decimal СтоимостьЗаЛитр_;
        protected NsgColumnDescriptor.Decimal ИтогоЛ_;
        protected NsgColumnDescriptor.Decimal ИтогоРуб_;
