...
namespace TechControl.Метаданные._SystemTables
{
    ...
    [NsgTypeName("NsgDataTable", Guid = "603b57bb-a4fb-4ffc-8120-83a40154b2fe")]
    public partial class МониторингТехникаТарифы : NsgSoft.DataObjects.NsgDataTable
    {
        #region Данные
        ...
        /// Создание объекта
        /// </summary>
        protected МониторингТехникаТарифы()
            : base()
        {
        }
        ...
        /// </summary>
        protected МониторингТехникаТарифы(NsgObject obj)
            : base(obj)
        {
        }
        ...
        public static МониторингТехникаТарифы Новый()
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("603b57bb-a4fb-4ffc-8120-83a40154b2fe"));
            if (obj == null)
                obj = new МониторингТехникаТарифы();
            return obj as МониторингТехникаТарифы;
        }
	...
	Идентификатор.Guid = NsgService.StringToGuid("d656778c-feac-46e2-9b77-4b02a004dd4c");
	...
	Автоинкремент.Guid = NsgService.StringToGuid("07885b84-7e2a-486d-a9bc-f80453c17c11");
	...
	Владелец.GroupName = "";
	Владелец.Guid = NsgService.StringToGuid("d3f448cd-dc5f-4b94-b4bc-8a17347a682d");
	...
	НомерСтроки.Guid = NsgService.StringToGuid("c7c04a0c-22d1-4405-a8a7-01fb9dbc92cd");
	...
	Тариф.GroupName = "";
	Тариф.Guid = NsgService.StringToGuid("b80431b4-0802-4312-906c-00b6611561b2");
	...
	Стоимость.GroupName = "";
	Стоимость.Guid = NsgService.StringToGuid("1c42577f-81ec-4e05-a4fa-d7231174193a");
	...
	ИспользоватьПоУмолчанию.Guid = NsgService.StringToGuid("629b7fb0-7311-4ed1-9895-fd1fd5717a19");
	...
	Name = "МониторингТехникаТарифы";
	Visible = true;
	Guid = NsgService.StringToGuid("603b57bb-a4fb-4ffc-8120-83a40154b2fe");
	DefaultSortingName = "";
	...
	TableName = "_tab_MonitoringTekhnikaT";
	Presentation = new NsgSoft.DataObjects.NsgLanguageString(new System.String[]{"(Default)"},
		 new System.Object[]{""});
	Description = "Мониторинг техника тарифы";
	...
	GroupName = "_SystemTables";
        ...
        {
            return "_SystemTables.МониторингТехникаТарифы";
        }
        ...
        /// </summary>
        public new МониторингТехникаТарифы.Строка NewRow()
        {
            return newRow(null) as МониторингТехникаТарифы.Строка;
        }
        ...
        {
            if (row == null)
                row = new МониторингТехникаТарифы.Строка(this);
            return base.newRow(row) as МониторингТехникаТарифы.Строка;
        }

        /// <summary>
        /// Добавить новую строку в таблицу путем копирования переданной строки
        /// </summary>
        public МониторингТехникаТарифы.Строка NewRow(МониторингТехникаТарифы.Строка inRow)
        {
            МониторингТехникаТарифы.Строка row = inRow.Clone as МониторингТехникаТарифы.Строка;
            return base.newRow(row) as МониторингТехникаТарифы.Строка;
        }
        ...
        /// </summary>
        public new МониторингТехникаТарифы.Строка GetRow(int rowNumber)
        {
            return base.GetRow(rowNumber) as МониторингТехникаТарифы.Строка;
        }

        /// <summary>
        /// Возвращает новую строку таблицы, но в саму таблицу ее не включает (эталонная строка)
        /// </summary>
        public new МониторингТехникаТарифы.Строка GetEtalonRow()
        {
            МониторингТехникаТарифы.Строка row = new МониторингТехникаТарифы.Строка(this);
            row.MetaData = MetaData;
            return row;
        }

        private МониторингТехникаТарифы.Строка[] convertRowsArray(NsgDataTableRow[] array)
        {
            МониторингТехникаТарифы.Строка[] res = new МониторингТехникаТарифы.Строка[array.Length];
            array.CopyTo(res, 0);
            return res;
        }
        ...
        public new МониторингТехникаТарифы.Строка FindRowByTag(object Tag)
        {
            return base.FindRowByTag(Tag) as МониторингТехникаТарифы.Строка;
        }
        ...
        /// <param name="compare">Критерии поиска.</param>
        /// <returns>Найденные строки.</returns>
        public new МониторингТехникаТарифы.Строка[] FindRowsByTag(object Tag)
        {
        ...
        /// <param name="compare">Критерии поиска.</param>
        /// <returns>Найденные строки.</returns>
        public new МониторингТехникаТарифы.Строка FindRow(NsgCompare compare)
        {
            return base.FindRow(compare) as МониторингТехникаТарифы.Строка;
        }
        ...
        /// <returns>Найденные строки.</returns>
        public new МониторингТехникаТарифы.Строка FindRow(string inName, object inValue)
        {
            return base.FindRow(inName, inValue) as МониторингТехникаТарифы.Строка;
        }
        ...
        /// <param name="inValue">Значение поля.</param>
        /// <returns>Найденные строки.</returns>
        public new МониторингТехникаТарифы.Строка FindRow(NsgDataFixedFields inName, object inValue)
        {
            return base.FindRow(inName, inValue) as МониторингТехникаТарифы.Строка;
        }
        ...
        /// <param name="compare">Критерии поиска.</param>
        /// <returns>Найденные строки.</returns>
        public new МониторингТехникаТарифы.Строка[] FindRows(NsgCompare compare)
        {
        ...
        /// <param name="inValue">Значение поля.</param>
        /// <returns>Найденные строки.</returns>
        public new МониторингТехникаТарифы.Строка[] FindRows(string inName, object inValue)
        {
        ...
        /// <param name="inValue">Значение поля.</param>
        /// <returns>Найденные строки.</returns>
        public new МониторингТехникаТарифы.Строка[] FindRows(NsgDataFixedFields inName, object inValue)
        {
            return convertRowsArray(base.FindRows(inName, inValue));
        }
        ...
        /// </summary>
        public  NsgVirtualCursor<МониторингТехникаТарифы> GetNewVirtualCursor()
        {
            return base.GetNewVirtualCursor<МониторингТехникаТарифы>();
        }

        /// <summary>
        /// Получить все строки таблицы с учетом наложенного фильтра. Для получения всех сьтрок без учета фильтра используется свойство AllRows
        /// </summary>
        public new МониторингТехникаТарифы.Строка[] Rows
        {
            get
            {
        ...
        /// </summary>
        public new МониторингТехникаТарифы.Строка[] AllRows
        {
            get
            {
        ...
        /// <returns>Найденные строки.</returns>
        public new МониторингТехникаТарифы.Строка GetRow(Guid inID)
        {
            return base.GetRow(inID) as МониторингТехникаТарифы.Строка;
        }
        #endregion
        ...
        private МониторингТехникаТарифы[] convertArray(NsgMultipleObject[] array)
        {
            МониторингТехникаТарифы[] res = new МониторингТехникаТарифы[array.Length];
            array.CopyTo(res, 0);
            return res;
        }
        ...
        public new virtual МониторингТехникаТарифы[] FindAll(NsgCompare compare)
        {
        ...
        /// <returns>Список найденных объектов.</returns>
        public new virtual МониторингТехникаТарифы[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, NsgCompare compare)
        {
        ...
        /// <returns>Список найденных объектов.</returns>
        public new virtual МониторингТехникаТарифы[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, string inName, object inValue)
        {
        ...
        /// <param name="inValue">Значение для поиска. Условие поиска - полное совпадение.</param>
        /// <returns>Список найденных объектов.</returns>
        public new virtual МониторингТехникаТарифы[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, NsgDataFixedFields inName,
            object inValue)
        {
            return convertArray(base.FindAll(ref count, row_start, sorting, inName, inValue));
        }
        ...
        public override NsgObject CloneObject
        {
            get
            {
                return new МониторингТехникаТарифы(this as NsgObject);
            }
        }
        ...
        public new class ColumnDescriptor : NsgSoft.Forms.NsgColumnDescriptor
        {
            public ColumnDescriptor()
                : base()
            {
                base.NSGType = typeof(МониторингТехникаТарифы);
            }
			...
			public new МониторингТехникаТарифы Value
            {
                get
                {
                    return (МониторингТехникаТарифы)base.Value;
                }
                set
                {
                    base.Value = value;
