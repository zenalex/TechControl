...
namespace TT.Метаданные.Мониторинг
{
	...
	Марка.StringFormat = "";
	Марка.SubType = NsgSoft.Common.NsgRekvisitSubType.Common;
	...
	Марка.GroupName = "";
	Марка.Guid = NsgService.StringToGuid("c82f2f54-2e8c-46df-a7ae-8076741c8311");
	...
	Модель.StringFormat = "";
	Модель.SubType = NsgSoft.Common.NsgRekvisitSubType.Common;
	...
	Модель.GroupName = "";
	Модель.Guid = NsgService.StringToGuid("a59f9f96-822c-47b6-a63c-cfec7157a8aa");
	...
	ТипТС.GroupName = "";
	ТипТС.Guid = NsgService.StringToGuid("e4daf4e5-9b4f-4f52-8615-3af48d252bcc");
			...
			#region создание TT.Метаданные.Мониторинг.ТехникаФормаСписка ФормаСписка
			{  
	...
	ФормаСписка.FormClassName = "TT.Метаданные.Мониторинг.ТехникаФормаСписка";
	...
	ФормаСписка.Guid = NsgService.StringToGuid("3b0e1055-363b-4218-9dba-edf2494f1e08");
			...
			#endregion //создание TT.Метаданные.Мониторинг.ТехникаФормаСписка ФормаСписка
			
			#region создание TT.Метаданные.Мониторинг.ТехникаФормаЭлемента ФормаЭлемента
			{  
	...
	ФормаЭлемента.FormClassName = "TT.Метаданные.Мониторинг.ТехникаФормаЭлемента";
	...
	ФормаЭлемента.Guid = NsgService.StringToGuid("6414f41d-b43c-4998-8404-c36b3aa0341c");
			...
			#endregion //создание TT.Метаданные.Мониторинг.ТехникаФормаЭлемента ФормаЭлемента
	...
	ГодВыпуска.SubType = NsgSoft.Common.NsgRekvisitSubType.Common;
	...
	ГодВыпуска.Guid = NsgService.StringToGuid("1d55b81d-5106-46ba-b4a1-72346ef06de5");
	...
	ГосНомер.SubType = NsgSoft.Common.NsgRekvisitSubType.Common;
	...
	ГосНомер.GroupName = "";
	ГосНомер.Guid = NsgService.StringToGuid("d5079388-4202-4ae5-a60b-bfad004e53ba");
