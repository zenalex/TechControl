...
{
    public partial class МониторингТехникаТарифы
{
    [NsgTypeName("NsgDataTableRow", Guid = "603b57bb-a4fb-4ffc-8120-83a40154b2fe")]
    public partial class Строка : NsgSoft.DataObjects.NsgDataTableRow
    {
        ...
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("603b57bb-a4fb-4ffc-8120-83a40154b2fe"));
            if (obj == null)
                obj = new Строка();
        ...
        public override NsgMultipleObjectDescriptor Descriptor
        {
            get
            {
                if (descriptor == null)
                {
                    ...
                    descriptor.Name = "МониторингТехникаТарифы";
