...
namespace TechControl.Метаданные.Мониторинг
{
    ...
    [NsgTypeName("NsgReportObject", Guid = "99dad5ba-d40c-4957-9b8a-f2692eff097a")]
    public partial class ОтчетПоЗаправкам : NsgSoft.DataObjects.NsgReportObject
    {
        #region Данные
        ...
        /// </summary>
        protected ОтчетПоЗаправкам(NsgObject obj)
            : base(obj)
        {
        }
        ...
        public static ОтчетПоЗаправкам Новый()
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("99dad5ba-d40c-4957-9b8a-f2692eff097a"));
            if (obj == null)
                obj = new ОтчетПоЗаправкам();
            return obj as ОтчетПоЗаправкам;
        }
	...
	Автоинкремент.Guid = NsgService.StringToGuid("0510fa15-50c3-434d-a4d0-6cbbac26a2fe");
			...
			#region создание TechControl.Метаданные.Мониторинг.ОтчетПоЗаправкамФорма Форма
			{  
	...
	Форма.FormClassName = "TechControl.Метаданные.Мониторинг.ОтчетПоЗаправкамФорма";
	...
	Форма.GroupName = "";
	Форма.Guid = NsgService.StringToGuid("fbed7d20-5f33-4c46-a49c-1ea2a194de65");
	
				if (!ObjectList.Contains("Форма"))
                    ObjectList.Add(Форма);
			}
			#endregion //создание TechControl.Метаданные.Мониторинг.ОтчетПоЗаправкамФорма Форма
			

			#region заполнение полей класса
				//NsgReportObject
	IsLoadedFromDll = true;
	Name = "ОтчетПоЗаправкам";
	Visible = true;
	Guid = NsgService.StringToGuid("99dad5ba-d40c-4957-9b8a-f2692eff097a");
	DefaultSortingName = "";
	...
	TableName = "_report_OtchetPoZapravkam";
	...
	GroupName = "Мониторинг";
        ...
        public override NsgMultipleObjectDescriptor Descriptor
        {
            get
            {
                if (descriptor == null)
                {
                    ...
                    descriptor.Name = "ОтчетПоЗаправкам";
        ...
        {
            return "Мониторинг.ОтчетПоЗаправкам";
        }
        ...
        private ОтчетПоЗаправкам[] convertArray(NsgMultipleObject[] array)
        {
            ОтчетПоЗаправкам[] res = new ОтчетПоЗаправкам[array.Length];
            array.CopyTo(res, 0);
            return res;
        }
        ...
        public new virtual ОтчетПоЗаправкам[] FindAll(NsgCompare compare)
        {
        ...
        /// <returns>Список найденных объектов.</returns>
        public new virtual ОтчетПоЗаправкам[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, NsgCompare compare)
        {
        ...
        /// <returns>Список найденных объектов.</returns>
        public new virtual ОтчетПоЗаправкам[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, string inName, object inValue)
        {
        ...
        /// <param name="inValue">Значение для поиска. Условие поиска - полное совпадение.</param>
        /// <returns>Список найденных объектов.</returns>
        public new virtual ОтчетПоЗаправкам[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, NsgDataFixedFields inName,
            object inValue)
        {
            return convertArray(base.FindAll(ref count, row_start, sorting, inName, inValue));
        }
        ...
        public override NsgObject CloneObject
        {
            get
            {
                return new ОтчетПоЗаправкам(this as NsgObject);
            }
        }
        ...
        public new class ColumnDescriptor : NsgSoft.Forms.NsgColumnDescriptor
        {
            public ColumnDescriptor()
                : base()
            {
                base.NSGType = typeof(ОтчетПоЗаправкам);
            }
			...
			public new ОтчетПоЗаправкам Value
            {
                get
                {
                    return (ОтчетПоЗаправкам)base.Value;
                }
                set
                {
                    base.Value = value;
