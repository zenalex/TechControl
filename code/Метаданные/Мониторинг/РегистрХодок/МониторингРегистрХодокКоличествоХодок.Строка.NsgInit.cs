...
{
    public partial class МониторингРегистрХодокКоличествоХодок
{
    [NsgTypeName("NsgDataTableRow", Guid = "4c8634c4-ce95-41fc-8291-6e0ae1d726e0")]
    public partial class Строка : NsgSoft.DataObjects.NsgDataTableRow
    {
        ...
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("4c8634c4-ce95-41fc-8291-6e0ae1d726e0"));
            if (obj == null)
                obj = new Строка();
        ...
        public override NsgMultipleObjectDescriptor Descriptor
        {
            get
            {
                if (descriptor == null)
                {
                    ...
                    descriptor.Name = "МониторингРегистрХодокКоличествоХодок";
