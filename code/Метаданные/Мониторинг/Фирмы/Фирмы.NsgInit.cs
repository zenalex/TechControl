...
namespace TechControl.Метаданные.Мониторинг
{
    ...
    [NsgTypeName("NsgDataDictionary", Guid = "d79052cd-906c-494c-9499-78e49bee9ae7")]
    public partial class Фирмы : NsgSoft.DataObjects.NsgDataDictionary
    {
        #region Данные
        ...
        public static Фирмы Новый()
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("d79052cd-906c-494c-9499-78e49bee9ae7"));
            if (obj == null)
                obj = new Фирмы();
            return obj as Фирмы;
        }
	...
	Идентификатор.Guid = NsgService.StringToGuid("6b07fb78-b3a8-4b9a-9025-1ae68b1dc08a");
	...
	Автоинкремент.Guid = NsgService.StringToGuid("a2d8c7da-922a-471d-8eac-b9fd7955400c");
	...
	ЭтоГруппа.GroupName = "";
	ЭтоГруппа.Guid = NsgService.StringToGuid("9615d9d3-e43d-49f9-83aa-2fd5b876e9be");
	...
	ИдентификаторРодителя.Guid = NsgService.StringToGuid("b7232219-04e3-49f1-92bb-75422767caae");
	...
	Уровень.GroupName = "";
	Уровень.Guid = NsgService.StringToGuid("6492f546-3ec0-4bf9-9b77-d9891a590310");
	...
	ПрефиксКода.Guid = NsgService.StringToGuid("8d112b0e-144f-45e1-bd86-1b88c436acb4");
	...
	НомерКода.GroupName = "";
	НомерКода.Guid = NsgService.StringToGuid("ca2605f5-2021-4632-9976-b584e33a5b48");
	...
	Код.GroupName = "";
	Код.Guid = NsgService.StringToGuid("f1f6f1d4-feeb-4154-9e34-3194d7f21a92");
	...
	Наименование.Guid = NsgService.StringToGuid("e5f59fa7-6771-4376-8eee-73f0e115d195");
	...
	СостояниеДокумента.Guid = NsgService.StringToGuid("39aeb11c-1275-4d2f-a6c5-382b64d953cc");
	...
	Name = "Фирмы";
	Visible = true;
	Guid = NsgService.StringToGuid("d79052cd-906c-494c-9499-78e49bee9ae7");
	DefaultSortingName = "";
	...
	GroupName = "Мониторинг";
        ...
        public Фирмы Родитель
        {
            get
            {
                return base.Parent as Фирмы;
            }
            set
            {
                base.Parent = value;
        ...
        private Фирмы[] convertArray(NsgMultipleObject[] array)
        {
            Фирмы[] res = new Фирмы[array.Length];
            array.CopyTo(res, 0);
            return res;
        }
        ...
        public new virtual Фирмы[] FindAll(NsgCompare compare)
        {
        ...
        /// <returns>Список найденных объектов.</returns>
        public new virtual Фирмы[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, NsgCompare compare)
        {
        ...
        /// <returns>Список найденных объектов.</returns>
        public new virtual Фирмы[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, string inName, object inValue)
        {
        ...
        /// <param name="inValue">Значение для поиска. Условие поиска - полное совпадение.</param>
        /// <returns>Список найденных объектов.</returns>
        public new virtual Фирмы[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, NsgDataFixedFields inName,
            object inValue)
        {
            return convertArray(base.FindAll(ref count, row_start, sorting, inName, inValue));
        }
        ...
        public override NsgObject CloneObject
        {
            get
            {
                return new Фирмы(this as NsgObject);
            }
        }
        ...
        public new class ColumnDescriptor : NsgSoft.Forms.NsgColumnDescriptor
        {
			...
			public new Фирмы Value
            {
                get
                {
                    return (Фирмы)base.Value;
                }
                set
                {
                    base.Value = value;
