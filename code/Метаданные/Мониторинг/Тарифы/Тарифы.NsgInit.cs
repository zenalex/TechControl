...
namespace TechControl.Метаданные.Мониторинг
{
    ...
    [NsgTypeName("NsgDataDictionary", Guid = "2dfe9156-8aa8-4b1c-a023-01d22594cc78")]
    public partial class Тарифы : NsgSoft.DataObjects.NsgDataDictionary
    {
        #region Данные
        ...
        /// </summary>
        protected Тарифы(NsgObject obj)
            : base(obj)
        {
        }
        ...
        public static Тарифы Новый()
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("2dfe9156-8aa8-4b1c-a023-01d22594cc78"));
            if (obj == null)
                obj = new Тарифы();
            return obj as Тарифы;
        }
	...
	Идентификатор.Guid = NsgService.StringToGuid("927763d1-a410-4222-ac15-28c4d7edec73");
	...
	Автоинкремент.Guid = NsgService.StringToGuid("4eda7990-22b6-4339-a3e1-121f08e3693d");
	...
	ЭтоГруппа.GroupName = "";
	ЭтоГруппа.Guid = NsgService.StringToGuid("c8614696-b650-4a3d-929c-58aabc5e067a");
	...
	ИдентификаторРодителя.Guid = NsgService.StringToGuid("24369e2a-519f-4585-a60c-15c07ad8eb66");
	...
	Уровень.GroupName = "";
	Уровень.Guid = NsgService.StringToGuid("6e35cf7c-9e9a-470e-88cf-cb7da5265879");
	...
	ПрефиксКода.Guid = NsgService.StringToGuid("f483246f-d0cd-41bd-b044-62d365933314");
	...
	НомерКода.GroupName = "";
	НомерКода.Guid = NsgService.StringToGuid("8184d438-7acb-4c2e-b4e0-b90005fd338c");
	...
	Код.GroupName = "";
	Код.Guid = NsgService.StringToGuid("788a86cf-45e0-4a06-847a-655ebeaab4ce");
	...
	Наименование.Guid = NsgService.StringToGuid("fdebf411-3c2b-4810-b5d2-808566b4b742");
	...
	СостояниеДокумента.Guid = NsgService.StringToGuid("b71e8ff6-a139-4534-a7aa-efaa6f467785");
	...
	Стоимость.SubType = NsgSoft.Common.NsgRekvisitSubType.Element;
	...
	Стоимость.GroupName = "";
	Стоимость.Guid = NsgService.StringToGuid("90716f06-0c3f-4cb8-8de0-786b350a39c8");
	...
	Name = "Тарифы";
	Visible = true;
	Guid = NsgService.StringToGuid("2dfe9156-8aa8-4b1c-a023-01d22594cc78");
	DefaultSortingName = "";
	...
	GroupName = "Мониторинг";
        ...
        public Тарифы Родитель
        {
            get
            {
                return base.Parent as Тарифы;
            }
            set
            {
                base.Parent = value;
        ...
        private Тарифы[] convertArray(NsgMultipleObject[] array)
        {
            Тарифы[] res = new Тарифы[array.Length];
            array.CopyTo(res, 0);
            return res;
        }
        ...
        public new virtual Тарифы[] FindAll(NsgCompare compare)
        {
        ...
        /// <returns>Список найденных объектов.</returns>
        public new virtual Тарифы[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, NsgCompare compare)
        {
        ...
        /// <returns>Список найденных объектов.</returns>
        public new virtual Тарифы[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, string inName, object inValue)
        {
        ...
        /// <param name="inValue">Значение для поиска. Условие поиска - полное совпадение.</param>
        /// <returns>Список найденных объектов.</returns>
        public new virtual Тарифы[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, NsgDataFixedFields inName,
            object inValue)
        {
            return convertArray(base.FindAll(ref count, row_start, sorting, inName, inValue));
        }
        ...
        public override NsgObject CloneObject
        {
            get
            {
                return new Тарифы(this as NsgObject);
            }
        }
        ...
        public new class ColumnDescriptor : NsgSoft.Forms.NsgColumnDescriptor
        {
			...
			public new Тарифы Value
            {
                get
                {
                    return (Тарифы)base.Value;
                }
                set
                {
                    base.Value = value;
