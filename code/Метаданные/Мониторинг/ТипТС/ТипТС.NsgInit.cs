...
namespace TT.Метаданные.Мониторинг
{
    ...
    [NsgTypeName("NsgDataDictionary", Guid = "b1c69a7a-281a-4a1b-bafa-0665a44b64f6")]
    public partial class ТипТС : NsgSoft.DataObjects.NsgDataDictionary
    {
        #region Данные
        ...
        public static ТипТС Новый()
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("b1c69a7a-281a-4a1b-bafa-0665a44b64f6"));
            if (obj == null)
                obj = new ТипТС();
            return obj as ТипТС;
        }
	...
	Наименование.Guid = NsgService.StringToGuid("1fbb5300-6f1f-45d9-81e3-9050786416c9");
	...
	СостояниеДокумента.Guid = NsgService.StringToGuid("8de03a38-252c-4630-b018-3d5abffde817");
	...
	Name = "ТипТС";
	Visible = true;
	Guid = NsgService.StringToGuid("b1c69a7a-281a-4a1b-bafa-0665a44b64f6");
	DefaultSortingName = "";
	...
	GroupName = "Мониторинг";
        ...
        public ТипТС Родитель
        {
            get
            {
                return base.Parent as ТипТС;
            }
            set
            {
                base.Parent = value;
        ...
        private ТипТС[] convertArray(NsgMultipleObject[] array)
        {
            ТипТС[] res = new ТипТС[array.Length];
            array.CopyTo(res, 0);
            return res;
        }
        ...
        public new virtual ТипТС[] FindAll(NsgCompare compare)
        {
        ...
        /// <returns>Список найденных объектов.</returns>
        public new virtual ТипТС[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, NsgCompare compare)
        {
        ...
        /// <returns>Список найденных объектов.</returns>
        public new virtual ТипТС[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, string inName, object inValue)
        {
        ...
        /// <param name="inValue">Значение для поиска. Условие поиска - полное совпадение.</param>
        /// <returns>Список найденных объектов.</returns>
        public new virtual ТипТС[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, NsgDataFixedFields inName,
            object inValue)
        {
            return convertArray(base.FindAll(ref count, row_start, sorting, inName, inValue));
        }
        ...
        public override NsgObject CloneObject
        {
            get
            {
                return new ТипТС(this as NsgObject);
            }
        }
        ...
        public new class ColumnDescriptor : NsgSoft.Forms.NsgColumnDescriptor
        {
			...
			public new ТипТС Value
            {
                get
                {
                    return (ТипТС)base.Value;
                }
                set
                {
                    base.Value = value;
