...

{
    ...
    public partial class ТипТСФормаЭлемента:NsgSoft.Forms.NsgMultipleObjectElementForm
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ТипТСФормаЭлемента));
            ...
            this.Родитель = new TechControl.Метаданные.Мониторинг.ТипТС.ColumnDescriptor();
            ...
            this.Comment.FullName = "Мониторинг.ТипТС.Идентификатор";
            ...
            this.nsgVisualMultipleObject.FullName = "Мониторинг.ТипТС";
            // 
            // Идентификатор
            // 
            ...
            this.Родитель.NSGType = typeof(TechControl.Метаданные.Мониторинг.ТипТС);
            this.Родитель.PropertyType = typeof(TechControl.Метаданные.Мониторинг.ТипТС);
            ...
            this.nsgInput1.Location = new System.Drawing.Point(117, 14);
            ...
            this.nsgInput1.Size = new System.Drawing.Size(148, 20);
        ...
        private ТипТС.ColumnDescriptor Родитель;
