...
namespace TechControl.Метаданные.Учет
{
    ...
    [NsgTypeName("NsgDataDictionary", Guid = "63cc539a-9550-4fe3-8258-a8784b5c194e")]
    public partial class ТипыФотографий : NsgSoft.DataObjects.NsgDataDictionary
    {
        #region Данные
        ...
        /// </summary>
        protected ТипыФотографий(NsgObject obj)
            : base(obj)
        {
        }
        ...
        public static ТипыФотографий Новый()
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("63cc539a-9550-4fe3-8258-a8784b5c194e"));
            if (obj == null)
                obj = new ТипыФотографий();
            return obj as ТипыФотографий;
        }
	...
	Идентификатор.Guid = NsgService.StringToGuid("3161a36b-7131-4a47-8883-5bdea2489717");
	...
	Автоинкремент.Guid = NsgService.StringToGuid("900fc34b-bef8-4c01-9bc8-4427535b9077");
	...
	ЭтоГруппа.GroupName = "";
	ЭтоГруппа.Guid = NsgService.StringToGuid("1c124aad-ff04-484a-ad80-2903c4c98a3e");
	...
	ИдентификаторРодителя.Guid = NsgService.StringToGuid("c0076a1b-d142-48e0-80df-e7c2b5067039");
	...
	Уровень.GroupName = "";
	Уровень.Guid = NsgService.StringToGuid("d3dd848b-cd96-4c62-9cf0-881e412f23b3");
	...
	ПрефиксКода.Guid = NsgService.StringToGuid("60ff72b2-e763-42cb-8405-e4d77ec9f4c5");
	...
	НомерКода.GroupName = "";
	НомерКода.Guid = NsgService.StringToGuid("fad1810f-e942-4b57-9a9a-2ac7b2ee2b05");
	...
	Код.GroupName = "";
	Код.Guid = NsgService.StringToGuid("508e5285-2a26-47d1-808d-6d68eb65045b");
	...
	Наименование.Guid = NsgService.StringToGuid("54437aca-1df4-4071-bf31-963a433e1a66");
	...
	СостояниеДокумента.Guid = NsgService.StringToGuid("0980a74a-1c53-4e96-b52a-721895c789da");
			...
			#region создание Учет.ТипыФотографий НачальноеСостояниеОбъекта
			{  
                NsgDataPredefinedReference НачальноеСостояниеОбъекта = null;
				if (ObjectList.Contains("НачальноеСостояниеОбъекта"))
                    НачальноеСостояниеОбъекта = ObjectList["НачальноеСостояниеОбъекта"] as NsgDataPredefinedReference;
                else
                    НачальноеСостояниеОбъекта = new NsgDataPredefinedReference();
	//NsgDataPredefinedReference
	НачальноеСостояниеОбъекта.IsLoadedFromDll = true;
	НачальноеСостояниеОбъекта.SaveInDatabase = false;
	НачальноеСостояниеОбъекта.RequisiteValues = new NsgSoft.DataObjects.NsgPropertyCollection(new System.String[]{"Наименование"},
		 new System.Object[]{"Начальное состояние объекта"});
	НачальноеСостояниеОбъекта.Guid = NsgService.StringToGuid("e4756289-f918-4da8-b5f7-80b53e79ae9d");
	НачальноеСостояниеОбъекта.ReferentGroup = "";
	НачальноеСостояниеОбъекта.ReferentName = "";
	НачальноеСостояниеОбъекта.OwnerName = "";
	НачальноеСостояниеОбъекта.AllowEmptyOwner = false;
	НачальноеСостояниеОбъекта.StringFormat = "";
	НачальноеСостояниеОбъекта.SubType = NsgSoft.Common.NsgRekvisitSubType.Predefined;
	НачальноеСостояниеОбъекта.IncludeInPredefined = false;
	НачальноеСостояниеОбъекта.PeriodicType = NsgSoft.Database.PeriodicTypes.None;
	НачальноеСостояниеОбъекта.Required = false;
	НачальноеСостояниеОбъекта.EmptyValue = "";
	НачальноеСостояниеОбъекта.NullAllow = false;
	НачальноеСостояниеОбъекта.IndexType = NsgSoft.Database.NsgRekvisitIndexType.None;
	НачальноеСостояниеОбъекта.FieldName = "NachalnoeSostojan";
	НачальноеСостояниеОбъекта.InformMetaDataOnValueChanged = false;
	НачальноеСостояниеОбъекта.Visible = true;
	НачальноеСостояниеОбъекта.Name = "НачальноеСостояниеОбъекта";
	НачальноеСостояниеОбъекта.Presentation = new NsgSoft.DataObjects.NsgLanguageString(new System.String[]{"(Default)"},
		 new System.Object[]{""});
	НачальноеСостояниеОбъекта.Description = "Начальное состояние объекта";
	НачальноеСостояниеОбъекта.EditorVisible = NsgSoft.DataObjects.NsgDataObjectEditorAccess.Full;
	НачальноеСостояниеОбъекта.GroupName = "";
	
				if (!ObjectList.Contains("НачальноеСостояниеОбъекта"))
                    ObjectList.Add(НачальноеСостояниеОбъекта);
			}
			#endregion //создание Учет.ТипыФотографий НачальноеСостояниеОбъекта
	...
	Name = "ТипыФотографий";
	Visible = true;
	Guid = NsgService.StringToGuid("63cc539a-9550-4fe3-8258-a8784b5c194e");
	DefaultSortingName = "";
	...
	TableName = "_dic_TipyFotografiij";
	...
	GroupName = "Учет";
        ...
        public new partial class Names// :NsgSoft.DataObjects.NsgDataDictionary.Names
        {
            ...
            /// </summary>
            public static String НачальноеСостояниеОбъекта
            {
                get
                {
                    return "НачальноеСостояниеОбъекта";
                }
            }
        ...
        public override NsgMultipleObjectDescriptor Descriptor
        {
            get
            {
                if (descriptor == null)
                {
                    ...
                    descriptor.Name = "ТипыФотографий";
        ...
        public ТипыФотографий Родитель
        {
            get
            {
                return base.Parent as ТипыФотографий;
            }
            set
            {
                base.Parent = value;
        ...
        [NsgView(NsgViewTypes.DesignTime)]
        [NsgTypeName("NsgDataDictionary")]
        public static ТипыФотографий НачальноеСостояниеОбъекта
        {
            get
            {
                return (ТипыФотографий)getPredefined(NsgService.StringToGuid("63cc539a-9550-4fe3-8258-a8784b5c194e"), NsgService.StringToGuid("e4756289-f918-4da8-b5f7-80b53e79ae9d"));
            }
        }
        ...
        private ТипыФотографий[] convertArray(NsgMultipleObject[] array)
        {
            ТипыФотографий[] res = new ТипыФотографий[array.Length];
            array.CopyTo(res, 0);
            return res;
        }
        ...
        public new virtual ТипыФотографий[] FindAll(NsgCompare compare)
        {
        ...
        /// <returns>Список найденных объектов.</returns>
        public new virtual ТипыФотографий[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, NsgCompare compare)
        {
        ...
        /// <returns>Список найденных объектов.</returns>
        public new virtual ТипыФотографий[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, string inName, object inValue)
        {
        ...
        /// <param name="inValue">Значение для поиска. Условие поиска - полное совпадение.</param>
        /// <returns>Список найденных объектов.</returns>
        public new virtual ТипыФотографий[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, NsgDataFixedFields inName,
            object inValue)
        {
            return convertArray(base.FindAll(ref count, row_start, sorting, inName, inValue));
        }
        ...
        public override NsgObject CloneObject
        {
            get
            {
                return new ТипыФотографий(this as NsgObject);
            }
        }
        ...
        public new class ColumnDescriptor : NsgSoft.Forms.NsgColumnDescriptor
        {
            public ColumnDescriptor()
                : base()
            {
                base.NSGType = typeof(ТипыФотографий);
            }
			...
			public new ТипыФотографий Value
            {
                get
                {
                    return (ТипыФотографий)base.Value;
                }
                set
                {
                    base.Value = value;
