...
namespace TechControl.Метаданные.Учет
{
	...
	Владелец.FilterForConfigurator = "Учет.Номенклатура";
	...
	Владелец.Guid = NsgService.StringToGuid("6c3d6cd1-a6e5-44e2-8b21-7a6be834452c");
			...
			#region создание Учет.Перемещение Перемещение
			{  
                NsgDataTypedReference Перемещение = null;
				if (ObjectList.Contains("Перемещение"))
                    Перемещение = ObjectList["Перемещение"] as NsgDataTypedReference;
                else
                    Перемещение = new NsgDataTypedReference();
	//NsgDataTypedReference
	Перемещение.IsLoadedFromDll = true;
	Перемещение.ReferentGroup = "Учет";
	Перемещение.ReferentName = "Перемещение";
	Перемещение.SaveInDatabase = true;
	Перемещение.OwnerName = "";
	Перемещение.AllowEmptyOwner = false;
	Перемещение.StringFormat = "";
	Перемещение.SubType = NsgSoft.Common.NsgRekvisitSubType.Element;
	Перемещение.IncludeInPredefined = false;
	Перемещение.PeriodicType = NsgSoft.Database.PeriodicTypes.None;
	Перемещение.Required = false;
	Перемещение.EmptyValue = "";
	Перемещение.NullAllow = false;
	Перемещение.IndexType = NsgSoft.Database.NsgRekvisitIndexType.None;
	Перемещение.FieldName = "Peremeschenie";
	Перемещение.InformMetaDataOnValueChanged = false;
	Перемещение.Visible = true;
	Перемещение.Name = "Перемещение";
	Перемещение.Presentation = new NsgSoft.DataObjects.NsgLanguageString(new System.String[]{"(Default)"},
		 new System.Object[]{""});
	Перемещение.Description = "Перемещение";
	Перемещение.EditorVisible = NsgSoft.DataObjects.NsgDataObjectEditorAccess.Full;
	Перемещение.GroupName = "";
	Перемещение.Guid = NsgService.StringToGuid("487b6afb-cf82-44b0-ae28-51f0f1f046ef");
	
				if (!ObjectList.Contains("Перемещение"))
                    ObjectList.Add(Перемещение);
			}
			#endregion //создание Учет.Перемещение Перемещение
	...
	ДатаФотографии.Guid = NsgService.StringToGuid("8c079616-ecf0-4735-8e9c-e4db31d1ab97");
			...
			#region создание System.Drawing.Image Фотография
			{  
                NsgDataImage Фотография = null;
				if (ObjectList.Contains("Фотография"))
                    Фотография = ObjectList["Фотография"] as NsgDataImage;
                else
                    Фотография = new NsgDataImage();
	//NsgDataImage
	Фотография.IsLoadedFromDll = true;
	Фотография.MaximumSize = new Size(2000,2000);
	Фотография.MinimumSize = new Size(10,10);
	Фотография.StretchImage = false;
	Фотография.IndexType = NsgSoft.Database.NsgRekvisitIndexType.None;
	Фотография.NullAllow = true;
	Фотография.StringFormat = "";
	Фотография.SubType = NsgSoft.Common.NsgRekvisitSubType.Element;
	...
	Фотография.Guid = NsgService.StringToGuid("c4791899-bfc0-4604-9ec6-64163082b57d");
	
				if (!ObjectList.Contains("Фотография"))
                    ObjectList.Add(Фотография);
			}
			#endregion //создание System.Drawing.Image Фотография
	...
	GroupName = "Учет";
        ...
        public new partial class Names// :NsgSoft.DataObjects.NsgDataDictionary.Names
        {
            ...
            /// Перемещение
            /// </summary>
            public static String Перемещение
            {
                get
                {
                    return "Перемещение";
        ...
        [NsgReferentsFilterAttribute("Учет.Номенклатура")]
        ...
        public Учет.Перемещение Перемещение
        {
            get
            {
				 NsgDataTypedReference __Перемещение = ObjectList["Перемещение"] as NsgDataTypedReference;
                 return (Учет.Перемещение)__Перемещение.Referent;
            }
            set
            {
                NsgDataTypedReference __Перемещение = ObjectList["Перемещение"] as NsgDataTypedReference;
                __Перемещение.Referent = value;
            }
        }
        ...
        public System.Drawing.Image Фотография
        {
            get
            {
				 NsgDataImage __Фотография = ObjectList["Фотография"] as NsgDataImage;
                 return (System.Drawing.Image)__Фотография.Value;
            }
            set
            {
                NsgDataImage __Фотография = ObjectList["Фотография"] as NsgDataImage;
                __Фотография.Value = value;
            }
        }
