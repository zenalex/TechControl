...
namespace TechControl.Метаданные._SystemTables
{
    ...
    [NsgTypeName("NsgDataTable", Guid = "99133672-3b31-40d6-8bcd-9cd4a123f03c")]
    public partial class УчетРегистрЦенДвижения : NsgSoft.DataObjects.NsgDataTable
    {
        #region Данные
        ...
        /// Создание объекта
        /// </summary>
        protected УчетРегистрЦенДвижения()
            : base()
        {
        }
        ...
        /// </summary>
        protected УчетРегистрЦенДвижения(NsgObject obj)
            : base(obj)
        {
        }
        ...
        public static УчетРегистрЦенДвижения Новый()
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("99133672-3b31-40d6-8bcd-9cd4a123f03c"));
            if (obj == null)
                obj = new УчетРегистрЦенДвижения();
            return obj as УчетРегистрЦенДвижения;
        }
	...
	Идентификатор.Guid = NsgService.StringToGuid("24e4f7ad-f364-4043-a15e-ed306481bd76");
	...
	Автоинкремент.Guid = NsgService.StringToGuid("dce0fb81-8284-4cd0-98c4-01a97ca58bb5");
	...
	Владелец.FilterForConfigurator = "Сервис.КорректировкаРегистра,Учет.ПриходнаяНакладная";
	...
	Владелец.GroupName = "";
	Владелец.Guid = NsgService.StringToGuid("5bd99885-5dd4-4d82-bd43-db7d6029eaba");
	...
	Дата.GroupName = "";
	Дата.Guid = NsgService.StringToGuid("e6d1cf29-087e-429a-a61c-5ed5af05d423");
	...
	КонецПериода.Guid = NsgService.StringToGuid("51b090e7-65a8-41f1-9eac-38e58fb44e86");
	...
	Номенклатура.Guid = NsgService.StringToGuid("1c2569d8-f1b5-49cb-91a6-d7864d9443af");
	...
	Размер.GroupName = "";
	Размер.Guid = NsgService.StringToGuid("1d0ee5fd-a98c-46da-b30a-49f35ede246b");
			...
			#region создание System.Boolean ВключаетНДС
			{  
                NsgDataBoolean ВключаетНДС = null;
				if (ObjectList.Contains("ВключаетНДС"))
                    ВключаетНДС = ObjectList["ВключаетНДС"] as NsgDataBoolean;
                else
                    ВключаетНДС = new NsgDataBoolean();
	//NsgDataBoolean
	ВключаетНДС.IsLoadedFromDll = true;
	ВключаетНДС.DefaultValue = false;
	ВключаетНДС.TrueString = new NsgSoft.DataObjects.NsgLanguageString(new System.String[]{"(Default)"},
		 new System.Object[]{""});
	ВключаетНДС.FalseString = new NsgSoft.DataObjects.NsgLanguageString(new System.String[]{"(Default)"},
		 new System.Object[]{""});
	ВключаетНДС.StringFormat = "";
	ВключаетНДС.SubType = NsgSoft.Common.NsgRekvisitSubType.Dimension;
	ВключаетНДС.IncludeInPredefined = false;
	ВключаетНДС.PeriodicType = NsgSoft.Database.PeriodicTypes.None;
	ВключаетНДС.Required = false;
	ВключаетНДС.EmptyValue = "";
	ВключаетНДС.NullAllow = false;
	ВключаетНДС.IndexType = NsgSoft.Database.NsgRekvisitIndexType.None;
	ВключаетНДС.FieldName = "VkljuchaetNDS";
	ВключаетНДС.RegisterDistributionType = NsgSoft.DataObjects.NsgRegisterDistributionType.Filter;
	ВключаетНДС.CharacteristicCompareType = NsgSoft.Database.NsgComparison.Equal;
	ВключаетНДС.CharactericticWeight = 1;
	ВключаетНДС.InformMetaDataOnValueChanged = false;
	ВключаетНДС.Visible = true;
	ВключаетНДС.Name = "ВключаетНДС";
	ВключаетНДС.Presentation = new NsgSoft.DataObjects.NsgLanguageString(new System.String[]{"(Default)"},
		 new System.Object[]{""});
	ВключаетНДС.Description = "Включает НДС";
	ВключаетНДС.EditorVisible = NsgSoft.DataObjects.NsgDataObjectEditorAccess.Full;
	ВключаетНДС.GroupName = "";
	ВключаетНДС.Guid = NsgService.StringToGuid("276dcbe8-0292-44c4-97b9-61fe7d5c248b");
	
				if (!ObjectList.Contains("ВключаетНДС"))
                    ObjectList.Add(ВключаетНДС);
			}
			#endregion //создание System.Boolean ВключаетНДС
	...
	Цена.StringFormat = "";
	Цена.SubType = NsgSoft.Common.NsgRekvisitSubType.Property;
	...
	Цена.GroupName = "";
	Цена.Guid = NsgService.StringToGuid("821e3535-50c2-4100-b082-19651c4d848c");
	...
	OwnerFullName = "Учет.РегистрЦен";
	RegisterPeriod = NsgSoft.Common.NsgPeriod.None;
	RegisterPeriodCount = 1;
	TableSubType = NsgSoft.Common.NsgTableSubType.RegisterCharacteristicsTable;
	EntityType = NsgSoft.DataObjects.NsgInterfacedObject.EntityTypes.Object;
	Name = "УчетРегистрЦенДвижения";
	Visible = true;
	Guid = NsgService.StringToGuid("99133672-3b31-40d6-8bcd-9cd4a123f03c");
	DefaultSortingName = "";
	...
	TableName = "_tab_UchetRegistrCenDviz";
	Presentation = new NsgSoft.DataObjects.NsgLanguageString(new System.String[]{"(Default)"},
		 new System.Object[]{""});
	Description = "Учет цены движения";
	...
	GroupName = "_SystemTables";
        ...
        {
            return "_SystemTables.УчетРегистрЦенДвижения";
        }
        ...
        /// </summary>
        public new УчетРегистрЦенДвижения.Строка NewRow()
        {
            return newRow(null) as УчетРегистрЦенДвижения.Строка;
        }
        ...
        {
            if (row == null)
                row = new УчетРегистрЦенДвижения.Строка(this);
            return base.newRow(row) as УчетРегистрЦенДвижения.Строка;
        }

        /// <summary>
        /// Добавить новую строку в таблицу путем копирования переданной строки
        /// </summary>
        public УчетРегистрЦенДвижения.Строка NewRow(УчетРегистрЦенДвижения.Строка inRow)
        {
            УчетРегистрЦенДвижения.Строка row = inRow.Clone as УчетРегистрЦенДвижения.Строка;
            return base.newRow(row) as УчетРегистрЦенДвижения.Строка;
        }
        ...
        /// </summary>
        public new УчетРегистрЦенДвижения.Строка GetRow(int rowNumber)
        {
            return base.GetRow(rowNumber) as УчетРегистрЦенДвижения.Строка;
        }

        /// <summary>
        /// Возвращает новую строку таблицы, но в саму таблицу ее не включает (эталонная строка)
        /// </summary>
        public new УчетРегистрЦенДвижения.Строка GetEtalonRow()
        {
            УчетРегистрЦенДвижения.Строка row = new УчетРегистрЦенДвижения.Строка(this);
            row.MetaData = MetaData;
            return row;
        }

        private УчетРегистрЦенДвижения.Строка[] convertRowsArray(NsgDataTableRow[] array)
        {
            УчетРегистрЦенДвижения.Строка[] res = new УчетРегистрЦенДвижения.Строка[array.Length];
            array.CopyTo(res, 0);
            return res;
        }
        ...
        public new УчетРегистрЦенДвижения.Строка FindRowByTag(object Tag)
        {
            return base.FindRowByTag(Tag) as УчетРегистрЦенДвижения.Строка;
        }
        ...
        /// <param name="compare">Критерии поиска.</param>
        /// <returns>Найденные строки.</returns>
        public new УчетРегистрЦенДвижения.Строка[] FindRowsByTag(object Tag)
        {
        ...
        /// <param name="compare">Критерии поиска.</param>
        /// <returns>Найденные строки.</returns>
        public new УчетРегистрЦенДвижения.Строка FindRow(NsgCompare compare)
        {
            return base.FindRow(compare) as УчетРегистрЦенДвижения.Строка;
        }
        ...
        /// <returns>Найденные строки.</returns>
        public new УчетРегистрЦенДвижения.Строка FindRow(string inName, object inValue)
        {
            return base.FindRow(inName, inValue) as УчетРегистрЦенДвижения.Строка;
        }
        ...
        /// <param name="inValue">Значение поля.</param>
        /// <returns>Найденные строки.</returns>
        public new УчетРегистрЦенДвижения.Строка FindRow(NsgDataFixedFields inName, object inValue)
        {
            return base.FindRow(inName, inValue) as УчетРегистрЦенДвижения.Строка;
        }
        ...
        /// <param name="compare">Критерии поиска.</param>
        /// <returns>Найденные строки.</returns>
        public new УчетРегистрЦенДвижения.Строка[] FindRows(NsgCompare compare)
        {
        ...
        /// <param name="inValue">Значение поля.</param>
        /// <returns>Найденные строки.</returns>
        public new УчетРегистрЦенДвижения.Строка[] FindRows(string inName, object inValue)
        {
        ...
        /// <param name="inValue">Значение поля.</param>
        /// <returns>Найденные строки.</returns>
        public new УчетРегистрЦенДвижения.Строка[] FindRows(NsgDataFixedFields inName, object inValue)
        {
            return convertRowsArray(base.FindRows(inName, inValue));
        }
        ...
        /// </summary>
        public  NsgVirtualCursor<УчетРегистрЦенДвижения> GetNewVirtualCursor()
        {
            return base.GetNewVirtualCursor<УчетРегистрЦенДвижения>();
        }

        /// <summary>
        /// Получить все строки таблицы с учетом наложенного фильтра. Для получения всех сьтрок без учета фильтра используется свойство AllRows
        /// </summary>
        public new УчетРегистрЦенДвижения.Строка[] Rows
        {
            get
            {
        ...
        /// </summary>
        public new УчетРегистрЦенДвижения.Строка[] AllRows
        {
            get
            {
        ...
        /// <returns>Найденные строки.</returns>
        public new УчетРегистрЦенДвижения.Строка GetRow(Guid inID)
        {
            return base.GetRow(inID) as УчетРегистрЦенДвижения.Строка;
        }
        #endregion
        ...
        private УчетРегистрЦенДвижения[] convertArray(NsgMultipleObject[] array)
        {
            УчетРегистрЦенДвижения[] res = new УчетРегистрЦенДвижения[array.Length];
            array.CopyTo(res, 0);
            return res;
        }
        ...
        public new virtual УчетРегистрЦенДвижения[] FindAll(NsgCompare compare)
        {
        ...
        /// <returns>Список найденных объектов.</returns>
        public new virtual УчетРегистрЦенДвижения[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, NsgCompare compare)
        {
        ...
        /// <returns>Список найденных объектов.</returns>
        public new virtual УчетРегистрЦенДвижения[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, string inName, object inValue)
        {
        ...
        /// <param name="inValue">Значение для поиска. Условие поиска - полное совпадение.</param>
        /// <returns>Список найденных объектов.</returns>
        public new virtual УчетРегистрЦенДвижения[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, NsgDataFixedFields inName,
            object inValue)
        {
            return convertArray(base.FindAll(ref count, row_start, sorting, inName, inValue));
        }
        ...
        public override NsgObject CloneObject
        {
            get
            {
                return new УчетРегистрЦенДвижения(this as NsgObject);
            }
        }
        ...
        public new class ColumnDescriptor : NsgSoft.Forms.NsgColumnDescriptor
        {
            public ColumnDescriptor()
                : base()
            {
                base.NSGType = typeof(УчетРегистрЦенДвижения);
            }
			...
			public new УчетРегистрЦенДвижения Value
            {
                get
                {
                    return (УчетРегистрЦенДвижения)base.Value;
                }
                set
                {
                    base.Value = value;
