...
{
    public partial class УчетРегистрЦенДвижения
{
    [NsgTypeName("NsgDataTableRow", Guid = "99133672-3b31-40d6-8bcd-9cd4a123f03c")]
    public partial class Строка : NsgSoft.DataObjects.NsgDataTableRow
    {
        ...
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("99133672-3b31-40d6-8bcd-9cd4a123f03c"));
            if (obj == null)
                obj = new Строка();
        ...
        public new partial class Names// :NsgSoft.DataObjects.NsgDataTableRow.Names
        {
            ...
            /// Включает НДС
            /// </summary>
            public static String ВключаетНДС
            {
                get
                {
                    return "ВключаетНДС";
        ...
        public override NsgMultipleObjectDescriptor Descriptor
        {
            get
            {
                if (descriptor == null)
                {
                    ...
                    descriptor.Name = "УчетРегистрЦенДвижения";
        ...
        [NsgReferentsFilterAttribute("Сервис.КорректировкаРегистра,Учет.ПриходнаяНакладная")]
        ...
        public System.Boolean ВключаетНДС
        {
            get
            {
				 NsgDataBoolean __ВключаетНДС = ObjectList["ВключаетНДС"] as NsgDataBoolean;
                 return (System.Boolean)__ВключаетНДС.Value;
            }
            set
            {
                NsgDataBoolean __ВключаетНДС = ObjectList["ВключаетНДС"] as NsgDataBoolean;
                __ВключаетНДС.Value = value;
            }
        }
