...
namespace TechControl.Метаданные.Учет
{
    ...
    [NsgTypeName("NsgDataCharacteristics", Guid = "1a8bffdb-d009-441e-99c1-fdbe08dbb152")]
    public partial class РегистрЦен : NsgSoft.DataObjects.NsgDataCharacteristics
    {
        #region Данные
        ...
        /// </summary>
        public static РегистрЦен Новый(NsgDataDocument document)
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("1a8bffdb-d009-441e-99c1-fdbe08dbb152"));
            if (obj == null)
                obj = new РегистрЦен();
            (obj as РегистрЦен).Document = document;
            return obj as РегистрЦен;
        }
        ...
        /// </summary>
        protected РегистрЦен(NsgObject obj)
            : base(obj)
        {
        }
        ...
        public static РегистрЦен Новый()
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("1a8bffdb-d009-441e-99c1-fdbe08dbb152"));
            if (obj == null)
                obj = new РегистрЦен();
	...
	Идентификатор.Guid = NsgService.StringToGuid("4f974cd3-46be-4d46-ba8c-d03fff5c96a9");
	...
	Автоинкремент.Guid = NsgService.StringToGuid("92a1796e-e037-4f04-9b88-ec078892bfb7");
			...
			#region создание _SystemTables.УчетРегистрЦенДвижения Движения
			{  
	...
	Движения.ReferentName = "УчетРегистрЦенДвижения";
	...
	Движения.GroupName = "";
	Движения.Guid = NsgService.StringToGuid("f8d4d93c-dd73-4592-a958-004c10ba7d7b");
	
				if (!ObjectList.Contains("Движения"))
                    ObjectList.Add(Движения);
			}
			#endregion //создание _SystemTables.УчетРегистрЦенДвижения Движения
	...
	Владелец.GroupName = "";
	Владелец.Guid = NsgService.StringToGuid("a2202664-9ad1-4a5f-b3cb-dd8e8216787b");
	...
	Name = "РегистрЦен";
	Visible = true;
	Guid = NsgService.StringToGuid("1a8bffdb-d009-441e-99c1-fdbe08dbb152");
	DefaultSortingName = "";
	...
	TableName = "_reg_RegistrCen";
	Presentation = new NsgSoft.DataObjects.NsgLanguageString(new System.String[]{"(Default)"},
		 new System.Object[]{""});
	Description = "РегистрЦен";
	...
	ConnectAdditionalTables();
        ...
        public _SystemTables.УчетРегистрЦенДвижения Движения
        {
            get
            {
				 NsgRegisterTable __Движения = ObjectList["Движения"] as NsgRegisterTable;
                 return (_SystemTables.УчетРегистрЦенДвижения)__Движения.Referent;
            }
            set
            {
                NsgRegisterTable __Движения = ObjectList["Движения"] as NsgRegisterTable;
        ...
        private РегистрЦен[] convertArray(NsgMultipleObject[] array)
        {
            РегистрЦен[] res = new РегистрЦен[array.Length];
            array.CopyTo(res, 0);
            return res;
        }
        ...
        public new virtual РегистрЦен[] FindAll(NsgCompare compare)
        {
        ...
        /// <returns>Список найденных объектов.</returns>
        public new virtual РегистрЦен[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, NsgCompare compare)
        {
        ...
        /// <returns>Список найденных объектов.</returns>
        public new virtual РегистрЦен[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, string inName, object inValue)
        {
        ...
        /// <param name="inValue">Значение для поиска. Условие поиска - полное совпадение.</param>
        /// <returns>Список найденных объектов.</returns>
        public new virtual РегистрЦен[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, NsgDataFixedFields inName,
            object inValue)
        {
            return convertArray(base.FindAll(ref count, row_start, sorting, inName, inValue));
        }
        ...
        public override NsgObject CloneObject
        {
            get
            {
                return new РегистрЦен(this as NsgObject);
            }
        }
        ...
        public new class ColumnDescriptor : NsgSoft.Forms.NsgColumnDescriptor
        {
            public ColumnDescriptor()
                : base()
            {
                base.NSGType = typeof(РегистрЦен);
            }
			...
			public new РегистрЦен Value
            {
                get
                {
                    return (РегистрЦен)base.Value;
                }
                set
                {
                    base.Value = value;
