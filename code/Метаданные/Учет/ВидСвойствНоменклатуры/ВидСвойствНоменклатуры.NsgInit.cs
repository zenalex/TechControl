...
namespace TechControl.Метаданные.Учет
{
    ...
    [NsgTypeName("NsgDataDictionary", Guid = "90d71cb9-9b81-4907-8374-873bb8747962")]
    public partial class ВидСвойствНоменклатуры : NsgSoft.DataObjects.NsgDataDictionary
    {
        #region Данные
        ...
        /// Создание объекта
        /// </summary>
        protected ВидСвойствНоменклатуры()
            : base()
        {
        }
        ...
        /// </summary>
        protected ВидСвойствНоменклатуры(NsgObject obj)
            : base(obj)
        {
        }
        ...
        public static ВидСвойствНоменклатуры Новый()
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("90d71cb9-9b81-4907-8374-873bb8747962"));
            if (obj == null)
                obj = new ВидСвойствНоменклатуры();
            return obj as ВидСвойствНоменклатуры;
        }
	...
	Идентификатор.Guid = NsgService.StringToGuid("cc652949-c16a-4930-974a-85662832b261");
	...
	Автоинкремент.Guid = NsgService.StringToGuid("159ef1bd-2271-4ee2-87bd-5b0d535c0005");
	...
	ЭтоГруппа.GroupName = "";
	ЭтоГруппа.Guid = NsgService.StringToGuid("946cbc1e-f449-4c67-bc5a-e1bdc35a5375");
	...
	ИдентификаторРодителя.Guid = NsgService.StringToGuid("d164ec24-62d3-447d-9d87-55a2b270074c");
	...
	Уровень.GroupName = "";
	Уровень.Guid = NsgService.StringToGuid("71f09a5d-a1c7-4588-aabe-bf4dc292f5ad");
	...
	ПрефиксКода.Guid = NsgService.StringToGuid("de3c357a-cfa1-4061-9b69-cdb2d8230838");
	...
	НомерКода.GroupName = "";
	НомерКода.Guid = NsgService.StringToGuid("6e3ef611-3e47-40d5-9467-93df38ac77f6");
	...
	Код.GroupName = "";
	Код.Guid = NsgService.StringToGuid("4fe05fdf-47ef-40d2-9c3c-71df5485348d");
	...
	Наименование.Guid = NsgService.StringToGuid("f47324b9-59c1-49ff-9f36-e638a777a8df");
	...
	СостояниеДокумента.Guid = NsgService.StringToGuid("ba23e8da-2c31-40c9-a9bd-85b3dadcc48d");
	...
	АккаунтПользователя.Guid = NsgService.StringToGuid("0cc98977-efd8-4723-acf1-204de8ea86fe");
	...
	ПоследнееИзменение.Guid = NsgService.StringToGuid("6e62b97f-c8b0-4005-b8e1-069313201996");
	...
	Name = "ВидСвойствНоменклатуры";
	Visible = true;
	Guid = NsgService.StringToGuid("90d71cb9-9b81-4907-8374-873bb8747962");
	DefaultSortingName = "";
	...
	TableName = "_dic_VidNomenklatury";
	...
	GroupName = "Учет";
        ...
        public override NsgMultipleObjectDescriptor Descriptor
        {
            get
            {
                if (descriptor == null)
                {
                    ...
                    descriptor.Name = "ВидСвойствНоменклатуры";
        ...
        {
            return "Учет.ВидСвойствНоменклатуры";
        }
        ...
        [NsgView(NsgViewTypes.DesignTime)]
        [NsgTypeName("NsgDataDictionary")]
        public ВидСвойствНоменклатуры Родитель
        {
            get
            {
                return base.Parent as ВидСвойствНоменклатуры;
            }
            set
            {
                base.Parent = value;
        ...
        private ВидСвойствНоменклатуры[] convertArray(NsgMultipleObject[] array)
        {
            ВидСвойствНоменклатуры[] res = new ВидСвойствНоменклатуры[array.Length];
            array.CopyTo(res, 0);
            return res;
        }
        ...
        public new virtual ВидСвойствНоменклатуры[] FindAll(NsgCompare compare)
        {
        ...
        /// <returns>Список найденных объектов.</returns>
        public new virtual ВидСвойствНоменклатуры[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, NsgCompare compare)
        {
        ...
        /// <returns>Список найденных объектов.</returns>
        public new virtual ВидСвойствНоменклатуры[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, string inName, object inValue)
        {
        ...
        /// <param name="inValue">Значение для поиска. Условие поиска - полное совпадение.</param>
        /// <returns>Список найденных объектов.</returns>
        public new virtual ВидСвойствНоменклатуры[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, NsgDataFixedFields inName,
            object inValue)
        {
            return convertArray(base.FindAll(ref count, row_start, sorting, inName, inValue));
        }
        ...
        public override NsgObject CloneObject
        {
            get
            {
                return new ВидСвойствНоменклатуры(this as NsgObject);
            }
        }
        ...
        public new class ColumnDescriptor : NsgSoft.Forms.NsgColumnDescriptor
        {
            public ColumnDescriptor()
                : base()
            {
                base.NSGType = typeof(ВидСвойствНоменклатуры);
            }
			...
			public new ВидСвойствНоменклатуры Value
            {
                get
                {
                    return (ВидСвойствНоменклатуры)base.Value;
                }
                set
                {
                    base.Value = value;
