...
namespace TechControl.Метаданные.Учет
{
    ...
    [NsgTypeName("NsgDataDictionary", Guid = "ba70675c-03fb-4d59-b525-4996513d7a9a")]
    public partial class ТипыЦен : NsgSoft.DataObjects.NsgDataDictionary
    {
        #region Данные
        ...
        /// </summary>
        protected ТипыЦен(NsgObject obj)
            : base(obj)
        {
        }
        ...
        public static ТипыЦен Новый()
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("ba70675c-03fb-4d59-b525-4996513d7a9a"));
            if (obj == null)
                obj = new ТипыЦен();
            return obj as ТипыЦен;
        }
	...
	Идентификатор.Guid = NsgService.StringToGuid("dcce697a-81b4-4878-a477-1a0570991d00");
	...
	Автоинкремент.Guid = NsgService.StringToGuid("c39942e5-f4ce-482d-becd-9845d10e945f");
	...
	ЭтоГруппа.GroupName = "";
	ЭтоГруппа.Guid = NsgService.StringToGuid("a212446a-bc3e-47bf-9411-c23d7426ac10");
	...
	ИдентификаторРодителя.Guid = NsgService.StringToGuid("2f1f3264-7bf9-419c-b745-fc06c207a164");
	...
	Уровень.GroupName = "";
	Уровень.Guid = NsgService.StringToGuid("fc73429a-c67a-49f9-a72b-497c5ea72741");
	...
	ПрефиксКода.Guid = NsgService.StringToGuid("37247c53-035b-44d6-8dda-3fda07007d1e");
	...
	НомерКода.GroupName = "";
	НомерКода.Guid = NsgService.StringToGuid("29aa87e4-272e-47fa-bfee-cbaa689df50d");
	...
	Код.GroupName = "";
	Код.Guid = NsgService.StringToGuid("ab64dff0-43ce-41b9-9d74-01ebe077ff52");
	...
	Наименование.Guid = NsgService.StringToGuid("b3eb76f1-fb06-4571-a9cb-4c7ccf2a72e9");
	...
	СостояниеДокумента.Guid = NsgService.StringToGuid("15270fb0-f948-4531-98ec-4ccd4a429e6f");
			...
			#region создание Учет.ТипыЦен ПриходнаяЦена
			{  
                NsgDataPredefinedReference ПриходнаяЦена = null;
				if (ObjectList.Contains("ПриходнаяЦена"))
                    ПриходнаяЦена = ObjectList["ПриходнаяЦена"] as NsgDataPredefinedReference;
                else
                    ПриходнаяЦена = new NsgDataPredefinedReference();
	//NsgDataPredefinedReference
	ПриходнаяЦена.IsLoadedFromDll = true;
	ПриходнаяЦена.SaveInDatabase = false;
	ПриходнаяЦена.RequisiteValues = new NsgSoft.DataObjects.NsgPropertyCollection(new System.String[]{"Наименование"},
		 new System.Object[]{"ПриходнаяЦена"});
	ПриходнаяЦена.Guid = NsgService.StringToGuid("1f0e9717-e317-4a8d-8b84-6d24cfea972c");
	ПриходнаяЦена.ReferentGroup = "";
	ПриходнаяЦена.ReferentName = "";
	ПриходнаяЦена.OwnerName = "";
	ПриходнаяЦена.AllowEmptyOwner = false;
	ПриходнаяЦена.StringFormat = "";
	ПриходнаяЦена.SubType = NsgSoft.Common.NsgRekvisitSubType.Predefined;
	ПриходнаяЦена.IncludeInPredefined = false;
	ПриходнаяЦена.PeriodicType = NsgSoft.Database.PeriodicTypes.None;
	ПриходнаяЦена.Required = false;
	ПриходнаяЦена.EmptyValue = "";
	ПриходнаяЦена.NullAllow = false;
	ПриходнаяЦена.IndexType = NsgSoft.Database.NsgRekvisitIndexType.None;
	ПриходнаяЦена.FieldName = "PrikhodnajaCena";
	ПриходнаяЦена.InformMetaDataOnValueChanged = false;
	ПриходнаяЦена.Visible = true;
	ПриходнаяЦена.Name = "ПриходнаяЦена";
	ПриходнаяЦена.Presentation = new NsgSoft.DataObjects.NsgLanguageString(new System.String[]{"(Default)"},
		 new System.Object[]{""});
	ПриходнаяЦена.Description = "Приходная цена";
	ПриходнаяЦена.EditorVisible = NsgSoft.DataObjects.NsgDataObjectEditorAccess.Full;
	ПриходнаяЦена.GroupName = "";
	
				if (!ObjectList.Contains("ПриходнаяЦена"))
                    ObjectList.Add(ПриходнаяЦена);
			}
			#endregion //создание Учет.ТипыЦен ПриходнаяЦена
			
			#region создание Учет.ТипыЦен ОтпускнаяЦена
			{  
                NsgDataPredefinedReference ОтпускнаяЦена = null;
				if (ObjectList.Contains("ОтпускнаяЦена"))
                    ОтпускнаяЦена = ObjectList["ОтпускнаяЦена"] as NsgDataPredefinedReference;
                else
                    ОтпускнаяЦена = new NsgDataPredefinedReference();
	//NsgDataPredefinedReference
	ОтпускнаяЦена.IsLoadedFromDll = true;
	ОтпускнаяЦена.SaveInDatabase = false;
	ОтпускнаяЦена.RequisiteValues = new NsgSoft.DataObjects.NsgPropertyCollection(new System.String[]{"Наименование"},
		 new System.Object[]{"ОтпускнаяЦена"});
	ОтпускнаяЦена.Guid = NsgService.StringToGuid("335204b8-12d7-4966-b660-133a81b9cf8d");
	ОтпускнаяЦена.ReferentGroup = "";
	ОтпускнаяЦена.ReferentName = "";
	ОтпускнаяЦена.OwnerName = "";
	ОтпускнаяЦена.AllowEmptyOwner = false;
	ОтпускнаяЦена.StringFormat = "";
	ОтпускнаяЦена.SubType = NsgSoft.Common.NsgRekvisitSubType.Predefined;
	ОтпускнаяЦена.IncludeInPredefined = false;
	ОтпускнаяЦена.PeriodicType = NsgSoft.Database.PeriodicTypes.None;
	ОтпускнаяЦена.Required = false;
	ОтпускнаяЦена.EmptyValue = "";
	ОтпускнаяЦена.NullAllow = false;
	ОтпускнаяЦена.IndexType = NsgSoft.Database.NsgRekvisitIndexType.None;
	ОтпускнаяЦена.FieldName = "OtpusknajaCena";
	ОтпускнаяЦена.InformMetaDataOnValueChanged = false;
	ОтпускнаяЦена.Visible = true;
	ОтпускнаяЦена.Name = "ОтпускнаяЦена";
	ОтпускнаяЦена.Presentation = new NsgSoft.DataObjects.NsgLanguageString(new System.String[]{"(Default)"},
		 new System.Object[]{""});
	ОтпускнаяЦена.Description = "Отпускная цена";
	ОтпускнаяЦена.EditorVisible = NsgSoft.DataObjects.NsgDataObjectEditorAccess.Full;
	ОтпускнаяЦена.GroupName = "";
	
				if (!ObjectList.Contains("ОтпускнаяЦена"))
                    ObjectList.Add(ОтпускнаяЦена);
			}
			#endregion //создание Учет.ТипыЦен ОтпускнаяЦена
	...
	Name = "ТипыЦен";
	Visible = true;
	Guid = NsgService.StringToGuid("ba70675c-03fb-4d59-b525-4996513d7a9a");
	DefaultSortingName = "";
	...
	GroupName = "Учет";
        ...
        public new partial class Names// :NsgSoft.DataObjects.NsgDataDictionary.Names
        {
            ...
            /// Приходная цена
            /// </summary>
            public static String ПриходнаяЦена
            {
                get
                {
                    return "ПриходнаяЦена";
                }
            }
            ...
            /// Отпускная цена
            /// </summary>
            public static String ОтпускнаяЦена
            {
                get
                {
                    return "ОтпускнаяЦена";
                }
            }
        ...
        public ТипыЦен Родитель
        {
            get
            {
                return base.Parent as ТипыЦен;
            }
            set
            {
                base.Parent = value;
        ...
        [NsgView(NsgViewTypes.DesignTime)]
        [NsgTypeName("NsgDataDictionary")]
        public static ТипыЦен ПриходнаяЦена
        {
            get
            {
                return (ТипыЦен)getPredefined(NsgService.StringToGuid("ba70675c-03fb-4d59-b525-4996513d7a9a"), NsgService.StringToGuid("1f0e9717-e317-4a8d-8b84-6d24cfea972c"));
            }
        }
        ...
        [NsgView(NsgViewTypes.DesignTime)]
        [NsgTypeName("NsgDataDictionary")]
        public static ТипыЦен ОтпускнаяЦена
        {
            get
            {
                return (ТипыЦен)getPredefined(NsgService.StringToGuid("ba70675c-03fb-4d59-b525-4996513d7a9a"), NsgService.StringToGuid("335204b8-12d7-4966-b660-133a81b9cf8d"));
            }
        }
        ...
        private ТипыЦен[] convertArray(NsgMultipleObject[] array)
        {
            ТипыЦен[] res = new ТипыЦен[array.Length];
            array.CopyTo(res, 0);
            return res;
        }
        ...
        public new virtual ТипыЦен[] FindAll(NsgCompare compare)
        {
        ...
        /// <returns>Список найденных объектов.</returns>
        public new virtual ТипыЦен[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, NsgCompare compare)
        {
        ...
        /// <returns>Список найденных объектов.</returns>
        public new virtual ТипыЦен[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, string inName, object inValue)
        {
        ...
        /// <param name="inValue">Значение для поиска. Условие поиска - полное совпадение.</param>
        /// <returns>Список найденных объектов.</returns>
        public new virtual ТипыЦен[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, NsgDataFixedFields inName,
            object inValue)
        {
            return convertArray(base.FindAll(ref count, row_start, sorting, inName, inValue));
        }
        ...
        public override NsgObject CloneObject
        {
            get
            {
                return new ТипыЦен(this as NsgObject);
            }
        }
        ...
        public new class ColumnDescriptor : NsgSoft.Forms.NsgColumnDescriptor
        {
			...
			public new ТипыЦен Value
            {
                get
                {
                    return (ТипыЦен)base.Value;
                }
                set
                {
                    base.Value = value;
