...

{
    ...
    public partial class СвойствоНоменклатурыФормаЭлемента:NsgSoft.Forms.NsgMultipleObjectElementForm
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(СвойствоНоменклатурыФормаЭлемента));
            ...
            this.Значение = new TechControl.Метаданные.Учет.ВариантыЗначений.ColumnDescriptor();
            ...
            this.Таблица = new TechControl.Метаданные._SystemTables.УчетСвойствоНоменклатурыТаблица.ColumnDescriptor();
            ...
            this.Родитель = new TechControl.Метаданные.Учет.СвойствоНоменклатуры.ColumnDescriptor();
            ...
            this.Comment.FullName = "Учет.СвойствоНоменклатуры.Идентификатор";
            ...
            this.nsgVisualMultipleObject.FullName = "Учет.СвойствоНоменклатуры";
            // 
            // nsgIGrid1
            // 
        ...
        "Visible"};
            ...
            this.nsgIGrid1.Location = new System.Drawing.Point(100, 102);
            ...
            this.nsgIGrid1.Size = new System.Drawing.Size(338, 229);
            ...
            this.vmoТаблица.FullName = "_SystemTables.УчетСвойствоНоменклатурыТаблица.Владелец";
            // 
            // vmoТаблица
            // 
            nsgObjectDescriptor1.ConfigurationName = "TechControl";
            nsgObjectDescriptor1.FullName = "_SystemTables.УчетСвойствоНоменклатурыТаблица.Владелец";
            nsgObjectDescriptor1.MetaDataName = "Метаданные";
            nsgMasterDetailBinding1.DetailField = nsgObjectDescriptor1;
            nsgObjectDescriptor2.FullName = "Учет.СвойствоНоменклатуры.Таблица";
            ...
            this.vmoТаблица.Columns.Collection.Add(this.ВидСвойствНоменклатуры);
            this.vmoТаблица.Columns.Collection.Add(this.Значение);
            ...
            // Значение
            // 
            this.Значение.AutoGenerated = true;
            this.Значение.Caption = "Значение";
            this.Значение.Creator = typeof(NsgSoft.Forms.NsgMultipleObjectElementForm);
            this.Значение.Name = "Значение";
            this.Значение.NSGType = typeof(TechControl.Метаданные.Учет.ВариантыЗначений);
            this.Значение.PropertyType = typeof(TechControl.Метаданные.Учет.ВариантыЗначений);
            ...
            this.Таблица.NSGType = typeof(TechControl.Метаданные._SystemTables.УчетСвойствоНоменклатурыТаблица);
            this.Таблица.PropertyType = typeof(TechControl.Метаданные._SystemTables.УчетСвойствоНоменклатурыТаблица);
            ...
            this.Родитель.NSGType = typeof(TechControl.Метаданные.Учет.СвойствоНоменклатуры);
            this.Родитель.PropertyType = typeof(TechControl.Метаданные.Учет.СвойствоНоменклатуры);
            ...
            this.nsgInput1.FullName = "Учет.СвойствоНоменклатуры.Наименование";
            ...
            this.nsgInput1.Size = new System.Drawing.Size(338, 20);
            ...
            this.nsgLabel2.Size = new System.Drawing.Size(81, 13);
            this.nsgLabel2.TabIndex = 12;
            this.nsgLabel2.Text = "Номенклатура";
            // 
            // nsgInput2
            // 
            ...
            this.nsgInput2.FullName = "Учет.СвойствоНоменклатуры.Номенклатура";
            ...
            this.nsgInput3.FullName = "Учет.СвойствоНоменклатуры.АккаунтПользователя";
            ...
            // 
            // СвойствоНоменклатурыФормаЭлемента
            // 
            this.AllowDrop = true;
        ...
        protected _SystemTables.УчетСвойствоНоменклатурыТаблица.ColumnDescriptor Таблица;
        ...
        protected СвойствоНоменклатуры.ColumnDescriptor Родитель;
        ...
        protected ВариантыЗначений.ColumnDescriptor Значение;
