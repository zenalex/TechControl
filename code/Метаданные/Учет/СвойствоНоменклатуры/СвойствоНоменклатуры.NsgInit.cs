...
namespace TechControl.Метаданные.Учет
{
    ...
    [NsgTypeName("NsgDataDictionary", Guid = "9f609a5d-6e6c-49bc-a429-03c428d99edd")]
    public partial class СвойствоНоменклатуры : NsgSoft.DataObjects.NsgDataDictionary
    {
        #region Данные
        ...
        /// Создание объекта
        /// </summary>
        protected СвойствоНоменклатуры()
            : base()
        {
        }
        ...
        /// </summary>
        protected СвойствоНоменклатуры(NsgObject obj)
            : base(obj)
        {
        }
        ...
        public static СвойствоНоменклатуры Новый()
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("9f609a5d-6e6c-49bc-a429-03c428d99edd"));
            if (obj == null)
                obj = new СвойствоНоменклатуры();
            return obj as СвойствоНоменклатуры;
        }
	...
	Идентификатор.Guid = NsgService.StringToGuid("5f1a522e-9d78-4b67-aeba-886759de1105");
	...
	Автоинкремент.Guid = NsgService.StringToGuid("df89e5e4-0b59-4e71-af60-d23032db3dd7");
	...
	ЭтоГруппа.GroupName = "";
	ЭтоГруппа.Guid = NsgService.StringToGuid("fd5c64c7-bad6-4db4-b972-1d27ef9083a3");
	...
	ИдентификаторРодителя.Guid = NsgService.StringToGuid("c6712691-4d67-4bc5-a6e9-6ca5d39b293a");
	...
	Уровень.GroupName = "";
	Уровень.Guid = NsgService.StringToGuid("ed46f0c3-2e07-4a1e-a515-94171b578ce3");
	...
	ПрефиксКода.Guid = NsgService.StringToGuid("50d2974d-0409-4695-a66d-8f6f4d52ae9b");
	...
	НомерКода.GroupName = "";
	НомерКода.Guid = NsgService.StringToGuid("95e17517-f1e4-44a4-a627-659dc54b16b5");
	...
	Код.GroupName = "";
	Код.Guid = NsgService.StringToGuid("b69b289e-d580-4fdb-97dc-cd5d0fc6f439");
	...
	Наименование.Guid = NsgService.StringToGuid("9b91c882-86f5-4d71-9438-c0e3427aecf6");
	...
	СостояниеДокумента.Guid = NsgService.StringToGuid("4ecd2a71-6d21-4f1d-a7f9-d5175dc57716");
	...
	Номенклатура.SubType = NsgSoft.Common.NsgRekvisitSubType.Element;
	...
	Номенклатура.Guid = NsgService.StringToGuid("3fd3d18d-81f0-4040-9d89-767fed19db85");
			...
			#region создание _SystemTables.УчетСвойствоНоменклатурыТаблица Таблица
			{  
	...
	Таблица.ReferentName = "УчетСвойствоНоменклатурыТаблица";
	Таблица.OwnerName = "";
	...
	Таблица.GroupName = "";
	Таблица.Guid = NsgService.StringToGuid("a6257489-eaff-456c-bd3f-c7e57c8f2687");
	
				if (!ObjectList.Contains("Таблица"))
                    ObjectList.Add(Таблица);
			}
			#endregion //создание _SystemTables.УчетСвойствоНоменклатурыТаблица Таблица
	...
	АккаунтПользователя.Guid = NsgService.StringToGuid("614c5662-9372-4a5f-bddd-2d1e49fac305");
	...
	ПоследнееИзменение.Guid = NsgService.StringToGuid("fbf6a472-188c-4df8-b85d-cf3df21fc4c7");
	...
	Name = "СвойствоНоменклатуры";
	Visible = true;
	Guid = NsgService.StringToGuid("9f609a5d-6e6c-49bc-a429-03c428d99edd");
	DefaultSortingName = "";
	...
	TableName = "_dic_SvoijstvoNomenklatury";
	...
	GroupName = "Учет";
        ...
        public override NsgMultipleObjectDescriptor Descriptor
        {
            get
            {
                if (descriptor == null)
                {
                    ...
                    descriptor.Name = "СвойствоНоменклатуры";
        ...
        {
            return "Учет.СвойствоНоменклатуры";
        }
        ...
        public _SystemTables.УчетСвойствоНоменклатурыТаблица Таблица
        {
            get
            {
				 NsgDataTableReference __Таблица = ObjectList["Таблица"] as NsgDataTableReference;
                 return (_SystemTables.УчетСвойствоНоменклатурыТаблица)__Таблица.Referent;
            }
            set
            {
                NsgDataTableReference __Таблица = ObjectList["Таблица"] as NsgDataTableReference;
        ...
        [NsgView(NsgViewTypes.DesignTime)]
        [NsgTypeName("NsgDataDictionary")]
        public СвойствоНоменклатуры Родитель
        {
            get
            {
                return base.Parent as СвойствоНоменклатуры;
            }
            set
            {
                base.Parent = value;
        ...
        private СвойствоНоменклатуры[] convertArray(NsgMultipleObject[] array)
        {
            СвойствоНоменклатуры[] res = new СвойствоНоменклатуры[array.Length];
            array.CopyTo(res, 0);
            return res;
        }
        ...
        public new virtual СвойствоНоменклатуры[] FindAll(NsgCompare compare)
        {
        ...
        /// <returns>Список найденных объектов.</returns>
        public new virtual СвойствоНоменклатуры[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, NsgCompare compare)
        {
        ...
        /// <returns>Список найденных объектов.</returns>
        public new virtual СвойствоНоменклатуры[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, string inName, object inValue)
        {
        ...
        /// <param name="inValue">Значение для поиска. Условие поиска - полное совпадение.</param>
        /// <returns>Список найденных объектов.</returns>
        public new virtual СвойствоНоменклатуры[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, NsgDataFixedFields inName,
            object inValue)
        {
            return convertArray(base.FindAll(ref count, row_start, sorting, inName, inValue));
        }
        ...
        public override NsgObject CloneObject
        {
            get
            {
                return new СвойствоНоменклатуры(this as NsgObject);
            }
        }
        ...
        public new class ColumnDescriptor : NsgSoft.Forms.NsgColumnDescriptor
        {
            public ColumnDescriptor()
                : base()
            {
                base.NSGType = typeof(СвойствоНоменклатуры);
            }
			...
			public new СвойствоНоменклатуры Value
            {
                get
                {
                    return (СвойствоНоменклатуры)base.Value;
                }
                set
                {
                    base.Value = value;
