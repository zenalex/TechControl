...

{
    ...
    public partial class ПеремещениеФормаЭлемента:NsgSoft.Forms.NsgMultipleObjectElementForm
    {
        ...
        "Index"};
            ...
            this.nsgInput2.FullName = "Сотрудник";
            ...
            this.nsgInput1.FullName = "АккаунтПользователя";
            ...
            this.nsgInput3.FullName = "НомерДокумента";
        ...
        protected _SystemTables.УчетПеремещениеТаблица.ColumnDescriptor Таблица;
