...
namespace TechControl.Метаданные._SystemTables
{
    ...
    [NsgTypeName("NsgDataTable", Guid = "6e030ce2-6ddd-4b8d-9805-5ab7dca5f024")]
    public partial class УчетОстаткиНоменклатурыНакопления_1 : NsgSoft.DataObjects.NsgDataTable
    {
        #region Данные
        ...
        /// Создание объекта
        /// </summary>
        protected УчетОстаткиНоменклатурыНакопления_1()
            : base()
        {
        }
        ...
        /// </summary>
        protected УчетОстаткиНоменклатурыНакопления_1(NsgObject obj)
            : base(obj)
        {
        }
        ...
        public static УчетОстаткиНоменклатурыНакопления_1 Новый()
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("6e030ce2-6ddd-4b8d-9805-5ab7dca5f024"));
            if (obj == null)
                obj = new УчетОстаткиНоменклатурыНакопления_1();
            return obj as УчетОстаткиНоменклатурыНакопления_1;
        }
	...
	Автоинкремент.Guid = NsgService.StringToGuid("8266cbd9-d715-47c4-90e4-e1dcb1e4c2db");
	...
	ДатаДокумента.Guid = NsgService.StringToGuid("3d0ab11d-5307-4382-b825-99fdcc88b57b");
	...
	Name = "УчетОстаткиНоменклатурыНакопления_1";
	Visible = true;
	Guid = NsgService.StringToGuid("6e030ce2-6ddd-4b8d-9805-5ab7dca5f024");
	DefaultSortingName = "";
	...
	TableName = "_tab_UchetOstatkiNomenkl1";
	Presentation = new NsgSoft.DataObjects.NsgLanguageString(new System.String[]{"(Default)"},
		 new System.Object[]{""});
	Description = "Учет остатки накопления_1";
	...
	GroupName = "_SystemTables";
        ...
        {
            return "_SystemTables.УчетОстаткиНоменклатурыНакопления_1";
        }
        ...
        /// </summary>
        public new УчетОстаткиНоменклатурыНакопления_1.Строка NewRow()
        {
            return newRow(null) as УчетОстаткиНоменклатурыНакопления_1.Строка;
        }
        ...
        {
            if (row == null)
                row = new УчетОстаткиНоменклатурыНакопления_1.Строка(this);
            return base.newRow(row) as УчетОстаткиНоменклатурыНакопления_1.Строка;
        }

        /// <summary>
        /// Добавить новую строку в таблицу путем копирования переданной строки
        /// </summary>
        public УчетОстаткиНоменклатурыНакопления_1.Строка NewRow(УчетОстаткиНоменклатурыНакопления_1.Строка inRow)
        {
            УчетОстаткиНоменклатурыНакопления_1.Строка row = inRow.Clone as УчетОстаткиНоменклатурыНакопления_1.Строка;
            return base.newRow(row) as УчетОстаткиНоменклатурыНакопления_1.Строка;
        }
        ...
        /// </summary>
        public new УчетОстаткиНоменклатурыНакопления_1.Строка GetRow(int rowNumber)
        {
            return base.GetRow(rowNumber) as УчетОстаткиНоменклатурыНакопления_1.Строка;
        }

        /// <summary>
        /// Возвращает новую строку таблицы, но в саму таблицу ее не включает (эталонная строка)
        /// </summary>
        public new УчетОстаткиНоменклатурыНакопления_1.Строка GetEtalonRow()
        {
            УчетОстаткиНоменклатурыНакопления_1.Строка row = new УчетОстаткиНоменклатурыНакопления_1.Строка(this);
            row.MetaData = MetaData;
            return row;
        }

        private УчетОстаткиНоменклатурыНакопления_1.Строка[] convertRowsArray(NsgDataTableRow[] array)
        {
            УчетОстаткиНоменклатурыНакопления_1.Строка[] res = new УчетОстаткиНоменклатурыНакопления_1.Строка[array.Length];
            array.CopyTo(res, 0);
            return res;
        }
        ...
        public new УчетОстаткиНоменклатурыНакопления_1.Строка FindRowByTag(object Tag)
        {
            return base.FindRowByTag(Tag) as УчетОстаткиНоменклатурыНакопления_1.Строка;
        }
        ...
        /// <param name="compare">Критерии поиска.</param>
        /// <returns>Найденные строки.</returns>
        public new УчетОстаткиНоменклатурыНакопления_1.Строка[] FindRowsByTag(object Tag)
        {
        ...
        /// <param name="compare">Критерии поиска.</param>
        /// <returns>Найденные строки.</returns>
        public new УчетОстаткиНоменклатурыНакопления_1.Строка FindRow(NsgCompare compare)
        {
            return base.FindRow(compare) as УчетОстаткиНоменклатурыНакопления_1.Строка;
        }
        ...
        /// <returns>Найденные строки.</returns>
        public new УчетОстаткиНоменклатурыНакопления_1.Строка FindRow(string inName, object inValue)
        {
            return base.FindRow(inName, inValue) as УчетОстаткиНоменклатурыНакопления_1.Строка;
        }
        ...
        /// <param name="inValue">Значение поля.</param>
        /// <returns>Найденные строки.</returns>
        public new УчетОстаткиНоменклатурыНакопления_1.Строка FindRow(NsgDataFixedFields inName, object inValue)
        {
            return base.FindRow(inName, inValue) as УчетОстаткиНоменклатурыНакопления_1.Строка;
        }
        ...
        /// <param name="compare">Критерии поиска.</param>
        /// <returns>Найденные строки.</returns>
        public new УчетОстаткиНоменклатурыНакопления_1.Строка[] FindRows(NsgCompare compare)
        {
        ...
        /// <param name="inValue">Значение поля.</param>
        /// <returns>Найденные строки.</returns>
        public new УчетОстаткиНоменклатурыНакопления_1.Строка[] FindRows(string inName, object inValue)
        {
        ...
        /// <param name="inValue">Значение поля.</param>
        /// <returns>Найденные строки.</returns>
        public new УчетОстаткиНоменклатурыНакопления_1.Строка[] FindRows(NsgDataFixedFields inName, object inValue)
        {
            return convertRowsArray(base.FindRows(inName, inValue));
        }
        ...
        /// </summary>
        public  NsgVirtualCursor<УчетОстаткиНоменклатурыНакопления_1> GetNewVirtualCursor()
        {
            return base.GetNewVirtualCursor<УчетОстаткиНоменклатурыНакопления_1>();
        }

        /// <summary>
        /// Получить все строки таблицы с учетом наложенного фильтра. Для получения всех сьтрок без учета фильтра используется свойство AllRows
        /// </summary>
        public new УчетОстаткиНоменклатурыНакопления_1.Строка[] Rows
        {
            get
            {
        ...
        /// </summary>
        public new УчетОстаткиНоменклатурыНакопления_1.Строка[] AllRows
        {
            get
            {
        ...
        /// <returns>Найденные строки.</returns>
        public new УчетОстаткиНоменклатурыНакопления_1.Строка GetRow(Guid inID)
        {
            return base.GetRow(inID) as УчетОстаткиНоменклатурыНакопления_1.Строка;
        }
        #endregion
        ...
        private УчетОстаткиНоменклатурыНакопления_1[] convertArray(NsgMultipleObject[] array)
        {
            УчетОстаткиНоменклатурыНакопления_1[] res = new УчетОстаткиНоменклатурыНакопления_1[array.Length];
            array.CopyTo(res, 0);
            return res;
        }
        ...
        public new virtual УчетОстаткиНоменклатурыНакопления_1[] FindAll(NsgCompare compare)
        {
        ...
        /// <returns>Список найденных объектов.</returns>
        public new virtual УчетОстаткиНоменклатурыНакопления_1[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, NsgCompare compare)
        {
        ...
        /// <returns>Список найденных объектов.</returns>
        public new virtual УчетОстаткиНоменклатурыНакопления_1[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, string inName, object inValue)
        {
        ...
        /// <param name="inValue">Значение для поиска. Условие поиска - полное совпадение.</param>
        /// <returns>Список найденных объектов.</returns>
        public new virtual УчетОстаткиНоменклатурыНакопления_1[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, NsgDataFixedFields inName,
            object inValue)
        {
            return convertArray(base.FindAll(ref count, row_start, sorting, inName, inValue));
        }
        ...
        public override NsgObject CloneObject
        {
            get
            {
                return new УчетОстаткиНоменклатурыНакопления_1(this as NsgObject);
            }
        }
        ...
        public new class ColumnDescriptor : NsgSoft.Forms.NsgColumnDescriptor
        {
            public ColumnDescriptor()
                : base()
            {
                base.NSGType = typeof(УчетОстаткиНоменклатурыНакопления_1);
            }
			...
			public new УчетОстаткиНоменклатурыНакопления_1 Value
            {
                get
                {
                    return (УчетОстаткиНоменклатурыНакопления_1)base.Value;
                }
                set
                {
                    base.Value = value;
