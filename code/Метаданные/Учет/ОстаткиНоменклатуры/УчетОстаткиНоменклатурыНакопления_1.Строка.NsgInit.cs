...
{
    public partial class УчетОстаткиНоменклатурыНакопления_1
{
    [NsgTypeName("NsgDataTableRow", Guid = "6e030ce2-6ddd-4b8d-9805-5ab7dca5f024")]
    public partial class Строка : NsgSoft.DataObjects.NsgDataTableRow
    {
        ...
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("6e030ce2-6ddd-4b8d-9805-5ab7dca5f024"));
            if (obj == null)
                obj = new Строка();
        ...
        public override NsgMultipleObjectDescriptor Descriptor
        {
            get
            {
                if (descriptor == null)
                {
                    ...
                    descriptor.Name = "УчетОстаткиНоменклатурыНакопления_1";
