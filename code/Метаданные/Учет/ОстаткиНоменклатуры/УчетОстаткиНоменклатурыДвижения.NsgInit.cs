...
namespace TechControl.Метаданные._SystemTables
{
    ...
    [NsgTypeName("NsgDataTable", Guid = "abe89d6c-5115-45d9-9372-2b0033d03869")]
    public partial class УчетОстаткиНоменклатурыДвижения : NsgSoft.DataObjects.NsgDataTable
    {
        #region Данные
        ...
        /// Создание объекта
        /// </summary>
        protected УчетОстаткиНоменклатурыДвижения()
            : base()
        {
        }
        ...
        /// </summary>
        protected УчетОстаткиНоменклатурыДвижения(NsgObject obj)
            : base(obj)
        {
        }
        ...
        public static УчетОстаткиНоменклатурыДвижения Новый()
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("abe89d6c-5115-45d9-9372-2b0033d03869"));
            if (obj == null)
                obj = new УчетОстаткиНоменклатурыДвижения();
            return obj as УчетОстаткиНоменклатурыДвижения;
        }
	...
	Идентификатор.Guid = NsgService.StringToGuid("4182d493-5592-4536-8a71-4744eea926bb");
	...
	Автоинкремент.Guid = NsgService.StringToGuid("82a2edfc-bb12-41e6-bdd1-82bdb4599379");
	...
	Владелец.GroupName = "";
	Владелец.Guid = NsgService.StringToGuid("31cabf83-529d-4c38-9f86-fe781a668d86");
	...
	ДатаДокумента.Guid = NsgService.StringToGuid("09a01ff7-bfb9-4516-87f0-1274e0841856");
	...
	ВидДвижения.Guid = NsgService.StringToGuid("f6becf23-3c01-4cd2-8da2-cfded5c1c9b1");
	...
	Активность.Guid = NsgService.StringToGuid("fc47ff13-3389-4143-8e23-45b2d713291d");
	...
	Стоимость.GroupName = "";
	Стоимость.Guid = NsgService.StringToGuid("ee2f8b96-4b78-4622-8114-4a59e23dc7d5");
	...
	Количество.SubType = NsgSoft.Common.NsgRekvisitSubType.Property;
	...
	Количество.Guid = NsgService.StringToGuid("b12d5bc3-6570-495c-8796-5ae5a7311f19");
	...
	Name = "УчетОстаткиНоменклатурыДвижения";
	Visible = true;
	Guid = NsgService.StringToGuid("abe89d6c-5115-45d9-9372-2b0033d03869");
	DefaultSortingName = "";
	...
	TableName = "_tab_UchetOstatkiNomenkl2";
	Presentation = new NsgSoft.DataObjects.NsgLanguageString(new System.String[]{"(Default)"},
		 new System.Object[]{""});
	Description = "Учет остатки движения";
	...
	GroupName = "_SystemTables";
        ...
        {
            return "_SystemTables.УчетОстаткиНоменклатурыДвижения";
        }
        ...
        /// </summary>
        public new УчетОстаткиНоменклатурыДвижения.Строка NewRow()
        {
            return newRow(null) as УчетОстаткиНоменклатурыДвижения.Строка;
        }
        ...
        {
            if (row == null)
                row = new УчетОстаткиНоменклатурыДвижения.Строка(this);
            return base.newRow(row) as УчетОстаткиНоменклатурыДвижения.Строка;
        }

        /// <summary>
        /// Добавить новую строку в таблицу путем копирования переданной строки
        /// </summary>
        public УчетОстаткиНоменклатурыДвижения.Строка NewRow(УчетОстаткиНоменклатурыДвижения.Строка inRow)
        {
            УчетОстаткиНоменклатурыДвижения.Строка row = inRow.Clone as УчетОстаткиНоменклатурыДвижения.Строка;
            return base.newRow(row) as УчетОстаткиНоменклатурыДвижения.Строка;
        }
        ...
        /// </summary>
        public new УчетОстаткиНоменклатурыДвижения.Строка GetRow(int rowNumber)
        {
            return base.GetRow(rowNumber) as УчетОстаткиНоменклатурыДвижения.Строка;
        }

        /// <summary>
        /// Возвращает новую строку таблицы, но в саму таблицу ее не включает (эталонная строка)
        /// </summary>
        public new УчетОстаткиНоменклатурыДвижения.Строка GetEtalonRow()
        {
            УчетОстаткиНоменклатурыДвижения.Строка row = new УчетОстаткиНоменклатурыДвижения.Строка(this);
            row.MetaData = MetaData;
            return row;
        }

        private УчетОстаткиНоменклатурыДвижения.Строка[] convertRowsArray(NsgDataTableRow[] array)
        {
            УчетОстаткиНоменклатурыДвижения.Строка[] res = new УчетОстаткиНоменклатурыДвижения.Строка[array.Length];
            array.CopyTo(res, 0);
            return res;
        }
        ...
        public new УчетОстаткиНоменклатурыДвижения.Строка FindRowByTag(object Tag)
        {
            return base.FindRowByTag(Tag) as УчетОстаткиНоменклатурыДвижения.Строка;
        }
        ...
        /// <param name="compare">Критерии поиска.</param>
        /// <returns>Найденные строки.</returns>
        public new УчетОстаткиНоменклатурыДвижения.Строка[] FindRowsByTag(object Tag)
        {
        ...
        /// <param name="compare">Критерии поиска.</param>
        /// <returns>Найденные строки.</returns>
        public new УчетОстаткиНоменклатурыДвижения.Строка FindRow(NsgCompare compare)
        {
            return base.FindRow(compare) as УчетОстаткиНоменклатурыДвижения.Строка;
        }
        ...
        /// <returns>Найденные строки.</returns>
        public new УчетОстаткиНоменклатурыДвижения.Строка FindRow(string inName, object inValue)
        {
            return base.FindRow(inName, inValue) as УчетОстаткиНоменклатурыДвижения.Строка;
        }
        ...
        /// <param name="inValue">Значение поля.</param>
        /// <returns>Найденные строки.</returns>
        public new УчетОстаткиНоменклатурыДвижения.Строка FindRow(NsgDataFixedFields inName, object inValue)
        {
            return base.FindRow(inName, inValue) as УчетОстаткиНоменклатурыДвижения.Строка;
        }
        ...
        /// <param name="compare">Критерии поиска.</param>
        /// <returns>Найденные строки.</returns>
        public new УчетОстаткиНоменклатурыДвижения.Строка[] FindRows(NsgCompare compare)
        {
        ...
        /// <param name="inValue">Значение поля.</param>
        /// <returns>Найденные строки.</returns>
        public new УчетОстаткиНоменклатурыДвижения.Строка[] FindRows(string inName, object inValue)
        {
        ...
        /// <param name="inValue">Значение поля.</param>
        /// <returns>Найденные строки.</returns>
        public new УчетОстаткиНоменклатурыДвижения.Строка[] FindRows(NsgDataFixedFields inName, object inValue)
        {
            return convertRowsArray(base.FindRows(inName, inValue));
        }
        ...
        /// </summary>
        public  NsgVirtualCursor<УчетОстаткиНоменклатурыДвижения> GetNewVirtualCursor()
        {
            return base.GetNewVirtualCursor<УчетОстаткиНоменклатурыДвижения>();
        }

        /// <summary>
        /// Получить все строки таблицы с учетом наложенного фильтра. Для получения всех сьтрок без учета фильтра используется свойство AllRows
        /// </summary>
        public new УчетОстаткиНоменклатурыДвижения.Строка[] Rows
        {
            get
            {
        ...
        /// </summary>
        public new УчетОстаткиНоменклатурыДвижения.Строка[] AllRows
        {
            get
            {
        ...
        /// <returns>Найденные строки.</returns>
        public new УчетОстаткиНоменклатурыДвижения.Строка GetRow(Guid inID)
        {
            return base.GetRow(inID) as УчетОстаткиНоменклатурыДвижения.Строка;
        }
        #endregion
        ...
        private УчетОстаткиНоменклатурыДвижения[] convertArray(NsgMultipleObject[] array)
        {
            УчетОстаткиНоменклатурыДвижения[] res = new УчетОстаткиНоменклатурыДвижения[array.Length];
            array.CopyTo(res, 0);
            return res;
        }
        ...
        public new virtual УчетОстаткиНоменклатурыДвижения[] FindAll(NsgCompare compare)
        {
        ...
        /// <returns>Список найденных объектов.</returns>
        public new virtual УчетОстаткиНоменклатурыДвижения[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, NsgCompare compare)
        {
        ...
        /// <returns>Список найденных объектов.</returns>
        public new virtual УчетОстаткиНоменклатурыДвижения[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, string inName, object inValue)
        {
        ...
        /// <param name="inValue">Значение для поиска. Условие поиска - полное совпадение.</param>
        /// <returns>Список найденных объектов.</returns>
        public new virtual УчетОстаткиНоменклатурыДвижения[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, NsgDataFixedFields inName,
            object inValue)
        {
            return convertArray(base.FindAll(ref count, row_start, sorting, inName, inValue));
        }
        ...
        public override NsgObject CloneObject
        {
            get
            {
                return new УчетОстаткиНоменклатурыДвижения(this as NsgObject);
            }
        }
        ...
        public new class ColumnDescriptor : NsgSoft.Forms.NsgColumnDescriptor
        {
            public ColumnDescriptor()
                : base()
            {
                base.NSGType = typeof(УчетОстаткиНоменклатурыДвижения);
            }
			...
			public new УчетОстаткиНоменклатурыДвижения Value
            {
                get
                {
                    return (УчетОстаткиНоменклатурыДвижения)base.Value;
                }
                set
                {
                    base.Value = value;
