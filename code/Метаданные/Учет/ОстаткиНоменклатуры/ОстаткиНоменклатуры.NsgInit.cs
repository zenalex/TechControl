...
namespace TechControl.Метаданные.Учет
{
    ...
    [NsgTypeName("NsgDataRegister", Guid = "65bb2740-900b-4626-b04c-28831163860a")]
    public partial class ОстаткиНоменклатуры : NsgSoft.DataObjects.NsgDataRegister
    {
        #region Данные
        ...
        /// </summary>
        public static ОстаткиНоменклатуры Новый(NsgDataDocument document)
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("65bb2740-900b-4626-b04c-28831163860a"));
            if (obj == null)
                obj = new ОстаткиНоменклатуры();
            (obj as ОстаткиНоменклатуры).Document = document;
            return obj as ОстаткиНоменклатуры;
        }
        ...
        /// </summary>
        protected ОстаткиНоменклатуры(NsgObject obj)
            : base(obj)
        {
        }
        ...
        public static ОстаткиНоменклатуры Новый()
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("65bb2740-900b-4626-b04c-28831163860a"));
            if (obj == null)
                obj = new ОстаткиНоменклатуры();
	...
	Идентификатор.Guid = NsgService.StringToGuid("66e780d3-1dfc-4091-a127-e8405862485a");
	...
	Автоинкремент.Guid = NsgService.StringToGuid("d1685b91-338e-4327-8400-f61460d175e9");
			...
			#region создание _SystemTables.УчетОстаткиНоменклатурыДвижения Движения
			{  
	...
	Движения.ReferentName = "УчетОстаткиНоменклатурыДвижения";
	...
	Движения.GroupName = "";
	Движения.Guid = NsgService.StringToGuid("88a10d4a-c7da-40ed-a95a-04ac17d5252b");
	
				if (!ObjectList.Contains("Движения"))
                    ObjectList.Add(Движения);
			}
			#endregion //создание _SystemTables.УчетОстаткиНоменклатурыДвижения Движения
			
			#region создание _SystemTables.УчетОстаткиНоменклатурыНакопления Накопления
			{  
	...
	Накопления.ReferentName = "УчетОстаткиНоменклатурыНакопления";
	...
	Накопления.Guid = NsgService.StringToGuid("304c77bb-d43f-4218-9d9f-3fd8d39e63f6");
	
				if (!ObjectList.Contains("Накопления"))
                    ObjectList.Add(Накопления);
			}
			#endregion //создание _SystemTables.УчетОстаткиНоменклатурыНакопления Накопления
			
			#region создание _SystemTables.УчетОстаткиНоменклатурыНакопления_1 Накопления_1
			{  
	...
	Накопления_1.ReferentName = "УчетОстаткиНоменклатурыНакопления_1";
	...
	Накопления_1.Guid = NsgService.StringToGuid("497dd8c7-e568-4bbd-b870-41d5fdfa9916");
	
				if (!ObjectList.Contains("Накопления_1"))
                    ObjectList.Add(Накопления_1);
			}
			#endregion //создание _SystemTables.УчетОстаткиНоменклатурыНакопления_1 Накопления_1
	...
	Владелец.GroupName = "";
	Владелец.Guid = NsgService.StringToGuid("24783bab-778d-474a-971b-424d5aeef765");
	...
	ДатаДокумента.Guid = NsgService.StringToGuid("03b319b7-cbd9-4914-be03-b3d6a736e4f8");
	...
	Visible = true;
	Guid = NsgService.StringToGuid("65bb2740-900b-4626-b04c-28831163860a");
	DefaultSortingName = "";
	...
	TableName = "_reg_OstatkiNomenklatury";
	Presentation = new NsgSoft.DataObjects.NsgLanguageString(new System.String[]{"(Default)"},
		 new System.Object[]{""});
	Description = "Остатки номенклатуры";
	...
	ConnectAdditionalTables();
        ...
        public override NsgMultipleObjectDescriptor Descriptor
        {
            get
            {
                if (descriptor == null)
                {
                    ...
                    descriptor.Name = "ОстаткиНоменклатуры";
        ...
        {
            return "Учет.ОстаткиНоменклатуры";
        }
        ...
        public _SystemTables.УчетОстаткиНоменклатурыДвижения Движения
        {
            get
            {
				 NsgRegisterTable __Движения = ObjectList["Движения"] as NsgRegisterTable;
                 return (_SystemTables.УчетОстаткиНоменклатурыДвижения)__Движения.Referent;
            }
            set
            {
                NsgRegisterTable __Движения = ObjectList["Движения"] as NsgRegisterTable;
        ...
        public _SystemTables.УчетОстаткиНоменклатурыНакопления Накопления
        {
            get
            {
				 NsgRegisterTable __Накопления = ObjectList["Накопления"] as NsgRegisterTable;
                 return (_SystemTables.УчетОстаткиНоменклатурыНакопления)__Накопления.Referent;
            }
            set
            {
                NsgRegisterTable __Накопления = ObjectList["Накопления"] as NsgRegisterTable;
        ...
        public _SystemTables.УчетОстаткиНоменклатурыНакопления_1 Накопления_1
        {
            get
            {
				 NsgRegisterTable __Накопления_1 = ObjectList["Накопления_1"] as NsgRegisterTable;
                 return (_SystemTables.УчетОстаткиНоменклатурыНакопления_1)__Накопления_1.Referent;
            }
            set
            {
                NsgRegisterTable __Накопления_1 = ObjectList["Накопления_1"] as NsgRegisterTable;
        ...
        private ОстаткиНоменклатуры[] convertArray(NsgMultipleObject[] array)
        {
            ОстаткиНоменклатуры[] res = new ОстаткиНоменклатуры[array.Length];
            array.CopyTo(res, 0);
            return res;
        }
        ...
        public new virtual ОстаткиНоменклатуры[] FindAll(NsgCompare compare)
        {
        ...
        /// <returns>Список найденных объектов.</returns>
        public new virtual ОстаткиНоменклатуры[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, NsgCompare compare)
        {
        ...
        /// <returns>Список найденных объектов.</returns>
        public new virtual ОстаткиНоменклатуры[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, string inName, object inValue)
        {
        ...
        /// <param name="inValue">Значение для поиска. Условие поиска - полное совпадение.</param>
        /// <returns>Список найденных объектов.</returns>
        public new virtual ОстаткиНоменклатуры[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, NsgDataFixedFields inName,
            object inValue)
        {
            return convertArray(base.FindAll(ref count, row_start, sorting, inName, inValue));
        }
        ...
        public override NsgObject CloneObject
        {
            get
            {
                return new ОстаткиНоменклатуры(this as NsgObject);
            }
        }
        ...
        public new class ColumnDescriptor : NsgSoft.Forms.NsgColumnDescriptor
        {
            public ColumnDescriptor()
                : base()
            {
                base.NSGType = typeof(ОстаткиНоменклатуры);
            }
			...
			public new ОстаткиНоменклатуры Value
            {
                get
                {
                    return (ОстаткиНоменклатуры)base.Value;
                }
                set
                {
                    base.Value = value;
