...
namespace TechControl.Метаданные._SystemTables
{
    ...
    [NsgTypeName("NsgDataTable", Guid = "fe054100-65fd-4c09-892e-1bb904580674")]
    public partial class УчетПриходнаяНакладнаяТаблица : NsgSoft.DataObjects.NsgDataTable
    {
        #region Данные
        ...
        /// Создание объекта
        /// </summary>
        protected УчетПриходнаяНакладнаяТаблица()
            : base()
        {
        }
        ...
        /// </summary>
        protected УчетПриходнаяНакладнаяТаблица(NsgObject obj)
            : base(obj)
        {
        }
        ...
        public static УчетПриходнаяНакладнаяТаблица Новый()
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("fe054100-65fd-4c09-892e-1bb904580674"));
            if (obj == null)
                obj = new УчетПриходнаяНакладнаяТаблица();
            return obj as УчетПриходнаяНакладнаяТаблица;
        }
	...
	Идентификатор.Guid = NsgService.StringToGuid("2be1bd7b-42ab-4cb9-87b0-20c552650af0");
	...
	Автоинкремент.Guid = NsgService.StringToGuid("c4aca303-3dc2-4f7a-83ca-324c19c57d10");
	...
	Владелец.FilterForConfigurator = "Учет.ПриходнаяНакладная";
	...
	Владелец.GroupName = "";
	Владелец.Guid = NsgService.StringToGuid("e85849e4-1e61-4b17-974c-d66d2964f5a9");
	...
	НомерСтроки.Guid = NsgService.StringToGuid("ff04c5d5-399f-4126-aaa6-94210c159c05");
	...
	Количество.Guid = NsgService.StringToGuid("8b71a8be-9719-446a-9ec3-e2939aa74dfc");
	...
	Цена.GroupName = "";
	Цена.Guid = NsgService.StringToGuid("0d07b46e-b14c-491a-b321-909f0d7a82db");
	...
	Стоимость.GroupName = "";
	Стоимость.Guid = NsgService.StringToGuid("23fa6a4f-de8d-4b50-bea1-e2a1054d245e");
	...
	Номенклатура.Guid = NsgService.StringToGuid("b7adbe3b-a2e4-410e-8cf9-39bb2ada006a");
	...
	СвойствоНоменклатуры.Guid = NsgService.StringToGuid("696bf73e-beb1-4745-9af1-f5d33333f336");
	...
	OwnerFullName = "Учет.ПриходнаяНакладная";
	RegisterPeriod = NsgSoft.Common.NsgPeriod.None;
	RegisterPeriodCount = 0;
	TableSubType = NsgSoft.Common.NsgTableSubType.TablePart;
	EntityType = NsgSoft.DataObjects.NsgInterfacedObject.EntityTypes.Object;
	Name = "УчетПриходнаяНакладнаяТаблица";
	Visible = true;
	Guid = NsgService.StringToGuid("fe054100-65fd-4c09-892e-1bb904580674");
	DefaultSortingName = "";
	...
	TableName = "_tab_UchetPrikhodnajaNak";
	Presentation = new NsgSoft.DataObjects.NsgLanguageString(new System.String[]{"(Default)"},
		 new System.Object[]{""});
	Description = "Учет приходная накладная таблица";
	...
	GroupName = "_SystemTables";
        ...
        {
            return "_SystemTables.УчетПриходнаяНакладнаяТаблица";
        }
        ...
        /// </summary>
        public new УчетПриходнаяНакладнаяТаблица.Строка NewRow()
        {
            return newRow(null) as УчетПриходнаяНакладнаяТаблица.Строка;
        }
        ...
        {
            if (row == null)
                row = new УчетПриходнаяНакладнаяТаблица.Строка(this);
            return base.newRow(row) as УчетПриходнаяНакладнаяТаблица.Строка;
        }

        /// <summary>
        /// Добавить новую строку в таблицу путем копирования переданной строки
        /// </summary>
        public УчетПриходнаяНакладнаяТаблица.Строка NewRow(УчетПриходнаяНакладнаяТаблица.Строка inRow)
        {
            УчетПриходнаяНакладнаяТаблица.Строка row = inRow.Clone as УчетПриходнаяНакладнаяТаблица.Строка;
            return base.newRow(row) as УчетПриходнаяНакладнаяТаблица.Строка;
        }
        ...
        /// </summary>
        public new УчетПриходнаяНакладнаяТаблица.Строка GetRow(int rowNumber)
        {
            return base.GetRow(rowNumber) as УчетПриходнаяНакладнаяТаблица.Строка;
        }

        /// <summary>
        /// Возвращает новую строку таблицы, но в саму таблицу ее не включает (эталонная строка)
        /// </summary>
        public new УчетПриходнаяНакладнаяТаблица.Строка GetEtalonRow()
        {
            УчетПриходнаяНакладнаяТаблица.Строка row = new УчетПриходнаяНакладнаяТаблица.Строка(this);
            row.MetaData = MetaData;
            return row;
        }

        private УчетПриходнаяНакладнаяТаблица.Строка[] convertRowsArray(NsgDataTableRow[] array)
        {
            УчетПриходнаяНакладнаяТаблица.Строка[] res = new УчетПриходнаяНакладнаяТаблица.Строка[array.Length];
            array.CopyTo(res, 0);
            return res;
        }
        ...
        public new УчетПриходнаяНакладнаяТаблица.Строка FindRowByTag(object Tag)
        {
            return base.FindRowByTag(Tag) as УчетПриходнаяНакладнаяТаблица.Строка;
        }
        ...
        /// <param name="compare">Критерии поиска.</param>
        /// <returns>Найденные строки.</returns>
        public new УчетПриходнаяНакладнаяТаблица.Строка[] FindRowsByTag(object Tag)
        {
        ...
        /// <param name="compare">Критерии поиска.</param>
        /// <returns>Найденные строки.</returns>
        public new УчетПриходнаяНакладнаяТаблица.Строка FindRow(NsgCompare compare)
        {
            return base.FindRow(compare) as УчетПриходнаяНакладнаяТаблица.Строка;
        }
        ...
        /// <returns>Найденные строки.</returns>
        public new УчетПриходнаяНакладнаяТаблица.Строка FindRow(string inName, object inValue)
        {
            return base.FindRow(inName, inValue) as УчетПриходнаяНакладнаяТаблица.Строка;
        }
        ...
        /// <param name="inValue">Значение поля.</param>
        /// <returns>Найденные строки.</returns>
        public new УчетПриходнаяНакладнаяТаблица.Строка FindRow(NsgDataFixedFields inName, object inValue)
        {
            return base.FindRow(inName, inValue) as УчетПриходнаяНакладнаяТаблица.Строка;
        }
        ...
        /// <param name="compare">Критерии поиска.</param>
        /// <returns>Найденные строки.</returns>
        public new УчетПриходнаяНакладнаяТаблица.Строка[] FindRows(NsgCompare compare)
        {
        ...
        /// <param name="inValue">Значение поля.</param>
        /// <returns>Найденные строки.</returns>
        public new УчетПриходнаяНакладнаяТаблица.Строка[] FindRows(string inName, object inValue)
        {
        ...
        /// <param name="inValue">Значение поля.</param>
        /// <returns>Найденные строки.</returns>
        public new УчетПриходнаяНакладнаяТаблица.Строка[] FindRows(NsgDataFixedFields inName, object inValue)
        {
            return convertRowsArray(base.FindRows(inName, inValue));
        }
        ...
        /// </summary>
        public  NsgVirtualCursor<УчетПриходнаяНакладнаяТаблица> GetNewVirtualCursor()
        {
            return base.GetNewVirtualCursor<УчетПриходнаяНакладнаяТаблица>();
        }

        /// <summary>
        /// Получить все строки таблицы с учетом наложенного фильтра. Для получения всех сьтрок без учета фильтра используется свойство AllRows
        /// </summary>
        public new УчетПриходнаяНакладнаяТаблица.Строка[] Rows
        {
            get
            {
        ...
        /// </summary>
        public new УчетПриходнаяНакладнаяТаблица.Строка[] AllRows
        {
            get
            {
        ...
        /// <returns>Найденные строки.</returns>
        public new УчетПриходнаяНакладнаяТаблица.Строка GetRow(Guid inID)
        {
            return base.GetRow(inID) as УчетПриходнаяНакладнаяТаблица.Строка;
        }
        #endregion
        ...
        private УчетПриходнаяНакладнаяТаблица[] convertArray(NsgMultipleObject[] array)
        {
            УчетПриходнаяНакладнаяТаблица[] res = new УчетПриходнаяНакладнаяТаблица[array.Length];
            array.CopyTo(res, 0);
            return res;
        }
        ...
        public new virtual УчетПриходнаяНакладнаяТаблица[] FindAll(NsgCompare compare)
        {
        ...
        /// <returns>Список найденных объектов.</returns>
        public new virtual УчетПриходнаяНакладнаяТаблица[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, NsgCompare compare)
        {
        ...
        /// <returns>Список найденных объектов.</returns>
        public new virtual УчетПриходнаяНакладнаяТаблица[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, string inName, object inValue)
        {
        ...
        /// <param name="inValue">Значение для поиска. Условие поиска - полное совпадение.</param>
        /// <returns>Список найденных объектов.</returns>
        public new virtual УчетПриходнаяНакладнаяТаблица[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, NsgDataFixedFields inName,
            object inValue)
        {
            return convertArray(base.FindAll(ref count, row_start, sorting, inName, inValue));
        }
        ...
        public override NsgObject CloneObject
        {
            get
            {
                return new УчетПриходнаяНакладнаяТаблица(this as NsgObject);
            }
        }
        ...
        public new class ColumnDescriptor : NsgSoft.Forms.NsgColumnDescriptor
        {
            public ColumnDescriptor()
                : base()
            {
                base.NSGType = typeof(УчетПриходнаяНакладнаяТаблица);
            }
			...
			public new УчетПриходнаяНакладнаяТаблица Value
            {
                get
                {
                    return (УчетПриходнаяНакладнаяТаблица)base.Value;
                }
                set
                {
                    base.Value = value;
