...
{
    public partial class УчетПриходнаяНакладнаяТаблица
{
    [NsgTypeName("NsgDataTableRow", Guid = "fe054100-65fd-4c09-892e-1bb904580674")]
    public partial class Строка : NsgSoft.DataObjects.NsgDataTableRow
    {
        ...
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("fe054100-65fd-4c09-892e-1bb904580674"));
            if (obj == null)
                obj = new Строка();
        ...
        public override NsgMultipleObjectDescriptor Descriptor
        {
            get
            {
                if (descriptor == null)
                {
                    ...
                    descriptor.Name = "УчетПриходнаяНакладнаяТаблица";
        ...
        [NsgReferentsFilterAttribute("Учет.ПриходнаяНакладная")]
