...
namespace TechControl.Метаданные.Учет
{
    ...
    [NsgTypeName("NsgDataDictionary", Guid = "155abeca-3474-4a11-a376-7b9120361262")]
    public partial class ПланыАмортизации : NsgSoft.DataObjects.NsgDataDictionary
    {
        #region Данные
        ...
        /// </summary>
        protected ПланыАмортизации(NsgObject obj)
            : base(obj)
        {
        }
        ...
        public static ПланыАмортизации Новый()
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("155abeca-3474-4a11-a376-7b9120361262"));
            if (obj == null)
                obj = new ПланыАмортизации();
            return obj as ПланыАмортизации;
        }
	...
	Идентификатор.Guid = NsgService.StringToGuid("897212d3-afbc-4d6e-adac-5b2b57a519ca");
	...
	Автоинкремент.Guid = NsgService.StringToGuid("86db9c37-7093-4f6e-815b-d543c071d704");
	...
	ЭтоГруппа.GroupName = "";
	ЭтоГруппа.Guid = NsgService.StringToGuid("8f9ee321-ffac-49ce-bf04-c40bd8ec90a4");
	...
	ИдентификаторРодителя.Guid = NsgService.StringToGuid("aca331a6-e862-4ad6-9c9a-0c513972b1f8");
	...
	Уровень.GroupName = "";
	Уровень.Guid = NsgService.StringToGuid("1bc238c1-357e-4232-a9b7-99347f7675a9");
	...
	ПрефиксКода.Guid = NsgService.StringToGuid("0548ad20-09e4-4ca2-8af1-80c945a08af0");
	...
	НомерКода.GroupName = "";
	НомерКода.Guid = NsgService.StringToGuid("9891b5d0-bd35-4847-ae7f-b6d4e2eeb3d5");
	...
	Код.GroupName = "";
	Код.Guid = NsgService.StringToGuid("e6ee12fa-4b09-4ed5-8aa5-802b28d6662f");
	...
	Наименование.Guid = NsgService.StringToGuid("15894343-58c9-4281-b305-a0c5ecf1b0e3");
	...
	СостояниеДокумента.Guid = NsgService.StringToGuid("756f470b-c931-409c-9b07-01fa7f5fc9d0");
			...
			#region создание TechControl.Метаданные.Учет.ПланыАмортизацииФормаЭлемента ФормаЭлемента
			{  
	...
	ФормаЭлемента.FormClassName = "TechControl.Метаданные.Учет.ПланыАмортизацииФормаЭлемента";
	...
	ФормаЭлемента.Guid = NsgService.StringToGuid("1567a0ca-b481-4371-a40c-2ba12d852265");
	
				if (!ObjectList.Contains("ФормаЭлемента"))
                    ObjectList.Add(ФормаЭлемента);
			}
			#endregion //создание TechControl.Метаданные.Учет.ПланыАмортизацииФормаЭлемента ФормаЭлемента
			
			#region создание System.Int64 СрокАмортизацииМес
			{  
                NsgDataInteger СрокАмортизацииМес = null;
				if (ObjectList.Contains("СрокАмортизацииМес"))
                    СрокАмортизацииМес = ObjectList["СрокАмортизацииМес"] as NsgDataInteger;
                else
                    СрокАмортизацииМес = new NsgDataInteger();
	//NsgDataInteger
	СрокАмортизацииМес.IsLoadedFromDll = true;
	СрокАмортизацииМес.DefaultValue = 0M;
	СрокАмортизацииМес.MinValue = 0M;
	СрокАмортизацииМес.MaxValue = 0M;
	СрокАмортизацииМес.UseCalculator = true;
	СрокАмортизацииМес.StringFormat = "";
	СрокАмортизацииМес.SubType = NsgSoft.Common.NsgRekvisitSubType.Element;
	СрокАмортизацииМес.IncludeInPredefined = false;
	СрокАмортизацииМес.PeriodicType = NsgSoft.Database.PeriodicTypes.None;
	СрокАмортизацииМес.Required = false;
	СрокАмортизацииМес.EmptyValue = "";
	СрокАмортизацииМес.NullAllow = false;
	СрокАмортизацииМес.IndexType = NsgSoft.Database.NsgRekvisitIndexType.None;
	СрокАмортизацииМес.FieldName = "SrokAmortizaciiMes";
	СрокАмортизацииМес.SaveInDatabase = true;
	СрокАмортизацииМес.InformMetaDataOnValueChanged = false;
	СрокАмортизацииМес.Visible = true;
	СрокАмортизацииМес.Name = "СрокАмортизацииМес";
	СрокАмортизацииМес.Presentation = new NsgSoft.DataObjects.NsgLanguageString(new System.String[]{"(Default)"},
		 new System.Object[]{""});
	СрокАмортизацииМес.Description = "Срок амортизации мес";
	СрокАмортизацииМес.EditorVisible = NsgSoft.DataObjects.NsgDataObjectEditorAccess.Full;
	СрокАмортизацииМес.GroupName = "";
	СрокАмортизацииМес.Guid = NsgService.StringToGuid("e33117f2-1c0f-4406-8ae4-352e1bb6adad");
	
				if (!ObjectList.Contains("СрокАмортизацииМес"))
                    ObjectList.Add(СрокАмортизацииМес);
			}
			#endregion //создание System.Int64 СрокАмортизацииМес
			
			#region создание System.Int64 КоличествоПериодов
			{  
                NsgDataInteger КоличествоПериодов = null;
				if (ObjectList.Contains("КоличествоПериодов"))
                    КоличествоПериодов = ObjectList["КоличествоПериодов"] as NsgDataInteger;
                else
                    КоличествоПериодов = new NsgDataInteger();
	//NsgDataInteger
	КоличествоПериодов.IsLoadedFromDll = true;
	КоличествоПериодов.DefaultValue = 0M;
	КоличествоПериодов.MinValue = 0M;
	КоличествоПериодов.MaxValue = 0M;
	КоличествоПериодов.UseCalculator = true;
	КоличествоПериодов.StringFormat = "";
	КоличествоПериодов.SubType = NsgSoft.Common.NsgRekvisitSubType.Element;
	КоличествоПериодов.IncludeInPredefined = false;
	КоличествоПериодов.PeriodicType = NsgSoft.Database.PeriodicTypes.None;
	КоличествоПериодов.Required = false;
	КоличествоПериодов.EmptyValue = "";
	КоличествоПериодов.NullAllow = false;
	КоличествоПериодов.IndexType = NsgSoft.Database.NsgRekvisitIndexType.None;
	КоличествоПериодов.FieldName = "KolichestvoPeriodov";
	КоличествоПериодов.SaveInDatabase = true;
	КоличествоПериодов.InformMetaDataOnValueChanged = false;
	КоличествоПериодов.Visible = true;
	КоличествоПериодов.Name = "КоличествоПериодов";
	КоличествоПериодов.Presentation = new NsgSoft.DataObjects.NsgLanguageString(new System.String[]{"(Default)"},
		 new System.Object[]{""});
	КоличествоПериодов.Description = "Количество периодов";
	КоличествоПериодов.EditorVisible = NsgSoft.DataObjects.NsgDataObjectEditorAccess.Full;
	КоличествоПериодов.GroupName = "";
	КоличествоПериодов.Guid = NsgService.StringToGuid("df6b940d-0b97-413f-8946-7f6d87b70436");
	
				if (!ObjectList.Contains("КоличествоПериодов"))
                    ObjectList.Add(КоличествоПериодов);
			}
			#endregion //создание System.Int64 КоличествоПериодов
	...
	Name = "ПланыАмортизации";
	Visible = true;
	Guid = NsgService.StringToGuid("155abeca-3474-4a11-a376-7b9120361262");
	DefaultSortingName = "";
	...
	TableName = "_dic_PlanyAmortizacii";
	...
	GroupName = "Учет";
        ...
        public new partial class Names// :NsgSoft.DataObjects.NsgDataDictionary.Names
        {
            ...
            /// </summary>
            public static String СрокАмортизацииМес
            {
                get
                {
                    return "СрокАмортизацииМес";
                }
            }
            ...
            /// Количество периодов
            /// </summary>
            public static String КоличествоПериодов
            {
                get
                {
                    return "КоличествоПериодов";
                }
            }
        ...
        public override NsgMultipleObjectDescriptor Descriptor
        {
            get
            {
                if (descriptor == null)
                {
                    ...
                    descriptor.Name = "ПланыАмортизации";
        ...
        public System.Int64 СрокАмортизацииМес
        {
            get
            {
				 NsgDataInteger __СрокАмортизацииМес = ObjectList["СрокАмортизацииМес"] as NsgDataInteger;
                 return (System.Int64)__СрокАмортизацииМес.Value;
            }
            set
            {
                NsgDataInteger __СрокАмортизацииМес = ObjectList["СрокАмортизацииМес"] as NsgDataInteger;
                __СрокАмортизацииМес.Value = value;
            }
        }
        ...
        public System.Int64 КоличествоПериодов
        {
            get
            {
				 NsgDataInteger __КоличествоПериодов = ObjectList["КоличествоПериодов"] as NsgDataInteger;
                 return (System.Int64)__КоличествоПериодов.Value;
            }
            set
            {
                NsgDataInteger __КоличествоПериодов = ObjectList["КоличествоПериодов"] as NsgDataInteger;
                __КоличествоПериодов.Value = value;
            }
        }
        ...
        public ПланыАмортизации Родитель
        {
            get
            {
                return base.Parent as ПланыАмортизации;
            }
            set
            {
                base.Parent = value;
        ...
        private ПланыАмортизации[] convertArray(NsgMultipleObject[] array)
        {
            ПланыАмортизации[] res = new ПланыАмортизации[array.Length];
            array.CopyTo(res, 0);
            return res;
        }
        ...
        public new virtual ПланыАмортизации[] FindAll(NsgCompare compare)
        {
        ...
        /// <returns>Список найденных объектов.</returns>
        public new virtual ПланыАмортизации[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, NsgCompare compare)
        {
        ...
        /// <returns>Список найденных объектов.</returns>
        public new virtual ПланыАмортизации[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, string inName, object inValue)
        {
        ...
        /// <param name="inValue">Значение для поиска. Условие поиска - полное совпадение.</param>
        /// <returns>Список найденных объектов.</returns>
        public new virtual ПланыАмортизации[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, NsgDataFixedFields inName,
            object inValue)
        {
            return convertArray(base.FindAll(ref count, row_start, sorting, inName, inValue));
        }
        ...
        public override NsgObject CloneObject
        {
            get
            {
                return new ПланыАмортизации(this as NsgObject);
            }
        }
        ...
        public new class ColumnDescriptor : NsgSoft.Forms.NsgColumnDescriptor
        {
            public ColumnDescriptor()
                : base()
            {
                base.NSGType = typeof(ПланыАмортизации);
            }
			...
			public new ПланыАмортизации Value
            {
                get
                {
                    return (ПланыАмортизации)base.Value;
                }
                set
                {
                    base.Value = value;
